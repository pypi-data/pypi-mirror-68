from .basci_data_part1 import BasicDataPart1
from .basci_data_part2_fund_ret import BasicFundRet
...
class BasicDataProcessor(object):
    ...
    def process_all(self, start_date, end_date):
        ...
        failed_tasks.extend(self.basic_data_part1.process(start_date, end_date))
        failed_tasks.extend(self.basic_fund_ret.process(end_date))
