...
class AssetTradeParam:
    ...
    AssetPurchaseRate: AssetTradeRateItem=AssetTradeRateItem(csi500=0.011055, 
                                                            gem=0.010488, 
                                                            gold=0.001892, 
                                                            hs300=0.011987, 
                                                            national_debt=0.005438, 
                                                            sp500rmb=0.008135) #大类资产平均买入费率
    AssetRedeemRate: AssetTradeRateItem=AssetTradeRateItem(csi500=0.002973, 
                                                            gem=0.003407,
                                                            gold=0.000755,
                                                            hs300=0.004727,
                                                            national_debt=0.000287,
                                                            sp500rmb=0.003240) #大类资产平均卖出费率
