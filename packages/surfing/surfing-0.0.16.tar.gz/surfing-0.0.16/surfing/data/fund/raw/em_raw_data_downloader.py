...
class EmRawDataDownloader(object):
    ...
    def _upload_raw(self, df: pd.DataFrame, table_name: str):
        print(table_name)
    ...
    def add_columns_to_fin_fac(self, end_date: str):
        ...
        for row in db_session.query(EmStockFinFac):
            if row.DATES != datetime.datetime.strptime(end_date, '%Y%m%d').date().year:
                continue
    ...
    def em_tradedates(self, start_date, end_date):
        try:
            ...
            self._upload_raw(df, EmTradeDates.__table__.name)
            return True
        except Exception as e:
            print(e)
            traceback.print_stack()
...
if __name__ == '__main__':
    ...
    # em.em_stock_price('20200428', '20200428')
    # em.em_stock_daily_info('20200228', '20200228')
