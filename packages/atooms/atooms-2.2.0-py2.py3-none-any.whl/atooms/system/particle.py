...
def show_matplotlib(particle, cell, outfile='plot.png', linewidth=3, alpha=0.3):
    """
...
def show_ovito(particle, cell, radius=0.35, viewport=None, callback=None):
    """
    ...
    with trj.TrajectoryEXYZ(tmp_file, 'w') as th:
        th.write(system)
    for p in system.particle:
        p.position -= system.cell.side / 2
