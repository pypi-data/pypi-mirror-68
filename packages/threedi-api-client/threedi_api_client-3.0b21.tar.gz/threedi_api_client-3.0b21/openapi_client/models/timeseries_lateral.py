...
class TimeseriesLateral(object):
    ...
    def __init__(self, url=None, simulation=None, offset=None, interpolate=None, values=None, units=None, point=None, connection_node=None, state=None, state_detail=None, grid_id=None, id=None, uid=None):  # noqa: E501
