...
class WaterLevelProfileRequest(object):
    ...
    def __init__(self, geometry=None, points_limit=None, subscribe=None, subscribe_rate_limit=None):  # noqa: E501
    ...
    def points_limit(self, points_limit):
        ...
        :type: int
        """
        if points_limit is not None and points_limit > 200:  # noqa: E501
            raise ValueError("Invalid value for `points_limit`, must be a value less than or equal to `200`")  # noqa: E501
        if points_limit is not None and points_limit < 1:  # noqa: E501
    ...
    def subscribe_rate_limit(self, subscribe_rate_limit):
        ...
        :type: float
        """
        if subscribe_rate_limit is not None and subscribe_rate_limit > 1:  # noqa: E501
