...
class CfnLifecyclePolicy(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-dlm.CfnLifecyclePolicy"):
    ...
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnLifecyclePolicy":
    ...
    class CreateRuleProperty():
        def __init__(self, *, interval: jsii.Number, interval_unit: str, times: typing.Optional[typing.List[str]]=None) -> None:
            """
    ...
    class CrossRegionCopyRetainRuleProperty():
        def __init__(self, *, interval: typing.Optional[jsii.Number]=None, interval_unit: typing.Optional[str]=None) -> None:
            """
    ...
    class ParametersProperty():
        def __init__(self, *, exclude_boot_volume: typing.Optional[typing.Union[typing.Optional[bool], typing.Optional[aws_cdk.core.IResolvable]]]=None) -> None:
            """
...
class CfnLifecyclePolicyProps():
    def __init__(self, *, description: typing.Optional[str]=None, execution_role_arn: typing.Optional[str]=None, policy_details: typing.Optional[typing.Union[typing.Optional["CfnLifecyclePolicy.PolicyDetailsProperty"], typing.Optional[aws_cdk.core.IResolvable]]]=None, state: typing.Optional[str]=None) -> None:
