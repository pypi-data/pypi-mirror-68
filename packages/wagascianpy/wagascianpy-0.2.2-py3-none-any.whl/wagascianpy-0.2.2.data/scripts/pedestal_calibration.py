...
# WAGASCI modules
from anpy.analysis import WagasciAnalysis
from anpy.environment import WagasciEnvironment
from anpy.utils import limit_threads, join_threads
...
if __name__ == "__main__":
    PARSER = argparse.ArgumentParser(description='Analyze pedestal calibration data')
    ...
    PARSER.add_argument('--single-threshold', dest='single_threshold', action='store_true')
