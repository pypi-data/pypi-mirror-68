...
if __name__ == "__main__":
    ...
    BSD_DATABASE = ARGS.bsd_database[0]
    BSD_REPOSITORY = ARGS.bsd_repository[0] if ARGS.bsd_repository is not None else None
    T2KRUN = ARGS.t2krun
    RECURSIVE = ARGS.recursive

    anpy.beam_summary_data.beam_summary_data(INPUT_FILE, BSD_DATABASE, BSD_REPOSITORY, T2KRUN, RECURSIVE)
