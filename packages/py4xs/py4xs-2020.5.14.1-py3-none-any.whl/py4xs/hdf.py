...
class h5exp():
    ...
    def recalibrate(self, fn_std, det_type={"_SAXS": "Pilatus1M", "_WAXS2": "Pilatus1M"}):
        ...
        """
        pxsize = 0.172e-3
        dstd = h5xs(fn_std_h5, [self.detectors, self.qgrid]) 
        ...
        for det in self.detectors:
            ...
            ponit_file_text = ["poni_version: 2",
            ...
            if ep.flip: ## can only handle flip=1 right now
                ...
                ep.bm_ctr_y = yc
                ep.bm_ctr_x = xc
            print(f"bm_ctr_x = {ep.bm_ctr_x:.2f}, bm_ctr_y = {ep.bm_ctr_y:.2f}, ratioDw = {ep.ratioDw:.3f}")
