...
def imshow(dat, lbl=None, radius=1, vm=None, title=None, figsize=(7, 7), rgb=None):
    """
    ...
    kwargs = {}
    kwargs['cmap'] = plt.cm.gist_gray if not rgb else None 
...
def imoverlay(dat, lbl, vm=None):
    ...
    for channel in range(3):
        ...
        for i in range(lbl.shape[2]):
            layer[lbl[..., i]] = rgb[i % len(rgb)][channel]
