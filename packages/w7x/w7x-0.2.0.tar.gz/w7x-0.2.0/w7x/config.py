...
class Coils:
    # ideal coils ids
    idealNonPlanarCoilsIds = list(range(160, 210))  # non planar coils (5 each half module)
    idealPlanarCoilsIds = list(range(210, 230))  # planar A and B for all 10 half modules
    idealSweepCoilsIds = list(range(230, 240))  # sweep coils for all 10 half modules
    idealTrimCoilsIds = [350, 241, 351, 352, 353]  # trim coils in modules 1, 2(typeB), 3, 4, 5
    idealCoilsIds = idealNonPlanarCoilsIds + idealPlanarCoilsIds + idealSweepCoilsIds + idealTrimCoilsIds
    ...
    deformedCoilsIds = deformedNonPlanarCoilsIds + deformedPlanarCoilsIds + idealSweepCoilsIds + idealTrimCoilsIds  # No Sweep and Trim coils provided here!
    ...
    asbuiltCoilsIds = asbuiltNonPlanarCoilsIds + asbuiltPlanarCoilsIds + idealSweepCoilsIds + idealTrimCoilsIds  # No Sweep and Trim coils provided here!
...
class Defaults:
    ...
    class MagneticConfig:
        standard_rw = [1., 1., 1., 1., 1.] + [0.] * (2 + 2 + 5)
        high_iota_rw = [1., 1., 1., 1., 1., -0.23, -0.23] + [0.] * (2 + 5)
        low_iota_rw = [1., 1., 1., 1., 1., 0.25, 0.25] + [0.] * (2 + 5)
        inward_shifted_rw = [0.96, 0.95, 0.97, 1.07, 1.08, 0.1, -0.2] + [0.] * (2 + 5)  # NOQA
        outward_shifted_rw = [1.04, 1.04, 1.01, 0.96, 0.96, -0.14, 0.14] + [0.] * (2 + 5)  # NOQA
        low_mirror_rw = [0.94, 0.98, 0.98, 1.06, 1.06] + [0.] * (2 + 2 + 5)
        high_mirror_rw = [1.08, 1.05, 1.0, 0.95, 0.92] + [0.] * (2 + 2 + 5)
        low_shear_rw = [1.13, 1.12, 1.05, 0.85, 0.84, -0.2, 0.2] + [0.] * (2 + 5)  # NOQA
        limiter_case_rw = [1.07, 1.10, 1.02, 0.92, 0.89, -0.1, 0.2] + [0.] * (2 + 5)  # NOQA
        high_iota_a_rw = [1., 1., 1., 1., 1., -0.25, 0.] + [0.] * (2 + 5)
        high_iota_b_rw = [1., 1., 1., 1., 1., 0., -0.25] + [0.] * (2 + 5)
        low_iota_a_rw = [1., 1., 1., 1., 1., 0.25, 0.] + [0.] * (2 + 5)
        low_iota_b_rw = [1., 1., 1., 1., 1., 0., 0.25] + [0.] * (2 + 5)
