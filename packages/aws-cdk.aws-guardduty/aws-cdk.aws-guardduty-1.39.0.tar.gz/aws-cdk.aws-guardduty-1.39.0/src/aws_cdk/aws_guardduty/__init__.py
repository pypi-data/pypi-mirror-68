...
class CfnDetector(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-guardduty.CfnDetector"):
    ...
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnDetector":
...
class CfnDetectorProps():
    def __init__(self, *, enable: typing.Union[bool, aws_cdk.core.IResolvable], finding_publishing_frequency: typing.Optional[str]=None) -> None:
...
class CfnFilter(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-guardduty.CfnFilter"):
    ...
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, action: str, description: str, detector_id: str, finding_criteria: typing.Union[aws_cdk.core.IResolvable, "FindingCriteriaProperty"], name: str, rank: jsii.Number) -> None:
        ...
        """
        props = CfnFilterProps(action=action, description=description, detector_id=detector_id, finding_criteria=finding_criteria, name=name, rank=rank)

        jsii.create(CfnFilter, self, [scope, id, props])

    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnFilter":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    class ConditionProperty():
        def __init__(self, *, eq: typing.Optional[typing.List[str]]=None, gte: typing.Optional[jsii.Number]=None, lt: typing.Optional[jsii.Number]=None, lte: typing.Optional[jsii.Number]=None, neq: typing.Optional[typing.List[str]]=None) -> None:
            """
    ...
    class FindingCriteriaProperty():
        def __init__(self, *, criterion: typing.Any=None, item_type: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnFilter.ConditionProperty"]]]=None) -> None:
            """
...
@jsii.data_type(jsii_type="@aws-cdk/aws-guardduty.CfnFilterProps", jsii_struct_bases=[], name_mapping={'action': 'action', 'description': 'description', 'detector_id': 'detectorId', 'finding_criteria': 'findingCriteria', 'name': 'name', 'rank': 'rank'})
class CfnFilterProps():
    def __init__(self, *, action: str, description: str, detector_id: str, finding_criteria: typing.Union[aws_cdk.core.IResolvable, "CfnFilter.FindingCriteriaProperty"], name: str, rank: jsii.Number) -> None:
...
class CfnIPSetProps():
    def __init__(self, *, activate: typing.Union[bool, aws_cdk.core.IResolvable], detector_id: str, format: str, location: str, name: typing.Optional[str]=None) -> None:
...
class CfnMaster(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-guardduty.CfnMaster"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnMaster":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
class CfnMasterProps():
    def __init__(self, *, detector_id: str, master_id: str, invitation_id: typing.Optional[str]=None) -> None:
...
class CfnMember(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-guardduty.CfnMember"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnMember":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
class CfnMemberProps():
    def __init__(self, *, detector_id: str, email: str, member_id: str, disable_email_notification: typing.Optional[typing.Union[typing.Optional[bool], typing.Optional[aws_cdk.core.IResolvable]]]=None, message: typing.Optional[str]=None, status: typing.Optional[str]=None) -> None:
...
class CfnThreatIntelSet(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-guardduty.CfnThreatIntelSet"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnThreatIntelSet":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
