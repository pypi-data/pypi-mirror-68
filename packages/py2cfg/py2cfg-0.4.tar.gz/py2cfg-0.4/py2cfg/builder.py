...
from _ast import Assign, AugAssign, Call, ClassDef, Compare, Expr, FunctionDef, If, Module, Return, stmt, While, Yield  # type: ignore
from .model import Block, Link, CFG
...
class CFGBuilder(ast.NodeVisitor):
    ...
    def __init__(self, short: bool = False, label_edges: bool = True):
        self.isShort = short
        self.labelEdges = label_edges
    ...
    def build(
        ...
        """
        self.cfg = CFG(
            name, asynchr=asynchr, short=self.isShort, label_edges=self.labelEdges
        )
    ...
    def build_from_file(self, name: str, filepath: str):
        """
    ...
    def new_classCFG(self, node: ClassDef, asynchr: bool = False) -> None:
        ...
        class_builder = CFGBuilder(short=self.isShort, label_edges=self.labelEdges)
    ...
    def new_functionCFG(self, node: FunctionDef, asynchr: bool = False) -> None:
        ...
        func_builder = CFGBuilder(short=self.isShort, label_edges=self.labelEdges)
