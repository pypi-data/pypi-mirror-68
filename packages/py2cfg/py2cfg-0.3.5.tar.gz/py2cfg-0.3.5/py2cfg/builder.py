...
class CFGBuilder(ast.NodeVisitor):
    ...
    def build(self, name: str, tree: Module, asynchr: bool = False, entry_id: int = 0) -> CFG:
        """
    ...
    def add_exit(self, block: Block, nextblock: Block, exitcase: Optional[Compare] = None) -> None:
        """
    ...
    def new_classCFG(self, node: ClassDef, asynchr: bool = False) -> None:
        ...
        class_builder = CFGBuilder()
        self.cfg.classcfgs[node.name] = class_builder.build(node.name,
                                                              class_body,
                                                              asynchr,
                                                              self.current_id)
