...
class IconControllerApi(object):
    ...
    def find_all_by_key(self, key, **kwargs):  # noqa: E501
        """find_all_by_key  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.find_all_by_key(key, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.find_all_by_key_with_http_info(key, **kwargs)  # noqa: E501

    def find_all_by_key_with_http_info(self, key, **kwargs):  # noqa: E501
        """find_all_by_key  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.find_all_by_key_with_http_info(key, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('key' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `key` when calling `find_all_by_key`")  # noqa: E501
