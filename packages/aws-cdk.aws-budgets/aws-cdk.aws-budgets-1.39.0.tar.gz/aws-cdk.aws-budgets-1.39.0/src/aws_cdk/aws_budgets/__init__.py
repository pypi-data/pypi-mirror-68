...
class CfnBudget(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-budgets.CfnBudget"):
    ...
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnBudget":
    ...
    class NotificationProperty():
        def __init__(self, *, comparison_operator: str, notification_type: str, threshold: jsii.Number, threshold_type: typing.Optional[str]=None) -> None:
            """
    ...
    class NotificationWithSubscribersProperty():
        def __init__(self, *, notification: typing.Union[aws_cdk.core.IResolvable, "CfnBudget.NotificationProperty"], subscribers: typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnBudget.SubscriberProperty"]]]) -> None:
            """
    ...
    class TimePeriodProperty():
        def __init__(self, *, end: typing.Optional[str]=None, start: typing.Optional[str]=None) -> None:
            """
