...
class Runner():
    ...
    def process_run_command(self, args):
        ...
        # if monitor_url:
        #     console.print()
        #     console.print("monitor job at: " + monitor_url)
        ...
        if not fake_submit:
            ...
            dd = {"job_id": job_id, "job_num": job_num, "compute": compute, "ws_name": workspace, "exper_name": experiment, 
                ...
                "service_job_info": service_job_info, "service_info_by_node": service_info_by_node,
    ...
    def build_static_hparam_cmds(self, cmd_line, node_count, args):
        ...
        search_type = args["search_type"]
        fn_sweeps = args["hp_config"]
        static_search = True        # hard code this, for now
