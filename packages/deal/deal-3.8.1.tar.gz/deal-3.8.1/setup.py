...
setup(
    ...
    package_data={
        "deal": ["*.typed"],
        "deal.linter": [
            "stubs/cpython/*.json", "stubs/dateutil/*.json",
    ...
    extras_require={
        "dev": [
            "coverage", "coverage-conditional-plugin", "coveralls",
            "isort[pyproject]", "m2r", "marshmallow", "mypy", "pytest",
            "pytest-cov", "recommonmark", "sphinx", "sphinx-rtd-theme",
            "urllib3"
        ],
        "docs": [
        ...
        "tests": [
            "coverage", "coverage-conditional-plugin", "coveralls",
            "isort[pyproject]", "marshmallow", "mypy", "pytest", "pytest-cov",
            "urllib3"
        ]
    },
)
