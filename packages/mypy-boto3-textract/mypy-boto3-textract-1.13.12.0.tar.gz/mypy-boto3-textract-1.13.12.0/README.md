...
[boto3.Textract 1.13.12](https://boto3.amazonaws.com/v1/documentation/api/1.13.12/reference/services/textract.html#Textract) service
...
client: textract.TextractClient = boto3.client("textract")

# works for session as well
session = boto3.session.Session(region="us-west-1")
session_client: textract.TextractClient = session.client("textract")
