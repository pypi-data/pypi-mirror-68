...
def alembic_export(filepath: str = "",
    ...
    :param start: Start Frame, Start Frame 
    :type start: int
    :param end: End Frame, End Frame 
    :type end: int
...
def append(
    ...
    :param sort_method: File sorting modeFILE_SORT_ALPHA Sort alphabetically, Sort the file list alphabetically.FILE_SORT_EXTENSION Sort by extension, Sort the file list by extension/type.FILE_SORT_TIME Sort by time, Sort files by modification time.FILE_SORT_SIZE Sort by size, Sort files by size. 
    :type sort_method: typing.Union[int, str]
    :param link: Link, Link the objects or datablocks rather than appending 
    :type link: bool
...
def collada_export(filepath: str = "",
                   ...
                   include_uv_textures: bool = False,
                   include_material_textures: bool = False,
    ...
    :param export_transformation_type_selection: Transform, Transformation type for translation, scale and rotationmatrix Matrix, Use <matrix> to specify transformations.transrotloc TransRotLoc, Use <translate>, <rotate>, <scale> to specify transformations.both Both, Use <matrix> AND <translate>, <rotate>, <scale> to specify transformations. 
...
def previews_clear(id_type: typing.Union[typing.Set[int], typing.Set[str]] = {
    ...
    :param id_type: DataBlock Type, Which datablock previews to clear 
...
def read_homefile(filepath: str = "", load_ui: bool = True):
