...
class Matrix:
    ...
    def decompose(self, ) -> typing.Union['Quaternion', 'Vector']:
    ...
    def invert(self, fallback: 'Matrix' = None):
        ...
        :param fallback: Set the matrix to this value when the inverse can’t be calculated (instead of raising a ValueError exception). 
