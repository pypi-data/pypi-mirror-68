...
def bevel(bm: 'bmesh.types.BMesh',
          geom: typing.Union[typing.List['bmesh.types.BMVert'], typing.
                             ...
                             List['bmesh.types.BMFace']], offset: float,
...
def bisect_plane(
    ...
    :return:  geom_cut: output new geometry from the cuttype list of (bmesh.types.BMVert, bmesh.types.BMEdge)geom: input and output geometry (result of cut)type list of (bmesh.types.BMVert, bmesh.types.BMEdge, bmesh.types.BMFace) 
    '''
...
def create_monkey(bm: 'bmesh.types.BMesh', matrix: 'mathutils.Matrix') -> dict:
...
def delete(bm: 'bmesh.types.BMesh',
           geom: typing.Union[typing.List['bmesh.types.BMVert'], typing.
                              List['bmesh.types.BMEdge'], typing.
                              List['bmesh.types.BMFace']], context: int):
...
def extrude_face_region(
    ...
    :param use_keep_orig: keep original geometry 
...
def symmetrize(bm: 'bmesh.types.BMesh',
               input: typing.Union[typing.List['bmesh.types.BMVert'], typing.
                                   List['bmesh.types.BMEdge'], typing.
                                   List['bmesh.types.BMFace']], direction: int,
               dist: float) -> dict:
