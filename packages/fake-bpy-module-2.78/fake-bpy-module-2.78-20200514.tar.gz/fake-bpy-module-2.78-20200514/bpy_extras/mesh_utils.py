...
def edge_loops_from_tessfaces(
        mesh: 'bpy.types.Mesh',
        tessfaces: typing.List['bpy.types.MeshTessFace'] = None,
        seams=()) -> list:
    ...
    :type tessfaces: typing.List['bpy.types.MeshTessFace']
...
def face_random_points(
        num_points, tessfaces: typing.List['bpy.types.MeshTessFace']) -> list:
