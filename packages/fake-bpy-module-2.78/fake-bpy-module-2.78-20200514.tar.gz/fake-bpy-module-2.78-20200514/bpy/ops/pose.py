...
def breakdown(prev_frame: int = 0,
              next_frame: int = 0,
...
def paths_calculate(start_frame: int = 1,
                    end_frame: int = 250,
                    bake_location: typing.Union[int, str] = 'TAILS'):
...
def push(prev_frame: int = 0, next_frame: int = 0, percentage: float = 0.5):
...
def relax(prev_frame: int = 0, next_frame: int = 0, percentage: float = 0.5):
