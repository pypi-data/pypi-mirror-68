...
def group_operation(type: typing.Union[int, str] = 'UNLINK'):
    '''Undocumented 
...
def parent_clear(dragged_obj: str = "Object",
                 type: typing.Union[int, str] = 'CLEAR'):
...
def parent_drop(child: str = "Object",
                parent: str = "Object",
                type: typing.Union[int, str] = 'OBJECT'):
