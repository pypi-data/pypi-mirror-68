...
[boto3.Route53Resolver 1.13.12](https://boto3.amazonaws.com/v1/documentation/api/1.13.12/reference/services/route53resolver.html#Route53Resolver) service
...
client: route53resolver.Route53ResolverClient = boto3.client("route53resolver")

# works for session as well
session = boto3.session.Session(region="us-west-1")
session_client: route53resolver.Route53ResolverClient = session.client("route53resolver")
