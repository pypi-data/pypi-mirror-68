...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', 'v2.4.0-alpha.1588967589+g8edd4e7'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud v2.4.0-alpha.1588967589+g8edd4e7`
                """)
            else:
                raise
