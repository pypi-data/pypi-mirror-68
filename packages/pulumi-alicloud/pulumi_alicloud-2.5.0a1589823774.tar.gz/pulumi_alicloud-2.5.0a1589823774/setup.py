...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', 'v2.5.0-alpha.1589823774+g219f08b'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud v2.5.0-alpha.1589823774+g219f08b`
                """)
            else:
                raise
