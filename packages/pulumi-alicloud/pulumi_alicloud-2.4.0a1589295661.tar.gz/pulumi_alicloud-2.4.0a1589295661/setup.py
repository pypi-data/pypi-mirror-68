...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', 'v2.4.0-alpha.1589295661+g9c15a18'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud v2.4.0-alpha.1589295661+g9c15a18`
                """)
            else:
                raise
