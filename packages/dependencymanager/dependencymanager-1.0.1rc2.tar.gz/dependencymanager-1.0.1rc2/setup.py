...
https://github.com/davincif/dependency_manager
"""
...
setup(
	...
	url='https://github.com/davincif/dependency_manager',  # Optional

	# This should be your name or the name of the organization which owns the
	# project.
	author='davincif',  # Optional

	# This should be a valid email address corresponding to the author listed
	# above.
	author_email='davincif@davincif.com',  # Optional
	...
	keywords='package management manager pypi version development',  # Optional
