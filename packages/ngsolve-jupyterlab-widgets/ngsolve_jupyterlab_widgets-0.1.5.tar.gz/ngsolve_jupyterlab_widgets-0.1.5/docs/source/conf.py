...
# -*- coding: utf-8 -*-
#
# ngsolve_jupyterlab_widgets documentation build configuration file
#
...
project = 'ngsolve_jupyterlab_widgets'
copyright = '2020, Matthias Hochsteger'
...
_version_py = os.path.join(repo, 'ngsolve_jupyterlab_widgets', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'ngsolve_jupyterlab_widgetsdoc'
...
latex_documents = [
    (master_doc, 'ngsolve_jupyterlab_widgets.tex', 'ngsolve_jupyterlab_widgets Documentation',
     'Matthias Hochsteger', 'manual'),
]
...
man_pages = [
    ...
    'ngsolve_jupyterlab_widgets Documentation',
     [author], 1)
]
