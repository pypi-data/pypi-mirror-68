...
user = {
    ...
    '{'
    '<{can,why,how,[what,mean]},you,family>,[you,{cant,cannot,dont,do not,arent,are not},family],<family,you,impossible>,'
    '[you,{dont,do not},body],[{you,youre},{arent,are not},real],[{you are,youre,your},{robot,computer,device}]'
    '}':{
        'state': 'probe_family',

        '`I actually do have a family. '
        'I mean of course I think of the people who created me as my family. '
        'But, even beyond that, I treat their family as also being my family too.`': {
    ...
    '{[{do,can},{you,your},#LEM(have),#LEM(parent)],[who,are,your,#LEM(parent)]}': {
        'state': 'probe_parent',

        '`I do have what I would consider a main mom and dad from the team that made me, but I cannot really tell you '
        'any more than that because of the rules of the competition.`': {
