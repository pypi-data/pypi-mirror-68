...
system = {
    ...
    '`I am really looking forward to having them over, they haven\'t seen my new house and I want to meet my niece. '
...
user = {
    ...
    '{'
    '<you,{underwater,[{in,under},water]}>,'
    '<{can,why,how,[what,mean]},you,#LEM(swim)>,[you,{cant,cannot,dont,do not,arent,are not},#LEM(swim)],<#LEM(swim),you,impossible>,'
    '[you,{dont,do not},body],[{you,youre},{arent,are not},real],[{you are,youre,your},{robot,computer,device}],'
    '<{why,how,[what,mean]},you,[{own,have,live},{house,apartment,place,home}]>,[you,{cant,cannot,dont,do not},[{own,have,live},{house,apartment,place,home}]],<[{own,have,live},{house,apartment,place,home}],you,impossible>'
    '}': {
        'state': 'probe_robot',

        '`I know this probably isn\'t what you were thinking, but I do have a body and a life in the virtual world that I live in. '
        'I can live in a house and go swimming and do a lot of things like you do.`': {
