...
from dash_html_components import H5, H6, Div

from ..components import ComponentGroup
from ..html_helpers.divs import Container, Row
from . import as_component
...
class KWSDashApp:
    ...
    def create_header(self):
        self.component_layouts.append(
            as_component(H5, "title", self.name, container=Row).layout()
        )

        self.component_layouts.append(
            as_component(H6, "description", self.doc, container=Row).layout()
        )
