...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'docker', 'v2.2.0-alpha.1589877225+g20cff88'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource docker v2.2.0-alpha.1589877225+g20cff88`
                """)
            else:
                raise
