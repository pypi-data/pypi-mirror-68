...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'docker', 'v2.2.0-alpha.1589293336+g89ea4c0'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource docker v2.2.0-alpha.1589293336+g89ea4c0`
                """)
            else:
                raise
