"""Utility to dump out the contents of a type library to a file

Adapted from tlbrowse.py in the win32com.client package
...
def getInfoFrom(tlb, pos):
	...
	ret = []
	info = tlb.GetTypeInfo(pos)
	attr = info.GetTypeAttr()
	realPos, isMethod = GetRealMemberPos(attr, pos)
	if isMethod:
		id = info.GetFuncDesc(realPos)[0]
...
if __name__=='__main__':
	...
	try:
		...
		path = r"c:\program files\vb5cce\vb5.olb"
	dumpLibrary(path)
