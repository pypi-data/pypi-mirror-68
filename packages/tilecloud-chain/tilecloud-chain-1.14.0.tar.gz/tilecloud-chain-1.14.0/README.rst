...
you should have ``legend_mime`` and ``legend_extension`` in the layer configuration.
...
it still stores in the file named ``legend0.{{legend_extension}}``.
...
Proxy/cache issue for additional information.
