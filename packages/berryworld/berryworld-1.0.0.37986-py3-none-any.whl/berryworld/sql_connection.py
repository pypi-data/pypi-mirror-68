...
class SQLConnection:
    ...
    def open_read_connection(self):
        ...
        if self.wincred:
            if self.master:
                self.con = pyodbc.connect("Driver={" + self.driver + "};Server=" + self.server + ";uid=" +
                                          self.user_name + ";pwd=" + self.password + ";trusted_connection=yes")
            else:
                self.con = pyodbc.connect("Driver={" + self.driver + "};Server=" + self.server +
                                          ";Database=" + self.db_name + ";uid=" + self.user_name + ";pwd=" +
                                          self.password + ";trusted_connection=yes")
        else:
            self.con = pyodbc.connect("Driver={" + self.driver + "};Server=" + self.server + ";Database=" +
