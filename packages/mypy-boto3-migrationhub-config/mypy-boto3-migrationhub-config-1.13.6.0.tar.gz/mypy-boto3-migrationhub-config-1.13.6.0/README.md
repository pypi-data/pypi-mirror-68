...
[boto3.MigrationHubConfig 1.13.6](https://boto3.amazonaws.com/v1/documentation/api/1.13.6/reference/services/migrationhub-config.html#MigrationHubConfig) service
