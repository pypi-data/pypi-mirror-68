...
class PostInstallCommand(install):
    def run(self):
        install.run(self)
        print("mypy_boto3: Running post-install script for mypy-boto3-ecr")
        try:
            from mypy_boto3.main import add_package_to_index

            add_package_to_index("ecr")
            print("mypy_boto3: Service ecr added to index")
        except Exception as e:
            print("mypy_boto3: Package index update failed for mypy-boto3-ecr:", e)
...
setup(
    ...
    description="Type annotations for boto3.ECR 1.13.10 service, generated by mypy-boto3-buider 1.0.9",
    classifiers=[
