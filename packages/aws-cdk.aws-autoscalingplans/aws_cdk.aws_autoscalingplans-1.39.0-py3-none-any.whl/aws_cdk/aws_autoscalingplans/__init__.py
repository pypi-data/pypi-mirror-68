...
class CfnScalingPlan(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-autoscalingplans.CfnScalingPlan"):
    ...
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnScalingPlan":
    ...
    class ApplicationSourceProperty():
        def __init__(self, *, cloud_formation_stack_arn: typing.Optional[str]=None, tag_filters: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnScalingPlan.TagFilterProperty"]]]]]=None) -> None:
            """
    ...
    class CustomizedLoadMetricSpecificationProperty():
        def __init__(self, *, metric_name: str, namespace: str, statistic: str, dimensions: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnScalingPlan.MetricDimensionProperty"]]]]]=None, unit: typing.Optional[str]=None) -> None:
            """
    ...
    class PredefinedLoadMetricSpecificationProperty():
        def __init__(self, *, predefined_load_metric_type: str, resource_label: typing.Optional[str]=None) -> None:
            """
    ...
    class PredefinedScalingMetricSpecificationProperty():
        def __init__(self, *, predefined_scaling_metric_type: str, resource_label: typing.Optional[str]=None) -> None:
            """
...
class CfnScalingPlanProps():
    def __init__(self, *, application_source: typing.Union["CfnScalingPlan.ApplicationSourceProperty", aws_cdk.core.IResolvable], scaling_instructions: typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnScalingPlan.ScalingInstructionProperty"]]]) -> None:
