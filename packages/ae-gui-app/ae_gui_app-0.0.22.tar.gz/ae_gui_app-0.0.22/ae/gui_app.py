...
class MainAppBase(ConsoleApp, ABC):
    ...
    def change_flow(self, ifi: str, popups_to_close: Sequence = (), **event_kwargs) -> bool:
        ...
        if not self.call_method(flow_event_name(ifi), ifi, event_kwargs) \
            ...
            self.vpo(f"MainAppBase.change_flow REJECTED '{ifi}'; flow='{self.flow_id}' path={self.flow_path}")
            return False
        ...
        self.vpo(f"MainAppBase.change_flow CHANGED '{ifi}'; flow='{self.flow_id}' last='{self._last_focus_flow_id}'"
