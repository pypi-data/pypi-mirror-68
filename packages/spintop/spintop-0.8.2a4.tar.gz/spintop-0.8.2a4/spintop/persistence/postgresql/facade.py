...
class PostgreSQLPersistenceFacade(PersistenceFacade):
    def __init__(self, sql_engine, group_name='default'):
    ...
    def from_env(cls, uri, database_name, env=None):
        # uri contains database, group_name defines the database tenant.
        return cls(engine_from_uri(uri), group_name=database_name)
