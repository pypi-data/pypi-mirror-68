...
def init(loadPrelude=True, randomSeed=0, advise=True):
    r"""
    Init Maude.
    ...
    """
    return _maude.init(loadPrelude, randomSeed, advise)
...
class StateTransitionGraph(object):
    ...
    def modelCheck(self, formula):
        ...
        """
        return _maude.StateTransitionGraph_modelCheck(self, formula)
...
class StrategyTransitionGraph(object):
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    RULE_APPLICATION = _maude.StrategyTransitionGraph_RULE_APPLICATION
    r""" rule application"""
    OPAQUE_STRATEGY = _maude.StrategyTransitionGraph_OPAQUE_STRATEGY
    r""" opaque strategy"""
    SOLUTION = _maude.StrategyTransitionGraph_SOLUTION
    ...
    def getStateStrategy(self, stateNr):
        ...
        """
        return _maude.StrategyTransitionGraph_getStateStrategy(self, stateNr)
    ...
    def getTransition(self, origin, dest):
        ...
        """
        return _maude.StrategyTransitionGraph_getTransition(self, origin, dest)
    ...
    def modelCheck(self, formula):
        ...
        :return: The result of model checking.
        """
        return _maude.StrategyTransitionGraph_modelCheck(self, formula)
...
class Term(object):
    ...
    def ground(self):
        ...
        Notes: This function is not accurate (false negatives).
        """
...
class Module(object):
    ...
    def downStrategy(self, term):
        ...
        this module, which must include the ``META-LEVEL`` module.
    ...
    def downModule(self, term):
        ...
        :param term: The metarepresentation of a module, that is,
            ...
            The term will be reduced.
        """
        return _maude.Module_downModule(self, term)
