...
class CfnMember(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-managedblockchain.CfnMember"):
    ...
    class ApprovalThresholdPolicyProperty():
        def __init__(self, *, proposal_duration_in_hours: typing.Optional[jsii.Number]=None, threshold_comparator: typing.Optional[str]=None, threshold_percentage: typing.Optional[jsii.Number]=None) -> None:
            """
    ...
    class MemberConfigurationProperty():
        def __init__(self, *, name: str, description: typing.Optional[str]=None, member_framework_configuration: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnMember.MemberFrameworkConfigurationProperty"]]]=None) -> None:
            """
    ...
    class MemberFrameworkConfigurationProperty():
        def __init__(self, *, member_fabric_configuration: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnMember.MemberFabricConfigurationProperty"]]]=None) -> None:
            """
    ...
    class NetworkFrameworkConfigurationProperty():
        def __init__(self, *, network_fabric_configuration: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnMember.NetworkFabricConfigurationProperty"]]]=None) -> None:
            """
    ...
    class VotingPolicyProperty():
        def __init__(self, *, approval_threshold_policy: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnMember.ApprovalThresholdPolicyProperty"]]]=None) -> None:
            """
...
class CfnMemberProps():
    def __init__(self, *, member_configuration: typing.Union["CfnMember.MemberConfigurationProperty", aws_cdk.core.IResolvable], invitation_id: typing.Optional[str]=None, network_configuration: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnMember.NetworkConfigurationProperty"]]]=None, network_id: typing.Optional[str]=None) -> None:
...
class CfnNode(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-managedblockchain.CfnNode"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnNode":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
class CfnNodeProps():
    def __init__(self, *, member_id: str, network_id: str, node_configuration: typing.Union[aws_cdk.core.IResolvable, "CfnNode.NodeConfigurationProperty"]) -> None:
