...
from typing import TypeVar, Type, Union, Tuple, Callable
from datetime import datetime
T = TypeVar('T')


def check_var_input(message: str, output_type:Union[Type[T], Tuple[Type[T], Callable[[str], T]]]=str, end: str = '\n', question_start:str=' -> ', type_error_message:str='Invalid type', confirm_answer:bool=True, default:Union[T, Type[NoneClass]]=NoneClass, show_default:bool=True, **confirmation_binary_user_question_kwargs)->T:
