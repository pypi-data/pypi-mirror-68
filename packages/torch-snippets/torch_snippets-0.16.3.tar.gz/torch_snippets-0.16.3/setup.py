...
setup(
  ...
  version = '0.16.3',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/sizhky/torch_snippets/archive/0.16.3.tar.gz',    # I explain this later on
