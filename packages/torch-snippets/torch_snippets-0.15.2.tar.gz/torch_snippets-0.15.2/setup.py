...
setup(
  ...
  version = '0.15.2',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/sizhky/torch_snippets/archive/0.15.2.tar.gz',    # I explain this later on
