'v0.15.1'
'''Todo
- [ ] Make Colab compatible
- [ ] have a better keyword for transient log (`templog`)
- [ ] accumulate values
- [ ] convert to numpy if torch value is sent
- [ ] use regexs for plotting metrics
- [ ] add .plot_epochs()
'''
...
class Report:
    ...
    def record(self, pos, **metrics):
        for k,v in metrics.items():
            if k in ['end','pos','colab']: continue
            if hasattr(self, k):
