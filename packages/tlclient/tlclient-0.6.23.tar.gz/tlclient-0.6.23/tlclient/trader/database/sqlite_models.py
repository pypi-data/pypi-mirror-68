...
from peewee import CharField, CompositeKey, DoubleField, IntegerField, Model, SqliteDatabase

order_info_db = SqliteDatabase(None)
...
class OrderInfo(Model):
    """
        message_pb.RspOrderInfo
    """
    class Meta:
        database = order_info_db
...
class RtnOrder(Model):
    ...
    class Meta:
        ...
        primary_key = CompositeKey('order_id', 'order_status', 'traded_vol')
