...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, pulp_href=None, base_path=None, repository_version=None, content_guard=None, pulp_created=None, repository=None, name=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
