...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, pulp_href=None, base_path=None, content_guard=None, repository_version=None, pulp_created=None, name=None, repository=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
