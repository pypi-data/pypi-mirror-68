...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, pulp_created=None, repository=None, name=None, pulp_href=None, content_guard=None, base_path=None, repository_version=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
