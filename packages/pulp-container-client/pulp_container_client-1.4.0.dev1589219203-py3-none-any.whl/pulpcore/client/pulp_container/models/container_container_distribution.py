...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, content_guard=None, repository=None, name=None, pulp_href=None, pulp_created=None, repository_version=None, base_path=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
