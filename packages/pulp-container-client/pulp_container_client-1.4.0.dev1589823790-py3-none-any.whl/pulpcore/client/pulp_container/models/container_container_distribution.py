...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, name=None, repository_version=None, pulp_created=None, repository=None, content_guard=None, base_path=None, pulp_href=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
