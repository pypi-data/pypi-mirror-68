...
class CfnLoadBalancer(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-elasticloadbalancing.CfnLoadBalancer"):
    ...
    class AccessLoggingPolicyProperty():
        def __init__(self, *, enabled: typing.Union[bool, aws_cdk.core.IResolvable], s3_bucket_name: str, emit_interval: typing.Optional[jsii.Number]=None, s3_bucket_prefix: typing.Optional[str]=None) -> None:
            """
    ...
    class AppCookieStickinessPolicyProperty():
        def __init__(self, *, cookie_name: str, policy_name: str) -> None:
            """
    ...
    class ConnectionDrainingPolicyProperty():
        def __init__(self, *, enabled: typing.Union[bool, aws_cdk.core.IResolvable], timeout: typing.Optional[jsii.Number]=None) -> None:
            """
    ...
    class HealthCheckProperty():
        def __init__(self, *, healthy_threshold: str, interval: str, target: str, timeout: str, unhealthy_threshold: str) -> None:
            """
    ...
    class LBCookieStickinessPolicyProperty():
        def __init__(self, *, cookie_expiration_period: typing.Optional[str]=None, policy_name: typing.Optional[str]=None) -> None:
            """
    ...
    class ListenersProperty():
        def __init__(self, *, instance_port: str, load_balancer_port: str, protocol: str, instance_protocol: typing.Optional[str]=None, policy_names: typing.Optional[typing.List[str]]=None, ssl_certificate_id: typing.Optional[str]=None) -> None:
            """
    ...
    class PoliciesProperty():
        def __init__(self, *, attributes: typing.Union[typing.List[typing.Any], aws_cdk.core.IResolvable], policy_name: str, policy_type: str, instance_ports: typing.Optional[typing.List[str]]=None, load_balancer_ports: typing.Optional[typing.List[str]]=None) -> None:
            """
...
class LoadBalancerListener():
    def __init__(self, *, external_port: jsii.Number, allow_connections_from: typing.Optional[typing.List[aws_cdk.aws_ec2.IConnectable]]=None, external_protocol: typing.Optional["LoadBalancingProtocol"]=None, internal_port: typing.Optional[jsii.Number]=None, internal_protocol: typing.Optional["LoadBalancingProtocol"]=None, policy_names: typing.Optional[typing.List[str]]=None, ssl_certificate_id: typing.Optional[str]=None) -> None:
        """Add a backend to the load balancer.
