...
def project_documents(topic_ontology):
    def project_document(argument):
        ...
        set_cluster_mode()
        path_corpus = get_source_subset_path("ontology-"+topic_ontology,'part1')
    ...
    path_document_vectors= get_path_document_vectors('sample',topic_ontology+'-part1','word2vec-esa-100').replace(".csv","")
