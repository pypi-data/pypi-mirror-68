...
.. |commits-since| image:: https://img.shields.io/github/commits-since/samesense/python-bmpr/v0.0.2.svg
    :alt: Commits since latest release
    :target: https://github.com/samesense/python-bmpr/compare/v0.0.2...master
