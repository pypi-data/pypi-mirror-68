...
/*-----------------------------------------------
              @(target):= _polyclipNP.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__polyclipNP

#else
#  define SWIG_init    init_polyclipNP

#endif
#define SWIG_name    "_polyclipNP"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_polyclip_multi4(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "polyclip_multi4", 13, 13, swig_obj)) SWIG_fail;
  {
    npy_intp size[1] = {
      -1
    };
  ...
  }
  {
    ...
    arg12 = (float*) array_data(array11);
  }
  ecode13 = SWIG_AsVal_int(swig_obj[6], &val13);
  if (!SWIG_IsOK(ecode13)) {
    SWIG_exception_fail(SWIG_ArgError(ecode13), "in method '" "polyclip_multi4" "', argument " "13"" of type '" "int""'");
  } 
  arg13 = (int)(val13);
  {
  ...
  }
  {
    ...
    arg17 = (int*) array_data(array16);
  }
  {
    array18 = obj_to_array_no_conversion(swig_obj[9], NPY_INT);
    ...
    arg19 = (int*) array_data(array18);
  }
  {
    array20 = obj_to_array_no_conversion(swig_obj[10], NPY_INT);
    if (!array20 || !require_dimensions(array20,1) || !require_contiguous(array20)
      || !require_native(array20)) SWIG_fail;
    arg20 = 1;
    for (i20=0; i20 < array_numdims(array20); ++i20) arg20 *= array_size(array20,i20);
    arg21 = (int*) array_data(array20);
  }
  {
    array22 = obj_to_array_no_conversion(swig_obj[11], NPY_FLOAT);
    if (!array22 || !require_dimensions(array22,1) || !require_contiguous(array22)
      || !require_native(array22)) SWIG_fail;
    arg22 = 1;
    for (i22=0; i22 < array_numdims(array22); ++i22) arg22 *= array_size(array22,i22);
    arg23 = (float*) array_data(array22);
  }
  {
    array24 = obj_to_array_no_conversion(swig_obj[12], NPY_INT);
    if (!array24 || !require_dimensions(array24,1) || !require_contiguous(array24)
      || !require_native(array24)) SWIG_fail;
    arg24 = 1;
    for (i24=0; i24 < array_numdims(array24); ++i24) arg24 *= array_size(array24,i24);
    arg25 = (int*) array_data(array24);
  }
  polyclip_multi4(arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9,arg10,arg11,arg12,arg13,arg14,arg15,arg16,arg17,arg18,arg19,arg20,arg21,arg22,arg23,arg24,arg25);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "polyclip_multi4", _wrap_polyclip_multi4, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
