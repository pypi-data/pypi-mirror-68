...
class HyperDriveRun(Run):
    ...
    def cancel(self):
        ...
        run_history_host = get_service_url(project_auth, project_context.get_workspace_uri_path(),
                                           ...
                                           self.experiment.workspace.discovery_url)
        ...
        try:
            ...
            raise TrainingException("Exception occurred while cancelling HyperDrive run.",
    ...
    def _get_best_run_by_primary_metric_stored_in_parent(self, include_failed=True, include_canceled=True):
        ...
        if not run_id or not value or is_final is None:
            return None, None
