...
class Buffer:
    ...
    def __init__(self,
                 ...
                 ) -> typing.Union['bpy.context.object', 'Buffer']:
...
def glCopyTexImage2D(p0: int, p1: int, p2: int, p3: int, p4: int, p5: int,
                     p6: int, p7: int):
    '''
...
def glCreateShader(
        shaderType: typing.Union['GL_VERTEX_SHADER', 'GL_GEOMETRY_SHADER']
) -> int:
    '''Creates a shader object. 

    :type shaderType: typing.Union['GL_VERTEX_SHADER', 'GL_GEOMETRY_SHADER']
...
def glGetTexImage(p0: int, p1: int, p2: int, p3: int, p4):
    '''
...
def glReadPixels(p0: int, p1: int, p2: int, p3: int, p4: int, p5: int, p6):
    '''
...
def glTexImage1D(p0: int, p1: int, p2: int, p3: int, p4: int, p5: int, p6: int,
                 p7):
    '''
...
def glTexImage2D(p0: int, p1: int, p2: int, p3: int, p4: int, p5: int, p6: int,
                 p7: int, p8):
    '''
