...
def intersect_plane_plane(plane_a_co: 'mathutils.Vector',
                          plane_a_no: 'mathutils.Vector',
                          plane_b_co: 'mathutils.Vector',
                          plane_b_no: 'mathutils.Vector') -> tuple:
...
def intersect_sphere_sphere_2d(p_a: 'mathutils.Vector', radius_a: float,
                               p_b: 'mathutils.Vector',
                               radius_b: float) -> tuple:
