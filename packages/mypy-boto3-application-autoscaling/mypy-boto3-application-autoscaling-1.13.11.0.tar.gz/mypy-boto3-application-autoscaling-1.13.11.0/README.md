...
[boto3.ApplicationAutoScaling 1.13.11](https://boto3.amazonaws.com/v1/documentation/api/1.13.11/reference/services/application-autoscaling.html#ApplicationAutoScaling) service
