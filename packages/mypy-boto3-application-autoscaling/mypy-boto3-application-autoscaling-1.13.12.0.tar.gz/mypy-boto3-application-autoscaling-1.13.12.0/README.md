...
[boto3.ApplicationAutoScaling 1.13.12](https://boto3.amazonaws.com/v1/documentation/api/1.13.12/reference/services/application-autoscaling.html#ApplicationAutoScaling) service
