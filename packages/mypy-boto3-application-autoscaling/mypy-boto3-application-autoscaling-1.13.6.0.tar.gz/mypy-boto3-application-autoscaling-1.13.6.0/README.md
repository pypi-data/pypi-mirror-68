...
[boto3.ApplicationAutoScaling 1.13.6](https://boto3.amazonaws.com/v1/documentation/api/1.13.6/reference/services/application-autoscaling.html#ApplicationAutoScaling) service
