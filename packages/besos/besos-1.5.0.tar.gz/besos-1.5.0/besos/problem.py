...
class Problem(IO_Objects.ReprMixin):
    ...
    def __init__(
        self,
        inputs: Union[int, List[Union[str, IO_Objects.Descriptor]]] = None,
    ...
    def pre_optimaization(self):
        """Prepare optimazation for dependent parameter and non objectives.
        """
    ...
    def record_results(self, inputs, results):
        ...
        for obj in self.add_outputs:
            input.append(obj(results))
        self.add_outputs_list.append(input)
