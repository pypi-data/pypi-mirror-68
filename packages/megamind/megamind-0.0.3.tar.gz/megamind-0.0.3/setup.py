...
setup(
  name = 'megamind',         # How you named your package folder (MyLib)
  packages = ['megamind'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/Aiden-Python/Megamind/archive/v_0.0.3.tar.gz',    # I explain this later 
