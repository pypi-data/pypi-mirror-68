...
from azureml.train._estimator_helper import _get_arguments, _get_data_inputs, _get_data_configuration
...
from azureml.core.script_run_config import _update_args_and_inputs
...
def _rl_estimator_submit_method(estimator, workspace, experiment_name, **kwargs):
    ...
    _update_args_and_inputs(workspace, estimator.head_configuration)
    if estimator.simulator_configuration:
        _update_args_and_inputs(workspace, estimator.simulator_configuration)
