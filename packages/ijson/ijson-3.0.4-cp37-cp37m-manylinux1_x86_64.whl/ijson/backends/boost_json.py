...
def basic_parse(file, **kwargs):
    ...
    return _yajl2.basic_parse(_yajl2.basic_parse_boost_basecoro, f, buf_size, **kwargs)

def basic_parse_async(file, **kwargs):
    buf_size = kwargs.pop('buf_size', 64 * 1024)
    return _yajl2.basic_parse_async(_yajl2.basic_parse_boost_basecoro, file, buf_size, **kwargs)
...
def parse(file, **kwargs):
    f = compat.bytes_reader(file)
    buf_size = kwargs.pop('buf_size', 64 * 1024)
    return _yajl2.parse(_yajl2.basic_parse_boost_basecoro, f, buf_size, **kwargs)

def parse_async(file, **kwargs):
    buf_size = kwargs.pop('buf_size', 64 * 1024)
    return _yajl2.parse_async(_yajl2.basic_parse_boost_basecoro, file, buf_size, **kwargs)
...
def kvitems(file, prefix, map_type=None, **kwargs):
    f = compat.bytes_reader(file)
    buf_size = kwargs.pop('buf_size', 64 * 1024)
    return _yajl2.kvitems(_yajl2.basic_parse_boost_basecoro, f, buf_size, prefix, map_type, **kwargs)

def kvitems_async(file, prefix, map_type=None, **kwargs):
    buf_size = kwargs.pop('buf_size', 64 * 1024)
    return _yajl2.kvitems_async(_yajl2.basic_parse_boost_basecoro, file, buf_size, prefix, map_type, **kwargs)
...
def items(file, prefix, map_type=None, **kwargs):
    f = compat.bytes_reader(file)
    buf_size = kwargs.pop('buf_size', 64 * 1024)
    return _yajl2.items(_yajl2.basic_parse_boost_basecoro, f, buf_size, prefix, map_type, **kwargs)

def items_async(file, prefix, map_type=None, **kwargs):
    buf_size = kwargs.pop('buf_size', 64 * 1024)
    return _yajl2.items_async(_yajl2.basic_parse_boost_basecoro, file, buf_size, prefix, map_type, **kwargs)
