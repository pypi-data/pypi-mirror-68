...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'spotinst', 'v2.4.0-alpha.1589664470+g93431b8'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource spotinst v2.4.0-alpha.1589664470+g93431b8`
                """)
            else:
                raise
