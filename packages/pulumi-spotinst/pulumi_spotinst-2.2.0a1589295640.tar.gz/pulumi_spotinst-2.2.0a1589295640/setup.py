...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'spotinst', 'v2.2.0-alpha.1589295640+ga3c0a64'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource spotinst v2.2.0-alpha.1589295640+ga3c0a64`
                """)
            else:
                raise
