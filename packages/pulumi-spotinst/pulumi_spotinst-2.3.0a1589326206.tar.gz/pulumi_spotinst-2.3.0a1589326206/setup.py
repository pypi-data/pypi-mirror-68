...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'spotinst', 'v2.3.0-alpha.1589326206+g1eebc59'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource spotinst v2.3.0-alpha.1589326206+g1eebc59`
                """)
            else:
                raise
