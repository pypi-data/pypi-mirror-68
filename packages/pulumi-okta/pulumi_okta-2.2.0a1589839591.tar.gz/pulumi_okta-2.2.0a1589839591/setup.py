...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'okta', 'v2.2.0-alpha.1589839591+g270cb62'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource okta v2.2.0-alpha.1589839591+g270cb62`
                """)
            else:
                raise
