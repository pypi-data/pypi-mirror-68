...
@jsii.data_type(jsii_type="@aws-cdk/aws-iam.AddToPrincipalPolicyResult", jsii_struct_bases=[], name_mapping={'statement_added': 'statementAdded', 'policy_dependable': 'policyDependable'})
class AddToPrincipalPolicyResult():
    def __init__(self, *, statement_added: bool, policy_dependable: typing.Optional[aws_cdk.core.IDependable]=None) -> None:
        ...
        if policy_dependable is not None: self._values["policy_dependable"] = policy_dependable
    ...
    def __repr__(self) -> str:
        return 'AddToPrincipalPolicyResult(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


@jsii.data_type(jsii_type="@aws-cdk/aws-iam.AddToResourcePolicyResult", jsii_struct_bases=[], name_mapping={'statement_added': 'statementAdded', 'policy_dependable': 'policyDependable'})
class AddToResourcePolicyResult():
    ...
    def __repr__(self) -> str:
        return 'AddToResourcePolicyResult(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())
...
class CfnAccessKey(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iam.CfnAccessKey"):
    ...
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnAccessKey":
...
class CfnAccessKeyProps():
    def __init__(self, *, user_name: str, serial: typing.Optional[jsii.Number]=None, status: typing.Optional[str]=None) -> None:
...
class CfnInstanceProfile(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iam.CfnInstanceProfile"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnInstanceProfile":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
class CfnInstanceProfileProps():
    def __init__(self, *, roles: typing.List[str], instance_profile_name: typing.Optional[str]=None, path: typing.Optional[str]=None) -> None:
...
class CfnManagedPolicy(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iam.CfnManagedPolicy"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnManagedPolicy":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
class CfnManagedPolicyProps():
    def __init__(self, *, policy_document: typing.Any, description: typing.Optional[str]=None, groups: typing.Optional[typing.List[str]]=None, managed_policy_name: typing.Optional[str]=None, path: typing.Optional[str]=None, roles: typing.Optional[typing.List[str]]=None, users: typing.Optional[typing.List[str]]=None) -> None:
...
class CfnPolicyProps():
    def __init__(self, *, policy_document: typing.Any, policy_name: str, groups: typing.Optional[typing.List[str]]=None, roles: typing.Optional[typing.List[str]]=None, users: typing.Optional[typing.List[str]]=None) -> None:
...
class CfnRole(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iam.CfnRole"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnRole":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
class CfnRoleProps():
    def __init__(self, *, assume_role_policy_document: typing.Any, description: typing.Optional[str]=None, managed_policy_arns: typing.Optional[typing.List[str]]=None, max_session_duration: typing.Optional[jsii.Number]=None, path: typing.Optional[str]=None, permissions_boundary: typing.Optional[str]=None, policies: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnRole.PolicyProperty"]]]]]=None, role_name: typing.Optional[str]=None, tags: typing.Optional[typing.List[aws_cdk.core.CfnTag]]=None) -> None:
...
class CfnServiceLinkedRole(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iam.CfnServiceLinkedRole"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnServiceLinkedRole":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
class CfnServiceLinkedRoleProps():
    def __init__(self, *, aws_service_name: str, custom_suffix: typing.Optional[str]=None, description: typing.Optional[str]=None) -> None:
...
class CfnUser(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iam.CfnUser"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnUser":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    class LoginProfileProperty():
        def __init__(self, *, password: str, password_reset_required: typing.Optional[typing.Union[typing.Optional[bool], typing.Optional[aws_cdk.core.IResolvable]]]=None) -> None:
            """
...
class CfnUserToGroupAddition(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iam.CfnUserToGroupAddition"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnUserToGroupAddition":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
class CommonGrantOptions():
    def __init__(self, *, actions: typing.List[str], grantee: "IGrantable", resource_arns: typing.List[str]) -> None:
...
class CompositeDependable(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iam.CompositeDependable"):
...
class GrantOnPrincipalAndResourceOptions(CommonGrantOptions):
    def __init__(self, *, actions: typing.List[str], grantee: "IGrantable", resource_arns: typing.List[str], resource: "IResourceWithPolicy", resource_policy_principal: typing.Optional["IPrincipal"]=None, resource_self_arns: typing.Optional[typing.List[str]]=None) -> None:
...
class GrantOnPrincipalOptions(CommonGrantOptions):
    def __init__(self, *, actions: typing.List[str], grantee: "IGrantable", resource_arns: typing.List[str], scope: typing.Optional[aws_cdk.core.IConstruct]=None) -> None:
...
class GrantWithResourceOptions(CommonGrantOptions):
    def __init__(self, *, actions: typing.List[str], grantee: "IGrantable", resource_arns: typing.List[str], resource: "IResourceWithPolicy", resource_self_arns: typing.Optional[typing.List[str]]=None) -> None:
...
class GroupProps():
    def __init__(self, *, group_name: typing.Optional[str]=None, managed_policies: typing.Optional[typing.List["IManagedPolicy"]]=None, path: typing.Optional[str]=None) -> None:
...
class IOpenIdConnectProvider(aws_cdk.core.IResource, jsii.compat.Protocol):
...
class _IOpenIdConnectProviderProxy(jsii.proxy_for(aws_cdk.core.IResource)):
    """Represents an IAM OpenID Connect provider.

    stability
    :stability: experimental
    """
    __jsii_type__ = "@aws-cdk/aws-iam.IOpenIdConnectProvider"
    @builtins.property
    @jsii.member(jsii_name="openIdConnectProviderArn")
    def open_id_connect_provider_arn(self) -> str:
        """The Amazon Resource Name (ARN) of the IAM OpenID Connect provider.
...
class IPrincipal(IGrantable, jsii.compat.Protocol):
    ...
    def add_to_principal_policy(self, statement: "PolicyStatement") -> "AddToPrincipalPolicyResult":
        """Add to the policy of this principal.
...
class IResourceWithPolicy(aws_cdk.core.IConstruct, jsii.compat.Protocol):
    ...
    def add_to_resource_policy(self, statement: "PolicyStatement") -> "AddToResourcePolicyResult":
...
class ManagedPolicy(aws_cdk.core.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iam.ManagedPolicy"):
    """Managed policy."""
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, description: typing.Optional[str]=None, document: typing.Optional["PolicyDocument"]=None, groups: typing.Optional[typing.List["IGroup"]]=None, managed_policy_name: typing.Optional[str]=None, path: typing.Optional[str]=None, roles: typing.Optional[typing.List["IRole"]]=None, statements: typing.Optional[typing.List["PolicyStatement"]]=None, users: typing.Optional[typing.List["IUser"]]=None) -> None:
        """
        :param scope: -
        :param id: -
        ...
        """
        props = ManagedPolicyProps(description=description, document=document, groups=groups, managed_policy_name=managed_policy_name, path=path, roles=roles, statements=statements, users=users)
    ...
    @builtins.classmethod
    def from_managed_policy_arn(cls, scope: aws_cdk.core.Construct, id: str, managed_policy_arn: str) -> "IManagedPolicy":
...
@jsii.data_type(jsii_type="@aws-cdk/aws-iam.ManagedPolicyProps", jsii_struct_bases=[], name_mapping={'description': 'description', 'document': 'document', 'groups': 'groups', 'managed_policy_name': 'managedPolicyName', 'path': 'path', 'roles': 'roles', 'statements': 'statements', 'users': 'users'})
class ManagedPolicyProps():
    def __init__(self, *, description: typing.Optional[str]=None, document: typing.Optional["PolicyDocument"]=None, groups: typing.Optional[typing.List["IGroup"]]=None, managed_policy_name: typing.Optional[str]=None, path: typing.Optional[str]=None, roles: typing.Optional[typing.List["IRole"]]=None, statements: typing.Optional[typing.List["PolicyStatement"]]=None, users: typing.Optional[typing.List["IUser"]]=None) -> None:
        ...
        if description is not None: self._values["description"] = description
        if document is not None: self._values["document"] = document
        if groups is not None: self._values["groups"] = groups
        if managed_policy_name is not None: self._values["managed_policy_name"] = managed_policy_name
        if path is not None: self._values["path"] = path
        if roles is not None: self._values["roles"] = roles
...
class OpenIdConnectProvider(aws_cdk.core.Construct, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iam.OpenIdConnectProvider"):
    ...
    :stability: experimental
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, url: str, client_ids: typing.Optional[typing.List[str]]=None, thumbprints: typing.Optional[typing.List[str]]=None) -> None:
        ...
        :stability: experimental
        """
        props = OpenIdConnectProviderProps(url=url, client_ids=client_ids, thumbprints=thumbprints)

        jsii.create(OpenIdConnectProvider, self, [scope, id, props])

    @jsii.member(jsii_name="fromOpenIdConnectProviderArn")
    @builtins.classmethod
    def from_open_id_connect_provider_arn(cls, scope: aws_cdk.core.Construct, id: str, open_id_connect_provider_arn: str) -> "IOpenIdConnectProvider":
...
@jsii.data_type(jsii_type="@aws-cdk/aws-iam.OpenIdConnectProviderProps", jsii_struct_bases=[], name_mapping={'url': 'url', 'client_ids': 'clientIds', 'thumbprints': 'thumbprints'})
class OpenIdConnectProviderProps():
    def __init__(self, *, url: str, client_ids: typing.Optional[typing.List[str]]=None, thumbprints: typing.Optional[typing.List[str]]=None) -> None:
        ...
        if client_ids is not None: self._values["client_ids"] = client_ids
        if thumbprints is not None: self._values["thumbprints"] = thumbprints
    ...
    def __repr__(self) -> str:
        return 'OpenIdConnectProviderProps(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())
...
class PolicyProps():
    def __init__(self, *, force: typing.Optional[bool]=None, groups: typing.Optional[typing.List["IGroup"]]=None, policy_name: typing.Optional[str]=None, roles: typing.Optional[typing.List["IRole"]]=None, statements: typing.Optional[typing.List["PolicyStatement"]]=None, users: typing.Optional[typing.List["IUser"]]=None) -> None:
...
class PolicyStatement(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iam.PolicyStatement"):
    ...
    def __init__(self, *, actions: typing.Optional[typing.List[str]]=None, conditions: typing.Optional[typing.Mapping[str, typing.Any]]=None, effect: typing.Optional["Effect"]=None, not_actions: typing.Optional[typing.List[str]]=None, not_principals: typing.Optional[typing.List["IPrincipal"]]=None, not_resources: typing.Optional[typing.List[str]]=None, principals: typing.Optional[typing.List["IPrincipal"]]=None, resources: typing.Optional[typing.List[str]]=None, sid: typing.Optional[str]=None) -> None:
        ...
        """
        props = PolicyStatementProps(actions=actions, conditions=conditions, effect=effect, not_actions=not_actions, not_principals=not_principals, not_resources=not_resources, principals=principals, resources=resources, sid=sid)
...
@jsii.data_type(jsii_type="@aws-cdk/aws-iam.PolicyStatementProps", jsii_struct_bases=[], name_mapping={'actions': 'actions', 'conditions': 'conditions', 'effect': 'effect', 'not_actions': 'notActions', 'not_principals': 'notPrincipals', 'not_resources': 'notResources', 'principals': 'principals', 'resources': 'resources', 'sid': 'sid'})
class PolicyStatementProps():
    def __init__(self, *, actions: typing.Optional[typing.List[str]]=None, conditions: typing.Optional[typing.Mapping[str, typing.Any]]=None, effect: typing.Optional["Effect"]=None, not_actions: typing.Optional[typing.List[str]]=None, not_principals: typing.Optional[typing.List["IPrincipal"]]=None, not_resources: typing.Optional[typing.List[str]]=None, principals: typing.Optional[typing.List["IPrincipal"]]=None, resources: typing.Optional[typing.List[str]]=None, sid: typing.Optional[str]=None) -> None:
        ...
        if sid is not None: self._values["sid"] = sid
...
class PrincipalBase(metaclass=jsii.JSIIAbstractClass, jsii_type="@aws-cdk/aws-iam.PrincipalBase"):
    ...
    @jsii.member(jsii_name="addToPrincipalPolicy")
    def add_to_principal_policy(self, _statement: "PolicyStatement") -> "AddToPrincipalPolicyResult":
        """Add to the policy of this principal.
    ...
    def with_conditions(self, conditions: typing.Mapping[str, typing.Any]) -> "IPrincipal":
...
@jsii.implements(IPrincipal)
class PrincipalWithConditions(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iam.PrincipalWithConditions"):
    """An IAM principal with additional conditions specifying when the policy is in effect.

    For more information about conditions, see:
    https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_elements_condition.html
    """
    def __init__(self, principal: "IPrincipal", conditions: typing.Mapping[str, typing.Any]) -> None:
        """
        :param principal: -
        :param conditions: -
        """
...
@jsii.data_type(jsii_type="@aws-cdk/aws-iam.RoleProps", jsii_struct_bases=[], name_mapping={'assumed_by': 'assumedBy', 'description': 'description', 'external_id': 'externalId', 'external_ids': 'externalIds', 'inline_policies': 'inlinePolicies', 'managed_policies': 'managedPolicies', 'max_session_duration': 'maxSessionDuration', 'path': 'path', 'permissions_boundary': 'permissionsBoundary', 'role_name': 'roleName'})
class RoleProps():
    def __init__(self, *, assumed_by: "IPrincipal", description: typing.Optional[str]=None, external_id: typing.Optional[str]=None, external_ids: typing.Optional[typing.List[str]]=None, inline_policies: typing.Optional[typing.Mapping[str, "PolicyDocument"]]=None, managed_policies: typing.Optional[typing.List["IManagedPolicy"]]=None, max_session_duration: typing.Optional[aws_cdk.core.Duration]=None, path: typing.Optional[str]=None, permissions_boundary: typing.Optional["IManagedPolicy"]=None, role_name: typing.Optional[str]=None) -> None:
...
class ServicePrincipalOpts():
    def __init__(self, *, conditions: typing.Optional[typing.Mapping[str, typing.Any]]=None, region: typing.Optional[str]=None) -> None:
...
class LazyRole(aws_cdk.core.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iam.LazyRole"):
    ...
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, assumed_by: "IPrincipal", description: typing.Optional[str]=None, external_id: typing.Optional[str]=None, external_ids: typing.Optional[typing.List[str]]=None, inline_policies: typing.Optional[typing.Mapping[str, "PolicyDocument"]]=None, managed_policies: typing.Optional[typing.List["IManagedPolicy"]]=None, max_session_duration: typing.Optional[aws_cdk.core.Duration]=None, path: typing.Optional[str]=None, permissions_boundary: typing.Optional["IManagedPolicy"]=None, role_name: typing.Optional[str]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param assumed_by: The IAM principal (i.e. ``new ServicePrincipal('sns.amazonaws.com')``) which can assume this role. You can later modify the assume role policy document by accessing it via the ``assumeRolePolicy`` property.
        ...
        :param role_name: A name for the IAM role. For valid values, see the RoleName parameter for the CreateRole action in the IAM API Reference. IMPORTANT: If you specify a name, you cannot perform updates that require replacement of this resource. You can perform updates that require no or some interruption. If you must replace the resource, specify a new name. If you specify a name, you must specify the CAPABILITY_NAMED_IAM value to acknowledge your template's capabilities. For more information, see Acknowledging IAM Resources in AWS CloudFormation Templates. Default: - AWS CloudFormation generates a unique physical ID and uses that ID for the group name.
        """
        props = LazyRoleProps(assumed_by=assumed_by, description=description, external_id=external_id, external_ids=external_ids, inline_policies=inline_policies, managed_policies=managed_policies, max_session_duration=max_session_duration, path=path, permissions_boundary=permissions_boundary, role_name=role_name)
...
@jsii.data_type(jsii_type="@aws-cdk/aws-iam.LazyRoleProps", jsii_struct_bases=[RoleProps], name_mapping={'assumed_by': 'assumedBy', 'description': 'description', 'external_id': 'externalId', 'external_ids': 'externalIds', 'inline_policies': 'inlinePolicies', 'managed_policies': 'managedPolicies', 'max_session_duration': 'maxSessionDuration', 'path': 'path', 'permissions_boundary': 'permissionsBoundary', 'role_name': 'roleName'})
...
class Role(aws_cdk.core.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iam.Role"):
    ...
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, assumed_by: "IPrincipal", description: typing.Optional[str]=None, external_id: typing.Optional[str]=None, external_ids: typing.Optional[typing.List[str]]=None, inline_policies: typing.Optional[typing.Mapping[str, "PolicyDocument"]]=None, managed_policies: typing.Optional[typing.List["IManagedPolicy"]]=None, max_session_duration: typing.Optional[aws_cdk.core.Duration]=None, path: typing.Optional[str]=None, permissions_boundary: typing.Optional["IManagedPolicy"]=None, role_name: typing.Optional[str]=None) -> None:
        ...
        :param role_name: A name for the IAM role. For valid values, see the RoleName parameter for the CreateRole action in the IAM API Reference. IMPORTANT: If you specify a name, you cannot perform updates that require replacement of this resource. You can perform updates that require no or some interruption. If you must replace the resource, specify a new name. If you specify a name, you must specify the CAPABILITY_NAMED_IAM value to acknowledge your template's capabilities. For more information, see Acknowledging IAM Resources in AWS CloudFormation Templates. Default: - AWS CloudFormation generates a unique physical ID and uses that ID for the group name.
        """
        props = RoleProps(assumed_by=assumed_by, description=description, external_id=external_id, external_ids=external_ids, inline_policies=inline_policies, managed_policies=managed_policies, max_session_duration=max_session_duration, path=path, permissions_boundary=permissions_boundary, role_name=role_name)
