...
setup(
  ...
  url = 'https://github.com/tafaquh/tief',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/tafaquh/tief/archive/0.1.9.1.tar.gz',    # I explain this later on
