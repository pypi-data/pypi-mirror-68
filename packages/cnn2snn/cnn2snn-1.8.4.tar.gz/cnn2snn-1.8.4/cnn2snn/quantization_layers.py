...
class QuantizedDepthwiseConv2D(layers.DepthwiseConv2D):
    ...
    def __init__(self,
        ...
        """
        self.unsupported_args = {
            'data_format', 'activation', 'strides', 'depth_multiplier',
...
class QuantizedDense(layers.Dense):
    ...
    def __init__(self,
        ...
        """
        self.unsupported_args = {'activation', 'activity_regularizer'}
        _check_unsupported_args(kwargs, self.unsupported_args)
        self.quantizer = get_quantizer(quantizer)
...
class QuantizedSeparableConv2D(layers.SeparableConv2D):
    ...
    def __init__(self,
        ...
        """
        self.unsupported_args = {
            'data_format', 'activation', 'strides', 'dilation_rate',
            'depth_multiplier', 'activity_regularizer'
        }
        _check_unsupported_args(kwargs, self.unsupported_args)
        self.quantizer = get_quantizer(quantizer)
    ...
    def call(self, inputs):
        ...
        outputs = nn.separable_conv2d(
            inputs,
            self.quantizer.quantize(self.depthwise_kernel),
...
class ActivationDiscreteRelu(BaseQuantizedActivation):
    ...
    def __init__(self, bitwidth=1, **kwargs):
        ...
        """
        self.unsupported_args = {'activation'}
        _check_unsupported_args(kwargs, self.unsupported_args)
