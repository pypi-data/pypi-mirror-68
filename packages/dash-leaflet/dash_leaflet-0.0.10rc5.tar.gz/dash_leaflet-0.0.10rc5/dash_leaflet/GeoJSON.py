...
- featureHover (dict; optional): Last feature hover."""
    @_explicitize_args
    def __init__(self, children=None, data=Component.UNDEFINED, attribution=Component.UNDEFINED, className=Component.UNDEFINED, id=Component.UNDEFINED, style=Component.UNDEFINED, defaultOptions=Component.UNDEFINED, defaultStyle=Component.UNDEFINED, featureOptions=Component.UNDEFINED, featureStyle=Component.UNDEFINED, featureId=Component.UNDEFINED, featureClick=Component.UNDEFINED, featureHover=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'data', 'attribution', 'className', 'id', 'style', 'defaultOptions', 'defaultStyle', 'featureOptions', 'featureStyle', 'featureId', 'featureClick', 'featureHover']
        self._type = 'GeoJSON'
        self._namespace = 'dash_leaflet'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'data', 'attribution', 'className', 'id', 'style', 'defaultOptions', 'defaultStyle', 'featureOptions', 'featureStyle', 'featureId', 'featureClick', 'featureHover']
