...
- animate (boolean; optional): If true, panning will always be animated if possible. If false, it will not 
...
- duration (number; optional): Duration of animated panning, in seconds.
- easeLinearity (number; optional): Easing of the inertia
- noMoveStart (boolean; optional): If true, panning won't fire movestart event on start (used internally for panning 
inertia).
- bounds (list of list of numberss; optional): Sets a map view that contains the given geographical bounds with the maximum zoom 
level possible.
...
- boxZoom (boolean; optional): Whether the map can be zoomed to a rectangular area specified by dragging 
the mouse while pressing the shift key.
- center (list of numbers; default [56, 10]): Sets the geographic center of the map
- doubleClickZoom (boolean | string; optional): Whether the map can be zoomed in by double clicking on it and zoomed out by 
...
Defaults to true.
- dragging (boolean; optional): Whether the map be draggable with mouse/touch or not.
- keyboard (boolean; optional): Makes the map focusable and allows users to navigate the map with keyboard 
arrows and +/- keys.
- maxBounds (list of list of numberss; optional): When this option is set, the map restricts the view to the given geographical bounds, 
...
- scrollWheelZoom (dict; optional): Whether the map can be zoomed by using the mouse wheel. If passed 'center', 
it will zoom to the center of the view regardless of where the mouse was.
- useFlyTo (boolean; optional): Boolean to control whether to use flyTo functions for bounds and center. 
If false map.fitBounds and map.setView will be used. If true map.flyToBounds 
and map.flyTo will be used. Defaults to false.
- tap (boolean; optional): Enables mobile hacks for supporting instant taps (fixing 200ms click delay on 
...
- zoom (number; default 6): Sets the map zoom level
- preferCanvas (boolean; optional): Whether Paths should be rendered on a Canvas renderer. By default,
all Paths are rendered in a SVG renderer.
- attributionControl (boolean; optional): Whether a attribution control is added to the map by default.
- zoomControl (boolean; optional): Whether a zoom control is added to the map by default.
- closePopupOnClick (boolean; optional): Set it to false if you don't want popups to close when user clicks the map.
- zoomSnap (number; optional): Forces the map's zoom level to always be a multiple of this, particularly
...
- zoomDelta (number; optional): Controls how much the map's zoom level will change after a zoomIn(), 
zoomOut(), pressing + or - on the keyboard, or using the zoom controls. 
Values smaller than 1 (e.g. 0.5) allow for greater granularity.
- trackResize (boolean; optional): Whether the map automatically handles browser window resize to update itself.
- crs (dict; optional): The Coordinate Reference System to use. Don't change this if you're not sure 
what it means.
- minZoom (number; optional): Minimum zoom level of the map. If not specified and at least one GridLayer or 
TileLayer is in the map, the lowest of their minZoom options will be used instead.
- maxZoom (number; optional): Maximum zoom level of the map. If not specified and at least one GridLayer or 
...
- zoomAnimation (boolean; optional): Whether the map zoom animation is enabled. By default it's enabled in all browsers 
that support CSS3 Transitions except Android.
- zoomAnimationThreshold (number; optional): Won't animate zoom if the zoom difference exceeds this value.
- fadeAnimation (boolean; optional): Whether the tile fade animation is enabled. By default it's enabled in all browsers 
that support CSS3 Transitions except Android.
- markerZoomAnimation (boolean; optional): Whether markers animate their zoom with the zoom animation, if disabled they will 
disappear for the length of the animation. By default it's enabled in all browsers 
that support CSS3 Transitions except Android.
- transform3DLimit (number; optional): Defines the maximum size of a CSS translation transform. The default value should 
not be changed unless a web browser positions layers in the wrong place after doing 
a large panBy.
- inertia (boolean; optional): If enabled, panning of the map will have an inertia effect where the map builds 
...
Android devices.
- inertiaDeceleration (number; optional): The rate with which the inertial movement slows down, in pixels/second.
- inertiaMaxSpeed (number; optional): Max speed of the inertial movement, in pixels/second.
- worldCopyJump (boolean; optional): With this option enabled, the map tracks when you pan to another "copy" of 
the world and seamlessly jumps to the original one so that all overlays like 
markers and vector layers are still visible.
- maxBoundsViscosity (number; optional): If maxBounds is set, this option will control how solid the bounds are when 
...
- keyboardPanDelta (number; optional): Amount of pixels to pan when pressing an arrow key.
- wheelDebounceTime (number; optional): Limits the rate at which a wheel can fire (in milliseconds). By default user 
can't zoom via wheel more often than once per 40 ms.
- wheelPxPerZoomLevel (number; optional): How many scroll pixels (as reported by L.DomEvent.getWheelDelta) mean a change
of one full zoom level. Smaller values will make wheel-zooming faster (and vice 
versa).
- tapTolerance (number; optional): The max number of pixels a user can shift his finger during touch for it to 
be considered a valid tap.
- bounceAtZoomLimits (boolean; optional): Set it to false if you don't want the map to zoom beyond min/max zoom and then 
bounce back when pinch-zooming.
- id (string; optional): The ID used to identify this component in Dash callbacks (dynamic)
- style (dict; default {'width': "100%", 'height': "100%", "position": "relative"}): The CSS style of the component (dynamic)
...
- location_lat_lon_acc (list of numbers; optional): Dash callback property. Receives [lat, lng, accuracy] when user location is found."""
    @_explicitize_args
    def __init__(self, children=None, animate=Component.UNDEFINED, duration=Component.UNDEFINED, easeLinearity=Component.UNDEFINED, noMoveStart=Component.UNDEFINED, bounds=Component.UNDEFINED, boundsOptions=Component.UNDEFINED, boxZoom=Component.UNDEFINED, center=Component.UNDEFINED, doubleClickZoom=Component.UNDEFINED, dragging=Component.UNDEFINED, keyboard=Component.UNDEFINED, maxBounds=Component.UNDEFINED, scrollWheelZoom=Component.UNDEFINED, useFlyTo=Component.UNDEFINED, tap=Component.UNDEFINED, touchZoom=Component.UNDEFINED, viewport=Component.UNDEFINED, zoom=Component.UNDEFINED, preferCanvas=Component.UNDEFINED, attributionControl=Component.UNDEFINED, zoomControl=Component.UNDEFINED, closePopupOnClick=Component.UNDEFINED, zoomSnap=Component.UNDEFINED, zoomDelta=Component.UNDEFINED, trackResize=Component.UNDEFINED, crs=Component.UNDEFINED, minZoom=Component.UNDEFINED, maxZoom=Component.UNDEFINED, renderer=Component.UNDEFINED, zoomAnimation=Component.UNDEFINED, zoomAnimationThreshold=Component.UNDEFINED, fadeAnimation=Component.UNDEFINED, markerZoomAnimation=Component.UNDEFINED, transform3DLimit=Component.UNDEFINED, inertia=Component.UNDEFINED, inertiaDeceleration=Component.UNDEFINED, inertiaMaxSpeed=Component.UNDEFINED, worldCopyJump=Component.UNDEFINED, maxBoundsViscosity=Component.UNDEFINED, keyboardPanDelta=Component.UNDEFINED, wheelDebounceTime=Component.UNDEFINED, wheelPxPerZoomLevel=Component.UNDEFINED, tapTolerance=Component.UNDEFINED, bounceAtZoomLimits=Component.UNDEFINED, id=Component.UNDEFINED, style=Component.UNDEFINED, className=Component.UNDEFINED, attribution=Component.UNDEFINED, click_lat_lng=Component.UNDEFINED, dbl_click_lat_lng=Component.UNDEFINED, location_lat_lon_acc=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'animate', 'duration', 'easeLinearity', 'noMoveStart', 'bounds', 'boundsOptions', 'boxZoom', 'center', 'doubleClickZoom', 'dragging', 'keyboard', 'maxBounds', 'scrollWheelZoom', 'useFlyTo', 'tap', 'touchZoom', 'viewport', 'zoom', 'preferCanvas', 'attributionControl', 'zoomControl', 'closePopupOnClick', 'zoomSnap', 'zoomDelta', 'trackResize', 'crs', 'minZoom', 'maxZoom', 'renderer', 'zoomAnimation', 'zoomAnimationThreshold', 'fadeAnimation', 'markerZoomAnimation', 'transform3DLimit', 'inertia', 'inertiaDeceleration', 'inertiaMaxSpeed', 'worldCopyJump', 'maxBoundsViscosity', 'keyboardPanDelta', 'wheelDebounceTime', 'wheelPxPerZoomLevel', 'tapTolerance', 'bounceAtZoomLimits', 'id', 'style', 'className', 'attribution', 'click_lat_lng', 'dbl_click_lat_lng', 'location_lat_lon_acc']
        self._type = 'Map'
        self._namespace = 'dash_leaflet'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'animate', 'duration', 'easeLinearity', 'noMoveStart', 'bounds', 'boundsOptions', 'boxZoom', 'center', 'doubleClickZoom', 'dragging', 'keyboard', 'maxBounds', 'scrollWheelZoom', 'useFlyTo', 'tap', 'touchZoom', 'viewport', 'zoom', 'preferCanvas', 'attributionControl', 'zoomControl', 'closePopupOnClick', 'zoomSnap', 'zoomDelta', 'trackResize', 'crs', 'minZoom', 'maxZoom', 'renderer', 'zoomAnimation', 'zoomAnimationThreshold', 'fadeAnimation', 'markerZoomAnimation', 'transform3DLimit', 'inertia', 'inertiaDeceleration', 'inertiaMaxSpeed', 'worldCopyJump', 'maxBoundsViscosity', 'keyboardPanDelta', 'wheelDebounceTime', 'wheelPxPerZoomLevel', 'tapTolerance', 'bounceAtZoomLimits', 'id', 'style', 'className', 'attribution', 'click_lat_lng', 'dbl_click_lat_lng', 'location_lat_lon_acc']
