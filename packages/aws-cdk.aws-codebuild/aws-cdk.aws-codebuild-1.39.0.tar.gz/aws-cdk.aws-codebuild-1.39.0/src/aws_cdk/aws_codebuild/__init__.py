...
class BitBucketSourceCredentials(aws_cdk.core.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-codebuild.BitBucketSourceCredentials"):
    ...
    **Note**: CodeBuild only allows a single credential for BitBucket
    ...
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, password: aws_cdk.core.SecretValue, username: aws_cdk.core.SecretValue) -> None:
        """
        :param scope: -
        :param id: -
...
@jsii.data_type(jsii_type="@aws-cdk/aws-codebuild.BitBucketSourceCredentialsProps", jsii_struct_bases=[], name_mapping={'password': 'password', 'username': 'username'})
class BitBucketSourceCredentialsProps():
    def __init__(self, *, password: aws_cdk.core.SecretValue, username: aws_cdk.core.SecretValue) -> None:
    ...
    def __repr__(self) -> str:
        return 'BitBucketSourceCredentialsProps(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())
...
class BuildEnvironment():
    def __init__(self, *, build_image: typing.Optional["IBuildImage"]=None, compute_type: typing.Optional["ComputeType"]=None, environment_variables: typing.Optional[typing.Mapping[str, "BuildEnvironmentVariable"]]=None, privileged: typing.Optional[bool]=None) -> None:
        """
...
class BuildEnvironmentVariable():
    def __init__(self, *, value: typing.Any, type: typing.Optional["BuildEnvironmentVariableType"]=None) -> None:
        """
...
class CfnProject(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-codebuild.CfnProject"):
    ...
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, artifacts: typing.Union["ArtifactsProperty", aws_cdk.core.IResolvable], environment: typing.Union[aws_cdk.core.IResolvable, "EnvironmentProperty"], service_role: str, source: typing.Union["SourceProperty", aws_cdk.core.IResolvable], badge_enabled: typing.Optional[typing.Union[typing.Optional[bool], typing.Optional[aws_cdk.core.IResolvable]]]=None, cache: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["ProjectCacheProperty"]]]=None, description: typing.Optional[str]=None, encryption_key: typing.Optional[str]=None, file_system_locations: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union["ProjectFileSystemLocationProperty", aws_cdk.core.IResolvable]]]]]=None, logs_config: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["LogsConfigProperty"]]]=None, name: typing.Optional[str]=None, queued_timeout_in_minutes: typing.Optional[jsii.Number]=None, secondary_artifacts: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union["ArtifactsProperty", aws_cdk.core.IResolvable]]]]]=None, secondary_sources: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union["SourceProperty", aws_cdk.core.IResolvable]]]]]=None, secondary_source_versions: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.core.IResolvable, "ProjectSourceVersionProperty"]]]]]=None, source_version: typing.Optional[str]=None, tags: typing.Optional[typing.List[aws_cdk.core.CfnTag]]=None, timeout_in_minutes: typing.Optional[jsii.Number]=None, triggers: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["ProjectTriggersProperty"]]]=None, vpc_config: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["VpcConfigProperty"]]]=None) -> None:
        ...
        """
        props = CfnProjectProps(artifacts=artifacts, environment=environment, service_role=service_role, source=source, badge_enabled=badge_enabled, cache=cache, description=description, encryption_key=encryption_key, file_system_locations=file_system_locations, logs_config=logs_config, name=name, queued_timeout_in_minutes=queued_timeout_in_minutes, secondary_artifacts=secondary_artifacts, secondary_sources=secondary_sources, secondary_source_versions=secondary_source_versions, source_version=source_version, tags=tags, timeout_in_minutes=timeout_in_minutes, triggers=triggers, vpc_config=vpc_config)

        jsii.create(CfnProject, self, [scope, id, props])

    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnProject":
    ...
    def file_system_locations(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union["ProjectFileSystemLocationProperty", aws_cdk.core.IResolvable]]]]]:
    ...
    def file_system_locations(self, value: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union["ProjectFileSystemLocationProperty", aws_cdk.core.IResolvable]]]]]):
    ...
    class CloudWatchLogsConfigProperty():
        def __init__(self, *, status: str, group_name: typing.Optional[str]=None, stream_name: typing.Optional[str]=None) -> None:
            """
    ...
    class EnvironmentVariableProperty():
        def __init__(self, *, name: str, value: str, type: typing.Optional[str]=None) -> None:
            """
    ...
    class GitSubmodulesConfigProperty():
        def __init__(self, *, fetch_submodules: typing.Union[bool, aws_cdk.core.IResolvable]) -> None:
            """
    ...
    class LogsConfigProperty():
        def __init__(self, *, cloud_watch_logs: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnProject.CloudWatchLogsConfigProperty"]]]=None, s3_logs: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnProject.S3LogsConfigProperty"]]]=None) -> None:
            """
    ...
    class ProjectCacheProperty():
        def __init__(self, *, type: str, location: typing.Optional[str]=None, modes: typing.Optional[typing.List[str]]=None) -> None:
            """
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-codebuild.CfnProject.ProjectFileSystemLocationProperty", jsii_struct_bases=[], name_mapping={'identifier': 'identifier', 'location': 'location', 'mount_point': 'mountPoint', 'type': 'type', 'mount_options': 'mountOptions'})
    class ProjectFileSystemLocationProperty():
        def __init__(self, *, identifier: str, location: str, mount_point: str, type: str, mount_options: typing.Optional[str]=None) -> None:
            """
        ...
        def __repr__(self) -> str:
            return 'ProjectFileSystemLocationProperty(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())
    ...
    class ProjectSourceVersionProperty():
        def __init__(self, *, source_identifier: str, source_version: typing.Optional[str]=None) -> None:
            """
    ...
    class S3LogsConfigProperty():
        def __init__(self, *, status: str, encryption_disabled: typing.Optional[typing.Union[typing.Optional[bool], typing.Optional[aws_cdk.core.IResolvable]]]=None, location: typing.Optional[str]=None) -> None:
            """
    ...
    class VpcConfigProperty():
        def __init__(self, *, security_group_ids: typing.Optional[typing.List[str]]=None, subnets: typing.Optional[typing.List[str]]=None, vpc_id: typing.Optional[str]=None) -> None:
            """
    ...
    class WebhookFilterProperty():
        def __init__(self, *, pattern: str, type: str, exclude_matched_pattern: typing.Optional[typing.Union[typing.Optional[bool], typing.Optional[aws_cdk.core.IResolvable]]]=None) -> None:
            """
...
class CfnProjectProps():
    def __init__(self, *, artifacts: typing.Union["CfnProject.ArtifactsProperty", aws_cdk.core.IResolvable], environment: typing.Union[aws_cdk.core.IResolvable, "CfnProject.EnvironmentProperty"], service_role: str, source: typing.Union["CfnProject.SourceProperty", aws_cdk.core.IResolvable], badge_enabled: typing.Optional[typing.Union[typing.Optional[bool], typing.Optional[aws_cdk.core.IResolvable]]]=None, cache: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnProject.ProjectCacheProperty"]]]=None, description: typing.Optional[str]=None, encryption_key: typing.Optional[str]=None, file_system_locations: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union["CfnProject.ProjectFileSystemLocationProperty", aws_cdk.core.IResolvable]]]]]=None, logs_config: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnProject.LogsConfigProperty"]]]=None, name: typing.Optional[str]=None, queued_timeout_in_minutes: typing.Optional[jsii.Number]=None, secondary_artifacts: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union["CfnProject.ArtifactsProperty", aws_cdk.core.IResolvable]]]]]=None, secondary_sources: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union["CfnProject.SourceProperty", aws_cdk.core.IResolvable]]]]]=None, secondary_source_versions: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnProject.ProjectSourceVersionProperty"]]]]]=None, source_version: typing.Optional[str]=None, tags: typing.Optional[typing.List[aws_cdk.core.CfnTag]]=None, timeout_in_minutes: typing.Optional[jsii.Number]=None, triggers: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnProject.ProjectTriggersProperty"]]]=None, vpc_config: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnProject.VpcConfigProperty"]]]=None) -> None:
        ...
        if file_system_locations is not None: self._values["file_system_locations"] = file_system_locations
    ...
    @builtins.property
    def file_system_locations(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union["CfnProject.ProjectFileSystemLocationProperty", aws_cdk.core.IResolvable]]]]]:
        """``AWS::CodeBuild::Project.FileSystemLocations``.
...
@jsii.implements(aws_cdk.core.IInspectable)
class CfnReportGroup(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-codebuild.CfnReportGroup"):
    ...
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, export_config: typing.Union[aws_cdk.core.IResolvable, "ReportExportConfigProperty"], type: str, name: typing.Optional[str]=None, tags: typing.Optional[typing.List[aws_cdk.core.CfnTag]]=None) -> None:
        ...
        """
        props = CfnReportGroupProps(export_config=export_config, type=type, name=name, tags=tags)

        jsii.create(CfnReportGroup, self, [scope, id, props])

    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnReportGroup":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    def export_config(self) -> typing.Union[aws_cdk.core.IResolvable, "ReportExportConfigProperty"]:
    ...
    def export_config(self, value: typing.Union[aws_cdk.core.IResolvable, "ReportExportConfigProperty"]):
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-codebuild.CfnReportGroup.ReportExportConfigProperty", jsii_struct_bases=[], name_mapping={'export_config_type': 'exportConfigType', 's3_destination': 's3Destination'})
    class ReportExportConfigProperty():
        def __init__(self, *, export_config_type: str, s3_destination: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnReportGroup.S3ReportExportConfigProperty"]]]=None) -> None:
            """
        ...
        @builtins.property
        def s3_destination(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnReportGroup.S3ReportExportConfigProperty"]]]:
        ...
        def __repr__(self) -> str:
            return 'ReportExportConfigProperty(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


    @jsii.data_type(jsii_type="@aws-cdk/aws-codebuild.CfnReportGroup.S3ReportExportConfigProperty", jsii_struct_bases=[], name_mapping={'bucket': 'bucket', 'encryption_disabled': 'encryptionDisabled', 'encryption_key': 'encryptionKey', 'packaging': 'packaging', 'path': 'path'})
    class S3ReportExportConfigProperty():
        def __init__(self, *, bucket: str, encryption_disabled: typing.Optional[typing.Union[typing.Optional[bool], typing.Optional[aws_cdk.core.IResolvable]]]=None, encryption_key: typing.Optional[str]=None, packaging: typing.Optional[str]=None, path: typing.Optional[str]=None) -> None:
            """
        ...
        def __repr__(self) -> str:
            return 'S3ReportExportConfigProperty(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())



@jsii.data_type(jsii_type="@aws-cdk/aws-codebuild.CfnReportGroupProps", jsii_struct_bases=[], name_mapping={'export_config': 'exportConfig', 'type': 'type', 'name': 'name', 'tags': 'tags'})
class CfnReportGroupProps():
    def __init__(self, *, export_config: typing.Union[aws_cdk.core.IResolvable, "CfnReportGroup.ReportExportConfigProperty"], type: str, name: typing.Optional[str]=None, tags: typing.Optional[typing.List[aws_cdk.core.CfnTag]]=None) -> None:
    ...
    @builtins.property
    def export_config(self) -> typing.Union[aws_cdk.core.IResolvable, "CfnReportGroup.ReportExportConfigProperty"]:
        """``AWS::CodeBuild::ReportGroup.ExportConfig``.
    ...
    def __repr__(self) -> str:
        return 'CfnReportGroupProps(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())
...
class CfnSourceCredential(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-codebuild.CfnSourceCredential"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnSourceCredential":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
class CfnSourceCredentialProps():
    def __init__(self, *, auth_type: str, server_type: str, token: str, username: typing.Optional[str]=None) -> None:
...
@jsii.data_type(jsii_type="@aws-cdk/aws-codebuild.CommonProjectProps", jsii_struct_bases=[], name_mapping={'allow_all_outbound': 'allowAllOutbound', 'badge': 'badge', 'build_spec': 'buildSpec', 'cache': 'cache', 'description': 'description', 'encryption_key': 'encryptionKey', 'environment': 'environment', 'environment_variables': 'environmentVariables', 'file_system_locations': 'fileSystemLocations', 'grant_report_group_permissions': 'grantReportGroupPermissions', 'project_name': 'projectName', 'role': 'role', 'security_groups': 'securityGroups', 'subnet_selection': 'subnetSelection', 'timeout': 'timeout', 'vpc': 'vpc'})
class CommonProjectProps():
    def __init__(self, *, allow_all_outbound: typing.Optional[bool]=None, badge: typing.Optional[bool]=None, build_spec: typing.Optional["BuildSpec"]=None, cache: typing.Optional["Cache"]=None, description: typing.Optional[str]=None, encryption_key: typing.Optional[aws_cdk.aws_kms.IKey]=None, environment: typing.Optional["BuildEnvironment"]=None, environment_variables: typing.Optional[typing.Mapping[str, "BuildEnvironmentVariable"]]=None, file_system_locations: typing.Optional[typing.List["IFileSystemLocation"]]=None, grant_report_group_permissions: typing.Optional[bool]=None, project_name: typing.Optional[str]=None, role: typing.Optional[aws_cdk.aws_iam.IRole]=None, security_groups: typing.Optional[typing.List[aws_cdk.aws_ec2.ISecurityGroup]]=None, subnet_selection: typing.Optional[aws_cdk.aws_ec2.SubnetSelection]=None, timeout: typing.Optional[aws_cdk.core.Duration]=None, vpc: typing.Optional[aws_cdk.aws_ec2.IVpc]=None) -> None:
        """
        ...
        if environment_variables is not None: self._values["environment_variables"] = environment_variables
        if file_system_locations is not None: self._values["file_system_locations"] = file_system_locations
        if grant_report_group_permissions is not None: self._values["grant_report_group_permissions"] = grant_report_group_permissions
    ...
    @builtins.property
    def file_system_locations(self) -> typing.Optional[typing.List["IFileSystemLocation"]]:
...
class DockerImageOptions():
    def __init__(self, *, secrets_manager_credentials: typing.Optional[aws_cdk.aws_secretsmanager.ISecret]=None) -> None:
...
@jsii.data_type(jsii_type="@aws-cdk/aws-codebuild.EfsFileSystemLocationProps", jsii_struct_bases=[], name_mapping={'identifier': 'identifier', 'location': 'location', 'mount_point': 'mountPoint', 'mount_options': 'mountOptions'})
class EfsFileSystemLocationProps():
    def __init__(self, *, identifier: str, location: str, mount_point: str, mount_options: typing.Optional[str]=None) -> None:
    ...
    def __repr__(self) -> str:
        return 'EfsFileSystemLocationProps(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())
...
@jsii.data_type(jsii_type="@aws-cdk/aws-codebuild.FileSystemConfig", jsii_struct_bases=[], name_mapping={'location': 'location'})
class FileSystemConfig():
    def __init__(self, *, location: "CfnProject.ProjectFileSystemLocationProperty") -> None:
        """The type returned from {@link IFileSystemLocation#bind}.

        :param location: File system location wrapper property.
        """
        if isinstance(location, dict): location = CfnProject.ProjectFileSystemLocationProperty(**location)
        self._values = {
            'location': location,
        }
    ...
    def __repr__(self) -> str:
        return 'FileSystemConfig(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


class FileSystemLocation(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-codebuild.FileSystemLocation"):
    ...
    @builtins.classmethod
    def efs(cls, *, identifier: str, location: str, mount_point: str, mount_options: typing.Optional[str]=None) -> "IFileSystemLocation":
        ...
        :param mount_options: The mount options for a file system such as Amazon EFS. Default: 'nfsvers=4.1,rsize=1048576,wsize=1048576,hard,timeo=600,retrans=2'.
        """
        props = EfsFileSystemLocationProps(identifier=identifier, location=location, mount_point=mount_point, mount_options=mount_options)
...
class GitHubEnterpriseSourceCredentials(aws_cdk.core.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-codebuild.GitHubEnterpriseSourceCredentials"):
    ...
    **Note**: CodeBuild only allows a single credential for GitHub Enterprise
    ...
    :resource:: AWS::CodeBuild::SourceCredential
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, access_token: aws_cdk.core.SecretValue) -> None:
        """
        :param scope: -
        :param id: -
...
@jsii.data_type(jsii_type="@aws-cdk/aws-codebuild.GitHubEnterpriseSourceCredentialsProps", jsii_struct_bases=[], name_mapping={'access_token': 'accessToken'})
class GitHubEnterpriseSourceCredentialsProps():
    ...
    def __repr__(self) -> str:
        return 'GitHubEnterpriseSourceCredentialsProps(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


class GitHubSourceCredentials(aws_cdk.core.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-codebuild.GitHubSourceCredentials"):
...
@jsii.data_type(jsii_type="@aws-cdk/aws-codebuild.GitHubSourceCredentialsProps", jsii_struct_bases=[], name_mapping={'access_token': 'accessToken'})
class GitHubSourceCredentialsProps():
    ...
    def __repr__(self) -> str:
        return 'GitHubSourceCredentialsProps(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())
...
class IFileSystemLocation(jsii.compat.Protocol):
    ...
    @jsii.member(jsii_name="bind")
    def bind(self, scope: aws_cdk.core.Construct, project: "IProject") -> "FileSystemConfig":
...
class IProject(aws_cdk.core.IResource, aws_cdk.aws_iam.IGrantable, aws_cdk.aws_ec2.IConnectable, jsii.compat.Protocol):
    ...
    def metric_builds(self, *, account: typing.Optional[str]=None, color: typing.Optional[str]=None, dimensions: typing.Optional[typing.Mapping[str, typing.Any]]=None, label: typing.Optional[str]=None, period: typing.Optional[aws_cdk.core.Duration]=None, region: typing.Optional[str]=None, statistic: typing.Optional[str]=None, unit: typing.Optional[aws_cdk.aws_cloudwatch.Unit]=None) -> aws_cdk.aws_cloudwatch.Metric:
    ...
    def metric_failed_builds(self, *, account: typing.Optional[str]=None, color: typing.Optional[str]=None, dimensions: typing.Optional[typing.Mapping[str, typing.Any]]=None, label: typing.Optional[str]=None, period: typing.Optional[aws_cdk.core.Duration]=None, region: typing.Optional[str]=None, statistic: typing.Optional[str]=None, unit: typing.Optional[aws_cdk.aws_cloudwatch.Unit]=None) -> aws_cdk.aws_cloudwatch.Metric:
    ...
    def metric_succeeded_builds(self, *, account: typing.Optional[str]=None, color: typing.Optional[str]=None, dimensions: typing.Optional[typing.Mapping[str, typing.Any]]=None, label: typing.Optional[str]=None, period: typing.Optional[aws_cdk.core.Duration]=None, region: typing.Optional[str]=None, statistic: typing.Optional[str]=None, unit: typing.Optional[aws_cdk.aws_cloudwatch.Unit]=None) -> aws_cdk.aws_cloudwatch.Metric:
...
class IReportGroup(aws_cdk.core.IResource, jsii.compat.Protocol):
    ...
    def grant_write(self, identity: aws_cdk.aws_iam.IGrantable) -> aws_cdk.aws_iam.Grant:
...
@jsii.data_type(jsii_type="@aws-cdk/aws-codebuild.PipelineProjectProps", jsii_struct_bases=[CommonProjectProps], name_mapping={'allow_all_outbound': 'allowAllOutbound', 'badge': 'badge', 'build_spec': 'buildSpec', 'cache': 'cache', 'description': 'description', 'encryption_key': 'encryptionKey', 'environment': 'environment', 'environment_variables': 'environmentVariables', 'file_system_locations': 'fileSystemLocations', 'grant_report_group_permissions': 'grantReportGroupPermissions', 'project_name': 'projectName', 'role': 'role', 'security_groups': 'securityGroups', 'subnet_selection': 'subnetSelection', 'timeout': 'timeout', 'vpc': 'vpc'})
...
class Project(aws_cdk.core.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-codebuild.Project"):
    ...
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, artifacts: typing.Optional["IArtifacts"]=None, secondary_artifacts: typing.Optional[typing.List["IArtifacts"]]=None, secondary_sources: typing.Optional[typing.List["ISource"]]=None, source: typing.Optional["ISource"]=None, allow_all_outbound: typing.Optional[bool]=None, badge: typing.Optional[bool]=None, build_spec: typing.Optional["BuildSpec"]=None, cache: typing.Optional["Cache"]=None, description: typing.Optional[str]=None, encryption_key: typing.Optional[aws_cdk.aws_kms.IKey]=None, environment: typing.Optional["BuildEnvironment"]=None, environment_variables: typing.Optional[typing.Mapping[str, "BuildEnvironmentVariable"]]=None, file_system_locations: typing.Optional[typing.List["IFileSystemLocation"]]=None, grant_report_group_permissions: typing.Optional[bool]=None, project_name: typing.Optional[str]=None, role: typing.Optional[aws_cdk.aws_iam.IRole]=None, security_groups: typing.Optional[typing.List[aws_cdk.aws_ec2.ISecurityGroup]]=None, subnet_selection: typing.Optional[aws_cdk.aws_ec2.SubnetSelection]=None, timeout: typing.Optional[aws_cdk.core.Duration]=None, vpc: typing.Optional[aws_cdk.aws_ec2.IVpc]=None) -> None:
        ...
        :param vpc: VPC network to place codebuild network interfaces. Specify this if the codebuild project needs to access resources in a VPC. Default: - No VPC is specified.
        """
        props = ProjectProps(artifacts=artifacts, secondary_artifacts=secondary_artifacts, secondary_sources=secondary_sources, source=source, allow_all_outbound=allow_all_outbound, badge=badge, build_spec=build_spec, cache=cache, description=description, encryption_key=encryption_key, environment=environment, environment_variables=environment_variables, file_system_locations=file_system_locations, grant_report_group_permissions=grant_report_group_permissions, project_name=project_name, role=role, security_groups=security_groups, subnet_selection=subnet_selection, timeout=timeout, vpc=vpc)
    ...
    def add_file_system_location(self, file_system_location: "IFileSystemLocation") -> None:
...
@jsii.data_type(jsii_type="@aws-cdk/aws-codebuild.ProjectProps", jsii_struct_bases=[CommonProjectProps], name_mapping={'allow_all_outbound': 'allowAllOutbound', 'badge': 'badge', 'build_spec': 'buildSpec', 'cache': 'cache', 'description': 'description', 'encryption_key': 'encryptionKey', 'environment': 'environment', 'environment_variables': 'environmentVariables', 'file_system_locations': 'fileSystemLocations', 'grant_report_group_permissions': 'grantReportGroupPermissions', 'project_name': 'projectName', 'role': 'role', 'security_groups': 'securityGroups', 'subnet_selection': 'subnetSelection', 'timeout': 'timeout', 'vpc': 'vpc', 'artifacts': 'artifacts', 'secondary_artifacts': 'secondaryArtifacts', 'secondary_sources': 'secondarySources', 'source': 'source'})
class ProjectProps(CommonProjectProps):
    def __init__(self, *, allow_all_outbound: typing.Optional[bool]=None, badge: typing.Optional[bool]=None, build_spec: typing.Optional["BuildSpec"]=None, cache: typing.Optional["Cache"]=None, description: typing.Optional[str]=None, encryption_key: typing.Optional[aws_cdk.aws_kms.IKey]=None, environment: typing.Optional["BuildEnvironment"]=None, environment_variables: typing.Optional[typing.Mapping[str, "BuildEnvironmentVariable"]]=None, file_system_locations: typing.Optional[typing.List["IFileSystemLocation"]]=None, grant_report_group_permissions: typing.Optional[bool]=None, project_name: typing.Optional[str]=None, role: typing.Optional[aws_cdk.aws_iam.IRole]=None, security_groups: typing.Optional[typing.List[aws_cdk.aws_ec2.ISecurityGroup]]=None, subnet_selection: typing.Optional[aws_cdk.aws_ec2.SubnetSelection]=None, timeout: typing.Optional[aws_cdk.core.Duration]=None, vpc: typing.Optional[aws_cdk.aws_ec2.IVpc]=None, artifacts: typing.Optional["IArtifacts"]=None, secondary_artifacts: typing.Optional[typing.List["IArtifacts"]]=None, secondary_sources: typing.Optional[typing.List["ISource"]]=None, source: typing.Optional["ISource"]=None) -> None:
        """
        :param allow_all_outbound: Whether to allow the CodeBuild to send all network traffic. If set to false, you must individually add traffic rules to allow the CodeBuild project to connect to network targets. Only used if 'vpc' is supplied. Default: true
        :param badge: Indicates whether AWS CodeBuild generates a publicly accessible URL for your project's build badge. For more information, see Build Badges Sample in the AWS CodeBuild User Guide. Default: false
        :param build_spec: Filename or contents of buildspec in JSON format. Default: - Empty buildspec.
...
class ReportGroup(aws_cdk.core.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-codebuild.ReportGroup"):
    """The ReportGroup resource class."""
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, export_bucket: typing.Optional[aws_cdk.aws_s3.IBucket]=None, removal_policy: typing.Optional[aws_cdk.core.RemovalPolicy]=None, report_group_name: typing.Optional[str]=None, zip_export: typing.Optional[bool]=None) -> None:
        """
        :param scope: -
        :param id: -
        ...
        """
        props = ReportGroupProps(export_bucket=export_bucket, removal_policy=removal_policy, report_group_name=report_group_name, zip_export=zip_export)

        jsii.create(ReportGroup, self, [scope, id, props])

    @jsii.member(jsii_name="fromReportGroupName")
    @builtins.classmethod
    def from_report_group_name(cls, scope: aws_cdk.core.Construct, id: str, report_group_name: str) -> "IReportGroup":
...
@jsii.data_type(jsii_type="@aws-cdk/aws-codebuild.ReportGroupProps", jsii_struct_bases=[], name_mapping={'export_bucket': 'exportBucket', 'removal_policy': 'removalPolicy', 'report_group_name': 'reportGroupName', 'zip_export': 'zipExport'})
class ReportGroupProps():
    def __init__(self, *, export_bucket: typing.Optional[aws_cdk.aws_s3.IBucket]=None, removal_policy: typing.Optional[aws_cdk.core.RemovalPolicy]=None, report_group_name: typing.Optional[str]=None, zip_export: typing.Optional[bool]=None) -> None:
        ...
        if export_bucket is not None: self._values["export_bucket"] = export_bucket
        if removal_policy is not None: self._values["removal_policy"] = removal_policy
        if report_group_name is not None: self._values["report_group_name"] = report_group_name
        if zip_export is not None: self._values["zip_export"] = zip_export
    ...
    def __repr__(self) -> str:
        return 'ReportGroupProps(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


@jsii.data_type(jsii_type="@aws-cdk/aws-codebuild.S3ArtifactsProps", jsii_struct_bases=[ArtifactsProps], name_mapping={'identifier': 'identifier', 'bucket': 'bucket', 'encryption': 'encryption', 'include_build_id': 'includeBuildId', 'name': 'name', 'package_zip': 'packageZip', 'path': 'path'})
class S3ArtifactsProps(ArtifactsProps):
    def __init__(self, *, identifier: typing.Optional[str]=None, bucket: aws_cdk.aws_s3.IBucket, encryption: typing.Optional[bool]=None, include_build_id: typing.Optional[bool]=None, name: typing.Optional[str]=None, package_zip: typing.Optional[bool]=None, path: typing.Optional[str]=None) -> None:
...
class Source(metaclass=jsii.JSIIAbstractClass, jsii_type="@aws-cdk/aws-codebuild.Source"):
    ...
    @builtins.classmethod
    def bit_bucket(cls, *, owner: str, repo: str, branch_or_ref: typing.Optional[str]=None, clone_depth: typing.Optional[jsii.Number]=None, report_build_status: typing.Optional[bool]=None, webhook: typing.Optional[bool]=None, webhook_filters: typing.Optional[typing.List["FilterGroup"]]=None, identifier: typing.Optional[str]=None) -> "ISource":
        """
        ...
        :param identifier: The source identifier. This property is required on secondary sources.
        """
        props = BitBucketSourceProps(owner=owner, repo=repo, branch_or_ref=branch_or_ref, clone_depth=clone_depth, report_build_status=report_build_status, webhook=webhook, webhook_filters=webhook_filters, identifier=identifier)

        return jsii.sinvoke(cls, "bitBucket", [props])

    @jsii.member(jsii_name="codeCommit")
    @builtins.classmethod
    def code_commit(cls, *, repository: aws_cdk.aws_codecommit.IRepository, branch_or_ref: typing.Optional[str]=None, clone_depth: typing.Optional[jsii.Number]=None, identifier: typing.Optional[str]=None) -> "ISource":
        """
        :param repository: 
        :param branch_or_ref: The commit ID, pull request ID, branch name, or tag name that corresponds to the version of the source code you want to build. Default: the default branch's HEAD commit ID is used
        :param clone_depth: The depth of history to download. Minimum value is 0. If this value is 0, greater than 25, or not provided, then the full history is downloaded with each build of the project.
        :param identifier: The source identifier. This property is required on secondary sources.
        """
        props = CodeCommitSourceProps(repository=repository, branch_or_ref=branch_or_ref, clone_depth=clone_depth, identifier=identifier)

        return jsii.sinvoke(cls, "codeCommit", [props])

    @jsii.member(jsii_name="gitHub")
    @builtins.classmethod
    def git_hub(cls, *, owner: str, repo: str, branch_or_ref: typing.Optional[str]=None, clone_depth: typing.Optional[jsii.Number]=None, report_build_status: typing.Optional[bool]=None, webhook: typing.Optional[bool]=None, webhook_filters: typing.Optional[typing.List["FilterGroup"]]=None, identifier: typing.Optional[str]=None) -> "ISource":
        """
        ...
        :param identifier: The source identifier. This property is required on secondary sources.
        """
        props = GitHubSourceProps(owner=owner, repo=repo, branch_or_ref=branch_or_ref, clone_depth=clone_depth, report_build_status=report_build_status, webhook=webhook, webhook_filters=webhook_filters, identifier=identifier)

        return jsii.sinvoke(cls, "gitHub", [props])

    @jsii.member(jsii_name="gitHubEnterprise")
    @builtins.classmethod
    def git_hub_enterprise(cls, *, https_clone_url: str, branch_or_ref: typing.Optional[str]=None, clone_depth: typing.Optional[jsii.Number]=None, ignore_ssl_errors: typing.Optional[bool]=None, report_build_status: typing.Optional[bool]=None, webhook: typing.Optional[bool]=None, webhook_filters: typing.Optional[typing.List["FilterGroup"]]=None, identifier: typing.Optional[str]=None) -> "ISource":
        """
        ...
        :param identifier: The source identifier. This property is required on secondary sources.
        """
        props = GitHubEnterpriseSourceProps(https_clone_url=https_clone_url, branch_or_ref=branch_or_ref, clone_depth=clone_depth, ignore_ssl_errors=ignore_ssl_errors, report_build_status=report_build_status, webhook=webhook, webhook_filters=webhook_filters, identifier=identifier)

        return jsii.sinvoke(cls, "gitHubEnterprise", [props])

    @jsii.member(jsii_name="s3")
    @builtins.classmethod
    def s3(cls, *, bucket: aws_cdk.aws_s3.IBucket, path: str, version: typing.Optional[str]=None, identifier: typing.Optional[str]=None) -> "ISource":
        """
        :param bucket: 
        :param path: 
        ...
        :param identifier: The source identifier. This property is required on secondary sources.
        """
        props = S3SourceProps(bucket=bucket, path=path, version=version, identifier=identifier)
...
@jsii.data_type(jsii_type="@aws-cdk/aws-codebuild.SourceConfig", jsii_struct_bases=[], name_mapping={'source_property': 'sourceProperty', 'build_triggers': 'buildTriggers', 'source_version': 'sourceVersion'})
class SourceConfig():
    def __init__(self, *, source_property: "CfnProject.SourceProperty", build_triggers: typing.Optional["CfnProject.ProjectTriggersProperty"]=None, source_version: typing.Optional[str]=None) -> None:
...
class Artifacts(metaclass=jsii.JSIIAbstractClass, jsii_type="@aws-cdk/aws-codebuild.Artifacts"):
    ...
    @jsii.member(jsii_name="s3")
    @builtins.classmethod
    def s3(cls, *, bucket: aws_cdk.aws_s3.IBucket, encryption: typing.Optional[bool]=None, include_build_id: typing.Optional[bool]=None, name: typing.Optional[str]=None, package_zip: typing.Optional[bool]=None, path: typing.Optional[str]=None, identifier: typing.Optional[str]=None) -> "IArtifacts":
        """
        :param bucket: The name of the output bucket.
        :param encryption: If this is false, build output will not be encrypted. This is useful if the artifact to publish a static website or sharing content with others Default: true - output will be encrypted
        :param include_build_id: Indicates if the build ID should be included in the path. If this is set to true, then the build artifact will be stored in "//". Default: true
        ...
        :param identifier: The artifact identifier. This property is required on secondary artifacts.
        """
        props = S3ArtifactsProps(bucket=bucket, encryption=encryption, include_build_id=include_build_id, name=name, package_zip=package_zip, path=path, identifier=identifier)
...
@jsii.data_type(jsii_type="@aws-cdk/aws-codebuild.BitBucketSourceProps", jsii_struct_bases=[SourceProps], name_mapping={'identifier': 'identifier', 'owner': 'owner', 'repo': 'repo', 'branch_or_ref': 'branchOrRef', 'clone_depth': 'cloneDepth', 'report_build_status': 'reportBuildStatus', 'webhook': 'webhook', 'webhook_filters': 'webhookFilters'})
class BitBucketSourceProps(SourceProps):
    def __init__(self, *, identifier: typing.Optional[str]=None, owner: str, repo: str, branch_or_ref: typing.Optional[str]=None, clone_depth: typing.Optional[jsii.Number]=None, report_build_status: typing.Optional[bool]=None, webhook: typing.Optional[bool]=None, webhook_filters: typing.Optional[typing.List["FilterGroup"]]=None) -> None:
        ...
        if identifier is not None: self._values["identifier"] = identifier
        if branch_or_ref is not None: self._values["branch_or_ref"] = branch_or_ref
...
@jsii.data_type(jsii_type="@aws-cdk/aws-codebuild.CodeCommitSourceProps", jsii_struct_bases=[SourceProps], name_mapping={'identifier': 'identifier', 'repository': 'repository', 'branch_or_ref': 'branchOrRef', 'clone_depth': 'cloneDepth'})
class CodeCommitSourceProps(SourceProps):
    def __init__(self, *, identifier: typing.Optional[str]=None, repository: aws_cdk.aws_codecommit.IRepository, branch_or_ref: typing.Optional[str]=None, clone_depth: typing.Optional[jsii.Number]=None) -> None:
...
@jsii.data_type(jsii_type="@aws-cdk/aws-codebuild.GitHubEnterpriseSourceProps", jsii_struct_bases=[SourceProps], name_mapping={'identifier': 'identifier', 'https_clone_url': 'httpsCloneUrl', 'branch_or_ref': 'branchOrRef', 'clone_depth': 'cloneDepth', 'ignore_ssl_errors': 'ignoreSslErrors', 'report_build_status': 'reportBuildStatus', 'webhook': 'webhook', 'webhook_filters': 'webhookFilters'})
class GitHubEnterpriseSourceProps(SourceProps):
    def __init__(self, *, identifier: typing.Optional[str]=None, https_clone_url: str, branch_or_ref: typing.Optional[str]=None, clone_depth: typing.Optional[jsii.Number]=None, ignore_ssl_errors: typing.Optional[bool]=None, report_build_status: typing.Optional[bool]=None, webhook: typing.Optional[bool]=None, webhook_filters: typing.Optional[typing.List["FilterGroup"]]=None) -> None:
...
@jsii.data_type(jsii_type="@aws-cdk/aws-codebuild.GitHubSourceProps", jsii_struct_bases=[SourceProps], name_mapping={'identifier': 'identifier', 'owner': 'owner', 'repo': 'repo', 'branch_or_ref': 'branchOrRef', 'clone_depth': 'cloneDepth', 'report_build_status': 'reportBuildStatus', 'webhook': 'webhook', 'webhook_filters': 'webhookFilters'})
...
class PipelineProject(Project, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-codebuild.PipelineProject"):
    ...
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, allow_all_outbound: typing.Optional[bool]=None, badge: typing.Optional[bool]=None, build_spec: typing.Optional["BuildSpec"]=None, cache: typing.Optional["Cache"]=None, description: typing.Optional[str]=None, encryption_key: typing.Optional[aws_cdk.aws_kms.IKey]=None, environment: typing.Optional["BuildEnvironment"]=None, environment_variables: typing.Optional[typing.Mapping[str, "BuildEnvironmentVariable"]]=None, file_system_locations: typing.Optional[typing.List["IFileSystemLocation"]]=None, grant_report_group_permissions: typing.Optional[bool]=None, project_name: typing.Optional[str]=None, role: typing.Optional[aws_cdk.aws_iam.IRole]=None, security_groups: typing.Optional[typing.List[aws_cdk.aws_ec2.ISecurityGroup]]=None, subnet_selection: typing.Optional[aws_cdk.aws_ec2.SubnetSelection]=None, timeout: typing.Optional[aws_cdk.core.Duration]=None, vpc: typing.Optional[aws_cdk.aws_ec2.IVpc]=None) -> None:
        ...
        :param vpc: VPC network to place codebuild network interfaces. Specify this if the codebuild project needs to access resources in a VPC. Default: - No VPC is specified.
        """
        props = PipelineProjectProps(allow_all_outbound=allow_all_outbound, badge=badge, build_spec=build_spec, cache=cache, description=description, encryption_key=encryption_key, environment=environment, environment_variables=environment_variables, file_system_locations=file_system_locations, grant_report_group_permissions=grant_report_group_permissions, project_name=project_name, role=role, security_groups=security_groups, subnet_selection=subnet_selection, timeout=timeout, vpc=vpc)

        jsii.create(PipelineProject, self, [scope, id, props])


@jsii.data_type(jsii_type="@aws-cdk/aws-codebuild.S3SourceProps", jsii_struct_bases=[SourceProps], name_mapping={'identifier': 'identifier', 'bucket': 'bucket', 'path': 'path', 'version': 'version'})
class S3SourceProps(SourceProps):
    def __init__(self, *, identifier: typing.Optional[str]=None, bucket: aws_cdk.aws_s3.IBucket, path: str, version: typing.Optional[str]=None) -> None:
