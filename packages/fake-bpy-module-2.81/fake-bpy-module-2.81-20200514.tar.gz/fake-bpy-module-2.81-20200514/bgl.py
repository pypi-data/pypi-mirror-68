...
class Buffer:
    ...
    def __init__(self,
                 ...
                 ) -> typing.Union['Buffer', 'bpy.context.object']:
...
def glCreateShader(
        shaderType: typing.Union['GL_GEOMETRY_SHADER', 'GL_VERTEX_SHADER']
) -> int:
    '''Creates a shader object. 

    :type shaderType: typing.Union['GL_GEOMETRY_SHADER', 'GL_VERTEX_SHADER']
