...
In casi particolari, ad esempio nei :ref:`tornei ad eliminazione <sistema knockout>`, può
essere necessario inserire esplicitamente la :guilabel:`posizione` di ciascun concorrente, che
verrà usata per determinare la classifica iniziale che a sua volta influenza la generazione del
primo turno.

I valori sono *arbitrari* e sono relativi, non assoluti: i concorrenti verranno ordinati
secondo questo valore, in ordine crescente.
