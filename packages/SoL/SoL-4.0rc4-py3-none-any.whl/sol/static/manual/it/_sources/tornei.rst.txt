...
:guilabel:`Crea torneo knockout`
  Crea un nuovo torneo a eliminazione diretta a partire da un torneo precedente, giocato con il
  sistema *Svizzero* **e** *concluso*: viene chiesto quanti concorrenti dovranno essere da
  copiati nel nuovo torneo, secondo la classifica finale e impostandone la :ref:`posizione
  iniziale <posizione concorrenti>` di conseguenza. Tale numero deve essere una potenza di due
  (cioè, 2, 4, 8, 16...) e ovviamente minore o uguale al numero di concorrenti del torneo di
  partenza.
