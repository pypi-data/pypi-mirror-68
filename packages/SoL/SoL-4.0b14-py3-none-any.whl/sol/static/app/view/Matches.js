...
Ext.define('SoL.view.Matches', {
    ...
    recomputeAverages: function(field, newValue, oldValue) {
        ...
        for(var i = 1; i <= nboards; i++) {
            ...
            if(completed && !coins1.getValue() && !coins2.getValue()) {
                completed = false;
            }
            total1 += coins1.getValue();
            total2 += coins2.getValue();
        ...
        if(completed) {
            var score1 = Math.round(total1 / nboards),
                score2 = Math.round(total2 / nboards);
            ...
            c1column.getComponent('score1').setValue(score2);
            c2column.getComponent('score2').setValue(score1);
        }
    },
