...
To comply with the `General Data Protection Regulation`__ (GDPR), here are some information
...
For the *official* ``SoL`` instance ``https://sol4.metapensiero.it/`` the data protection
...
application, that are beyond the control of the aforementioned responsible person.
...
Players information is collected exclusively for the purpose of offering the Carrom tournaments
...
Some of the players' personal data can be reported in the public interface
(``https://sol4.metapensiero.it/lit/``), viewable by anonymous visitors. The single player can
