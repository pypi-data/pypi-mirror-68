...
Ext.define('SoL.view.Matches.Actions', {
    ...
    initActions: function() {
        ...
        me.recomputeRankingAction = me.addAction(new Ext.Action({
        ...
        if(!tourney.TrainingBoards) {
            me.selfEditMatchAction = me.addAction(new Ext.Action({
                ...
                text: _('Match boards self-insert form'),
                tooltip: _('Show the form that allows the competitors of selected match to self-insert their per-board results.'),
                iconCls: 'edit-record-icon',
                disabled: true,
                hidden: tourney.readOnly,
                needsOneSelectedRow: true,
            ...
            me.selfEditComp1Action = me.addAction(new Ext.Action({
                ...
                text: _('Competitor 1 boards self-insert form'),
                tooltip: _('Show the form that allows the first competitor of the selected match to self-insert own per-board results.'),
                iconCls: 'edit-record-icon',
                disabled: true,
                hidden: tourney.readOnly,
                needsOneSelectedRow: true,
            ...
            me.selfEditComp2Action = me.addAction(new Ext.Action({
                ...
                text: _('Competitor 2 boards self-insert form'),
                tooltip: _('Show the form that allows the second competitor of the selected match to self-insert own per-board results.'),
                iconCls: 'edit-record-icon',
                disabled: true,
                hidden: tourney.readOnly,
                needsOneSelectedRow: true,
    ...
    attachActions: function() {
        ...
        tbar.add(0,
                 ...
                 tourney.TrainingBoards ? me.recomputeRankingAction : null,
