...
setuptools.setup(
    ...
    description="GIC CSITR approved AWS CDK constructs",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/GICLabs/labs-cdk",
    package_dir={'': 'labs_cdk'},
    packages=setuptools.find_packages(where="labs_cdk"),
    install_requires=[
        "attrs==19.3.0",
        ...
        "aws-cdk.aws-ecs-patterns==1.38.0",
        "aws-cdk.aws-elasticache==1.38.0",
