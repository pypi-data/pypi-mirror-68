...
from shioaji.account import FutureAccount, StockAccount, Account
from shioaji.backend import _http
from shioaji.backend.solace import SolaceAPI
from shioaji.constant import OrderState
from shioaji.contracts import BaseContract, Contract, Future, Option, Stock, Index
from shioaji.data import Ticks, Snapshots
...
class Shioaji:
    ...
    def snapshots(
        ...
        timeout: int = 5000,
        cb: typing.Callable[[Snapshots], None] = None,
    ) -> Snapshots:
