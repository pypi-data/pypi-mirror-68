...
class ResidentialPvFeedInDamp(OperationStrategy):
    ...
    lithium_ion at sundown.
    """

    def __init__(self, power_profile, general_config: GeneralSimulationConfig, pv_generation_profile: PvGenerationProfile):
    ...
    def pv_prediction(self, pv_generation_profile: PvGenerationProfile) -> list:
        """
        ...
        """
        print('PV Prediction is performed this may take some time.')
        pv_profile = pv_generation_profile.copy
        pv = pv_profile.profile_data_to_list()
