...
class LithiumIonBattery(StorageTechnology):
    ...
    def __init__(self, cell: str, voltage: float, capacity: float, thermal_model: str, data_export: DataHandler,
        ...
        cell_type: CellType = self.__factory.create_cell_type(cell, voltage, capacity)
        self.__cell_type: CellType = self.__factory.create_cell_type(cell, voltage, capacity)
        self.__thermal_model: ThermalModel = self.__factory.create_thermal_model_from(thermal_model, cell_type,
    ...
    def update(self) -> None:
        ...
        self.__thermal_model.update(time, bs)
        bs.time = time
