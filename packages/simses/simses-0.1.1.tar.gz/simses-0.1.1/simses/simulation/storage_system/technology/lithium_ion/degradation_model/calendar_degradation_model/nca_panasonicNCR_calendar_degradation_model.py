...
class PanasonicNCACalendarDegradationModel(CalendarDegradationModel):
    ...
    def __init__(self, cell_type: CellType, general_config: GeneralSimulationConfig):
    ...
    def calculate_degradation(self, battery_state: LithiumIonState) -> None:
        ...
        capacity_loss = rel_capacity_loss(virtual_time + self.__timestep / 86400) - self.__capacity_loss_cal
    ...
    def calculate_resistance_increase(self, battery_state: LithiumIonState) -> None:
        ...
        resistance_increase = rel_resistance_increase(virtual_time + self.__timestep / 86400) - self.__rinc_cal
