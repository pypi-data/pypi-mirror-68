...
class SanyoNMCCalendarDegradationModel(CalendarDegradationModel):
    ...
    def __init__(self, cell_type: CellType, battery_config: BatteryConfig, general_config: GeneralSimulationConfig):
    ...
    def calculate_degradation(self, battery_state: LithiumIonState) -> None:
        ...
        capacity_loss = alpha_cap*(virtual_time + self.__timestep / 86400)**(0.75) - qloss
    ...
    def calculate_resistance_increase(self, battery_state: LithiumIonState) -> None:
        ...
        resistance_increase = alpha_res*(virtual_time + self.__timestep / 86400)**(0.75) - rinc_cal
