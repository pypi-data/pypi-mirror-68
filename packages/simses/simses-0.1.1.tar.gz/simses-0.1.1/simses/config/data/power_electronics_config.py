from constants_simses import ROOT_PATH
...
class PowerElectronicsConfig(DataConfig):
    ...
    def acdc_converter_data(self) -> str:
        ...
        return ROOT_PATH + self.get_property(self.__section, 'ACDC_CONVERTER_DATA')
    ...
    def dcdc_converter_dir(self) -> str:
        """Returns directory of acdc converter data files"""
        return ROOT_PATH + self.get_property(self.__section, 'DCDC_CONVERTER_DIR')
