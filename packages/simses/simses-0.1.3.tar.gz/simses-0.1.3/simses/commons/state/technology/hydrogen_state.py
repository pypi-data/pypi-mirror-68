...
class HydrogenState(StorageTechnologyState):
    ...
    TEMPERATURE_EL = 'temperature of electrolyzer stack in K'
    TEMPERATURE_FC = 'temperature of fuelcell stack in K'
    ...
    RESISTANCE_INCREASE_CALENDRIC_EL = 'increase reisistance calendric in p.u.'
    ...
    @property
    def resistance_increase_calendric_el(self) -> float:
        return self.get(self.RESISTANCE_INCREASE_CALENDRIC_EL)

    @resistance_increase_calendric_el.setter
    def resistance_increase_calendric_el(self, value: float):
        self.set(self.RESISTANCE_INCREASE_CALENDRIC_EL, value)

    # @property
    # def relative_time(self) -> float:
    #     return self.get(self.RELATIVE_TIME)
    #
    # @relative_time.setter
    # def relative_time(self, value: float):
    #     self.set(self.RELATIVE_TIME, value)
