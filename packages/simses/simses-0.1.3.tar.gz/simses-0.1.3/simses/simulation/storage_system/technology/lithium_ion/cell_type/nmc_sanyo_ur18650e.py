...
class SanyoNMC(CellType):
    ...
    def __init__(self, voltage: float, capacity: float, battery_data_config: BatteryDataConfig, battery_config: BatteryConfig):
        ...
        self.__OCV_FILE = battery_data_config.nmc_sanyo_ocv_file
        ...
        # (source: https://akkuplus.de/Panasonic-UR18650E-37-Volt-2150mAh-Li-Ion-EOL)
        self.__mass = 0.0445  # kg
    ...
    def get_open_circuit_voltage(self, battery_state: LithiumIonState) -> float:
        ...
        # get the index of the row which has the closest value to current soc value, but
