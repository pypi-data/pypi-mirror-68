...
class FieldDataNMC(CellType):
    """Characterisation using field data: Master Thesis by Felix Müller"""

    __CELL_VOLTAGE = 3.7  # V
    __CELL_CAPACITY = 78  # Ah
    __CELL_RESISTANCE = 0.636847061 * 10 ** (-3)  # Ohm

    # Parameters for Curve Fitting: Discharge
    __p1_dch = 20.2900420445977
    __p2_dch = -60.0887052392938
    __p3_dch = 65.004615459861130
    __p4_dch = -30.2045044257067
    __p5_dch = 5.20873794411933
    __p6_dch = 0.473682851204244
    __p7_dch = 3.39477691039580

    # Parameters for Curve Fitting: Charge
    __p1_ch = 20.7178220259285
    __p2_ch = -60.1746391328553
    __p3_ch = 62.3322998026395
    __p4_ch = -25.9004650617671
    __p5_ch = 2.76790388555959
    __p6_ch = 0.931931308431992
    __p7_ch = 3.40824770275865

    # Parameters for Curve Fitting: Rest
    __p1_rest = 5.25592568044651
    __p2_rest = -14.2882018732096
    __p3_rest = 11.7858191391494
    __p4_rest = -0.932995895183766
    __p5_rest = -2.41656520395104
    __p6_rest = 1.28233771368260
    __p7_rest = 3.37506295609074
