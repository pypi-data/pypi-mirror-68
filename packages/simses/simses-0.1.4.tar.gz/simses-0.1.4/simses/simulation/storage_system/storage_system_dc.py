...
class StorageSystemDC:
    ...
    def __get_current_state(self) -> SystemState:
        ...
        system_state.convection_heat = storage_state.convection_heat
        system_state.storage_power_loss = storage_state.power_loss
        # reverse calculation
        dc_power = storage_state.voltage * storage_state.current
        self.__dcdc_converter.reverse_calculate_dc_current(dc_power, storage_state.voltage)
        system_state.dc_power = self.__dcdc_converter.dc_power
