...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.3781275.svg)](https://doi.org/10.5281/zenodo.3781275)
...
```
Samapriya Roy. (2020, May 1). samapriya/porder: porder: Simple CLI for Planet ordersV2 API (Version 0.7.1). Zenodo.
http://doi.org/10.5281/zenodo.3781275
```
