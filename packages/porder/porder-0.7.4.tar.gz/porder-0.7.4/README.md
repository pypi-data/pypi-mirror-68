...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.3831044.svg)](https://doi.org/10.5281/zenodo.3831044)
...
```
Samapriya Roy. (2020, May 16). samapriya/porder: porder: Simple CLI for Planet ordersV2 API (Version 0.7.3). Zenodo.
http://doi.org/10.5281/zenodo.3831044
```
