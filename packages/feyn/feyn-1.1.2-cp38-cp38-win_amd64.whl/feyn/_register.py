from typing import Hashable, List, Tuple, Union, cast
import requests
...
class RegisterCollection:
    ...
    def get(self, name: str, register_type: str = "fixed") -> Register:
        """
        ...
        >>>     regs.append(ql.registers.get(colname))
        ...
        return self._register_from_json(req.json())
