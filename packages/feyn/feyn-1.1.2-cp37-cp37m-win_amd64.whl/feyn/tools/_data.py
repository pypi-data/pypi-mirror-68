...
def split(data: Iterable, ratio:List[int]=[1,1]) -> List[Iterable]:
    ...
    Example: Split data in to train, test and validation data. 80% training data and 10% test and validation data each
    >>> train, test, validation = feyn.tools.split(data, [8,1,1])
