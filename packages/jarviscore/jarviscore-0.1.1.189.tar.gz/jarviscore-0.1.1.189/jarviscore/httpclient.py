...
class HTTPClient():
    ...
    def __init__(self, owner:str, db_user=None, db_pass=None, twitch_oauth=None):
    ...
    def PutFromTwitch(self, url: str, body: dict) -> WebResponse:
        headers = self.__get_twitch_headers(url)
        return self.Put(url, body=body, headers=headers)
    
    def PutJSONFromTwitch(self, url: str, body: dict) -> WebResponse:
        headers = self.__get_twitch_headers(url)
