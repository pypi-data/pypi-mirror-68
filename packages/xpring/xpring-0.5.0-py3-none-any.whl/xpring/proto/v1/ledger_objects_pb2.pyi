...
class LedgerEntryType(builtin___int):
    DESCRIPTOR: google___protobuf___descriptor___EnumDescriptor = ...
    @classmethod
    def Name(cls, number: builtin___int) -> builtin___str: ...
    @classmethod
    def Value(cls, name: builtin___str) -> 'LedgerEntryType': ...
    @classmethod
    def keys(cls) -> typing___List[builtin___str]: ...
    @classmethod
    def values(cls) -> typing___List['LedgerEntryType']: ...
    @classmethod
    def items(cls) -> typing___List[typing___Tuple[builtin___str, 'LedgerEntryType']]: ...
    LEDGER_ENTRY_TYPE_UNSPECIFIED = typing___cast('LedgerEntryType', 0)
    LEDGER_ENTRY_TYPE_ACCOUNT_ROOT = typing___cast('LedgerEntryType', 1)
    LEDGER_ENTRY_TYPE_AMENDMENTS = typing___cast('LedgerEntryType', 2)
    LEDGER_ENTRY_TYPE_CHECK = typing___cast('LedgerEntryType', 3)
    LEDGER_ENTRY_TYPE_DEPOSIT_PREAUTH = typing___cast('LedgerEntryType', 4)
    LEDGER_ENTRY_TYPE_DIRECTORY_NODE = typing___cast('LedgerEntryType', 5)
    LEDGER_ENTRY_TYPE_ESCROW = typing___cast('LedgerEntryType', 6)
    LEDGER_ENTRY_TYPE_FEE_SETTINGS = typing___cast('LedgerEntryType', 7)
    LEDGER_ENTRY_TYPE_LEDGER_HASHES = typing___cast('LedgerEntryType', 8)
    LEDGER_ENTRY_TYPE_OFFER = typing___cast('LedgerEntryType', 9)
    LEDGER_ENTRY_TYPE_PAY_CHANNEL = typing___cast('LedgerEntryType', 10)
    LEDGER_ENTRY_TYPE_RIPPLE_STATE = typing___cast('LedgerEntryType', 11)
    LEDGER_ENTRY_TYPE_SIGNER_LIST = typing___cast('LedgerEntryType', 12)
LEDGER_ENTRY_TYPE_UNSPECIFIED = typing___cast('LedgerEntryType', 0)
LEDGER_ENTRY_TYPE_ACCOUNT_ROOT = typing___cast('LedgerEntryType', 1)
LEDGER_ENTRY_TYPE_AMENDMENTS = typing___cast('LedgerEntryType', 2)
LEDGER_ENTRY_TYPE_CHECK = typing___cast('LedgerEntryType', 3)
...
class LedgerObject(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"account_root",u"amendments",u"check",u"deposit_preauth",u"directory_node",u"escrow",u"fee_settings",u"ledger_hashes",u"object",u"offer",u"pay_channel",u"ripple_state",u"signer_list"]) -> builtin___bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"account_root",u"amendments",u"check",u"deposit_preauth",u"directory_node",u"escrow",u"fee_settings",u"ledger_hashes",u"object",u"offer",u"pay_channel",u"ripple_state",u"signer_list"]) -> None: ...
    else:
...
class AccountRoot(google___protobuf___message___Message):
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"account",u"account_transaction_id",u"balance",u"domain",u"email_hash",u"flags",u"message_key",u"owner_count",u"previous_transaction_id",u"previous_transaction_ledger_sequence",u"regular_key",u"sequence",u"tick_size",u"transfer_rate"]) -> builtin___bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"account",u"account_transaction_id",u"balance",u"domain",u"email_hash",u"flags",u"message_key",u"owner_count",u"previous_transaction_id",u"previous_transaction_ledger_sequence",u"regular_key",u"sequence",u"tick_size",u"transfer_rate"]) -> None: ...
    else:
...
class Amendments(google___protobuf___message___Message):
    ...
    class Majority(google___protobuf___message___Message):
        ...
        def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        if sys.version_info >= (3,):
            def HasField(self, field_name: typing_extensions___Literal[u"amendment",u"close_time"]) -> builtin___bool: ...
            def ClearField(self, field_name: typing_extensions___Literal[u"amendment",u"close_time"]) -> None: ...
        else:
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"flags"]) -> builtin___bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"amendments",u"flags",u"majorities"]) -> None: ...
    else:
...
class Check(google___protobuf___message___Message):
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"account",u"destination",u"destination_node",u"destination_tag",u"expiration",u"flags",u"invoice_id",u"owner_node",u"previous_transaction_id",u"previous_transaction_ledger_sequence",u"send_max",u"sequence",u"source_tag"]) -> builtin___bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"account",u"destination",u"destination_node",u"destination_tag",u"expiration",u"flags",u"invoice_id",u"owner_node",u"previous_transaction_id",u"previous_transaction_ledger_sequence",u"send_max",u"sequence",u"source_tag"]) -> None: ...
    else:
...
class DepositPreauthObject(google___protobuf___message___Message):
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"account",u"authorize",u"flags",u"owner_node",u"previous_transaction_id",u"previous_transaction_ledger_sequence"]) -> builtin___bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"account",u"authorize",u"flags",u"owner_node",u"previous_transaction_id",u"previous_transaction_ledger_sequence"]) -> None: ...
    else:
...
class DirectoryNode(google___protobuf___message___Message):
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"flags",u"index_next",u"index_previous",u"owner",u"root_index",u"taker_gets_currency",u"taker_gets_issuer",u"taker_pays_currency",u"taker_pays_issuer"]) -> builtin___bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"flags",u"index_next",u"index_previous",u"indexes",u"owner",u"root_index",u"taker_gets_currency",u"taker_gets_issuer",u"taker_pays_currency",u"taker_pays_issuer"]) -> None: ...
    else:
...
class Escrow(google___protobuf___message___Message):
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"account",u"amount",u"cancel_after",u"condition",u"destination",u"destination_node",u"destination_tag",u"finish_after",u"flags",u"owner_node",u"previous_transaction_id",u"previous_transaction_ledger_sequence",u"source_tag"]) -> builtin___bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"account",u"amount",u"cancel_after",u"condition",u"destination",u"destination_node",u"destination_tag",u"finish_after",u"flags",u"owner_node",u"previous_transaction_id",u"previous_transaction_ledger_sequence",u"source_tag"]) -> None: ...
    else:
...
class FeeSettings(google___protobuf___message___Message):
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"base_fee",u"flags",u"reference_fee_units",u"reserve_base",u"reserve_increment"]) -> builtin___bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"base_fee",u"flags",u"reference_fee_units",u"reserve_base",u"reserve_increment"]) -> None: ...
    else:
...
class LedgerHashes(google___protobuf___message___Message):
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"flags",u"last_ledger_sequence"]) -> builtin___bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"flags",u"hashes",u"last_ledger_sequence"]) -> None: ...
    else:
...
class Offer(google___protobuf___message___Message):
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"account",u"book_directory",u"book_node",u"expiration",u"flags",u"owner_node",u"previous_transaction_id",u"previous_transaction_ledger_sequence",u"sequence",u"taker_gets",u"taker_pays"]) -> builtin___bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"account",u"book_directory",u"book_node",u"expiration",u"flags",u"owner_node",u"previous_transaction_id",u"previous_transaction_ledger_sequence",u"sequence",u"taker_gets",u"taker_pays"]) -> None: ...
    else:
...
class PayChannel(google___protobuf___message___Message):
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"account",u"amount",u"balance",u"cancel_after",u"destination",u"destination_tag",u"expiration",u"flags",u"owner_node",u"previous_transaction_id",u"previous_transaction_ledger_sequence",u"public_key",u"settle_delay",u"source_tag"]) -> builtin___bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"account",u"amount",u"balance",u"cancel_after",u"destination",u"destination_tag",u"expiration",u"flags",u"owner_node",u"previous_transaction_id",u"previous_transaction_ledger_sequence",u"public_key",u"settle_delay",u"source_tag"]) -> None: ...
    else:
...
class RippleState(google___protobuf___message___Message):
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"balance",u"flags",u"high_limit",u"high_node",u"high_quality_in",u"high_quality_out",u"low_limit",u"low_node",u"low_quality_in",u"low_quality_out",u"previous_transaction_id",u"previous_transaction_ledger_sequence"]) -> builtin___bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"balance",u"flags",u"high_limit",u"high_node",u"high_quality_in",u"high_quality_out",u"low_limit",u"low_node",u"low_quality_in",u"low_quality_out",u"previous_transaction_id",u"previous_transaction_ledger_sequence"]) -> None: ...
    else:
...
class SignerList(google___protobuf___message___Message):
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"flags",u"owner_node",u"previous_transaction_id",u"previous_transaction_ledger_sequence",u"signer_list_id",u"signer_quorum"]) -> builtin___bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"flags",u"owner_node",u"previous_transaction_id",u"previous_transaction_ledger_sequence",u"signer_entries",u"signer_list_id",u"signer_quorum"]) -> None: ...
    else:
