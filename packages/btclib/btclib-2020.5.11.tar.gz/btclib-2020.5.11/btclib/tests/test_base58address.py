...
class TestAddresses(unittest.TestCase):
    def test_b58address_from_h160(self):
        ...
        bad_prefix = b"\xbb"
        self.assertRaises(
            ValueError, b58address_from_h160, bad_prefix, payload, network
        )
    ...
    def test_p2sh(self):
        ...
        self.assertEqual(
            redeem_script_hash.hex(), "4266fc6f2c2861d7fe229b279a79803afca7ba34"
        )
    ...
    def test_p2w_p2sh(self):
        ...
        script = encode(
            ["OP_DUP", "OP_HASH160", h160pubkey, "OP_EQUALVERIFY", "OP_CHECKSIG"]
        )
    ...
    def test_address_from_wif(self):
        ...
        b32 = p2wpkh(pubkey)
        self.assertEqual(
            h160_from_b58address(b58)[1:], witness_from_b32address(b32)[1:]
        )
        ...
        self.assertEqual(
            prvkeyinfo_from_prvkey(wif1)[0], prvkeyinfo_from_prvkey(wif2)[0]
        )
