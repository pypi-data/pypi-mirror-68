...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'aiven', 'v2.2.0-alpha.1589291287+gbf19f39'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource aiven v2.2.0-alpha.1589291287+gbf19f39`
                """)
            else:
                raise
