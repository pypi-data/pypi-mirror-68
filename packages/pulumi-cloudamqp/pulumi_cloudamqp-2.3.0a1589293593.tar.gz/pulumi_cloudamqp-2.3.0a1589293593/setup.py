...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'cloudamqp', 'v2.3.0-alpha.1589293593+gc674a9c'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource cloudamqp v2.3.0-alpha.1589293593+gc674a9c`
                """)
            else:
                raise
