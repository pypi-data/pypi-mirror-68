...
class CfnEventBus(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-events.CfnEventBus"):
    ...
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnEventBus":
...
class CfnEventBusPolicy(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-events.CfnEventBusPolicy"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnEventBusPolicy":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
class CfnEventBusPolicyProps():
    def __init__(self, *, action: str, principal: str, statement_id: str, condition: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnEventBusPolicy.ConditionProperty"]]]=None, event_bus_name: typing.Optional[str]=None) -> None:
...
class CfnEventBusProps():
    def __init__(self, *, name: str, event_source_name: typing.Optional[str]=None) -> None:
...
class CfnRule(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-events.CfnRule"):
    ...
    class EcsParametersProperty():
        def __init__(self, *, task_definition_arn: str, group: typing.Optional[str]=None, launch_type: typing.Optional[str]=None, network_configuration: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnRule.NetworkConfigurationProperty"]]]=None, platform_version: typing.Optional[str]=None, task_count: typing.Optional[jsii.Number]=None) -> None:
            """
    ...
    class InputTransformerProperty():
        def __init__(self, *, input_template: str, input_paths_map: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.Mapping[str, str]]]]=None) -> None:
            """
    ...
    class NetworkConfigurationProperty():
        def __init__(self, *, aws_vpc_configuration: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnRule.AwsVpcConfigurationProperty"]]]=None) -> None:
            """
    ...
    class RunCommandParametersProperty():
        def __init__(self, *, run_command_targets: typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnRule.RunCommandTargetProperty"]]]) -> None:
            """
...
class EventBusAttributes():
    def __init__(self, *, event_bus_arn: str, event_bus_name: str, event_bus_policy: str, event_source_name: typing.Optional[str]=None) -> None:
...
class EventBusProps():
    def __init__(self, *, event_bus_name: typing.Optional[str]=None, event_source_name: typing.Optional[str]=None) -> None:
...
class OnEventOptions():
    def __init__(self, *, description: typing.Optional[str]=None, event_pattern: typing.Optional["EventPattern"]=None, rule_name: typing.Optional[str]=None, target: typing.Optional["IRuleTarget"]=None) -> None:
...
class RuleProps():
    def __init__(self, *, description: typing.Optional[str]=None, enabled: typing.Optional[bool]=None, event_bus: typing.Optional["IEventBus"]=None, event_pattern: typing.Optional["EventPattern"]=None, rule_name: typing.Optional[str]=None, schedule: typing.Optional["Schedule"]=None, targets: typing.Optional[typing.List["IRuleTarget"]]=None) -> None:
...
@jsii.data_type(jsii_type="@aws-cdk/aws-events.RuleTargetConfig", jsii_struct_bases=[], name_mapping={'arn': 'arn', 'id': 'id', 'batch_parameters': 'batchParameters', 'ecs_parameters': 'ecsParameters', 'input': 'input', 'kinesis_parameters': 'kinesisParameters', 'role': 'role', 'run_command_parameters': 'runCommandParameters', 'sqs_parameters': 'sqsParameters', 'target_resource': 'targetResource'})
class RuleTargetConfig():
    def __init__(self, *, arn: str, id: str, batch_parameters: typing.Optional["CfnRule.BatchParametersProperty"]=None, ecs_parameters: typing.Optional["CfnRule.EcsParametersProperty"]=None, input: typing.Optional["RuleTargetInput"]=None, kinesis_parameters: typing.Optional["CfnRule.KinesisParametersProperty"]=None, role: typing.Optional[aws_cdk.aws_iam.IRole]=None, run_command_parameters: typing.Optional["CfnRule.RunCommandParametersProperty"]=None, sqs_parameters: typing.Optional["CfnRule.SqsParametersProperty"]=None, target_resource: typing.Optional[aws_cdk.core.IConstruct]=None) -> None:
        ...
        """
        if isinstance(batch_parameters, dict): batch_parameters = CfnRule.BatchParametersProperty(**batch_parameters)
...
class RuleTargetInputProperties():
    def __init__(self, *, input: typing.Optional[str]=None, input_path: typing.Optional[str]=None, input_paths_map: typing.Optional[typing.Mapping[str, str]]=None, input_template: typing.Optional[str]=None) -> None:
