...
from seislab.src.segpy.encoding import ASCII
from seislab.src.segpy.packer import HeaderPacker

from seislab.src.segpy.trace_header import TraceHeaderRev1
from seislab.src.segpy.util import file_length, filename_from_handle
from seislab.src.segpy.datatypes import (DATA_SAMPLE_FORMAT_TO_SEG_Y_TYPE, SEG_Y_TYPE_DESCRIPTION,
                                         SEG_Y_TYPE_TO_CTYPE, size_in_bytes)
from seislab.src.segpy.toolkit import (extract_revision,
                                       bytes_per_sample,
