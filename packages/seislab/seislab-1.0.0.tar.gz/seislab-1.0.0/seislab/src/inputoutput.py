...
import math
#
sys.path.append(os.path.dirname(__file__)[:-12])
from seislab.src.analysis import analysis as seis_ays
from seislab.src.segpy.header import field
from seislab.src.segpy.types import Int32
import seislab.src.segpy.reader as syreader
import seislab.src.segpy.writer as sywriter
import seislab.src.segpy.packer as sypacker
from seislab.src.segpy.binary_reel_header import BinaryReelHeader
from seislab.src.segpy.trace_header import TraceHeaderRev1
