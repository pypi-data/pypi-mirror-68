...
class ApiClient(object):
    ...
    def __init__(self, host=None, header_name=None, header_value=None, cookie=None):
        ...
        self.user_agent = 'Swagger-Codegen/20.5/python'
    ...
    def __call_api(self, resource_path, method,
        ...
        # auth setting
        # self.update_params_for_auth(header_params, query_params, auth_settings) # delete ,or will return authorization error
        ...
        if _preload_content:
            ...
            if response_type:
                ...
                return_data = response_data # old:Node ,can not get return value
