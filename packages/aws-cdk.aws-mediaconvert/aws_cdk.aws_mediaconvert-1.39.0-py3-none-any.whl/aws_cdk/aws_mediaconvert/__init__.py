...
class CfnJobTemplate(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-mediaconvert.CfnJobTemplate"):
    ...
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, settings_json: typing.Any, acceleration_settings: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["AccelerationSettingsProperty"]]]=None, category: typing.Optional[str]=None, description: typing.Optional[str]=None, hop_destinations: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.core.IResolvable, "HopDestinationProperty"]]]]]=None, name: typing.Optional[str]=None, priority: typing.Optional[jsii.Number]=None, queue: typing.Optional[str]=None, status_update_interval: typing.Optional[str]=None, tags: typing.Any=None) -> None:
        ...
        """
        props = CfnJobTemplateProps(settings_json=settings_json, acceleration_settings=acceleration_settings, category=category, description=description, hop_destinations=hop_destinations, name=name, priority=priority, queue=queue, status_update_interval=status_update_interval, tags=tags)

        jsii.create(CfnJobTemplate, self, [scope, id, props])

    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnJobTemplate":
    ...
    def hop_destinations(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.core.IResolvable, "HopDestinationProperty"]]]]]:
    ...
    def hop_destinations(self, value: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.core.IResolvable, "HopDestinationProperty"]]]]]):
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-mediaconvert.CfnJobTemplate.HopDestinationProperty", jsii_struct_bases=[], name_mapping={'priority': 'priority', 'queue': 'queue', 'wait_minutes': 'waitMinutes'})
    class HopDestinationProperty():
        def __init__(self, *, priority: typing.Optional[jsii.Number]=None, queue: typing.Optional[str]=None, wait_minutes: typing.Optional[jsii.Number]=None) -> None:
            """
            ...
            if wait_minutes is not None: self._values["wait_minutes"] = wait_minutes
        ...
        def __repr__(self) -> str:
            return 'HopDestinationProperty(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())



@jsii.data_type(jsii_type="@aws-cdk/aws-mediaconvert.CfnJobTemplateProps", jsii_struct_bases=[], name_mapping={'settings_json': 'settingsJson', 'acceleration_settings': 'accelerationSettings', 'category': 'category', 'description': 'description', 'hop_destinations': 'hopDestinations', 'name': 'name', 'priority': 'priority', 'queue': 'queue', 'status_update_interval': 'statusUpdateInterval', 'tags': 'tags'})
class CfnJobTemplateProps():
    def __init__(self, *, settings_json: typing.Any, acceleration_settings: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnJobTemplate.AccelerationSettingsProperty"]]]=None, category: typing.Optional[str]=None, description: typing.Optional[str]=None, hop_destinations: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnJobTemplate.HopDestinationProperty"]]]]]=None, name: typing.Optional[str]=None, priority: typing.Optional[jsii.Number]=None, queue: typing.Optional[str]=None, status_update_interval: typing.Optional[str]=None, tags: typing.Any=None) -> None:
        ...
        if hop_destinations is not None: self._values["hop_destinations"] = hop_destinations
    ...
    @builtins.property
    def hop_destinations(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnJobTemplate.HopDestinationProperty"]]]]]:
        """``AWS::MediaConvert::JobTemplate.HopDestinations``.
...
class CfnPreset(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-mediaconvert.CfnPreset"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnPreset":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
class CfnPresetProps():
    def __init__(self, *, settings_json: typing.Any, category: typing.Optional[str]=None, description: typing.Optional[str]=None, name: typing.Optional[str]=None, tags: typing.Any=None) -> None:
...
class CfnQueue(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-mediaconvert.CfnQueue"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnQueue":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
class CfnQueueProps():
    def __init__(self, *, description: typing.Optional[str]=None, name: typing.Optional[str]=None, pricing_plan: typing.Optional[str]=None, status: typing.Optional[str]=None, tags: typing.Any=None) -> None:
