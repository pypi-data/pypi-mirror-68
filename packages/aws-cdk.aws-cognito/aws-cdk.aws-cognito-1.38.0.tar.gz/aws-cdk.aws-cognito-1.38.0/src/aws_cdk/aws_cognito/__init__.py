...
class IUserPool(aws_cdk.core.IResource, jsii.compat.Protocol):
    ...
    def add_client(self, id: str, *, auth_flows: typing.Optional["AuthFlow"]=None, generate_secret: typing.Optional[bool]=None, o_auth: typing.Optional["OAuthSettings"]=None, user_pool_client_name: typing.Optional[str]=None) -> "IUserPoolClient":
...
class _IUserPoolProxy(jsii.proxy_for(aws_cdk.core.IResource)):
    ...
    def add_client(self, id: str, *, auth_flows: typing.Optional["AuthFlow"]=None, generate_secret: typing.Optional[bool]=None, o_auth: typing.Optional["OAuthSettings"]=None, user_pool_client_name: typing.Optional[str]=None) -> "IUserPoolClient":
        ...
        :stability: experimental
        """
        options = UserPoolClientOptions(auth_flows=auth_flows, generate_secret=generate_secret, o_auth=o_auth, user_pool_client_name=user_pool_client_name)
...
class RequiredAttributes():
    def __init__(self, *, address: typing.Optional[bool]=None, birthdate: typing.Optional[bool]=None, email: typing.Optional[bool]=None, family_name: typing.Optional[bool]=None, fullname: typing.Optional[bool]=None, gender: typing.Optional[bool]=None, given_name: typing.Optional[bool]=None, last_update_time: typing.Optional[bool]=None, locale: typing.Optional[bool]=None, middle_name: typing.Optional[bool]=None, nickname: typing.Optional[bool]=None, phone_number: typing.Optional[bool]=None, preferred_username: typing.Optional[bool]=None, profile_page: typing.Optional[bool]=None, profile_picture: typing.Optional[bool]=None, timezone: typing.Optional[bool]=None, website: typing.Optional[bool]=None) -> None:
        ...
        :param email: Whether theb user's e-mail address, represented as an RFC 5322 [RFC5322] addr-spec, is a required attribute. Default: false
...
class UserPool(aws_cdk.core.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-cognito.UserPool"):
    ...
    :stability: experimental
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, auto_verify: typing.Optional["AutoVerifiedAttrs"]=None, custom_attributes: typing.Optional[typing.Mapping[str, "ICustomAttribute"]]=None, email_settings: typing.Optional["EmailSettings"]=None, lambda_triggers: typing.Optional["UserPoolTriggers"]=None, mfa: typing.Optional["Mfa"]=None, mfa_second_factor: typing.Optional["MfaSecondFactor"]=None, password_policy: typing.Optional["PasswordPolicy"]=None, required_attributes: typing.Optional["RequiredAttributes"]=None, self_sign_up_enabled: typing.Optional[bool]=None, sign_in_aliases: typing.Optional["SignInAliases"]=None, sms_role: typing.Optional[aws_cdk.aws_iam.IRole]=None, sms_role_external_id: typing.Optional[str]=None, user_invitation: typing.Optional["UserInvitationConfig"]=None, user_pool_name: typing.Optional[str]=None, user_verification: typing.Optional["UserVerificationConfig"]=None) -> None:
        """
        :param scope: -
        :param id: -
...
class UserPoolClient(aws_cdk.core.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-cognito.UserPoolClient"):
    ...
    :stability: experimental
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, user_pool: "IUserPool", auth_flows: typing.Optional["AuthFlow"]=None, generate_secret: typing.Optional[bool]=None, o_auth: typing.Optional["OAuthSettings"]=None, user_pool_client_name: typing.Optional[str]=None) -> None:
        """
        :param scope: -
        :param id: -
        ...
        :stability: experimental
        """
        props = UserPoolClientProps(user_pool=user_pool, auth_flows=auth_flows, generate_secret=generate_secret, o_auth=o_auth, user_pool_client_name=user_pool_client_name)
...
@jsii.data_type(jsii_type="@aws-cdk/aws-cognito.UserPoolClientOptions", jsii_struct_bases=[], name_mapping={'auth_flows': 'authFlows', 'generate_secret': 'generateSecret', 'o_auth': 'oAuth', 'user_pool_client_name': 'userPoolClientName'})
class UserPoolClientOptions():
    def __init__(self, *, auth_flows: typing.Optional["AuthFlow"]=None, generate_secret: typing.Optional[bool]=None, o_auth: typing.Optional["OAuthSettings"]=None, user_pool_client_name: typing.Optional[str]=None) -> None:
...
@jsii.data_type(jsii_type="@aws-cdk/aws-cognito.UserPoolClientProps", jsii_struct_bases=[UserPoolClientOptions], name_mapping={'auth_flows': 'authFlows', 'generate_secret': 'generateSecret', 'o_auth': 'oAuth', 'user_pool_client_name': 'userPoolClientName', 'user_pool': 'userPool'})
class UserPoolClientProps(UserPoolClientOptions):
    def __init__(self, *, auth_flows: typing.Optional["AuthFlow"]=None, generate_secret: typing.Optional[bool]=None, o_auth: typing.Optional["OAuthSettings"]=None, user_pool_client_name: typing.Optional[str]=None, user_pool: "IUserPool") -> None:
...
class UserVerificationConfig():
    ...
    def email_body(self) -> typing.Optional[str]:
        ...
        - 'Hello {username}, Your verification code is {####}' if VerificationEmailStyle.CODE is chosen,
