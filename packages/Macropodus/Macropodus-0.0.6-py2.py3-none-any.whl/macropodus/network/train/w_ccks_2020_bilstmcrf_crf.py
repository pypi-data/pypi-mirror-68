...
from macropodus.conf.path_config import path_model_dir, \
                                        ...
                                        path_ccks_2020_ner_train, path_ccks_2020_ner_dev
...
def train_w2v(hyper_parameters=None, rate=1.0):
    if not hyper_parameters:
        hyper_parameters = {
            ...
            'data': {'train_data': path_ccks_2020_ner_train, # path_seg_pku_1998_train, # path_ner_people_1998_train, # path_tag_people_2014_train, # path_seg_pku_1998_train,  # path_ner_people_1998_train, # 训练数据
                     'val_data': path_ccks_2020_ner_dev # path_tag_people_1998_train # path_seg_pku_1998_train # path_ner_people_1998_valid # path_tag_people_2014_valid # path_seg_pku_1998_train  # path_ner_people_1998_valid    # 验证数据
                     },
        }
