...
class AAPluginTester:
    ...
    @classmethod
    def run_scenario(cls, plugin_cls, plugin_configuration, scenario_params, target_username=None, gateway_user=None):
        tester = cls(
            plugin_cls,
    ...
    def execute_authenticate(self):
        ...
        while True:
            verdict = self.plugin_cls(self.plugin_configuration).authenticate(**(self.parameters.make_copy()))
