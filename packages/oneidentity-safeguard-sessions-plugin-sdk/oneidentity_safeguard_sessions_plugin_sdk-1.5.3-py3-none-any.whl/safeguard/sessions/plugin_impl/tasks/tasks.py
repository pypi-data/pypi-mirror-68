...
def run_scenario(
    c, name=None, list_scenarios=False, config_file=None, target_username=None, gateway_username=None, self_test=False
):
    if list_scenarios:
    ...
    for scenario_name in scenarios_to_run:
        ...
        try:
            AAPluginTester.run_scenario(
                plugin_class, config, scenarios[scenario_name], target_username, gateway_username
            )
