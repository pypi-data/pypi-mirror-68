...
Usage::
    ...
    from mypy_boto3.imagebuilder.type_defs import CancelImageCreationResponseTypeDef

    data: CancelImageCreationResponseTypeDef = {...}
"""
import sys
...
ListImageRecipesResponseTypeDef = TypedDict(
    "ListImageRecipesResponseTypeDef",
    {"requestId": str, "imageRecipeSummaryList": List[ImageRecipeSummaryTypeDef], "nextToken": str},
    total=False,
)
