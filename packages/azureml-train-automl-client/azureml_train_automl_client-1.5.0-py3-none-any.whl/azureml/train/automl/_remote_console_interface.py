...
class RemoteConsoleInterface:
    ...
    def print_scores(self, parent_run: 'AutoMLRun', primary_metric: str) -> None:
        ...
        child_runs_not_finished = RemoteConsoleInterface._get_child_run_ids(parent_run.id, automl_settings, tags)
        while True:
            ...
            if runs_finished:
                ...
                for run_id in runs_finished:
                    ...
                    training_frac = float(properties.get('training_percent', 100)) / 100
                    ...
                    is_unknown = False
                    if best_metric is None or best_metric == 'nan' or best_metric == 'NaN':
                        best_metric = score
                    else:
