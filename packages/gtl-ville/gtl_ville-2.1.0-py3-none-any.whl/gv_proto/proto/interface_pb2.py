...
_INTERFACE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='gv_proto.proto.Interface.get_travel_times',
    index=4,
    containing_service=None,
    input_type=gv__proto_dot_proto_dot_archivist__pb2._TRAVELTIMESREQUEST,
    output_type=gv__proto_dot_proto_dot_archivist__pb2._TRAVELTIMES,
    serialized_options=None,
  ),
  _descriptor.MethodDescriptor(
