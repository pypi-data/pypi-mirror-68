...
class InterfaceBase(abc.ABC):
    ...
    @abc.abstractmethod
    async def get_travel_times(self, stream: 'grpclib.server.Stream[gv_proto.proto.archivist_pb2.TravelTimesRequest, gv_proto.proto.archivist_pb2.TravelTimes]') -> None:
        pass
    ...
    def __mapping__(self) -> typing.Dict[str, grpclib.const.Handler]:
        return {
            ...
            '/gv_proto.proto.Interface/get_travel_times': grpclib.const.Handler(
                self.get_travel_times,
                grpclib.const.Cardinality.UNARY_UNARY,
                gv_proto.proto.archivist_pb2.TravelTimesRequest,
                gv_proto.proto.archivist_pb2.TravelTimes,
            ),
...
class InterfaceStub:
    ...
    def __init__(self, channel: grpclib.client.Channel) -> None:
        ...
        self.get_travel_times = grpclib.client.UnaryUnaryMethod(
            channel,
