...
_INTERFACE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='gv_services.proto.Interface.get_data_quality',
    index=3,
    containing_service=None,
    input_type=gv__services_dot_proto_dot_archivist__pb2._DATAQUALITYREQUEST,
    output_type=gv__services_dot_proto_dot_archivist__pb2._DATAQUALITY,
    serialized_options=None,
  ),
  _descriptor.MethodDescriptor(
