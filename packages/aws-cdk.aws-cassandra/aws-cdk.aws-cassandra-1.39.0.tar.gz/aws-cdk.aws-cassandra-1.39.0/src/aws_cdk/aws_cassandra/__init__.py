...
class CfnKeyspace(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-cassandra.CfnKeyspace"):
    ...
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, keyspace_name: typing.Optional[str]=None) -> None:
    ...
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnKeyspace":
    ...
    def keyspace_name(self, value: typing.Optional[str]):
        jsii.set(self, "keyspaceName", value)


@jsii.data_type(jsii_type="@aws-cdk/aws-cassandra.CfnKeyspaceProps", jsii_struct_bases=[], name_mapping={'keyspace_name': 'keyspaceName'})
class CfnKeyspaceProps():
    def __init__(self, *, keyspace_name: typing.Optional[str]=None) -> None:
        ...
        if keyspace_name is not None: self._values["keyspace_name"] = keyspace_name
    ...
    def __repr__(self) -> str:
        return 'CfnKeyspaceProps(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


@jsii.implements(aws_cdk.core.IInspectable)
class CfnTable(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-cassandra.CfnTable"):
    ...
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, keyspace_name: str, partition_key_columns: typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union["ColumnProperty", aws_cdk.core.IResolvable]]], billing_mode: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["BillingModeProperty"]]]=None, clustering_key_columns: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.core.IResolvable, "ClusteringKeyColumnProperty"]]]]]=None, regular_columns: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union["ColumnProperty", aws_cdk.core.IResolvable]]]]]=None, table_name: typing.Optional[str]=None) -> None:
        ...
        """
        props = CfnTableProps(keyspace_name=keyspace_name, partition_key_columns=partition_key_columns, billing_mode=billing_mode, clustering_key_columns=clustering_key_columns, regular_columns=regular_columns, table_name=table_name)
    ...
    @keyspace_name.setter
    def keyspace_name(self, value: str):
        jsii.set(self, "keyspaceName", value)

    @builtins.property
    @jsii.member(jsii_name="partitionKeyColumns")
    def partition_key_columns(self) -> typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union["ColumnProperty", aws_cdk.core.IResolvable]]]:
    ...
    def partition_key_columns(self, value: typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union["ColumnProperty", aws_cdk.core.IResolvable]]]):
        jsii.set(self, "partitionKeyColumns", value)

    @builtins.property
    @jsii.member(jsii_name="billingMode")
    def billing_mode(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["BillingModeProperty"]]]:
    ...
    @billing_mode.setter
    def billing_mode(self, value: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["BillingModeProperty"]]]):
        jsii.set(self, "billingMode", value)

    @builtins.property
    @jsii.member(jsii_name="clusteringKeyColumns")
    def clustering_key_columns(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.core.IResolvable, "ClusteringKeyColumnProperty"]]]]]:
    ...
    def clustering_key_columns(self, value: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.core.IResolvable, "ClusteringKeyColumnProperty"]]]]]):
        jsii.set(self, "clusteringKeyColumns", value)

    @builtins.property
    @jsii.member(jsii_name="regularColumns")
    def regular_columns(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union["ColumnProperty", aws_cdk.core.IResolvable]]]]]:
    ...
    def regular_columns(self, value: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union["ColumnProperty", aws_cdk.core.IResolvable]]]]]):
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-cassandra.CfnTable.BillingModeProperty", jsii_struct_bases=[], name_mapping={'mode': 'mode', 'provisioned_throughput': 'provisionedThroughput'})
    class BillingModeProperty():
        def __init__(self, *, mode: str, provisioned_throughput: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnTable.ProvisionedThroughputProperty"]]]=None) -> None:
            """
        ...
        def __repr__(self) -> str:
            return 'BillingModeProperty(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


    @jsii.data_type(jsii_type="@aws-cdk/aws-cassandra.CfnTable.ClusteringKeyColumnProperty", jsii_struct_bases=[], name_mapping={'column': 'column', 'order_by': 'orderBy'})
    class ClusteringKeyColumnProperty():
        def __init__(self, *, column: typing.Union["CfnTable.ColumnProperty", aws_cdk.core.IResolvable], order_by: typing.Optional[str]=None) -> None:
            """
            ...
            if order_by is not None: self._values["order_by"] = order_by

        @builtins.property
        def column(self) -> typing.Union["CfnTable.ColumnProperty", aws_cdk.core.IResolvable]:
        ...
        def __repr__(self) -> str:
            return 'ClusteringKeyColumnProperty(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


    @jsii.data_type(jsii_type="@aws-cdk/aws-cassandra.CfnTable.ColumnProperty", jsii_struct_bases=[], name_mapping={'column_name': 'columnName', 'column_type': 'columnType'})
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-cassandra.CfnTable.ProvisionedThroughputProperty", jsii_struct_bases=[], name_mapping={'read_capacity_units': 'readCapacityUnits', 'write_capacity_units': 'writeCapacityUnits'})
    class ProvisionedThroughputProperty():
        def __init__(self, *, read_capacity_units: jsii.Number, write_capacity_units: jsii.Number) -> None:
            """
...
@jsii.data_type(jsii_type="@aws-cdk/aws-cassandra.CfnTableProps", jsii_struct_bases=[], name_mapping={'keyspace_name': 'keyspaceName', 'partition_key_columns': 'partitionKeyColumns', 'billing_mode': 'billingMode', 'clustering_key_columns': 'clusteringKeyColumns', 'regular_columns': 'regularColumns', 'table_name': 'tableName'})
class CfnTableProps():
    def __init__(self, *, keyspace_name: str, partition_key_columns: typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union["CfnTable.ColumnProperty", aws_cdk.core.IResolvable]]], billing_mode: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnTable.BillingModeProperty"]]]=None, clustering_key_columns: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnTable.ClusteringKeyColumnProperty"]]]]]=None, regular_columns: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union["CfnTable.ColumnProperty", aws_cdk.core.IResolvable]]]]]=None, table_name: typing.Optional[str]=None) -> None:
        ...
        if clustering_key_columns is not None: self._values["clustering_key_columns"] = clustering_key_columns
        if regular_columns is not None: self._values["regular_columns"] = regular_columns
    ...
    @builtins.property
    def partition_key_columns(self) -> typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union["CfnTable.ColumnProperty", aws_cdk.core.IResolvable]]]:
        """``AWS::Cassandra::Table.PartitionKeyColumns``.
    ...
    @builtins.property
    def billing_mode(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnTable.BillingModeProperty"]]]:
        """``AWS::Cassandra::Table.BillingMode``.
    ...
    @builtins.property
    def clustering_key_columns(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnTable.ClusteringKeyColumnProperty"]]]]]:
        """``AWS::Cassandra::Table.ClusteringKeyColumns``.
    ...
    @builtins.property
    def regular_columns(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union["CfnTable.ColumnProperty", aws_cdk.core.IResolvable]]]]]:
        """``AWS::Cassandra::Table.RegularColumns``.
