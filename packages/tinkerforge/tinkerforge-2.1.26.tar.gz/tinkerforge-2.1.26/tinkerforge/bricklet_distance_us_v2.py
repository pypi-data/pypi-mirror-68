...
class BrickletDistanceUSV2(Device):
    ...
    def __init__(self, uid, ipcon):
        ...
        """
        Device.__init__(self, uid, ipcon, BrickletDistanceUSV2.DEVICE_IDENTIFIER, BrickletDistanceUSV2.DEVICE_DISPLAY_NAME)
        ...
        self.callback_formats[BrickletDistanceUSV2.CALLBACK_DISTANCE] = (10, 'H')
    ...
    def get_distance(self):
        ...
        return self.ipcon.send_request(self, BrickletDistanceUSV2.FUNCTION_GET_DISTANCE, (), '', 10, 'H')
    ...
    def set_distance_callback_configuration(self, period, value_has_to_change, option, min, max):
        ...
        self.ipcon.send_request(self, BrickletDistanceUSV2.FUNCTION_SET_DISTANCE_CALLBACK_CONFIGURATION, (period, value_has_to_change, option, min, max), 'I ! c H H', 0, '')
    ...
    def get_distance_callback_configuration(self):
        ...
        return GetDistanceCallbackConfiguration(*self.ipcon.send_request(self, BrickletDistanceUSV2.FUNCTION_GET_DISTANCE_CALLBACK_CONFIGURATION, (), '', 18, 'I ! c H H'))
    ...
    def set_update_rate(self, update_rate):
        ...
        self.ipcon.send_request(self, BrickletDistanceUSV2.FUNCTION_SET_UPDATE_RATE, (update_rate,), 'B', 0, '')
    ...
    def get_update_rate(self):
        ...
        return self.ipcon.send_request(self, BrickletDistanceUSV2.FUNCTION_GET_UPDATE_RATE, (), '', 9, 'B')
    ...
    def set_distance_led_config(self, config):
        ...
        self.ipcon.send_request(self, BrickletDistanceUSV2.FUNCTION_SET_DISTANCE_LED_CONFIG, (config,), 'B', 0, '')
    ...
    def get_distance_led_config(self):
        ...
        return self.ipcon.send_request(self, BrickletDistanceUSV2.FUNCTION_GET_DISTANCE_LED_CONFIG, (), '', 9, 'B')
    ...
    def get_spitfp_error_count(self):
        ...
        * overflow errors.
        ...
        return GetSPITFPErrorCount(*self.ipcon.send_request(self, BrickletDistanceUSV2.FUNCTION_GET_SPITFP_ERROR_COUNT, (), '', 24, 'I I I I'))
    ...
    def set_bootloader_mode(self, mode):
        ...
        return self.ipcon.send_request(self, BrickletDistanceUSV2.FUNCTION_SET_BOOTLOADER_MODE, (mode,), 'B', 9, 'B')
    ...
    def get_bootloader_mode(self):
        ...
        return self.ipcon.send_request(self, BrickletDistanceUSV2.FUNCTION_GET_BOOTLOADER_MODE, (), '', 9, 'B')
    ...
    def set_write_firmware_pointer(self, pointer):
        ...
        self.ipcon.send_request(self, BrickletDistanceUSV2.FUNCTION_SET_WRITE_FIRMWARE_POINTER, (pointer,), 'I', 0, '')
    ...
    def write_firmware(self, data):
        ...
        return self.ipcon.send_request(self, BrickletDistanceUSV2.FUNCTION_WRITE_FIRMWARE, (data,), '64B', 9, 'B')
    ...
    def set_status_led_config(self, config):
        ...
        self.ipcon.send_request(self, BrickletDistanceUSV2.FUNCTION_SET_STATUS_LED_CONFIG, (config,), 'B', 0, '')
    ...
    def get_status_led_config(self):
        ...
        return self.ipcon.send_request(self, BrickletDistanceUSV2.FUNCTION_GET_STATUS_LED_CONFIG, (), '', 9, 'B')
    ...
    def get_chip_temperature(self):
        ...
        return self.ipcon.send_request(self, BrickletDistanceUSV2.FUNCTION_GET_CHIP_TEMPERATURE, (), '', 10, 'h')
    ...
    def reset(self):
        ...
        self.ipcon.send_request(self, BrickletDistanceUSV2.FUNCTION_RESET, (), '', 0, '')
    ...
    def write_uid(self, uid):
        ...
        self.ipcon.send_request(self, BrickletDistanceUSV2.FUNCTION_WRITE_UID, (uid,), 'I', 0, '')
    ...
    def read_uid(self):
        ...
        return self.ipcon.send_request(self, BrickletDistanceUSV2.FUNCTION_READ_UID, (), '', 12, 'I')
    ...
    def get_identity(self):
        ...
        """
        return GetIdentity(*self.ipcon.send_request(self, BrickletDistanceUSV2.FUNCTION_GET_IDENTITY, (), '', 33, '8s 8s c 3B 3B H'))
