...
class BrickletAmbientLight(Device):
    ...
    def __init__(self, uid, ipcon):
        ...
        self.callback_formats[BrickletAmbientLight.CALLBACK_ILLUMINANCE] = (10, 'H')
        self.callback_formats[BrickletAmbientLight.CALLBACK_ANALOG_VALUE] = (10, 'H')
        self.callback_formats[BrickletAmbientLight.CALLBACK_ILLUMINANCE_REACHED] = (10, 'H')
        self.callback_formats[BrickletAmbientLight.CALLBACK_ANALOG_VALUE_REACHED] = (10, 'H')
    ...
    def get_illuminance(self):
        ...
        return self.ipcon.send_request(self, BrickletAmbientLight.FUNCTION_GET_ILLUMINANCE, (), '', 10, 'H')
    ...
    def get_analog_value(self):
        ...
        return self.ipcon.send_request(self, BrickletAmbientLight.FUNCTION_GET_ANALOG_VALUE, (), '', 10, 'H')
    ...
    def set_illuminance_callback_period(self, period):
        ...
        self.ipcon.send_request(self, BrickletAmbientLight.FUNCTION_SET_ILLUMINANCE_CALLBACK_PERIOD, (period,), 'I', 0, '')
    ...
    def get_illuminance_callback_period(self):
        ...
        return self.ipcon.send_request(self, BrickletAmbientLight.FUNCTION_GET_ILLUMINANCE_CALLBACK_PERIOD, (), '', 12, 'I')
    ...
    def set_analog_value_callback_period(self, period):
        ...
        self.ipcon.send_request(self, BrickletAmbientLight.FUNCTION_SET_ANALOG_VALUE_CALLBACK_PERIOD, (period,), 'I', 0, '')
    ...
    def get_analog_value_callback_period(self):
        ...
        return self.ipcon.send_request(self, BrickletAmbientLight.FUNCTION_GET_ANALOG_VALUE_CALLBACK_PERIOD, (), '', 12, 'I')
    ...
    def set_illuminance_callback_threshold(self, option, min, max):
        ...
        self.ipcon.send_request(self, BrickletAmbientLight.FUNCTION_SET_ILLUMINANCE_CALLBACK_THRESHOLD, (option, min, max), 'c H H', 0, '')
    ...
    def get_illuminance_callback_threshold(self):
        ...
        return GetIlluminanceCallbackThreshold(*self.ipcon.send_request(self, BrickletAmbientLight.FUNCTION_GET_ILLUMINANCE_CALLBACK_THRESHOLD, (), '', 13, 'c H H'))
    ...
    def set_analog_value_callback_threshold(self, option, min, max):
        ...
        self.ipcon.send_request(self, BrickletAmbientLight.FUNCTION_SET_ANALOG_VALUE_CALLBACK_THRESHOLD, (option, min, max), 'c H H', 0, '')
    ...
    def get_analog_value_callback_threshold(self):
        ...
        return GetAnalogValueCallbackThreshold(*self.ipcon.send_request(self, BrickletAmbientLight.FUNCTION_GET_ANALOG_VALUE_CALLBACK_THRESHOLD, (), '', 13, 'c H H'))
    ...
    def set_debounce_period(self, debounce):
        ...
        * :func:`Set Analog Value Callback Threshold`
        ...
        self.ipcon.send_request(self, BrickletAmbientLight.FUNCTION_SET_DEBOUNCE_PERIOD, (debounce,), 'I', 0, '')
    ...
    def get_debounce_period(self):
        ...
        return self.ipcon.send_request(self, BrickletAmbientLight.FUNCTION_GET_DEBOUNCE_PERIOD, (), '', 12, 'I')
    ...
    def get_identity(self):
        ...
        """
        return GetIdentity(*self.ipcon.send_request(self, BrickletAmbientLight.FUNCTION_GET_IDENTITY, (), '', 33, '8s 8s c 3B 3B H'))
