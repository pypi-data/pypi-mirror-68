...
class CfnDeviceProps():
    def __init__(self, *, device_id: str, enabled: typing.Union[bool, aws_cdk.core.IResolvable]) -> None:
...
class CfnPlacement(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iot1click.CfnPlacement"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnPlacement":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
class CfnPlacementProps():
    def __init__(self, *, project_name: str, associated_devices: typing.Any=None, attributes: typing.Any=None, placement_name: typing.Optional[str]=None) -> None:
...
class CfnProject(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iot1click.CfnProject"):
    ...
    class DeviceTemplateProperty():
        def __init__(self, *, callback_overrides: typing.Any=None, device_type: typing.Optional[str]=None) -> None:
            """
    ...
    class PlacementTemplateProperty():
        def __init__(self, *, default_attributes: typing.Any=None, device_templates: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.Mapping[str, typing.Union[aws_cdk.core.IResolvable, "CfnProject.DeviceTemplateProperty"]]]]]=None) -> None:
            """
        ...
        @builtins.property
        def device_templates(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.Mapping[str, typing.Union[aws_cdk.core.IResolvable, "CfnProject.DeviceTemplateProperty"]]]]]:
...
class CfnProjectProps():
    def __init__(self, *, placement_template: typing.Union["CfnProject.PlacementTemplateProperty", aws_cdk.core.IResolvable], description: typing.Optional[str]=None, project_name: typing.Optional[str]=None) -> None:
