...
if kw618_pkg == "Local":
    ...
    df2 = import_data(in_file_path=f"{FILE_PATH_FOR_KW618}/k_pandas/df_test2.csv") # 这里的kw618路径是动态的 (_file_path.py文件会自动寻址)
...
try:
    ...
    engine = create_engine('mysql+pymysql://root:123456@localhost:3306/ttt_db?charset=utf8')
except:
    print(k_tb(10))  ## except中, 可以呈现详细的报错信息
    print(
...
if socket.gethostname() != "iZbp1fp1ljg8kuditz9t94Z":
    ...
    # pandas专用引擎
    remote_engine = create_engine('mysql+pymysql://root:123456@121.40.240.153:3306/ttt_db?charset=utf8')
