...
class Transmission:
    ...
    def remove(self, id: str, delete_local_data: bool = False) -> Dict:
        args = {
            'ids': [id],
            'delete-local-data': delete_local_data
        }
        return self._post(method='torrent-remove', args=args)
...
class Torrent:
    ...
    def remove(self, *args, **kwargs) -> Dict:
        return self.client.remove(self.id, *args, **kwargs)
