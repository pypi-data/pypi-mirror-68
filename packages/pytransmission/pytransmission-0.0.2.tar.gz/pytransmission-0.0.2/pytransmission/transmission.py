...
class Transmission:
    ...
    def _add_torrent(self, args: Dict[str, str]) -> Dict:
        args.update({
            'paused': 'false',
    ...
    def get_torrent_field(self, id: str, field: str) -> str:
        args = {
            'ids': [id],
            'fields': [field]
        }
    ...
    def rename_torrent(self, id: str, new_name: str) -> Dict:
        name = self.get_torrent_field(id, 'name')
        args = {
            'ids': [id],
            'path': name,
            'name': new_name
    ...
    def move_torrent(self, id: str, new_path: str) -> Dict:
        args = {
            'ids': [id],
            'location': new_path,
            'move': True
