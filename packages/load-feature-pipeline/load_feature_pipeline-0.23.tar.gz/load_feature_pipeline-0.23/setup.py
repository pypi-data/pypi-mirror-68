...
# worker-startup log.
CUSTOM_COMMANDS = [['pip', 'install', 'apache-beam==2.11.0'],
                   ['pip', 'install', 'feature-creation==0.1'],
                   ['pip', 'install', 'scipy==1.2.1'],
                   ['pip', 'install', 'google-cloud-core==0.29.1'],
                   ['pip', 'install', 'pandas==0.24.2'],
                   ['pip', 'install', 'scikit-learn==0.17'],
                   ['pip', 'install', 'google-cloud-storage==1.14.'],
...
setuptools.setup(
    name='load_feature_pipeline',
    version='0.23',
    description='Load Features Pipeline Workflow Package.',
    ...
    author="Kaya Smith",
    author_email="kaya@fleetops.ai",
    long_description='A FleetOps Pipeline for Building Load Features',
    long_description_content_type="text/markdown",
    url="https://bitbucket.org/fleetopsteam/fleetops-gcp-pipeline",
    classifiers=[
