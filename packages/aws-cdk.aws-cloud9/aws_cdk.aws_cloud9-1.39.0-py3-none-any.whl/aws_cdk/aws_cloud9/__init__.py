...
class CfnEnvironmentEC2(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-cloud9.CfnEnvironmentEC2"):
    ...
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnEnvironmentEC2":
...
@jsii.data_type(jsii_type="@aws-cdk/aws-cloud9.Ec2EnvironmentProps", jsii_struct_bases=[], name_mapping={'vpc': 'vpc', 'description': 'description', 'ec2_environment_name': 'ec2EnvironmentName', 'instance_type': 'instanceType', 'subnet_selection': 'subnetSelection'})
class Ec2EnvironmentProps():
    def __init__(self, *, vpc: aws_cdk.aws_ec2.IVpc, description: typing.Optional[str]=None, ec2_environment_name: typing.Optional[str]=None, instance_type: typing.Optional[aws_cdk.aws_ec2.InstanceType]=None, subnet_selection: typing.Optional[aws_cdk.aws_ec2.SubnetSelection]=None) -> None:
        ...
        if description is not None: self._values["description"] = description
        if ec2_environment_name is not None: self._values["ec2_environment_name"] = ec2_environment_name
    ...
    def __repr__(self) -> str:
        return 'Ec2EnvironmentProps(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())
...
class Ec2Environment(aws_cdk.core.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-cloud9.Ec2Environment"):
    ...
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, vpc: aws_cdk.aws_ec2.IVpc, description: typing.Optional[str]=None, ec2_environment_name: typing.Optional[str]=None, instance_type: typing.Optional[aws_cdk.aws_ec2.InstanceType]=None, subnet_selection: typing.Optional[aws_cdk.aws_ec2.SubnetSelection]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param vpc: The VPC that AWS Cloud9 will use to communicate with the Amazon Elastic Compute Cloud (Amazon EC2) instance.
        ...
        :stability: experimental
        """
        props = Ec2EnvironmentProps(vpc=vpc, description=description, ec2_environment_name=ec2_environment_name, instance_type=instance_type, subnet_selection=subnet_selection)

        jsii.create(Ec2Environment, self, [scope, id, props])

    @jsii.member(jsii_name="fromEc2EnvironmentName")
    @builtins.classmethod
    def from_ec2_environment_name(cls, scope: aws_cdk.core.Construct, id: str, ec2_environment_name: str) -> "IEc2Environment":
