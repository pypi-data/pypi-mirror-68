...
class DSMRReader():
    ...
    def extract_data_from_telegram(self, telegram):
      ...
      data = dict(
        ...
        current_electricity_usage = str(telegram[obis_references.CURRENT_ELECTRICITY_USAGE].value * 1000),
        current_electricity_delivery = str(telegram[obis_references.CURRENT_ELECTRICITY_DELIVERY].value * 1000),
        electricity_active_tariff = str(telegram[obis_references.ELECTRICITY_ACTIVE_TARIFF].value),
