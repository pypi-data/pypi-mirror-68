...
class DSMRReader():
    ...
    def extract_data_from_telegram(self, telegram):
      ...
      # TODO: add uom: telegram.CURRENT_ELECTRICITY_USAGE.unit

      data = dict(
        unix_timestamp = int(time.time()),
        current_electricity_usage = str(telegram.CURRENT_ELECTRICITY_USAGE.value * 1000),
        current_electricity_delivery = str(telegram.CURRENT_ELECTRICITY_DELIVERY.value * 1000),
        electricity_active_tariff = str(telegram.ELECTRICITY_ACTIVE_TARIFF.value),
        usage_total_low = str(telegram.ELECTRICITY_USED_TARIFF_1.value * 1000),
        usage_total_high = str(telegram.ELECTRICITY_USED_TARIFF_2.value * 1000),
        redelivery_total_low = str(telegram.ELECTRICITY_DELIVERED_TARIFF_1.value * 1000),
        redelivery_total_high = str(telegram.ELECTRICITY_DELIVERED_TARIFF_2.value * 1000),
        usage_gas_total = str(telegram.HOURLY_GAS_METER_READING].value.value * 1000)
      )
