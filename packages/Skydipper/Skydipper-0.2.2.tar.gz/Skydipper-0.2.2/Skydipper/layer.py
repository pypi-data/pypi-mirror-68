...
class Layer:
    ...
    def update(self, update_params=None, token=self.token):
        """
    ...
    def delete(self, token=self.token, force=False):
        """
    ...
    def clone(self, token=self.token, env='staging', clone_server=None, layer_params={}, target_dataset_id=None):
        """
