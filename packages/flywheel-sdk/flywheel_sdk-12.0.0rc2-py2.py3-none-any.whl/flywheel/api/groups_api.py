...
"""
    ...
    OpenAPI spec version: 12.0.0-rc.2
...
class GroupsApi(object):
    ...
    def add_group_permission_0(self, group_id, body, **kwargs):  # noqa: E501
        """Add a permission
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_'):
            return self.add_group_permission_0_with_http_info(group_id, body, **kwargs)  # noqa: E501
        else:
            (data) = self.add_group_permission_0_with_http_info(group_id, body, **kwargs)  # noqa: E501
            if data and hasattr(data, 'return_value'):
                return data.return_value()
            return data


    def add_group_permission_0_with_http_info(self, group_id, body, **kwargs):  # noqa: E501
        """Add a permission
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method add_group_permission_0" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'group_id' is set
        if ('group_id' not in params or
                params['group_id'] is None):
            raise ValueError("Missing the required parameter `group_id` when calling `add_group_permission_0`")  # noqa: E501
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `add_group_permission_0`")  # noqa: E501
    ...
    def delete_group_user_permission_0(self, group_id, user_id, **kwargs):  # noqa: E501
        """Delete a permission
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_'):
            return self.delete_group_user_permission_0_with_http_info(group_id, user_id, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_group_user_permission_0_with_http_info(group_id, user_id, **kwargs)  # noqa: E501
            if data and hasattr(data, 'return_value'):
                return data.return_value()
            return data


    def delete_group_user_permission_0_with_http_info(self, group_id, user_id, **kwargs):  # noqa: E501
        """Delete a permission
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_group_user_permission_0" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'group_id' is set
        if ('group_id' not in params or
                params['group_id'] is None):
            raise ValueError("Missing the required parameter `group_id` when calling `delete_group_user_permission_0`")  # noqa: E501
        # verify the required parameter 'user_id' is set
        if ('user_id' not in params or
                params['user_id'] is None):
            raise ValueError("Missing the required parameter `user_id` when calling `delete_group_user_permission_0`")  # noqa: E501
    ...
    def get_group_user_permission_0(self, group_id, user_id, **kwargs):  # noqa: E501
        """List a user&#39;s permissions for this group.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_'):
            return self.get_group_user_permission_0_with_http_info(group_id, user_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_group_user_permission_0_with_http_info(group_id, user_id, **kwargs)  # noqa: E501
            if data and hasattr(data, 'return_value'):
                return data.return_value()
            return data


    def get_group_user_permission_0_with_http_info(self, group_id, user_id, **kwargs):  # noqa: E501
        """List a user&#39;s permissions for this group.
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_group_user_permission_0" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'group_id' is set
        if ('group_id' not in params or
                params['group_id'] is None):
            raise ValueError("Missing the required parameter `group_id` when calling `get_group_user_permission_0`")  # noqa: E501
        # verify the required parameter 'user_id' is set
        if ('user_id' not in params or
                params['user_id'] is None):
            raise ValueError("Missing the required parameter `user_id` when calling `get_group_user_permission_0`")  # noqa: E501
    ...
    def modify_group_user_permission_0(self, group_id, user_id, body, **kwargs):  # noqa: E501
        """Update a user&#39;s permission for this group.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_'):
            return self.modify_group_user_permission_0_with_http_info(group_id, user_id, body, **kwargs)  # noqa: E501
        else:
            (data) = self.modify_group_user_permission_0_with_http_info(group_id, user_id, body, **kwargs)  # noqa: E501
            if data and hasattr(data, 'return_value'):
                return data.return_value()
            return data


    def modify_group_user_permission_0_with_http_info(self, group_id, user_id, body, **kwargs):  # noqa: E501
        """Update a user&#39;s permission for this group.
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method modify_group_user_permission_0" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'group_id' is set
        if ('group_id' not in params or
                params['group_id'] is None):
            raise ValueError("Missing the required parameter `group_id` when calling `modify_group_user_permission_0`")  # noqa: E501
        # verify the required parameter 'user_id' is set
        if ('user_id' not in params or
                params['user_id'] is None):
            raise ValueError("Missing the required parameter `user_id` when calling `modify_group_user_permission_0`")  # noqa: E501
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `modify_group_user_permission_0`")  # noqa: E501
