...
class History(object):
    ...
    def __init__(self, client_id, client_secret, proxies={}, verify=True):
        ...
        self._headers = {
            ...
            "User-Agent": "Python API 1.77 / {local_version}".format(local_version=platform.python_version())
        }

        self._dataset_id = None
    
    def _requests(self, method, url, headers={}, data={}, json={}, params={}, stream=False):
    ...
    def get_history_list(self, dataset_id):
        ...
        response = self._requests(
            method='get',
            url='{base_url}/datasets/{dataset_id}/history/'.format(
    ...
    def get_history_metadata(self, dataset_id, history_date):
        ...
        response = self._requests(
            method='get',
            url='{base_url}/datasets/{dataset_id}/history/{history_date}'.format(
                base_url=self._BASE_URL,
                dataset_id=dataset_id,
