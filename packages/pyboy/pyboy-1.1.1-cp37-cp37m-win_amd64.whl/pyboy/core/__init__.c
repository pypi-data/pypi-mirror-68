...
static CYTHON_SMALL_CODE int __Pyx_InitGlobals(void) {
  ...
  if (__Pyx_InitString(__pyx_string_tab[2], &__pyx_n_u_core) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
  ...
  if (__Pyx_InitString(__pyx_string_tab[5], &__pyx_n_s_mb) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
