...
void Ngrams::load(const std::string& corpus) {
    std::string path;
    std::ifstream in;
    if (corpus == "gutenberg") path = "../data/gutenberg.DAT";
    else throw "No corpus found named: " + corpus;
    Logger::log("Loading corpus " + corpus + " from binary...");
    try {
