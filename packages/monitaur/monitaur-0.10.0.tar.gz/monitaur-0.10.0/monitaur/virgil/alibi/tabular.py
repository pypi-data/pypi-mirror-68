"""
Copyright 2017 Seldon Technologies Ltd.
Modifications copyright (C) 2020 Monitaur
Source: https://github.com/SeldonIO/alibi
"""

from typing import Any, Callable, Dict, Set, Tuple  # noqa: F401

import numpy as np
from monitaur.virgil.alibi.alibi_discretizer import Discretizer
from monitaur.virgil.alibi.base import AnchorBaseBeam
from monitaur.virgil.alibi.explanation import AnchorExplanation
...
class AnchorTabular(object):
    ...
    def explain(
        ...
        **kwargs: Any
        ...
        explanation["ml_model"] = {}
        explanation["ml_model"]["name"] = self.__class__.__name__
