...
branches = read.read_parameters(input_file)[16]
max_Z = read.read_parameters(input_file)[17]
...
lista_freqs = []
lista_freqs.append(freqs[:,branches[0]:branches[-1]+1])
...
Zs_projected = np.zeros((meta, len(branches), Nqpoints))
