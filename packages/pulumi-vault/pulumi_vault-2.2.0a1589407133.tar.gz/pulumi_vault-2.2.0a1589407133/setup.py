...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', 'v2.2.0-alpha.1589407133+gc689387'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault v2.2.0-alpha.1589407133+gc689387`
                """)
            else:
                raise
