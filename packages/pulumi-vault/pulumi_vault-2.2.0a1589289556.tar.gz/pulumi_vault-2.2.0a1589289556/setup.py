...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', 'v2.2.0-alpha.1589289556+g8d6dc5e'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault v2.2.0-alpha.1589289556+g8d6dc5e`
                """)
            else:
                raise
