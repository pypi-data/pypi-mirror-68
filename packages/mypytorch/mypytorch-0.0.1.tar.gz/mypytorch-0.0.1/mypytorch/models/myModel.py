...
class MyModel(MyBaseModel):
    ...
    def fit(self, dataloader, eval_dataloader=None, epochs=10, device=None):
        ...
        for epoch in self.mb:
            ...
            self.update_history(epoch, train_metrics, eval_metrics)
    ...
    def update_history(self, epoch, train_metrics, eval_metrics=[]):
