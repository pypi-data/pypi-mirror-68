...
class SmappeeApi(object):
    ...
    token_url = 'https://app1pub.smappee.net/dev/v3/oauth2/token' #'https://farm2pub.smappee.net/dev/v3/oauth2/token'
    servicelocation_url = 'https://app1pub.smappee.net/dev/v3/servicelocation' #'https://farm2pub.smappee.net/dev/v3/servicelocation'
