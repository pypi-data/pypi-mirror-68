...
class EnergyStarMeterLinkChild(Model):
    ...
    :param use_per_day_unit: The meter's average use per day unit
    :type use_per_day_unit: float
    :param cost_per_day: The meter's average cost per day
    :type cost_per_day: float
    :param cost_per_day_unit: The meter's average cost per day unit
    :type cost_per_day_unit: float
    ...
    _attribute_map = {
        ...
        'use_per_day_unit': {'key': 'usePerDayUnit', 'type': 'float'},
        'cost_per_day': {'key': 'costPerDay', 'type': 'float'},
        'cost_per_day_unit': {'key': 'costPerDayUnit', 'type': 'float'},
        'energy_star_compatible': {'key': 'energyStarCompatible', 'type': 'bool'},
    }

    def __init__(self, meter=None, pm_meter_id=None, use_per_day=None, use_per_day_unit=None, cost_per_day=None, cost_per_day_unit=None, energy_star_compatible=None):
        super(EnergyStarMeterLinkChild, self).__init__()
        self.meter = meter
        self.pm_meter_id = pm_meter_id
        self.use_per_day = use_per_day
        self.use_per_day_unit = use_per_day_unit
        self.cost_per_day = cost_per_day
        self.cost_per_day_unit = cost_per_day_unit
