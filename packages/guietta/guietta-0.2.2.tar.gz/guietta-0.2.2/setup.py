...
# Installing PyQt5 with pip breaks the one pre-shipped
# with the distribution (segfault when importing
# because of difference in the binary libraries),
# so avoid installing it as a requirement if the system
# already has one
