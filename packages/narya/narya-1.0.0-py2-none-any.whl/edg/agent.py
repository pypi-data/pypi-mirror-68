...
from utils.agent_utils                  import traverse, change
...
class AgentValue:
    ...
    def get_edg_map(
        ...
        Args:
          observations: A np.array of shape (72,96,16) with the stacked observations
          observations_count: A np.array of shape (72,96,16) with the stacked observations counts. Observations counts stores the
