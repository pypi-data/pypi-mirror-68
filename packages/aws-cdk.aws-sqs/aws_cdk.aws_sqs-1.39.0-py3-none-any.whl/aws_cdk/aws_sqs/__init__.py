...
class CfnQueuePolicy(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-sqs.CfnQueuePolicy"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnQueuePolicy":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
class CfnQueuePolicyProps():
    def __init__(self, *, policy_document: typing.Any, queues: typing.List[str]) -> None:
...
class QueueAttributes():
    def __init__(self, *, queue_arn: str, key_arn: typing.Optional[str]=None, queue_name: typing.Optional[str]=None, queue_url: typing.Optional[str]=None) -> None:
