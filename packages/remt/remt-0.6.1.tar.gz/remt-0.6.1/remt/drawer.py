...
STYLE = {
    ...
    15: style_default(tool_line=tool.line_ballpoint),

    # Fineliner
    4: style_default(tool_line=tool.line_fineliner),
    17: style_default(tool_line=tool.line_fineliner),

    # Highlighter
    5: STYLE_HIGHLIGHTER,
    18: STYLE_HIGHLIGHTER,
    ...
    13: style_default(tool_line=tool.line_sharp_pencil, brush='pencil.png'),
