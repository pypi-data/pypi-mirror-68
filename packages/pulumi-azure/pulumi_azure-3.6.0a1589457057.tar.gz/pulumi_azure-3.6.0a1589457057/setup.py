...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v3.6.0-alpha.1589457057+g1fdcab88'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v3.6.0-alpha.1589457057+g1fdcab88`
                """)
            else:
                raise
