...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v3.5.0-alpha.1589235936+gd8611fd6'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v3.5.0-alpha.1589235936+gd8611fd6`
                """)
            else:
                raise
