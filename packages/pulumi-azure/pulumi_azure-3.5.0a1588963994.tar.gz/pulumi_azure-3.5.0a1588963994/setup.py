...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v3.5.0-alpha.1588963994+gd6fe8b02'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v3.5.0-alpha.1588963994+gd6fe8b02`
                """)
            else:
                raise
