...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v3.5.0-alpha.1588936354+gd4f4422c'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v3.5.0-alpha.1588936354+gd4f4422c`
                """)
            else:
                raise
