...
def group_link(group: typing.Union[str, int] = ''):
...
def lamp_add(type: typing.Union[str, int] = 'POINT',
             radius: float = 1.0,
             view_align: bool = False,
             location: typing.List[float] = (0.0, 0.0, 0.0),
             rotation: typing.List[float] = (0.0, 0.0, 0.0),
...
def select_by_layer(match: typing.Union[str, int] = 'EXACT',
                    extend: bool = False,
                    layers: int = 1):
    '''Select all visible objects on a layer 

    :param match: Match 
    :type match: typing.Union[str, int]
...
def vertex_group_smooth(group_select_mode: typing.Union[str, int] = '',
                        ...
                        repeat: int = 1,
                        expand: float = 0.0,
                        source: typing.Union[str, int] = 'ALL'):
    ...
    :type source: typing.Union[str, int]
    '''
