...
def collada_export(
        ...
        export_texture_type_selection: typing.Union[str, int] = 'mat',
        open_sim: bool = False,
    ...
    :type export_transformation_type_selection: typing.Union[str, int]
    ...
    :type export_texture_type_selection: typing.Union[str, int]
...
def previews_clear(id_type: typing.Union[typing.Set[str], typing.Set[int]] = {
