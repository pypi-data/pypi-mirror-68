...
def add_texture_paint_slot(type: typing.Union[str, int] = 'DIFFUSE_COLOR',
                           name: str = "Untitled",
                           width: int = 1024,
                           height: int = 1024,
...
def brush_select(paint_mode: typing.Union[str, int] = 'ACTIVE',
                 sculpt_tool: typing.Union[str, int] = 'BLOB',
                 vertex_paint_tool: typing.Union[str, int] = 'MIX',
                 weight_paint_tool: typing.Union[str, int] = 'MIX',
                 texture_paint_tool: typing.Union[str, int] = 'DRAW',
                 toggle: bool = False,
    ...
    :type paint_mode: typing.Union[str, int]
    ...
    :type vertex_paint_tool: typing.Union[str, int]
    :param weight_paint_tool: Weight Paint ToolMIX Mix, Use mix blending mode while painting.ADD Add, Use add blending mode while painting.SUB Subtract, Use subtract blending mode while painting.MUL Multiply, Use multiply blending mode while painting.BLUR Blur, Blur the color with surrounding values.LIGHTEN Lighten, Use lighten blending mode while painting.DARKEN Darken, Use darken blending mode while painting. 
    :type weight_paint_tool: typing.Union[str, int]
    :param texture_paint_tool: Texture Paint Tool 
    :type texture_paint_tool: typing.Union[str, int]
