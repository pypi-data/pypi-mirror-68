...
void Results::set(int i, std::string question, std::string score, float weight, std::string feedback)
{
    _test_results[i]["quesiton"] = question;
    _test_results[i]["mark"] = score;
    _test_results[i]["weight"] = weight;
    _test_results[i]["feedback"] = feedback;
}
