...
@jsii.data_type(jsii_type="@aws-cdk/aws-apigatewayv2.HttpApiProps", jsii_struct_bases=[], name_mapping={'api_name': 'apiName', 'create_default_stage': 'createDefaultStage', 'default_integration': 'defaultIntegration'})
class HttpApiProps():
    def __init__(self, *, api_name: typing.Optional[str]=None, create_default_stage: typing.Optional[bool]=None, default_integration: typing.Optional["IHttpRouteIntegration"]=None) -> None:
...
class HttpApi(aws_cdk.core.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-apigatewayv2.HttpApi"):
    ...
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, api_name: typing.Optional[str]=None, create_default_stage: typing.Optional[bool]=None, default_integration: typing.Optional["IHttpRouteIntegration"]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param api_name: Name for the HTTP API resoruce. Default: - id of the HttpApi construct.
        ...
        :stability: experimental
        """
        props = HttpApiProps(api_name=api_name, create_default_stage=create_default_stage, default_integration=default_integration)
