/*! For license information please see chunk.3d4e9acb5d0e646a328a.js.LICENSE */
(self.webpackJsonp=self.webpackJsonp||[]).push([[87],{261:function(e,t,i){"use strict";var r=i(1),o=i(0),a=i(111),n=i(50);class c extends o.a{constructor(){super(...arguments),this.mini=!1,this.exited=!1,this.disabled=!1,this.extended=!1,this.showIconAtEnd=!1,this.icon="",this.label=""}createRenderRoot(){return this.attachShadow({mode:"open",delegatesFocus:!0})}render(){const e={"mdc-fab--mini":this.mini,"mdc-fab--exited":this.exited,"mdc-fab--extended":this.extended,"icon-end":this.showIconAtEnd},t=""!==this.label&&this.extended;let i="";this.icon&&(i=o.f`
...
//# sourceMappingURL=chunk.3d4e9acb5d0e646a328a.js.map