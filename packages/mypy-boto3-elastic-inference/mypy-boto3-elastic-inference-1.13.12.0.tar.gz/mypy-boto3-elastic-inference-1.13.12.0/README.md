...
[boto3.ElasticInference 1.13.12](https://boto3.amazonaws.com/v1/documentation/api/1.13.12/reference/services/elastic-inference.html#ElasticInference) service
...
describe_accelerators_paginator: elastic_inference.DescribeAcceleratorsPaginator = client.get_paginator("describe_accelerators")
```
