...
class LegacyModelNames:
    """Defines names for all legacy models supported by automated ML."""

    class ClassificationLegacyModelNames:
        """Defines names for all classification legacy models."""
    ...
    class RegressionLegacyModelNames:
        """Defines names for all regression legacy models."""
