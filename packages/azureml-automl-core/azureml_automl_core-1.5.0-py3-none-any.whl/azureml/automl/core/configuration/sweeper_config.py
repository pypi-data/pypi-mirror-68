...
class SweeperConfig:
    ...
    def __init__(self, logger: Optional[Union[Logger, LoggerAdapter]] = None) -> None:
    ...
    def get_config(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if file_path is None:
                raise ConfigException("Configuration url is not accessible!", has_pii=False,
                                      reference_code=ReferenceCodes._SWEEPER_CONFIG_FROM_DICT)
