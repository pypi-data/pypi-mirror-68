...
from azureml.automl.core.shared.exceptions import AutoMLException, ErrorTypes, ClientException
...
def get_error_code(exception: BaseException) -> str:
    ...
    if hasattr(exception, 'error_code'):
        error_code = cast(AutoMLException, exception).error_code
    elif isinstance(exception, MemoryError):
        error_code = ErrorCodes.INSUFFICIENTMEMORY_ERROR
