    ...
    def _get_usage(self, prefix_message=None):
        ...
        try:
            phys_mem, _, kernel_cpu, user_cpu, \
                child_phys_mem, _, child_kernel_cpu, child_user_cpu = Win32Helper.get_resource_usage()
            ...
            self.logger.info("Unable to obtain memory usage.")
...
class SystemResourceUsageTelemetryFactory:
    ...
    @staticmethod
    def get_system_usage_telemetry(logger: Union[logging.Logger, logging.LoggerAdapter],
                                   interval: int = 10) -> SystemResourceUsageTelemetry:
        """
