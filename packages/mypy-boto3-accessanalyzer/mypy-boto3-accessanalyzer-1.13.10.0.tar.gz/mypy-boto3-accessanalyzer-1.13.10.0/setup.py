...
class PostInstallCommand(install):
    def run(self):
        install.run(self)
        print("mypy_boto3: Running post-install script for mypy-boto3-accessanalyzer")
        try:
            from mypy_boto3.main import add_package_to_index

            add_package_to_index("accessanalyzer")
            print("mypy_boto3: Service accessanalyzer added to index")
        except Exception as e:
            print("mypy_boto3: Package index update failed for mypy-boto3-accessanalyzer:", e)
...
setup(
    ...
    description="Type annotations for boto3.AccessAnalyzer 1.13.10 service, generated by mypy-boto3-buider 1.0.9",
    classifiers=[
