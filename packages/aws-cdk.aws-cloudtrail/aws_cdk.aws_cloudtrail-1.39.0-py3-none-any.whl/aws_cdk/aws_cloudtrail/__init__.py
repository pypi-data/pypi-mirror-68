...
@jsii.data_type(jsii_type="@aws-cdk/aws-cloudtrail.AddEventSelectorOptions", jsii_struct_bases=[], name_mapping={'include_management_events': 'includeManagementEvents', 'read_write_type': 'readWriteType'})
...
class CfnTrail(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-cloudtrail.CfnTrail"):
    ...
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnTrail":
...
class Trail(aws_cdk.core.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-cloudtrail.Trail"):
    ...
    def add_lambda_event_selector(self, data_resource_values: typing.List[str], *, include_management_events: typing.Optional[bool]=None, read_write_type: typing.Optional["ReadWriteType"]=None) -> None:
        """When an event occurs in your account, CloudTrail evaluates whether the event matches the settings for your trails.
        ...
        return jsii.invoke(self, "addLambdaEventSelector", [data_resource_values, options])

    @jsii.member(jsii_name="addS3EventSelector")
    def add_s3_event_selector(self, data_resource_values: typing.List[str], *, include_management_events: typing.Optional[bool]=None, read_write_type: typing.Optional["ReadWriteType"]=None) -> None:
        """When an event occurs in your account, CloudTrail evaluates whether the event matches the settings for your trails.
        ...
        return jsii.invoke(self, "addS3EventSelector", [data_resource_values, options])
