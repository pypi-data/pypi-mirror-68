...
class File(object):
    ...
    def open(self, filename, mode):
        return _VisusKernelPy.File_open(self, filename, mode)

    def createAndOpen(self, filename, mode):
        return _VisusKernelPy.File_createAndOpen(self, filename, mode)
    ...
    def getMode(self):
        return _VisusKernelPy.File_getMode(self)
