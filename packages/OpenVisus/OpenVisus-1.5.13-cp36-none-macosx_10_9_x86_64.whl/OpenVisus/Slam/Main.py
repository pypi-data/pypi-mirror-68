import os,sys,platform,subprocess,glob,datetime
import numpy
import cv2
...
def Main():
	...
	# example: -m OpenVisus slam --pdim 2 "D:\GoogleSci\visus_slam\TaylorGrant"
	# example: -m OpenVisus slam  --pdim 3 "D:\GoogleSci\visus_dataset\male\RAW\Fullcolor\fullbody"
