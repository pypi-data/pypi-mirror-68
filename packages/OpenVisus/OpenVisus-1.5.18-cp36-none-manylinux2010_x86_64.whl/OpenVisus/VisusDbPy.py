...
class Dataset(_object):
    ...
    def read(self, ar):
        return _VisusDbPy.Dataset_read(self, ar)
...
class IdxDataset(Dataset):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["idxfile"] = _VisusDbPy.IdxDataset_idxfile_set
    __swig_getmethods__["idxfile"] = _VisusDbPy.IdxDataset_idxfile_get
    if _newclass:
        idxfile = _swig_property(_VisusDbPy.IdxDataset_idxfile_get, _VisusDbPy.IdxDataset_idxfile_set)
    __swig_setmethods__["hzaddress_conversion_boxquery"] = _VisusDbPy.IdxDataset_hzaddress_conversion_boxquery_set
    __swig_getmethods__["hzaddress_conversion_boxquery"] = _VisusDbPy.IdxDataset_hzaddress_conversion_boxquery_get
    if _newclass:
        hzaddress_conversion_boxquery = _swig_property(_VisusDbPy.IdxDataset_hzaddress_conversion_boxquery_get, _VisusDbPy.IdxDataset_hzaddress_conversion_boxquery_set)
    __swig_setmethods__["hzaddress_conversion_pointquery"] = _VisusDbPy.IdxDataset_hzaddress_conversion_pointquery_set
    __swig_getmethods__["hzaddress_conversion_pointquery"] = _VisusDbPy.IdxDataset_hzaddress_conversion_pointquery_get
    if _newclass:
        hzaddress_conversion_pointquery = _swig_property(_VisusDbPy.IdxDataset_hzaddress_conversion_pointquery_get, _VisusDbPy.IdxDataset_hzaddress_conversion_pointquery_set)
    ...
    def getTypeName(self):
        return _VisusDbPy.IdxDataset_getTypeName(self)

    def clone(self):
        return _VisusDbPy.IdxDataset_clone(self)
    if _newclass:
        tryRemoveLockAndCorruptedBinaryFiles = staticmethod(_VisusDbPy.IdxDataset_tryRemoveLockAndCorruptedBinaryFiles)
    else:
        tryRemoveLockAndCorruptedBinaryFiles = _VisusDbPy.IdxDataset_tryRemoveLockAndCorruptedBinaryFiles

    def removeFiles(self):
        return _VisusDbPy.IdxDataset_removeFiles(self)

    def compressDataset(self, compression):
        return _VisusDbPy.IdxDataset_compressDataset(self, compression)

    def getLevelSamples(self, H):
        return _VisusDbPy.IdxDataset_getLevelSamples(self, H)

    def adjustFilterBox(self, query, filter, box, H):
        return _VisusDbPy.IdxDataset_adjustFilterBox(self, query, filter, box, H)
    ...
    def setIdxFile(self, value):
        return _VisusDbPy.IdxDataset_setIdxFile(self, value)

    def read(self, ar):
        return _VisusDbPy.IdxDataset_read(self, ar)

    def createAccess(self, *args):
        return _VisusDbPy.IdxDataset_createAccess(self, *args)

    def getAddressRangeSamples(self, start_address, end_address):
        return _VisusDbPy.IdxDataset_getAddressRangeSamples(self, start_address, end_address)
    ...
    def nextQuery(self, query):
        return _VisusDbPy.IdxDataset_nextQuery(self, query)

    def mergeBoxQueryWithBlock(self, query, block_query):
        return _VisusDbPy.IdxDataset_mergeBoxQueryWithBlock(self, query, block_query)

    def createBoxQueryRequest(self, query):
        return _VisusDbPy.IdxDataset_createBoxQueryRequest(self, query)

    def beginQuery(self, *args):
        return _VisusDbPy.IdxDataset_beginQuery(self, *args)

    def executeQuery(self, *args):
        return _VisusDbPy.IdxDataset_executeQuery(self, *args)

    def createPointQueryRequest(self, query):
        return _VisusDbPy.IdxDataset_createPointQueryRequest(self, query)

    def setEndResolution(self, query, value):
        return _VisusDbPy.IdxDataset_setEndResolution(self, query, value)
...
def IdxDataset_tryRemoveLockAndCorruptedBinaryFiles(directory):
    return _VisusDbPy.IdxDataset_tryRemoveLockAndCorruptedBinaryFiles(directory)
IdxDataset_tryRemoveLockAndCorruptedBinaryFiles = _VisusDbPy.IdxDataset_tryRemoveLockAndCorruptedBinaryFiles
...
class IdxMultipleDataset(IdxDataset):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["is_mosaic"] = _VisusDbPy.IdxMultipleDataset_is_mosaic_set
    __swig_getmethods__["is_mosaic"] = _VisusDbPy.IdxMultipleDataset_is_mosaic_get
    if _newclass:
        is_mosaic = _swig_property(_VisusDbPy.IdxMultipleDataset_is_mosaic_get, _VisusDbPy.IdxMultipleDataset_is_mosaic_set)
    ...
    def getTypeName(self):
        return _VisusDbPy.IdxMultipleDataset_getTypeName(self)

    def clone(self):
        return _VisusDbPy.IdxMultipleDataset_clone(self)
    ...
    def computeDefaultFields(self):
        return _VisusDbPy.IdxMultipleDataset_computeDefaultFields(self)

    def read(self, ar):
        return _VisusDbPy.IdxMultipleDataset_read(self, ar)

    def getInnerDatasets(self):
        return _VisusDbPy.IdxMultipleDataset_getInnerDatasets(self)

    def getFieldByNameThrowEx(self, name):
        return _VisusDbPy.IdxMultipleDataset_getFieldByNameThrowEx(self, name)

    def createAccess(self, *args):
        return _VisusDbPy.IdxMultipleDataset_createAccess(self, *args)

    def createFilter(self, FIELD):
        return _VisusDbPy.IdxMultipleDataset_createFilter(self, FIELD)

    def beginQuery(self, query):
        return _VisusDbPy.IdxMultipleDataset_beginQuery(self, query)

    def nextQuery(self, QUERY):
        return _VisusDbPy.IdxMultipleDataset_nextQuery(self, QUERY)

    def executeQuery(self, ACCESS, QUERY):
        return _VisusDbPy.IdxMultipleDataset_executeQuery(self, ACCESS, QUERY)

    def createIdxFile(self, idx_filename, idx_field):
        return _VisusDbPy.IdxMultipleDataset_createIdxFile(self, idx_filename, idx_field)
...
class VisusConvert(_object):
    ...
    def run(self, args):
        return _VisusDbPy.VisusConvert_run(self, args)
