...
class LogicSamples(object):
    ...
    @staticmethod
    def merge(Wsamples, Wbuffer, Rsamples, Rbuffer, merge_mode, aborted):
...
class BlockQuery(Query):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    start_address = property(_VisusDbPy.BlockQuery_start_address_get, _VisusDbPy.BlockQuery_start_address_set)
    end_address = property(_VisusDbPy.BlockQuery_end_address_get, _VisusDbPy.BlockQuery_end_address_set)
    logic_samples = property(_VisusDbPy.BlockQuery_logic_samples_get, _VisusDbPy.BlockQuery_logic_samples_set)
    done = property(_VisusDbPy.BlockQuery_done_get, _VisusDbPy.BlockQuery_done_set)

    def __init__(self, dataset, field, time, start_address, end_address, mode, aborted):
        _VisusDbPy.BlockQuery_swiginit(self, _VisusDbPy.new_BlockQuery(dataset, field, time, start_address, end_address, mode, aborted))
...
class BoxQuery(Query):
    ...
    merge_mode = property(_VisusDbPy.BoxQuery_merge_mode_get, _VisusDbPy.BoxQuery_merge_mode_set)
    ...
    def __init__(self, *args):
        _VisusDbPy.BoxQuery_swiginit(self, _VisusDbPy.new_BoxQuery(*args))
...
class PointQuery(Query):
    ...
    def __init__(self, *args):
        _VisusDbPy.PointQuery_swiginit(self, _VisusDbPy.new_PointQuery(*args))
...
# Register DatasetFilter in _VisusDbPy:
_VisusDbPy.DatasetFilter_swigregister(DatasetFilter)
...
class Dataset(object):
    ...
    down_datasets = property(_VisusDbPy.Dataset_down_datasets_get, _VisusDbPy.Dataset_down_datasets_set)
    ...
    @staticmethod
    def copyDataset(Dvf, Daccess, Dfield, Dtime, Svf, Saccess, Sfield, Stime):
...
class IdxDataset(Dataset):
    ...
    hzaddress_conversion_boxquery = property(_VisusDbPy.IdxDataset_hzaddress_conversion_boxquery_get, _VisusDbPy.IdxDataset_hzaddress_conversion_boxquery_set)
    hzaddress_conversion_pointquery = property(_VisusDbPy.IdxDataset_hzaddress_conversion_pointquery_get, _VisusDbPy.IdxDataset_hzaddress_conversion_pointquery_set)
...
class IdxMultipleDataset(IdxDataset):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    is_mosaic = property(_VisusDbPy.IdxMultipleDataset_is_mosaic_get, _VisusDbPy.IdxMultipleDataset_is_mosaic_set)
