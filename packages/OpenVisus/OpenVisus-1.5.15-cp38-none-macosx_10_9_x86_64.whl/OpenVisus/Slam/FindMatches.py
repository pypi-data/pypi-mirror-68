...
def DebugMatches(filename,width,height,img1,points1,H1,img2,points2,H2,TargetWidth=1024):
	...
	bounds1=transformPoints([(0, 0) ,(width, 0) , (width, height), (0, height)],H1)
	bounds2=transformPoints([(0, 0) ,(width, 0) , (width, height), (0, height)],H2)
	...
	blended1=cv2.warpPerspective(img1, Timg1, (W, H))#, cv2.INTER_LINEAR, cv2.BORDER_TRANSPARENT, (0, 0, 0, 0))
	blended2=cv2.warpPerspective(img2, Timg2, (W, H))#, cv2.INTER_LINEAR, cv2.BORDER_TRANSPARENT, (0, 0, 0, 0))
	...
	borders1=transformPoints([(0, 0) ,(width, 0) , (width, height), (0, height)], H1)
	borders2=transformPoints([(0, 0) ,(width, 0) , (width, height), (0, height)], H2)
	for I in range(4):
