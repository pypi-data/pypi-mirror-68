...
class CpuPaletteNode(VisusDataflowPy.Node):
    ...
    def __init__(self, *args):
        if self.__class__ == CpuPaletteNode:
            ...
            _self = self
        _VisusNodesPy.CpuPaletteNode_swiginit(self, _VisusNodesPy.new_CpuPaletteNode(_self, *args))
...
class FieldNode(VisusDataflowPy.Node):
    ...
    def __init__(self):
        if self.__class__ == FieldNode:
            ...
            _self = self
        _VisusNodesPy.FieldNode_swiginit(self, _VisusNodesPy.new_FieldNode(_self, ))
...
class ModelViewNode(VisusDataflowPy.Node):
    ...
    def __init__(self):
        if self.__class__ == ModelViewNode:
            ...
            _self = self
        _VisusNodesPy.ModelViewNode_swiginit(self, _VisusNodesPy.new_ModelViewNode(_self, ))
...
class PaletteNode(VisusDataflowPy.Node):
    ...
    def __init__(self, *args):
        if self.__class__ == PaletteNode:
            ...
            _self = self
        _VisusNodesPy.PaletteNode_swiginit(self, _VisusNodesPy.new_PaletteNode(_self, *args))
...
class StatisticsNode(VisusDataflowPy.Node):
    ...
    def __init__(self):
        if self.__class__ == StatisticsNode:
            ...
            _self = self
        _VisusNodesPy.StatisticsNode_swiginit(self, _VisusNodesPy.new_StatisticsNode(_self, ))
...
class TimeNode(VisusDataflowPy.Node):
    ...
    def __init__(self, *args):
        if self.__class__ == TimeNode:
            ...
            _self = self
        _VisusNodesPy.TimeNode_swiginit(self, _VisusNodesPy.new_TimeNode(_self, *args))
...
class DatasetNode(VisusDataflowPy.Node):
    ...
    def __init__(self):
        if self.__class__ == DatasetNode:
            ...
            _self = self
        _VisusNodesPy.DatasetNode_swiginit(self, _VisusNodesPy.new_DatasetNode(_self, ))
...
class QueryNode(VisusDataflowPy.Node):
    ...
    def __init__(self):
        if self.__class__ == QueryNode:
            ...
            _self = self
        _VisusNodesPy.QueryNode_swiginit(self, _VisusNodesPy.new_QueryNode(_self, ))
...
class KdQueryNode(QueryNode):
    ...
    def __init__(self):
        if self.__class__ == KdQueryNode:
            ...
            _self = self
        _VisusNodesPy.KdQueryNode_swiginit(self, _VisusNodesPy.new_KdQueryNode(_self, ))
