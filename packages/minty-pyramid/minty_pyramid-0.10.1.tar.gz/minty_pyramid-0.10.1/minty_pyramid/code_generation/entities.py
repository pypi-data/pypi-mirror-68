...
class EntityGenerator:
    ...
    def generate_json_api_object(
        self, meta_schema, attribute_schema, entity_type, relationships={}
    ):
        ...
        return {
            ...
            "attributes": {"type": "object", "properties": attribute_schema},
            "relationships": {
                "type": "object",
    ...
    def _transform_entity_to_jsonapi(self, entity, schema):
        ...
        properties = self.generate_json_api_object(
        ...
        output_schema["title"] = f"Entity{schema['title']}"
