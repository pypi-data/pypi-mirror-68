...
import numpy_cloud.lib.function_base as nfb
from numpy_cloud.random import rand
from numpy_cloud.lib import (
...
from numpy_cloud.compat import long
...
class TestRot90(CloudArrayTest):
    def test_basic(self):
...
class TestAverage(CloudArrayTest):
...
class TestSelect(CloudArrayTest):
...
class TestInsert(CloudArrayTest):
...
class TestCumsum(CloudArrayTest):
...
class TestCumprod(CloudArrayTest):
...
class TestDelete(CloudArrayTest):
...
class TestGradient(CloudArrayTest):
...
class TestAngle(CloudArrayTest):
...
class TestTrimZeros(CloudArrayTest):
...
class TestExtins(CloudArrayTest):
...
class TestVectorize(CloudArrayTest):
...
class TestDigitize(CloudArrayTest):
...
class TestUnwrap(CloudArrayTest):
...
class TestFilterwindows(CloudArrayTest):
...
class TestTrapz(CloudArrayTest):
...
class TestUnique(CloudArrayTest):
...
class TestCheckFinite(CloudArrayTest):
...
class TestCorrCoef(CloudArrayTest):
    A = np.array(
...
class TestKaiser(CloudArrayTest):
...
class TestMsort(CloudArrayTest):
...
class TestMeshgrid(CloudArrayTest):
...
class TestPiecewise(CloudArrayTest):
...
class TestBincount(CloudArrayTest):
...
class TestInterp(CloudArrayTest):
...
class TestPercentile(CloudArrayTest):
...
class TestQuantile(CloudArrayTest):
...
class TestMedian(CloudArrayTest):
...
class TestAdd_newdoc_ufunc(CloudArrayTest):
...
class TestAdd_newdoc(CloudArrayTest):
