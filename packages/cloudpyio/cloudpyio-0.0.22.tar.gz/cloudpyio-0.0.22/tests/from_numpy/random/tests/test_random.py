...
class TestBinomial(CloudArrayTest):
...
class TestMultinomial(CloudArrayTest):
    def test_basic(self):
...
class TestSetState(CloudArrayTest):
    def setup(self):
...
class TestRandint(CloudArrayTest):
...
class TestRandomDist(CloudArrayTest):
...
class TestThread(CloudArrayTest):
...
# See Issue #4263
class TestSingleEltArrayInput(CloudArrayTest):
    def setup(self):
