...
from numpy_cloud import matrix, asmatrix, bmat
from numpy.testing import (
    assert_, assert_equal, assert_almost_equal, assert_array_equal,
    assert_array_almost_equal, assert_raises
    )
from numpy_cloud.linalg import matrix_power
from numpy_cloud.matrixlib import mat

class TestCtor(CloudArrayTest):
    def test_basic(self):
        A = np.array([[1, 2], [3, 4]])
        mA = matrix(A)
...
class TestProperties(CloudArrayTest):
    def test_sum(self):
    ...
    def test_basic(self):
        import numpy_cloud.linalg as linalg
...
class TestCasting(CloudArrayTest):
    def test_basic(self):
        A = np.arange(100).reshape(10, 10)
        mA = matrix(A)
...
class TestAlgebra(CloudArrayTest):
    def test_basic(self):
        import numpy_cloud.linalg as linalg
...
class TestMatrixReturn(CloudArrayTest):
...
class TestNewScalarIndexing(CloudArrayTest):
    a = matrix([[1, 2], [3, 4]])
...
class TestShape(CloudArrayTest):
