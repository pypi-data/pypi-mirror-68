...
from numpy_cloud.core.multiarray import _vec_string
...
class TestBasic(CloudArrayTest):
...
class TestVecString(CloudArrayTest):
...
class TestWhitespace(CloudArrayTest):
    def setup(self):
...
class TestComparisonsMixed1(CloudArrayTest):
    """Ticket #1276"""
...
class TestComparisonsMixed2(CloudArrayTest):
    """Ticket #1276"""
...
class TestInformation(CloudArrayTest):
    def setup(self):
        self.A = np.array([[' abc ', ''],
                           ['12345', 'MixedCase'],
...
class TestOperations(CloudArrayTest):
    def setup(self):
        self.A = np.array([['abc', '123'],
                           ['789', 'xyz']]).view(np.chararray)
