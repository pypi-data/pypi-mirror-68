...
from numpy_cloud.core._multiarray_tests import array_indexing
...
class TestIndexing(CloudArrayTest):
...
class TestFieldIndexing(CloudArrayTest):
    def test_scalar_return_type(self):
...
class TestBroadcastedAssignments(CloudArrayTest):
...
class TestSubclasses(CloudArrayTest):
    def test_basic(self):
...
class TestFancyIndexingCast(CloudArrayTest):
...
class TestFancyIndexingEquivalence(CloudArrayTest):
...
class TestMultiIndexingAutomated(CloudArrayTest):
    """
...
class TestFloatNonIntegerArgument(CloudArrayTest):
    """
...
class TestBooleanIndexing(CloudArrayTest):
...
class TestArrayToIndexDeprecation(CloudArrayTest):
...
class TestNonIntegerArrayLike(CloudArrayTest):
...
class TestMultipleEllipsisError(CloudArrayTest):
...
class TestCApiAccess(CloudArrayTest):
