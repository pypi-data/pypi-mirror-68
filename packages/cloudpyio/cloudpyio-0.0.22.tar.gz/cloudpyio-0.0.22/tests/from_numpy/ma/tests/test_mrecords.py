...
from numpy_cloud import recarray
from numpy_cloud.ma import masked, nomask
from numpy.testing import temppath
from numpy_cloud.core.records import (
    fromrecords as recfromrecords, fromarrays as recfromarrays
    )
from numpy_cloud.ma.mrecords import (
...
class TestMRecords(CloudArrayTest):
...
##############################################################################
class TestMRecordsImport(CloudArrayTest):
