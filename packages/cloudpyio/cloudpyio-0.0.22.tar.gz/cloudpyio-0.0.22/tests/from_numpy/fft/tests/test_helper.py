...
from numpy_cloud import fft, pi
from numpy_cloud.fft.helper import _FFTCache


class TestFFTShift(CloudArrayTest):
    ...
    def test_equal_to_original(self):
        ...
        from numpy_cloud.compat import integer_types
        from numpy_cloud.core import asarray, concatenate, arange, take
...
class TestFFTFreq(CloudArrayTest):
...
class TestRFFTFreq(CloudArrayTest):
...
class TestIRFFTN(CloudArrayTest):
...
class TestFFTCache(CloudArrayTest):
