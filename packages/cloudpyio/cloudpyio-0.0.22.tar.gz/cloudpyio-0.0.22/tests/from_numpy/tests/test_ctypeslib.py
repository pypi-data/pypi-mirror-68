...
from numpy_cloud.ctypeslib import ndpointer, load_library, as_array
from numpy_cloud.distutils.misc_util import get_shared_lib_extension
...
class TestLoadLibrary(CloudArrayTest):
    def test_basic(self):
        try:
            # Should succeed
...
class TestNdpointer(CloudArrayTest):
    def test_dtype(self):
        dt = np.intc
...
class TestAsArray(CloudArrayTest):
    def test_array(self):
