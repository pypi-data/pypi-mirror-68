...
from pandas_cloud._libs.sparse import IntIndex
from pandas_cloud.compat import range
# rewrite: omit test decoratores (td) import

import pandas_cloud as pd
from pandas_cloud.core.sparse.api import SparseArray, SparseDtype, SparseSeries
...
class TestSparseArray(CloudArrayTest, object):
...
class TestSparseArrayAnalytics(CloudArrayTest, object):
...
class TestAccessor(CloudArrayTest, object):
