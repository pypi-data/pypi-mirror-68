...
from pandas_cloud import Categorical, DataFrame, Series, date_range
from pandas_cloud.tests.arrays.categorical.common import TestCategorical
import pandas_cloud.util.testing as tm


class TestCategoricalOpsWithFactor(CloudArrayTest, TestCategorical):
...
class TestCategoricalOps(CloudArrayTest, object):
