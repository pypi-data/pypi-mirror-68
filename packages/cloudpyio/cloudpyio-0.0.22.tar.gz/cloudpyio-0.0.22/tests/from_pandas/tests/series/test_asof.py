...
from pandas_cloud import Series, Timestamp, date_range, isna, notna, offsets
import pandas_cloud.util.testing as tm


class TestSeriesAsof(CloudArrayTest, ):
    ...
    def test_periodindex(self):
        from pandas_cloud import period_range, PeriodIndex
        # array or list or dates
        N = 50
