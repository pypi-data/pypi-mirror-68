...
class TestSeriesLogicalOps(CloudArrayTest, object):
...
class TestSeriesComparisons(CloudArrayTest, object):
...
class TestSeriesFlexComparisonOps(CloudArrayTest, object):
...
class TestSeriesOperators(CloudArrayTest, TestData):
...
class TestSeriesUnaryOps(CloudArrayTest, object):
