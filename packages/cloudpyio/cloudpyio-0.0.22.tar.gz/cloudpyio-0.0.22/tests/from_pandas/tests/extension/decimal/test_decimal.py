...
class TestDtype(CloudArrayTest, BaseDecimal, base.BaseDtypeTests):
    @pytest.mark.skipif(compat.PY2, reason="Context not hashable.")
    def test_hashable(self, dtype):
        pass


class TestInterface(CloudArrayTest, BaseDecimal, base.BaseInterfaceTests):

    pytestmark = pytest.mark.skipif(compat.PY2,
                                    reason="Unhashble dtype in Py2.")


class TestConstructors(CloudArrayTest, BaseDecimal, base.BaseConstructorsTests):
...
class TestReshaping(CloudArrayTest, BaseDecimal, base.BaseReshapingTests):
    pytestmark = pytest.mark.skipif(compat.PY2,
                                    reason="Unhashble dtype in Py2.")


class TestGetitem(CloudArrayTest, BaseDecimal, base.BaseGetitemTests):
...
class TestMissing(CloudArrayTest, BaseDecimal, base.BaseMissingTests):
    pass
...
class TestNumericReduce(CloudArrayTest, Reduce, base.BaseNumericReduceTests):
    pass


class TestBooleanReduce(CloudArrayTest, Reduce, base.BaseBooleanReduceTests):
    pass


class TestMethods(CloudArrayTest, BaseDecimal, base.BaseMethodsTests):
...
class TestCasting(CloudArrayTest, BaseDecimal, base.BaseCastingTests):
    pass


class TestGroupby(CloudArrayTest, BaseDecimal, base.BaseGroupbyTests):
    pytestmark = pytest.mark.skipif(compat.PY2,
                                    reason="Unhashble dtype in Py2.")


class TestSetitem(CloudArrayTest, BaseDecimal, base.BaseSetitemTests):
    pass
...
class TestArithmeticOps(CloudArrayTest, BaseDecimal, base.BaseArithmeticOpsTests):
...
class TestComparisonOps(CloudArrayTest, BaseDecimal, base.BaseComparisonOpsTests):
