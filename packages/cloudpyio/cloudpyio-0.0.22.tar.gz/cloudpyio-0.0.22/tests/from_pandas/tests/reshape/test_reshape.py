...
from pandas_cloud import DataFrame, Series
from pandas_cloud.core.sparse.api import SparseDtype, SparseArray
...
from pandas_cloud import get_dummies, Categorical, Index
import pandas_cloud.util.testing as tm
from pandas_cloud.compat import u


class TestGetDummies(CloudArrayTest, object):
...
class TestCategoricalReshape(CloudArrayTest, object):
...
class TestMakeAxisDummies(CloudArrayTest, object):
