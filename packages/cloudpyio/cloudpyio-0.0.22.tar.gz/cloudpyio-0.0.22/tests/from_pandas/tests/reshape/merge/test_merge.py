...
from pandas_cloud import (Categorical, CategoricalIndex, DataFrame, DatetimeIndex,
                    Float64Index, Int64Index, MultiIndex, RangeIndex,
                    Series, UInt64Index)
from pandas_cloud.api.types import CategoricalDtype as CDT
from pandas_cloud.compat import lrange
from pandas_cloud.core.dtypes.common import is_categorical_dtype, is_object_dtype
from pandas_cloud.core.dtypes.dtypes import CategoricalDtype
from pandas_cloud.core.reshape.concat import concat
from pandas_cloud.core.reshape.merge import MergeError, merge
...
class TestMerge(CloudArrayTest, object):
...
class TestMergeDtypes(CloudArrayTest, object):
...
class TestMergeCategorical(CloudArrayTest, object):
...
class TestMergeOnIndexes(CloudArrayTest, object):
