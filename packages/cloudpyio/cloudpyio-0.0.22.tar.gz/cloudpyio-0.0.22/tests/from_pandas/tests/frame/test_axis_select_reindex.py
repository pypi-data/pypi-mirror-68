...
from pandas_cloud.compat import lrange, lzip, u
from pandas_cloud import (compat, DataFrame, Series, Index, MultiIndex, Categorical,
                    date_range, isna)
...
class TestDataFrameSelectReindex(CloudArrayTest, TestData):
