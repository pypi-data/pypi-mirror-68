...
from pandas_cloud.tseries.offsets import BMonthEnd, Minute, MonthEnd

START, END = datetime(2009, 1, 1), datetime(2010, 1, 1)


class TestDatetimeIndexSetOps(CloudArrayTest, object):
    ...
    def test_union_bug_4564(self):
        from pandas_cloud import DateOffset
...
# rewrite: omit @td...
    def test_month_range_union_tz_dateutil(self):
        from pandas_cloud._libs.tslibs.timezones import dateutil_gettz
