...
from pandas_cloud.core.dtypes.dtypes import CategoricalDtype, IntervalDtype
...
class TestIntSubtype(CloudArrayTest, Base):
...
class TestFloatSubtype(CloudArrayTest, Base):
...
class TestDatetimelikeSubtype(CloudArrayTest, Base):
