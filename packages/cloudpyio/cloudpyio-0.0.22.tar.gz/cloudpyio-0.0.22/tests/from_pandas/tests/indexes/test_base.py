...
import pandas_cloud.core.config as cf
...
from pandas_cloud._libs.tslib import Timestamp
from pandas_cloud.compat import (
...
from pandas_cloud.core.dtypes.generic import ABCIndex
from pandas_cloud.core.index import _get_combined_index, ensure_index_from_sequences
from pandas_cloud.core.indexes.api import Index, MultiIndex
from pandas_cloud.core.indexes.datetimes import _to_m8
from pandas_cloud.tests.indexes.common import Base
from pandas_cloud.util.testing import assert_almost_equal
from pandas_cloud.core.sorting import safe_sort


class TestIndex(CloudArrayTest, Base):
    _holder = Index
...
Index([u'a', u'bb', u'ccc', u'a', u'bb', u'ccc', u'a', u'bb', u'ccc', u'a',
    ...
    def test_tab_complete_warning(self, ip):
        ...
        code = "import pandas_cloud as pd; idx = pd.Index([1, 2])"
        ip.run_code(code)
...
class TestMixedIntIndex(CloudArrayTest, Base):
...
class TestIndexUtils(CloudArrayTest, object):
