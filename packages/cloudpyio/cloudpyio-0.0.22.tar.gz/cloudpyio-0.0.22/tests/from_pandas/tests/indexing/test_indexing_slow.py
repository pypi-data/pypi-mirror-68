...
from pandas_cloud.core.api import DataFrame, MultiIndex, Series
import pandas_cloud.util.testing as tm


class TestIndexingSlow(CloudArrayTest, object):
    ...
    def test_multiindex_get_loc(self):  # GH7724, GH2646
        ...
        with warnings.catch_warnings(record=True):
            ...
            from numpy_cloud.random import randint, choice, randn
