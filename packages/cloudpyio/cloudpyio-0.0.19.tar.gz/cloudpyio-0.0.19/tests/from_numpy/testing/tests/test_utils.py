...
class TestArrayEqual(CloudArrayTest):
...
class TestBuildErrorMessage(CloudArrayTest):
...
class TestEqual(CloudArrayTest):
...
class TestArrayAlmostEqual(CloudArrayTest):
...
class TestAlmostEqual(CloudArrayTest):
...
class TestApproxEqual(CloudArrayTest):
...
class TestArrayAssertLess(CloudArrayTest):
...
class TestRaises(CloudArrayTest):
...
class TestWarns(CloudArrayTest):
...
class TestAssertAllclose(CloudArrayTest):
...
class TestArrayAlmostEqualNulp(CloudArrayTest):
...
class TestStringEqual(CloudArrayTest):
    def test_simple(self):
...
class TestAssertNoGcCycles(CloudArrayTest):
