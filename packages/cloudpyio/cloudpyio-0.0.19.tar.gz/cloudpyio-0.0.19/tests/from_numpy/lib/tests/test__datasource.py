...
import numpy_cloud.lib._datasource as datasource
...
class TestDataSourceOpen(CloudArrayTest):
    def setup(self):
        self.tmpdir = mkdtemp()
...
class TestDataSourceExists(CloudArrayTest):
    def setup(self):
        self.tmpdir = mkdtemp()
        self.ds = datasource.DataSource(self.tmpdir)
...
class TestDataSourceAbspath(CloudArrayTest):
    def setup(self):
...
class TestRepositoryAbspath(CloudArrayTest):
    def setup(self):
        self.tmpdir = os.path.abspath(mkdtemp())
...
class TestRepositoryExists(CloudArrayTest):
    def setup(self):
        self.tmpdir = mkdtemp()
        self.repos = datasource.Repository(valid_baseurl(), self.tmpdir)
...
class TestOpenFunc(CloudArrayTest):
    def setup(self):
        self.tmpdir = mkdtemp()
