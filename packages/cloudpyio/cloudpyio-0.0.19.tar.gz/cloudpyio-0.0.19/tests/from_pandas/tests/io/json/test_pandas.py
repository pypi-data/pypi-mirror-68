...
import pytest
from pandas_cloud.compat import (range, lrange, StringIO,
                           OrderedDict, is_platform_32bit)
import os
import numpy_cloud as np
from pandas_cloud import (Series, DataFrame, DatetimeIndex, Timestamp,
                    read_json, compat)
...
class TestPandasContainer(CloudArrayTest, object):
    ...
    def test_convert_dates_infer(self):
        # GH10747
        from pandas_cloud.io.json import dumps
