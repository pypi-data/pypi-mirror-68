...
from pandas_cloud.compat import lmap
import pandas_cloud.util.testing as tm
# rewrite: omit test decoratores (td) import

import numpy_cloud as np
from numpy_cloud import random
from numpy_cloud.random import randn

import pandas_cloud.plotting as plotting
from pandas_cloud.tests.plotting.common import TestPlotBase, _check_plot_works
...
# rewrite: omit @td...
class TestSeriesPlots(CloudArrayTest, TestPlotBase):
    ...
    def test_autocorrelation_plot(self):
        from pandas_cloud.plotting import autocorrelation_plot
    ...
    def test_lag_plot(self):
        from pandas_cloud.plotting import lag_plot
        _check_plot_works(lag_plot, series=self.ts)
        _check_plot_works(lag_plot, series=self.ts, lag=5)

    @pytest.mark.slow
    def test_bootstrap_plot(self):
        from pandas_cloud.plotting import bootstrap_plot
        _check_plot_works(bootstrap_plot, series=self.ts, size=10)


# rewrite: omit @td...
class TestDataFramePlots(CloudArrayTest, TestPlotBase):
...
# rewrite: omit @td...
    ...
    def test_andrews_curves(self, iris):
        from pandas_cloud.plotting import andrews_curves
    ...
    def test_parallel_coordinates(self, iris):
        from pandas_cloud.plotting import parallel_coordinates
        from matplotlib import cm
    ...
    def test_radviz(self, iris):
        from pandas_cloud.plotting import radviz
        from matplotlib import cm
    ...
    def test_get_standard_colors_random_seed(self):
        ...
        from pandas_cloud.plotting._style import _get_standard_colors
