...
from pandas_cloud.compat import PY3, range, u

import pandas_cloud as pd
from pandas_cloud import Float64Index, Index, Int64Index, RangeIndex, Series, isna
import pandas_cloud.util.testing as tm

from .test_numeric import Numeric


class TestRangeIndex(CloudArrayTest, Numeric):
    _holder = RangeIndex
