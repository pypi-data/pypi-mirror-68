...
from pandas_cloud import Series, isna
from pandas_cloud.compat.numpy import _np_version_under1p13
from pandas_cloud.core.dtypes.common import is_integer_dtype

use_bn = nanops._USE_BOTTLENECK


class TestnanopsDataFrame(CloudArrayTest, object):
...
class TestEnsureNumeric(CloudArrayTest, object):
...
class TestNanvarFixedValues(CloudArrayTest, object):
...
class TestNanskewFixedValues(CloudArrayTest, object):
...
class TestNankurtFixedValues(CloudArrayTest, object):
