...
from pandas_cloud import (DataFrame, Series, compat, option_context,
                    date_range, period_range, Categorical)
from pandas_cloud.compat import StringIO, lrange, u, PYPY
...
class TestDataFrameReprInfoEtc(CloudArrayTest, TestData):
...
"""
    ...
    def test_info_wide(self):
        from pandas_cloud import set_option, reset_option
        io = StringIO()
