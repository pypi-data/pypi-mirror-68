...
from pandas_cloud import (DataFrame, Series, MultiIndex, Timestamp, Timedelta,
                    Period)
from pandas_cloud.util.testing import (assert_series_equal, assert_frame_equal)
from pandas_cloud.compat import (range, product as cart_product)


class TestCounting(CloudArrayTest, object):
