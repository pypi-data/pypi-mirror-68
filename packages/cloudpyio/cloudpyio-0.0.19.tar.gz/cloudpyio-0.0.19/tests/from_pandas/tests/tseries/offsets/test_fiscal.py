...
from pandas_cloud.tseries.frequencies import get_offset
from pandas_cloud._libs.tslibs.frequencies import INVALID_FREQ_ERR_MSG
from pandas_cloud.tseries.offsets import FY5253Quarter, FY5253
...
class TestFY5253LastOfMonth(CloudArrayTest, Base):
...
class TestFY5253NearestEndMonth(CloudArrayTest, Base):
...
class TestFY5253LastOfMonthQuarter(CloudArrayTest, Base):
...
class TestFY5253NearestEndMonthQuarter(CloudArrayTest, Base):
