...
import pandas_cloud._libs.sparse as splib
# rewrite: omit test decoratores (td) import

from pandas_cloud import Series
from pandas_cloud.core.arrays.sparse import BlockIndex, IntIndex, _make_index
...
class TestSparseIndexUnion(CloudArrayTest, object):
...
class TestSparseIndexIntersect(CloudArrayTest, object):
...
class TestSparseIndexCommon(CloudArrayTest, object):
...
class TestBlockIndex(CloudArrayTest, object):
...
class TestIntIndex(CloudArrayTest, object):
...
class TestSparseOperators(CloudArrayTest, object):
