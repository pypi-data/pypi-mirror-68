...
from pandas_cloud import Series, DataFrame, date_range
from pandas_cloud.compat import range, lrange
...
# rewrite: omit @td...
    ...
    def test_custom_business_day_freq(self):
        # GH7222
        from pandas_cloud.tseries.offsets import CustomBusinessDay
