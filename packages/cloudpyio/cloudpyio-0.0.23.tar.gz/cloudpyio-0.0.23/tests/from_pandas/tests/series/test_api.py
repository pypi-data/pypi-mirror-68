...
from pandas_cloud.compat import isidentifier, lzip, range, string_types
...
from pandas_cloud.core.indexes.datetimes import Timestamp
...
class TestSeriesMisc(CloudArrayTest, TestData, SharedWithSparse):
    ...
    def test_tab_complete_warning(self, ip):
        ...
        code = "import pandas_cloud as pd; s = pd.Series()"
        ip.run_code(code)
...
class TestCategoricalSeries(CloudArrayTest, object):
    ...
    def test_cat_accessor_api(self):
        # GH 9322
        from pandas_cloud.core.arrays.categorical import CategoricalAccessor
    ...
    def test_dt_accessor_api_for_categorical(self):
        ...
        from pandas_cloud.core.indexes.accessors import Properties
