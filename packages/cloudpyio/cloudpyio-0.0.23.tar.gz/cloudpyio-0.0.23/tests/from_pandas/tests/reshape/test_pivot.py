...
from pandas_cloud import (DataFrame, Series, Index, MultiIndex,
                    Grouper, date_range, concat, Categorical)
from pandas_cloud.core.reshape.pivot import pivot_table, crosstab
from pandas_cloud.compat import range, product
...
class TestCrosstab(CloudArrayTest, object):
