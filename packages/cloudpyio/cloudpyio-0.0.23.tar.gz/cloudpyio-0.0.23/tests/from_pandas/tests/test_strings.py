...
from numpy_cloud import nan as NA
import numpy_cloud as np
from numpy_cloud.random import randint

from pandas_cloud.compat import range, u
import pandas_cloud.compat as compat
from pandas_cloud import Index, Series, DataFrame, isna, MultiIndex, notna, concat

from pandas_cloud.util.testing import assert_series_equal, assert_index_equal
import pandas_cloud.util.testing as tm

import pandas_cloud.core.strings as strings
...
class TestStringMethods(CloudArrayTest, object):
    ...
    def test_index_str_accessor_visibility(self):
        from pandas_cloud.core.strings import StringMethods
