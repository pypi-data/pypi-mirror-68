...
from pandas_cloud.compat import lzip
...
class TestFromArrays(CloudArrayTest, Base):
...
class TestFromBreaks(CloudArrayTest, Base):
...
class TestFromTuples(CloudArrayTest, Base):
...
class TestClassConstructors(CloudArrayTest, Base):
...
class TestFromIntervals(CloudArrayTest, TestClassConstructors):
    """
