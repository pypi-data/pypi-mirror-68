...
from pandas_cloud.core.dtypes.generic import ABCDateOffset

import pandas_cloud as pd
from pandas_cloud import (
    DatetimeIndex, Index, PeriodIndex, Series, Timestamp, bdate_range,
    date_range)
from pandas_cloud.tests.test_base import Ops
import pandas_cloud.util.testing as tm

from pandas_cloud.tseries.offsets import BDay, BMonthEnd, CDay, Day, Hour

START, END = datetime(2009, 1, 1), datetime(2010, 1, 1)


class TestDatetimeIndexOps(CloudArrayTest, Ops):
...
class TestBusinessDatetimeIndex(CloudArrayTest, object):
...
class TestCustomDatetimeIndex(CloudArrayTest, object):
    def setup_method(self, method):
        if hasattr(super(), "setup_method"): super().method_method(setup)
