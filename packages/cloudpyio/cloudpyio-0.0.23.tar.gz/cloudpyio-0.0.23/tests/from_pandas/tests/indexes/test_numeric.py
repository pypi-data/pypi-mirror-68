...
from pandas_cloud._libs.tslibs import Timestamp
from pandas_cloud.compat import range

import pandas_cloud as pd
from pandas_cloud import Float64Index, Index, Int64Index, Series, UInt64Index
...
class TestFloat64Index(CloudArrayTest, Numeric):
...
class TestInt64Index(CloudArrayTest, NumericInt):
    _dtype = 'int64'
    _holder = Int64Index
...
class TestUInt64Index(CloudArrayTest, NumericInt):
