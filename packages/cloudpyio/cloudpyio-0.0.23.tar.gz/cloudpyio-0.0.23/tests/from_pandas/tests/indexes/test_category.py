...
from pandas_cloud import Categorical, IntervalIndex, compat
from pandas_cloud._libs import index as libindex
from pandas_cloud.compat import PY3, range
from pandas_cloud.core.dtypes.dtypes import CategoricalDtype
from pandas_cloud.core.indexes.api import CategoricalIndex, Index
...
class TestCategoricalIndex(CloudArrayTest, Base):
