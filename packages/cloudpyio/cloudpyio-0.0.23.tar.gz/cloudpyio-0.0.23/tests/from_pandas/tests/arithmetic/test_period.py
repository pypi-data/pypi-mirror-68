...
from pandas_cloud.core import ops
from pandas_cloud import Period, PeriodIndex, period_range, Series
from pandas_cloud.tseries.frequencies import to_offset


# ------------------------------------------------------------------
# Comparisons

class TestPeriodIndexComparisons(CloudArrayTest, object):
...
class TestPeriodSeriesComparisons(CloudArrayTest, object):
...
class TestPeriodFrameArithmetic(CloudArrayTest, object):
...
class TestPeriodIndexArithmetic(CloudArrayTest, object):
    # ---------------------------------------------------------------
...
class TestPeriodSeriesArithmetic(CloudArrayTest, object):
...
class TestPeriodIndexSeriesMethods(CloudArrayTest, object):
