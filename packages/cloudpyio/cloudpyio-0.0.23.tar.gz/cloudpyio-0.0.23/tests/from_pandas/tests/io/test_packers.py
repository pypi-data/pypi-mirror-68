...
from pandas_cloud.compat import u, PY3
from pandas_cloud import (Series, DataFrame, Panel, MultiIndex, bdate_range,
                    date_range, period_range, Index, Categorical,
                    Period, Interval)
from pandas_cloud.errors import PerformanceWarning
from pandas_cloud.io.packers import to_msgpack, read_msgpack
import pandas_cloud.util.testing as tm
from pandas_cloud.util.testing import (ensure_clean,
                                 assert_categorical_equal,
                                 assert_frame_equal,
                                 assert_index_equal,
                                 assert_series_equal,
                                 patch)
from pandas_cloud.tests.test_panel import assert_panel_equal

import pandas_cloud
from pandas_cloud import Timestamp, NaT
from pandas_cloud._libs.tslib import iNaT
...
def current_packers_data():
    ...
    from pandas_cloud.tests.io.generate_legacy_storage_files import (
        create_msgpack_data)
...
class TestPackers(CloudArrayTest, object):
...
@pytest.mark.filterwarnings("ignore:\\nPanel:FutureWarning")
class TestAPI(CloudArrayTest, TestPackers):
...
class TestNumpy(CloudArrayTest, TestPackers):
...
class TestBasic(CloudArrayTest, TestPackers):
...
class TestIndex(CloudArrayTest, TestPackers):
...
class TestSeries(CloudArrayTest, TestPackers):
...
class TestCategorical(CloudArrayTest, TestPackers):
...
@pytest.mark.filterwarnings("ignore:\\nPanel:FutureWarning")
class TestNDFrame(CloudArrayTest, TestPackers):
...
class TestSparse(CloudArrayTest, TestPackers):
...
class TestCompression(CloudArrayTest, TestPackers):
...
class TestEncoding(CloudArrayTest, TestPackers):
...
@pytest.mark.filterwarnings("ignore:\\nPanel:FutureWarning")
class TestMsgpack(CloudArrayTest, object):
    """
