...
from pandas_cloud import compat, Index, DataFrame

from pandas_cloud.io.json import json_normalize
from pandas_cloud.io.json.normalize import nested_to_record
...
class TestJSONNormalize(CloudArrayTest, object):
...
class TestNestedToRecord(CloudArrayTest, object):
