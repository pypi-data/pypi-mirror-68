...
from pandas_cloud import NaT, Timedelta, Timestamp
from pandas_cloud.core import ops
import pandas_cloud.util.testing as tm


class TestTimedeltaAdditionSubtraction(CloudArrayTest, object):
    """
...
class TestTimedeltaMultiplicationDivision(CloudArrayTest, object):
    """
    Tests for Timedelta methods:
