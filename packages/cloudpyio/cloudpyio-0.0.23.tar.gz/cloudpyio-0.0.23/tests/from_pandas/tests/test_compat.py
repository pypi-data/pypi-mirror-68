...
import pytest
import re
from pandas_cloud.compat import (range, zip, map, filter, lrange, lzip, lmap,
                           lfilter, builtins, iterkeys, itervalues, iteritems,
                           next, get_range_parameters, PY2, re_type)


class TestBuiltinIterators(CloudArrayTest, object):
...
class TestCompatFunctions(CloudArrayTest, object):
