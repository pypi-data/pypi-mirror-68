...
from pandas_cloud.compat import range, lrange, long
from pandas_cloud import compat

from numpy_cloud.random import randn
import numpy_cloud as np

from pandas_cloud import (DataFrame, Series, date_range, timedelta_range,
...
class TestDataFrameMisc(CloudArrayTest, SharedWithSparse):
    ...
    def test_tab_complete_warning(self, ip):
        ...
        code = "import pandas_cloud as pd; df = pd.DataFrame()"
        ip.run_code(code)
