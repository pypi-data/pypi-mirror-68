...
from numpy_cloud import nan, random
...
from pandas_cloud.tests.frame.common import TestData, _check_mixed_float
...
class TestDataFrameMissingData(CloudArrayTest, TestData):
...
class TestDataFrameInterpolate(CloudArrayTest, TestData):
