...
from pandas_cloud.tseries.offsets import (BMonthBegin, BMonthEnd,
                                    MonthBegin, MonthEnd,
...
class TestMonthBegin(CloudArrayTest, Base):
    _offset = MonthBegin
...
class TestMonthEnd(CloudArrayTest, Base):
    _offset = MonthEnd
...
class TestBMonthBegin(CloudArrayTest, Base):
    _offset = BMonthBegin
...
class TestBMonthEnd(CloudArrayTest, Base):
    _offset = BMonthEnd
...
class TestQuarterBegin(CloudArrayTest, Base):
...
class TestQuarterEnd(CloudArrayTest, Base):
    _offset = QuarterEnd
...
class TestBQuarterBegin(CloudArrayTest, Base):
...
class TestBQuarterEnd(CloudArrayTest, Base):
    _offset = BQuarterEnd
...
class TestYearBegin(CloudArrayTest, Base):
    _offset = YearBegin
...
class TestYearEnd(CloudArrayTest, Base):
    _offset = YearEnd
...
class TestYearEndDiffMonth(CloudArrayTest, Base):
    offset_cases = []
...
class TestBYearBegin(CloudArrayTest, Base):
    _offset = BYearBegin
...
class TestBYearEnd(CloudArrayTest, Base):
    _offset = BYearEnd
...
class TestBYearEndLagged(CloudArrayTest, Base):
    _offset = BYearEnd
