...
from numpy_cloud import array
from numpy_cloud.compat import long
from numpy.testing import assert_, assert_raises
from . import util


class TestReturnReal(CloudArrayTest):
...
class TestCReturnReal(CloudArrayTest):
    suffix = ".pyf"
...
class TestF77ReturnReal(CloudArrayTest):
    code = """
       function t0(value)
         real value
         real t0
...
class TestF90ReturnReal(CloudArrayTest):
    suffix = ".f90"
    code = """
