...
class TestAtleast1d(CloudArrayTest):
...
class TestAtleast2d(CloudArrayTest):
    def test_0D_array(self):
        a = array(1)
        b = array(2)
...
class TestAtleast3d(CloudArrayTest):
    def test_0D_array(self):
        a = array(1)
        b = array(2)
...
class TestHstack(CloudArrayTest):
...
class TestVstack(CloudArrayTest):
    def test_non_iterable(self):
...
class TestConcatenate(CloudArrayTest):
...
class TestBlock(CloudArrayTest):
    def test_returns_copy(self):
        a = np.eye(3)
        b = np.block(a)
        b[0, 0] = 2
