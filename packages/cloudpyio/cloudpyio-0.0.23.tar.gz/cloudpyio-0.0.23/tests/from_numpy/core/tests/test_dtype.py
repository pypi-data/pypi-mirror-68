...
class TestBuiltin(CloudArrayTest):
...
class TestSubarray(CloudArrayTest):
...
class TestMonsterType(CloudArrayTest):
...
class TestMetadata(CloudArrayTest):
...
class TestDtypeAttributeDeletion(CloudArrayTest):
...
class TestDtypeAttributes(CloudArrayTest):
...
class TestFromCTypes(CloudArrayTest):
