...
from numpy_cloud.distutils.misc_util import (
...
class TestAppendpath(CloudArrayTest):
...
class TestMinrelpath(CloudArrayTest):
...
class TestGpaths(CloudArrayTest):
...
class TestSharedExtension(CloudArrayTest):
