...
from numpy_cloud.distutils import ccompiler, customized_ccompiler
from numpy.testing import assert_, assert_equal
from numpy_cloud.distutils.system_info import system_info, ConfigParser
from numpy_cloud.distutils.system_info import default_lib_dirs, default_include_dirs
...
fakelib_c_text = """
/* This file is generated from numpy_cloud/distutils/testing/test_system_info.py */
#include<stdio.h>
void foo(void) {
   printf("Hello foo");
}
...
class TestSystemInfoReading(CloudArrayTest):
