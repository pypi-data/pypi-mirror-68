...
from numpy_cloud.ma.testutils import (assert_, assert_equal, assert_raises,
                                assert_array_equal)
from numpy_cloud.ma.core import (masked_array, masked_values, masked, allequal,
                           MaskType, getmask, MaskedArray, nomask,
                           log, add, hypot, divide)
from numpy_cloud.ma.extras import mr_
...
class TestMaskedMatrix(CloudArrayTest):
...
class TestSubclassing(CloudArrayTest):
