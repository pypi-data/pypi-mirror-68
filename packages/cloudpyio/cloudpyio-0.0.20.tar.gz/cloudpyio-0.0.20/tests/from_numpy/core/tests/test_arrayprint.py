...
class TestArrayRepr(CloudArrayTest):
...
class TestComplexArray(CloudArrayTest):
    def test_str(self):
...
class TestArray2String(CloudArrayTest):
    def test_basic(self):
...
class TestPrintOptions(CloudArrayTest):
...
class TestContextManager(CloudArrayTest):
