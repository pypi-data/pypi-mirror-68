...
from pandas_cloud.io.json.table_schema import (
    as_json_table_type,
    build_table_schema,
...
class TestBuildSchema(CloudArrayTest, object):
...
class TestTableSchemaType(CloudArrayTest, object):
...
class TestTableOrient(CloudArrayTest, object):
...
class TestTableOrientReader(CloudArrayTest, object):
