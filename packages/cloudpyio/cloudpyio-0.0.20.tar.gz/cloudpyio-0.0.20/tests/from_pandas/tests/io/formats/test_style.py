...
from pandas_cloud.io.formats.style import Styler, _get_level_lengths  # noqa


class TestStyler(CloudArrayTest, object):
...
# rewrite: omit @td...
class TestStylerMatplotlibDep(CloudArrayTest, object):
