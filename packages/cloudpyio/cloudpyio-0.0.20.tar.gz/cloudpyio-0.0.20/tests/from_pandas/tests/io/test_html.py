...
from pandas_cloud import (DataFrame, MultiIndex, read_csv, Timestamp, Index,
                    date_range, Series)
from pandas_cloud.compat import (map, zip, StringIO, BytesIO,
                           is_platform_windows, PY3, reload)
from pandas_cloud.errors import ParserError
from pandas_cloud.io.common import URLError, file_path_to_url
import pandas_cloud.io.html
from pandas_cloud.io.html import read_html

import pandas_cloud.util.testing as tm
# rewrite: omit test decoratores (td) import
from pandas_cloud.util.testing import makeCustomDataframe as mkdf, network
...
class TestReadHtml(CloudArrayTest, object):
    ...
    def test_banklist_header(self, datapath):
        from pandas_cloud.io.html import _remove_whitespace
