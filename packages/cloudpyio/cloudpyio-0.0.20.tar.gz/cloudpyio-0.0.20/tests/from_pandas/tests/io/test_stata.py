...
from pandas_cloud.compat import iterkeys
from pandas_cloud.core.dtypes.common import is_categorical_dtype
from pandas_cloud.core.frame import DataFrame, Series
from pandas_cloud.io.parsers import read_csv
from pandas_cloud.io.stata import (InvalidColumnName, PossiblePrecisionLoss,
...
class TestStata(CloudArrayTest, object):
