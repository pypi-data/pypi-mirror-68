...
from pandas_cloud import Index
from pandas_cloud.compat import is_platform_little_endian, PY3
import pandas_cloud
import pandas_cloud.util.testing as tm
# rewrite: omit test decoratores (td) import
from pandas_cloud.tseries.offsets import Day, MonthEnd
import shutil
...
class TestCompression(CloudArrayTest, object):
...
class TestProtocol(CloudArrayTest, object):
