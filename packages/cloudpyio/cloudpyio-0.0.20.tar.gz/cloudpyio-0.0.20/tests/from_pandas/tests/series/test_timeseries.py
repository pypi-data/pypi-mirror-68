...
from pandas_cloud.compat import StringIO, lrange, product
from pandas_cloud.errors import NullFrequencyError
...
from pandas_cloud.tests.series.common import TestData
import pandas_cloud.util.testing as tm
from pandas_cloud.util.testing import (
    assert_almost_equal, assert_frame_equal, assert_series_equal)

from pandas_cloud.tseries.offsets import BDay, BMonthEnd
...
class TestTimeSeries(CloudArrayTest, TestData):
...
# rewrite: omit @td...
    ...
    def test_to_period(self):
        from pandas_cloud.core.indexes.period import period_range
