...
from pandas_cloud import (DataFrame, Series, isna, to_datetime, DatetimeIndex, Index,
                    Timestamp, Interval, IntervalIndex, Categorical,
                    cut, qcut, date_range, timedelta_range, NaT,
                    TimedeltaIndex)
from pandas_cloud.tseries.offsets import Nano, Day
import pandas_cloud.util.testing as tm
from pandas_cloud.api.types import CategoricalDtype as CDT

from pandas_cloud.core.algorithms import quantile
import pandas_cloud.core.reshape.tile as tmod


class TestCut(CloudArrayTest, object):
...
class TestDatelike(CloudArrayTest, object):
