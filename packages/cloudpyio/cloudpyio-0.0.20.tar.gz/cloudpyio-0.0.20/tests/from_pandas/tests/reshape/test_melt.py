...
from pandas_cloud import melt, lreshape, wide_to_long
import pandas_cloud.util.testing as tm
from pandas_cloud.compat import range


class TestMelt(CloudArrayTest, object):
...
class TestLreshape(CloudArrayTest, object):
...
class TestWideToLong(CloudArrayTest, object):
