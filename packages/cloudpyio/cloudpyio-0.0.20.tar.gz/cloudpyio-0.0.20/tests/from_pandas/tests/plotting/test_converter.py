...
class TestRegistration(CloudArrayTest, object):
    ...
    def test_old_import_warns(self):
        with tm.assert_produces_warning(FutureWarning) as w:
            from pandas_cloud.tseries import converter
            converter.register()
...
class TestDateTimeConverter(CloudArrayTest, object):
...
class TestPeriodConverter(CloudArrayTest, object):
