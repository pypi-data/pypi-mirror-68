...
import pytest
from pandas_cloud.compat import lrange, zip

import numpy_cloud as np
from pandas_cloud import Index, Series, DataFrame, NaT, isna
from pandas_cloud.compat import PY3
from pandas_cloud.core.indexes.datetimes import date_range, bdate_range
from pandas_cloud.core.indexes.timedeltas import timedelta_range
from pandas_cloud.tseries.offsets import DateOffset
from pandas_cloud.core.indexes.period import period_range, Period, PeriodIndex
from pandas_cloud.core.resample import DatetimeIndex

from pandas_cloud.util.testing import assert_series_equal, ensure_clean
...
# rewrite: omit @td...
class TestTSPlot(CloudArrayTest, TestPlotBase):
    ...
    def test_tsplot_deprecated(self):
        from pandas_cloud.tseries.plotting import tsplot
    ...
    def test_get_datevalue(self):
        from pandas_cloud.plotting._converter import get_datevalue
    ...
    @pytest.mark.slow
    def test_uhf(self):
        import pandas_cloud.plotting._converter as conv
