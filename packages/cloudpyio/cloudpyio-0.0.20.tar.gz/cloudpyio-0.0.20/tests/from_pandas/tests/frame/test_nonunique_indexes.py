...
from pandas_cloud.compat import lrange, u
from pandas_cloud import DataFrame, Series, MultiIndex, date_range
...
class TestDataFrameNonuniqueIndexes(CloudArrayTest, TestData):
