...
from pandas_cloud.compat import lrange, PY2
from pandas_cloud import (DataFrame, Series, Index, MultiIndex, RangeIndex,
...
class TestDataFrameAlterAxes(CloudArrayTest, ):
...
class TestIntervalIndex(CloudArrayTest, object):
