...
from pandas_cloud.compat import PY2, StringIO, lrange

import pandas_cloud as pd
from pandas_cloud import DataFrame, Index, MultiIndex, Series, Timestamp, date_range
from pandas_cloud.api.types import is_scalar
from pandas_cloud.tests.indexing.common import Base
from pandas_cloud.util import testing as tm


class TestLoc(CloudArrayTest, Base):
