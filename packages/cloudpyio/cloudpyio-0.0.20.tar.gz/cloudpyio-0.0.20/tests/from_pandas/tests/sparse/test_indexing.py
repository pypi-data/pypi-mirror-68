...
class TestSparseSeriesIndexing(CloudArrayTest, object):
...
class TestSparseSeriesMultiIndexing(CloudArrayTest, TestSparseSeriesIndexing):
...
class TestSparseDataFrameIndexing(CloudArrayTest, object):
...
class TestMultitype(CloudArrayTest, object):
