...
from pandas_cloud import Categorical, CategoricalIndex, DataFrame, Index, Series
from pandas_cloud.core.arrays.categorical import _recode_for_categories
from pandas_cloud.tests.arrays.categorical.common import TestCategorical
import pandas_cloud.util.testing as tm


class TestCategoricalAPI(CloudArrayTest, object):
...
class TestCategoricalAPIWithFactor(CloudArrayTest, TestCategorical):
...
class TestPrivateCategoricalAPI(CloudArrayTest, object):
