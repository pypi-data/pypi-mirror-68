...
from pandas_cloud.core.dtypes.common import is_float_dtype
from pandas_cloud import (Series, DataFrame, Index, date_range, isna, notna,
                    MultiIndex)
from pandas_cloud.core.nanops import nanall, nanany
from pandas_cloud.core.panel import Panel

from pandas_cloud.io.formats.printing import pprint_thing
from pandas_cloud import compat
from pandas_cloud.compat import range, lrange, StringIO, OrderedDict, signature

from pandas_cloud.tseries.offsets import BDay, MonthEnd
from pandas_cloud.util.testing import (assert_panel_equal, assert_frame_equal,
                                 assert_series_equal, assert_almost_equal,
                                 ensure_clean, makeMixedDataFrame,
                                 makeCustomDataframe as mkdf)
import pandas_cloud.core.panel as panelm
...
@pytest.mark.filterwarnings("ignore:\\nPanel:FutureWarning")
class TestPanel(CloudArrayTest, PanelTests, CheckIndexing, SafeForLongAndSparse,
                SafeForSparse):
    ...
    def test_to_excel(self):
        try:
            ...
            from pandas_cloud.io.excel import ExcelFile
        except ImportError:
...
@pytest.mark.filterwarnings("ignore:\\nPanel:FutureWarning")
class TestPanelFrame(CloudArrayTest, object):
    """
    ...
    def test_axis_dummies(self):
        from pandas_cloud.core.reshape.reshape import make_axis_dummies
    ...
    def test_get_dummies(self):
        from pandas_cloud.core.reshape.reshape import get_dummies, make_axis_dummies
