...
class TestSetitemCoercion(CloudArrayTest, CoercionBase):
...
class TestInsertIndexCoercion(CloudArrayTest, CoercionBase):
...
class TestWhereCoercion(CloudArrayTest, CoercionBase):
...
class TestFillnaSeriesCoercion(CloudArrayTest, CoercionBase):
...
class TestReplaceSeriesCoercion(CloudArrayTest, CoercionBase):
