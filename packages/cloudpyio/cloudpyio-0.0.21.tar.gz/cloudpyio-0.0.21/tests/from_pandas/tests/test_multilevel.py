...
from pandas_cloud.core.index import Index, MultiIndex
from pandas_cloud import (Panel, DataFrame, Series, isna, Timestamp)

from pandas_cloud.core.dtypes.common import is_float_dtype, is_integer_dtype
import pandas_cloud.util.testing as tm
from pandas_cloud.compat import (range, lrange, StringIO, lzip, u, product as
                           cart_product, zip)
...
class TestMultiLevel(CloudArrayTest, Base):
...
class TestSorted(CloudArrayTest, Base):
