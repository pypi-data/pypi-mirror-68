...
import pandas_cloud._libs.parsers as parser
from pandas_cloud._libs.parsers import TextReader
import pandas_cloud.compat as compat
from pandas_cloud.compat import BytesIO, StringIO, map
...
from pandas_cloud.io.parsers import TextFileReader, read_csv


class TestTextReader(CloudArrayTest, object):
