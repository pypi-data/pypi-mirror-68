...
from pandas_cloud import read_clipboard
from pandas_cloud import get_option
from pandas_cloud.compat import PY2
from pandas_cloud.util import testing as tm
from pandas_cloud.util.testing import makeCustomDataframe as mkdf
from pandas_cloud.io.clipboard.exceptions import PyperclipException
...
def test_mock_clipboard(mock_clipboard):
    import pandas_cloud.io.clipboard
...
class TestClipboard(CloudArrayTest, object):
