...
from pandas_cloud import DatetimeIndex, Index, Timestamp, date_range, notna
import pandas_cloud.util.testing as tm

from pandas_cloud.tseries.offsets import BDay, CDay

START, END = datetime(2009, 1, 1), datetime(2010, 1, 1)


class TestGetItem(CloudArrayTest, object):
...
class TestWhere(CloudArrayTest, object):
...
class TestTake(CloudArrayTest, object):
    def test_take(self):
        # GH#10295
        idx1 = pd.date_range('2011-01-01', '2011-01-31', freq='D', name='idx')
        idx2 = pd.date_range('2011-01-01', '2011-01-31', freq='D',
