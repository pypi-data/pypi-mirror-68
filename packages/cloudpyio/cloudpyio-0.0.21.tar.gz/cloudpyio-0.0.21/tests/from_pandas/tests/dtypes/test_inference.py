...
from pandas_cloud._libs import lib, iNaT, missing as libmissing
from pandas_cloud import (Series, Index, DataFrame, Timedelta,
                    DatetimeIndex, TimedeltaIndex, Timestamp,
                    Panel, Period, Categorical, isna, Interval,
                    DateOffset)
from pandas_cloud import compat
from pandas_cloud.compat import u, PY2, StringIO, lrange
from pandas_cloud.core.dtypes import inference
...
class TestInference(CloudArrayTest, object):
...
class TestTypeInference(CloudArrayTest, object):
    ...
    def test_categorical(self):
        ...
        # GH 8974
        from pandas_cloud import Categorical, Series
...
class TestNumberScalar(CloudArrayTest, object):
...
class TestIsScalar(CloudArrayTest, object):
