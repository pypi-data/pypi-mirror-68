...
from numpy_cloud.lib._iotools import (
...
class TestLineSplitter(CloudArrayTest):
...
class TestNameValidator(CloudArrayTest):
...
class TestStringConverter(CloudArrayTest):
    ...
    def test_upgrade(self):
        ...
        import numpy_cloud.core.numeric as nx
...
class TestMiscFunctions(CloudArrayTest):
