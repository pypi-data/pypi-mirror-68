...
class TestNanFunctions_MinMax(CloudArrayTest):
...
class TestNanFunctions_ArgminArgmax(CloudArrayTest):
...
class TestNanFunctions_IntTypes(CloudArrayTest):
...
class TestNanFunctions_SumProd(CloudArrayTest):
...
class TestNanFunctions_CumSumProd(CloudArrayTest):
...
class TestNanFunctions_MeanVarStd(CloudArrayTest):
...
class TestNanFunctions_Median(CloudArrayTest):
...
class TestNanFunctions_Percentile(CloudArrayTest):
...
class TestNanFunctions_Quantile(CloudArrayTest):
