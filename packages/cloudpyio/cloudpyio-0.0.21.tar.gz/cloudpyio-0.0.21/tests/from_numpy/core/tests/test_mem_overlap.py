...
from numpy_cloud.core._multiarray_tests import solve_diophantine, internal_overlap
from numpy_cloud.core import _umath_tests
from numpy_cloud.lib.stride_tricks import as_strided
...
def view_element_first_byte(x):
    ...
    from numpy_cloud.lib.stride_tricks import DummyArray
