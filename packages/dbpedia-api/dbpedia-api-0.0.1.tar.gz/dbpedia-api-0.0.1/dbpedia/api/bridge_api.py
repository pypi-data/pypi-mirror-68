...
class BridgeApi(object):
    ...
    def bridges_get(self, **kwargs):  # noqa: E501
        """List all instances of Bridge  # noqa: E501
    ...
    def bridges_get_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(list[Bridge], status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and 'per_page' in local_var_params and local_var_params['per_page'] > 200:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `per_page` when calling `bridges_get`, must be a value less than or equal to `200`")  # noqa: E501
        if self.api_client.client_side_validation and 'per_page' in local_var_params and local_var_params['per_page'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `per_page` when calling `bridges_get`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def bridges_id_get(self, id, **kwargs):  # noqa: E501
        """Get a single Bridge by its id  # noqa: E501

        Gets the details of a given Bridge (more information in http://dbpedia.org/ontology/Bridge)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.bridges_id_get(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str id: The ID of the Bridge to be retrieved (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.bridges_id_get_with_http_info(id, **kwargs)  # noqa: E501

    def bridges_id_get_with_http_info(self, id, **kwargs):  # noqa: E501
        """Get a single Bridge by its id  # noqa: E501

        Gets the details of a given Bridge (more information in http://dbpedia.org/ontology/Bridge)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.bridges_id_get_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(Bridge, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `id` when calling `bridges_id_get`")  # noqa: E501
