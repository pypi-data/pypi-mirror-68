...
class Type(object):
    ...
    @property
    def label(self):
        """Gets the label of this Type.  # noqa: E501

        short description of the resource  # noqa: E501

        :return: The label of this Type.  # noqa: E501
        :rtype: list[str]
        """
        return self._label
    ...
    def label(self, label):
        ...
        :param label: The label of this Type.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def type(self):
        """Gets the type of this Type.  # noqa: E501
