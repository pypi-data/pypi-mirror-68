...
class Beer(object):
    ...
    def __init__(self, approximate_calories=None, ingredient=None, taste=None, description=None, type_of_yeast=None, discontinued=None, label=None, type=None, percentage_alcohol=None, creator_of_dish=None, serving_temperature=None, introduced=None, type_of_storage=None, id=None, type_of_grain=None, local_vars_configuration=None):  # noqa: E501
        """Beer - a model defined in OpenAPI"""  # noqa: E501
    ...
    def approximate_calories(self):
        """Gets the approximate_calories of this Beer.  # noqa: E501

        Approximate calories per serving.  # noqa: E501

        :return: The approximate_calories of this Beer.  # noqa: E501
        :rtype: list[float]
        """
    ...
    def approximate_calories(self, approximate_calories):
        """Sets the approximate_calories of this Beer.

        Approximate calories per serving.  # noqa: E501

        :param approximate_calories: The approximate_calories of this Beer.  # noqa: E501
        :type: list[float]
        """
    ...
    @property
    def ingredient(self):
        """Gets the ingredient of this Beer.  # noqa: E501
        ...
        :return: The ingredient of this Beer.  # noqa: E501
        :rtype: list[object]
        """
    ...
    def ingredient(self, ingredient):
        """Sets the ingredient of this Beer.

        An ingredient is a substance that forms part of a mixture (in a general sense). Here it is used in the context of recipes that specify which ingredients are used to prepare a specific dish or drink.  # noqa: E501

        :param ingredient: The ingredient of this Beer.  # noqa: E501
        :type: list[object]
        """
    ...
    @property
    def taste(self):
        """Gets the taste of this Beer.  # noqa: E501

        Description not available  # noqa: E501

        :return: The taste of this Beer.  # noqa: E501
        :rtype: list[str]
        """
        return self._taste
    ...
    def taste(self, taste):
        """Sets the taste of this Beer.

        Description not available  # noqa: E501

        :param taste: The taste of this Beer.  # noqa: E501
        :type: list[str]
        """
    ...
    def description(self):
        """Gets the description of this Beer.  # noqa: E501

        small description  # noqa: E501

        :return: The description of this Beer.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def description(self, description):
        """Sets the description of this Beer.

        small description  # noqa: E501

        :param description: The description of this Beer.  # noqa: E501
        :type: list[str]
        """
    ...
    def type_of_yeast(self):
        """Gets the type_of_yeast of this Beer.  # noqa: E501

        Description not available  # noqa: E501

        :return: The type_of_yeast of this Beer.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def type_of_yeast(self, type_of_yeast):
        """Sets the type_of_yeast of this Beer.

        Description not available  # noqa: E501

        :param type_of_yeast: The type_of_yeast of this Beer.  # noqa: E501
        :type: list[str]
        """
    ...
    def discontinued(self):
        """Gets the discontinued of this Beer.  # noqa: E501

        Description not available  # noqa: E501

        :return: The discontinued of this Beer.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def discontinued(self, discontinued):
        """Sets the discontinued of this Beer.

        Description not available  # noqa: E501

        :param discontinued: The discontinued of this Beer.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def label(self):
        """Gets the label of this Beer.  # noqa: E501

        short description of the resource  # noqa: E501

        :return: The label of this Beer.  # noqa: E501
        :rtype: list[str]
        """
        return self._label
    ...
    def label(self, label):
        """Sets the label of this Beer.

        short description of the resource  # noqa: E501

        :param label: The label of this Beer.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def type(self):
        """Gets the type of this Beer.  # noqa: E501

        type of the resource  # noqa: E501

        :return: The type of this Beer.  # noqa: E501
        :rtype: list[str]
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this Beer.

        type of the resource  # noqa: E501

        :param type: The type of this Beer.  # noqa: E501
        :type: list[str]
        """
    ...
    def percentage_alcohol(self):
        """Gets the percentage_alcohol of this Beer.  # noqa: E501

        percentage of alcohol present in a beverage  # noqa: E501

        :return: The percentage_alcohol of this Beer.  # noqa: E501
        :rtype: list[int]
        """
    ...
    def percentage_alcohol(self, percentage_alcohol):
        """Sets the percentage_alcohol of this Beer.

        percentage of alcohol present in a beverage  # noqa: E501

        :param percentage_alcohol: The percentage_alcohol of this Beer.  # noqa: E501
        :type: list[int]
        """
    ...
    def creator_of_dish(self, creator_of_dish):
        """Sets the creator_of_dish of this Beer.

        The person that creates (invents) the food (eg. Caesar Cardini is the creator of the Caesar salad).  # noqa: E501

        :param creator_of_dish: The creator_of_dish of this Beer.  # noqa: E501
        :type: list[object]
        """
    ...
    def serving_temperature(self):
        """Gets the serving_temperature of this Beer.  # noqa: E501

        Serving temperature for the food (e.g.: hot, cold, warm or room temperature).  # noqa: E501

        :return: The serving_temperature of this Beer.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def serving_temperature(self, serving_temperature):
        """Sets the serving_temperature of this Beer.

        Serving temperature for the food (e.g.: hot, cold, warm or room temperature).  # noqa: E501

        :param serving_temperature: The serving_temperature of this Beer.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def introduced(self):
        """Gets the introduced of this Beer.  # noqa: E501

        Description not available  # noqa: E501

        :return: The introduced of this Beer.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def introduced(self, introduced):
        """Sets the introduced of this Beer.

        Description not available  # noqa: E501

        :param introduced: The introduced of this Beer.  # noqa: E501
        :type: list[str]
        """
    ...
    def type_of_storage(self):
        """Gets the type_of_storage of this Beer.  # noqa: E501

        Description not available  # noqa: E501

        :return: The type_of_storage of this Beer.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def type_of_storage(self, type_of_storage):
        """Sets the type_of_storage of this Beer.

        Description not available  # noqa: E501

        :param type_of_storage: The type_of_storage of this Beer.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def id(self):
        """Gets the id of this Beer.  # noqa: E501

        identifier  # noqa: E501

        :return: The id of this Beer.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    def type_of_grain(self):
        """Gets the type_of_grain of this Beer.  # noqa: E501

        Description not available  # noqa: E501

        :return: The type_of_grain of this Beer.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def type_of_grain(self, type_of_grain):
        """Sets the type_of_grain of this Beer.

        Description not available  # noqa: E501

        :param type_of_grain: The type_of_grain of this Beer.  # noqa: E501
        :type: list[str]
        """
