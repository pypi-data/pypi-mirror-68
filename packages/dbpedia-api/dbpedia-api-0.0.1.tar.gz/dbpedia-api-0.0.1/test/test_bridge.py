...
import dbpedia
from dbpedia.models.bridge import Bridge  # noqa: E501
...
class TestBridge(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = dbpedia.models.bridge.Bridge()  # noqa: E501
        if include_optional :
            return Bridge(
                city_type = [
                    '0'
                ...
                united_states_national_bridge_id = [
                    '0'
                    ], 
                political_majority = [
                    None
