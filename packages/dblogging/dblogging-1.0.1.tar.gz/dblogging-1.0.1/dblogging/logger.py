...
class Logger:
    def __init__(self):
        ...
        self.jsonpickle.set_encoder_options('json', sort_keys=True, indent=4)
    ...
    def set_rule(self, mode: str = 'current', log_tag: LogTag = None, min_tag_value: Union[LogTag, int] = None,
        ...
        Args:
            ...
            log_tag: The log tag that logs the message concerning the rule change. Defaults to the default tag.
                    ...
                    if mask_input_regexes:
                        ...
                        for key in params.keys():
                            if re.match(pattern=in_regexes, string=key, flags=re.IGNORECASE):
                                params[key] = '********'
                    before_string += '\nArguments:\n' + self.jsonpickle.dumps(params, max_depth=3, unpicklable=False)
                ...
                try:
                    ...
                    if result is not None:
                        if mask_output:
                            ...
                            ret_vals = self.jsonpickle.dumps(result, max_depth=3, unpicklable=False)
