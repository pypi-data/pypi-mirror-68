class CurrentUsedPlatformInfo:
    ...
    def is_bixby_v1(self) -> bool:
        return self._is_bixby_v1

    @is_bixby_v1.setter
    def is_bixby_v1(self, is_bixby_v1: bool) -> None:
        if not isinstance(is_bixby_v1, bool):
            raise Exception(f"is_dialogflow_v1 was type {type(_is_bixby_v1)} which is not valid value for his parameter.")
        self._is_bixby_v1 = is_bixby_v1
