...
class FP16Optimizer:
    ...
    def initialize_flat_fp32_weight(self):
        ...
        Returns:
            (torch.Tensor, torch.Tensor): The Parameters in fp16 and fp32
        """
    ...
    def step(self, closure=None, multiplier=1, denom=None):
        ...
        norm_1 = clip_grad_norm_(self.fp16_model.parameters(), self.grad_clip)
        norm = clip_grad_norm_([self.fp32_params], self.grad_clip)
        print("Norm_fp16={}, norm_fp32={}".format(norm_1, norm))
        updated = False
