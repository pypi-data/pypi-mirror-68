...
setup(
    ...
    version = '0.4.4',
    license='EUPL v1.2',
    description = 'Flyr is a thermal data extractor for FLIR image written fully in Python, without depending on ExifTool.',
    long_description=long_description,  # FIXME doesn't work yet
    ...
    download_url = 'https://bitbucket.org/nimmerwoner/flyr/downloads/flyr-0.4.4.tar.gz',
