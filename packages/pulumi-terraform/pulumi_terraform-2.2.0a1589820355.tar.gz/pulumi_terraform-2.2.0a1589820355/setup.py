...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'terraform', 'v2.2.0-alpha.1589820355+gf2baf62'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource terraform v2.2.0-alpha.1589820355+gf2baf62`
                """)
