...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'terraform', 'v2.1.0-alpha.1589538199+g753b5ee'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource terraform v2.1.0-alpha.1589538199+g753b5ee`
                """)
