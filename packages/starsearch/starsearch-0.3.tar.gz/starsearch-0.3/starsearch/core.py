...
class EsoClass(QueryWithLogin):
    ...
    def list_instruments(self, cache=False):
        ...
        if self._instrument_list is None:
            ...
            for element in root.select("div[id=col3] a[href]"):
                ...
                if u"http://archive.eso.org/wdb/wdb/cas" in href:
    ...
    def list_surveys(self, cache=False):
        ...
        if self._survey_list is None:
            survey_list_response = self._request(
                "GET", "http://archive.eso.org/wdb/wdb/adp/phase3_spectral/form",
                cache=cache)
    ...
    def verify_data_exists(self, dataset):
        ...
        otherwise
        """
        url = 'http://archive.eso.org/wdb/wdb/cas/eso_archive_main/query'
    ...
    def query_apex_quicklooks(self, project_id=None, help=False,
        ...
        """
        apex_query_url = 'http://archive.eso.org/wdb/wdb/cas/apex_product/form'
        table = None
        if open_form:
