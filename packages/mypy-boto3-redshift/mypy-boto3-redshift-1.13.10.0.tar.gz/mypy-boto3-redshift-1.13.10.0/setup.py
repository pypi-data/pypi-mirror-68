...
class PostInstallCommand(install):
    def run(self):
        install.run(self)
        print("mypy_boto3: Running post-install script for mypy-boto3-redshift")
        try:
            from mypy_boto3.main import add_package_to_index

            add_package_to_index("redshift")
            print("mypy_boto3: Service redshift added to index")
        except Exception as e:
            print("mypy_boto3: Package index update failed for mypy-boto3-redshift:", e)
...
setup(
    ...
    description="Type annotations for boto3.Redshift 1.13.10 service, generated by mypy-boto3-buider 1.0.9",
    classifiers=[
