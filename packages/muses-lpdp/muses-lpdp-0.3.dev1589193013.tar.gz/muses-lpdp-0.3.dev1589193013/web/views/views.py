...
from web.forms import LoginForm, RegisterForm, ContactForm, ControlCenterChangeEmailForm, \
    ...
    LogoutForm, TagForm, LicenseForm, PreferencesGeneralForm, CheckEmailForm
...
class PersonalPostAlertsListView(PersonalListView):
    section_name = _("My Post Alerts")
...
class PersonalAdmonitionsListView(PersonalListView):
    section_name = _("My Admonitions")
    template_name = "web/muses_personal_list_admonitions.html"
    model = Admonition
    paginate_by = 10


class PersonalMessagesListView(PersonalListView):
...
class HealthcheckView(MultiFormsView):
    section_name = _("Healthcheck Center")
    ...
    template_name = "web/healthcheck.html"
    form_classes = {
        'form_checkmail': CheckEmailForm,
    }
