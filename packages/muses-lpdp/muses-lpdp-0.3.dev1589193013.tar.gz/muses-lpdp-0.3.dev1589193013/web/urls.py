...
urlpatterns = [
    ...
    # Page utilisée pour permettre certains diagnostics en vue de résoudre certains soucis
    path('healthcheck/',
         views.HealthcheckView.as_view(template_name="web/healthcheck.html", section_name="Healthcheck"),
         name='muses_healthcheck'),
    ...
    ### Urls réservées pour les administrateurs
    path('adm/', include([
        path('',
