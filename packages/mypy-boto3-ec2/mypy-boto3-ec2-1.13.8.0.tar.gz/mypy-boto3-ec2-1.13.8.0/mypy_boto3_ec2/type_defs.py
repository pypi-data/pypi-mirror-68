...
Usage::
    ...
    from mypy_boto3.ec2.type_defs import AcceptReservedInstancesExchangeQuoteResultTypeDef
...
CreateLaunchTemplateVersionResultTypeDef = TypedDict(
    "CreateLaunchTemplateVersionResultTypeDef",
    {"LaunchTemplateVersion": LaunchTemplateVersionTypeDef, "Warning": ValidationWarningTypeDef},
    total=False,
)
...
DeleteClientVpnEndpointResultTypeDef = TypedDict(
    "DeleteClientVpnEndpointResultTypeDef", {"Status": ClientVpnEndpointStatusTypeDef}, total=False
)
...
DeleteVpcEndpointsResultTypeDef = TypedDict(
    "DeleteVpcEndpointsResultTypeDef", {"Unsuccessful": List[UnsuccessfulItemTypeDef]}, total=False
)
...
GpuInfoTypeDef = TypedDict(
    "GpuInfoTypeDef", {"Gpus": List[GpuDeviceInfoTypeDef], "TotalGpuMemoryInMiB": int}, total=False
)
...
DescribeLocalGatewayVirtualInterfacesResultTypeDef = TypedDict(
    "DescribeLocalGatewayVirtualInterfacesResultTypeDef",
    {"LocalGatewayVirtualInterfaces": List[LocalGatewayVirtualInterfaceTypeDef], "NextToken": str},
    total=False,
)
...
ImportSnapshotResultTypeDef = TypedDict(
    "ImportSnapshotResultTypeDef",
    {"Description": str, "ImportTaskId": str, "SnapshotTaskDetail": SnapshotTaskDetailTypeDef},
    total=False,
)
...
ModifyInstanceEventStartTimeResultTypeDef = TypedDict(
    "ModifyInstanceEventStartTimeResultTypeDef", {"Event": InstanceStatusEventTypeDef}, total=False
)
...
ModifyVpnTunnelCertificateResultTypeDef = TypedDict(
    "ModifyVpnTunnelCertificateResultTypeDef", {"VpnConnection": VpnConnectionTypeDef}, total=False
)
