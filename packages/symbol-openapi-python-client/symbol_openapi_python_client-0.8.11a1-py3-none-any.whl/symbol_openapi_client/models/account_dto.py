...
class AccountDTO(object):
    ...
    openapi_types = {
        ...
        'supplemental_account_keys': 'list[AccountKeyDTO]',
    ...
    attribute_map = {
        ...
        'supplemental_account_keys': 'supplementalAccountKeys',
    ...
    def __init__(self, address=None, address_height=None, public_key=None, public_key_height=None, account_type=None, supplemental_account_keys=None, activity_buckets=None, mosaics=None, importance=None, importance_height=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._supplemental_account_keys = None
        ...
        self.supplemental_account_keys = supplemental_account_keys
    ...
    @property
    def supplemental_account_keys(self):
        """Gets the supplemental_account_keys of this AccountDTO.  # noqa: E501


        :return: The supplemental_account_keys of this AccountDTO.  # noqa: E501
        :rtype: list[AccountKeyDTO]
        """
        return self._supplemental_account_keys

    @supplemental_account_keys.setter
    def supplemental_account_keys(self, supplemental_account_keys):
        """Sets the supplemental_account_keys of this AccountDTO.


        :param supplemental_account_keys: The supplemental_account_keys of this AccountDTO.  # noqa: E501
        :type: list[AccountKeyDTO]
        """
        if self.local_vars_configuration.client_side_validation and supplemental_account_keys is None:  # noqa: E501
            raise ValueError("Invalid value for `supplemental_account_keys`, must not be `None`")  # noqa: E501

        self._supplemental_account_keys = supplemental_account_keys
