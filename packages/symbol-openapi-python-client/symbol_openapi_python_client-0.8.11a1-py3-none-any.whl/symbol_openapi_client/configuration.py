...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of symbol_openapi_client.signing.HttpSigningConfiguration
    ...
    You can programmatically set the cookie:
      conf = symbol_openapi_client.Configuration(
    ...
    Note you can use the constants defined in the symbol_openapi_client.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = symbol_openapi_client.Configuration(
        signing_info = symbol_openapi_client.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
    ...
    def to_debug_report(self):
        ...
        return "Python SDK Debug Report:\n"\
               ...
               "Version of the API: 0.8.10\n"\
               "SDK Package Version: 0.8.11a1".\
