...
class BlockRoutesApi(object):
    ...
    def get_block_transactions_with_http_info(self, height, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('height' not in local_var_params or  # noqa: E501
                                                        local_var_params['height'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `height` when calling `get_block_transactions`")  # noqa: E501

        if self.api_client.client_side_validation and 'page_size' in local_var_params and local_var_params['page_size'] > 100:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `page_size` when calling `get_block_transactions`, must be a value less than or equal to `100`")  # noqa: E501
        if self.api_client.client_side_validation and 'page_size' in local_var_params and local_var_params['page_size'] < 10:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `page_size` when calling `get_block_transactions`, must be a value greater than or equal to `10`")  # noqa: E501
        collection_formats = {}
    ...
    def get_blocks_by_height_with_limit(self, height, limit, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str height: Block height.  (required)
        :param int limit: Number of elements to be returned. The limit should be greater than or equal to \"db.pageSizeMin\" and not higher than \"db.pageSizeMax\". The settings are adjustable via the configuration file (rest/resources/rest.json) per REST instance.  (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def get_blocks_by_height_with_limit_with_http_info(self, height, limit, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(list[BlockInfoDTO], status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('height' not in local_var_params or  # noqa: E501
                                                        local_var_params['height'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `height` when calling `get_blocks_by_height_with_limit`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('limit' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `limit` when calling `get_blocks_by_height_with_limit`")  # noqa: E501
