...
class TestMosaicRoutesApi(unittest.TestCase):
    ...
    def test_get_mosaics_from_account(self):
        """Test case for get_mosaics_from_account

        Get mosaics created by an account  # noqa: E501
        """
        pass

    def test_get_mosaics_from_accounts(self):
        """Test case for get_mosaics_from_accounts
