...
class AmazonCaptcha(object):
    ...
    monoweight = 1 # Stands to define the range of color codes while monochroming. Please, do not change.
    maximum_letter_length = 33
    minimum_letter_length = 14

    def __init__(self, img, onreturn = 'string'):
        """
    ...
    @classmethod
    def from_webdriver(cls, driver, onreturn = 'string'):
        """
        ...
        return cls(BytesIO(img_bytes_array), onreturn = onreturn)
