...
class Bijector(tf.Module):
  ...
  **WARNING** Handling of non-injective transforms is subject to change.
  ...
  def __call__(self, value, name=None, **kwargs):
    ...
    from tensorflow_probability.python.bijectors._jax import chain  # pylint: disable=g-import-not-at-top
    from tensorflow_probability.python.distributions._jax import distribution  # pylint: disable=g-import-not-at-top
    from tensorflow_probability.python.distributions._jax import transformed_distribution  # pylint: disable=g-import-not-at-top
