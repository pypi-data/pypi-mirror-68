...
from tensorflow_probability.python.distributions._numpy import binomial
from tensorflow_probability.python.distributions._numpy import categorical as categorical_lib
