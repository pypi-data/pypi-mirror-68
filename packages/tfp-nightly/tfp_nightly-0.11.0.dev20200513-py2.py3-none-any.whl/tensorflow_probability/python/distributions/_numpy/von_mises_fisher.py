...
from tensorflow_probability.python.bijectors._numpy import square as square_bijector
from tensorflow_probability.python.distributions._numpy import beta as beta_lib
