...
from tensorflow_probability.python.distributions._jax import binomial
from tensorflow_probability.python.distributions._jax import categorical as categorical_lib
