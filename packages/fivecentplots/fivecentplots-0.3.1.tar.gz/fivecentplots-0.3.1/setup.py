...
setup(
    ...
    description='Wrapper for python plotting across packages with easier syntax',
    long_description='Wrapper for python plotting across packages with easier syntax',

    # The project's main homepage.
    url='https://github.com/endangeredoxen/fivecentplots',
    download_url='https://github.com/endangeredoxen/fivecentplots/archive/v0.3.1.tar.gz',
