...
class CfnSubscription(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-sns.CfnSubscription"):
    ...
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnSubscription":
...
class CfnTopic(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-sns.CfnTopic"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnTopic":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    class SubscriptionProperty():
        def __init__(self, *, endpoint: str, protocol: str) -> None:
            """
...
class CfnTopicPolicy(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-sns.CfnTopicPolicy"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnTopicPolicy":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
class CfnTopicPolicyProps():
    def __init__(self, *, policy_document: typing.Any, topics: typing.List[str]) -> None:
...
class StringConditions():
    def __init__(self, *, blacklist: typing.Optional[typing.List[str]]=None, match_prefixes: typing.Optional[typing.List[str]]=None, whitelist: typing.Optional[typing.List[str]]=None) -> None:
...
class SubscriptionOptions():
    def __init__(self, *, endpoint: str, protocol: "SubscriptionProtocol", filter_policy: typing.Optional[typing.Mapping[str, "SubscriptionFilter"]]=None, raw_message_delivery: typing.Optional[bool]=None, region: typing.Optional[str]=None) -> None:
...
class SubscriptionProps(SubscriptionOptions):
    def __init__(self, *, endpoint: str, protocol: "SubscriptionProtocol", filter_policy: typing.Optional[typing.Mapping[str, "SubscriptionFilter"]]=None, raw_message_delivery: typing.Optional[bool]=None, region: typing.Optional[str]=None, topic: "ITopic") -> None:
...
class TopicProps():
    def __init__(self, *, display_name: typing.Optional[str]=None, master_key: typing.Optional[aws_cdk.aws_kms.IKey]=None, topic_name: typing.Optional[str]=None) -> None:
...
class TopicSubscriptionConfig(SubscriptionOptions):
    def __init__(self, *, endpoint: str, protocol: "SubscriptionProtocol", filter_policy: typing.Optional[typing.Mapping[str, "SubscriptionFilter"]]=None, raw_message_delivery: typing.Optional[bool]=None, region: typing.Optional[str]=None, subscriber_id: str, subscriber_scope: typing.Optional[aws_cdk.core.Construct]=None) -> None:
