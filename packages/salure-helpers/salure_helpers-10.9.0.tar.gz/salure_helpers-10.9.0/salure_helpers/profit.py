...
class UpdateConnector:
    ...
    def update_bank_account(self, data: dict, overload_fields={}):
        ...
        :return: status code for request and optional error message
        """
        allowed_fields = ['bankname', 'country', 'cash_payment', 'salary_bank_account', 'acc_outside_sepa', 'bank_type', 'iban_check', 'sequence_number']
    ...
    def new_employee_with_first_contract(self, data: dict, overload_fields={}):
        ...
        allowed_fields_person = ['initials', 'email_work', 'email_home', 'country_of_birth', 'place_of_birth',
                                 'birth_name_separate', 'name_use']
        ...
        required_fields_address = ['house_number', 'street', 'postal_code', 'city', 'country']
        ...
        allowed_fields = allowed_fields_person + allowed_fields_salary + allowed_fields_schedule
