...
class CfnCluster(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-msk.CfnCluster"):
    ...
    def open_monitoring(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["OpenMonitoringProperty"]]]:
    ...
    def open_monitoring(self, value: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["OpenMonitoringProperty"]]]):
        jsii.set(self, "openMonitoring", value)

    @jsii.data_type(jsii_type="@aws-cdk/aws-msk.CfnCluster.BrokerLogsProperty", jsii_struct_bases=[], name_mapping={'cloud_watch_logs': 'cloudWatchLogs', 'firehose': 'firehose', 's3': 's3'})
    class BrokerLogsProperty():
        def __init__(self, *, cloud_watch_logs: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnCluster.CloudWatchLogsProperty"]]]=None, firehose: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnCluster.FirehoseProperty"]]]=None, s3: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnCluster.S3Property"]]]=None) -> None:
            """
        ...
        @builtins.property
        def cloud_watch_logs(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnCluster.CloudWatchLogsProperty"]]]:
        ...
        @builtins.property
        def firehose(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnCluster.FirehoseProperty"]]]:
        ...
        @builtins.property
        def s3(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnCluster.S3Property"]]]:
        ...
        def __repr__(self) -> str:
            return 'BrokerLogsProperty(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())
    ...
    class ClientAuthenticationProperty():
        def __init__(self, *, tls: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnCluster.TlsProperty"]]]=None) -> None:
            """
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-msk.CfnCluster.CloudWatchLogsProperty", jsii_struct_bases=[], name_mapping={'enabled': 'enabled', 'log_group': 'logGroup'})
    class CloudWatchLogsProperty():
        def __init__(self, *, enabled: typing.Union[bool, aws_cdk.core.IResolvable], log_group: typing.Optional[str]=None) -> None:
            """
        ...
        def __repr__(self) -> str:
            return 'CloudWatchLogsProperty(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())
    ...
    class EncryptionInTransitProperty():
        def __init__(self, *, client_broker: typing.Optional[str]=None, in_cluster: typing.Optional[typing.Union[typing.Optional[bool], typing.Optional[aws_cdk.core.IResolvable]]]=None) -> None:
            """
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-msk.CfnCluster.FirehoseProperty", jsii_struct_bases=[], name_mapping={'enabled': 'enabled', 'delivery_stream': 'deliveryStream'})
    class FirehoseProperty():
        def __init__(self, *, enabled: typing.Union[bool, aws_cdk.core.IResolvable], delivery_stream: typing.Optional[str]=None) -> None:
            """
            ...
            if delivery_stream is not None: self._values["delivery_stream"] = delivery_stream
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-msk.CfnCluster.JmxExporterProperty", jsii_struct_bases=[], name_mapping={'enabled_in_broker': 'enabledInBroker'})
    class JmxExporterProperty():
        def __init__(self, *, enabled_in_broker: typing.Union[bool, aws_cdk.core.IResolvable]) -> None:
            """
        ...
        @builtins.property
        def enabled_in_broker(self) -> typing.Union[bool, aws_cdk.core.IResolvable]:
        ...
        def __repr__(self) -> str:
            return 'JmxExporterProperty(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


    @jsii.data_type(jsii_type="@aws-cdk/aws-msk.CfnCluster.LoggingInfoProperty", jsii_struct_bases=[], name_mapping={'broker_logs': 'brokerLogs'})
    class LoggingInfoProperty():
        def __init__(self, *, broker_logs: typing.Union[aws_cdk.core.IResolvable, "CfnCluster.BrokerLogsProperty"]) -> None:
            """
        ...
        @builtins.property
        def broker_logs(self) -> typing.Union[aws_cdk.core.IResolvable, "CfnCluster.BrokerLogsProperty"]:
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-msk.CfnCluster.NodeExporterProperty", jsii_struct_bases=[], name_mapping={'enabled_in_broker': 'enabledInBroker'})
    class NodeExporterProperty():
        ...
        def __repr__(self) -> str:
            return 'NodeExporterProperty(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


    @jsii.data_type(jsii_type="@aws-cdk/aws-msk.CfnCluster.OpenMonitoringProperty", jsii_struct_bases=[], name_mapping={'prometheus': 'prometheus'})
    class OpenMonitoringProperty():
        def __init__(self, *, prometheus: typing.Union[aws_cdk.core.IResolvable, "CfnCluster.PrometheusProperty"]) -> None:
            """
        ...
        @builtins.property
        def prometheus(self) -> typing.Union[aws_cdk.core.IResolvable, "CfnCluster.PrometheusProperty"]:
        ...
        def __repr__(self) -> str:
            return 'OpenMonitoringProperty(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


    @jsii.data_type(jsii_type="@aws-cdk/aws-msk.CfnCluster.PrometheusProperty", jsii_struct_bases=[], name_mapping={'jmx_exporter': 'jmxExporter', 'node_exporter': 'nodeExporter'})
    class PrometheusProperty():
        def __init__(self, *, jmx_exporter: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnCluster.JmxExporterProperty"]]]=None, node_exporter: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnCluster.NodeExporterProperty"]]]=None) -> None:
            """
            ...
            if jmx_exporter is not None: self._values["jmx_exporter"] = jmx_exporter
            if node_exporter is not None: self._values["node_exporter"] = node_exporter

        @builtins.property
        def jmx_exporter(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnCluster.JmxExporterProperty"]]]:
        ...
        @builtins.property
        def node_exporter(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnCluster.NodeExporterProperty"]]]:
        ...
        def __repr__(self) -> str:
            return 'PrometheusProperty(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


    @jsii.data_type(jsii_type="@aws-cdk/aws-msk.CfnCluster.S3Property", jsii_struct_bases=[], name_mapping={'enabled': 'enabled', 'bucket': 'bucket', 'prefix': 'prefix'})
    class S3Property():
        def __init__(self, *, enabled: typing.Union[bool, aws_cdk.core.IResolvable], bucket: typing.Optional[str]=None, prefix: typing.Optional[str]=None) -> None:
            """
    ...
    class StorageInfoProperty():
        def __init__(self, *, ebs_storage_info: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnCluster.EBSStorageInfoProperty"]]]=None) -> None:
            """
    ...
    class TlsProperty():
        def __init__(self, *, certificate_authority_arn_list: typing.Optional[typing.List[str]]=None) -> None:
            """
...
class CfnClusterProps():
    def __init__(self, *, broker_node_group_info: typing.Union["CfnCluster.BrokerNodeGroupInfoProperty", aws_cdk.core.IResolvable], cluster_name: str, kafka_version: str, number_of_broker_nodes: jsii.Number, client_authentication: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnCluster.ClientAuthenticationProperty"]]]=None, configuration_info: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnCluster.ConfigurationInfoProperty"]]]=None, encryption_info: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnCluster.EncryptionInfoProperty"]]]=None, enhanced_monitoring: typing.Optional[str]=None, logging_info: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnCluster.LoggingInfoProperty"]]]=None, open_monitoring: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnCluster.OpenMonitoringProperty"]]]=None, tags: typing.Any=None) -> None:
        ...
        if open_monitoring is not None: self._values["open_monitoring"] = open_monitoring
    ...
    @builtins.property
    def logging_info(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnCluster.LoggingInfoProperty"]]]:
        """``AWS::MSK::Cluster.LoggingInfo``.
    ...
    @builtins.property
    def open_monitoring(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnCluster.OpenMonitoringProperty"]]]:
        """``AWS::MSK::Cluster.OpenMonitoring``.
