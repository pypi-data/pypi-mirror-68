...
_AGENTINFORMATIONARRAY = _descriptor.Descriptor(
  name='AgentInformationArray',
  full_name='com.rookout.AgentInformationArray',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='agents', full_name='com.rookout.AgentInformationArray.agents', index=0,
...
_AGENTINFORMATIONARRAY.fields_by_name['agents'].message_type = _AGENTINFORMATION
...
DESCRIPTOR.message_types_by_name['AgentInformationArray'] = _AGENTINFORMATIONARRAY
...
AgentInformationArray = _reflection.GeneratedProtocolMessageType('AgentInformationArray', (_message.Message,), dict(
