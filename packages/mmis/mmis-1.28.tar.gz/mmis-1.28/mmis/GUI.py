...
class TabSettings(wx.Panel):
    ...
    def on_logging_timer(self, e):
        Module_names = ['Not Found','Sample Heater', 'Dual Heater', 'LiqN2 Control']
    ...
    def Excel_File_Header_Generation(self):
        ...
        DH_Header = "Dual Heater,"+"Dual Heater,"+"Dual Heater,"+"Dual Heater,"+"Dual Heater,"+"Dual Heater,"
        DH_Header_Params = "Temperature Ambient,"+"Voltage - Amb - Ctrl,"+"Current - Amb - Ctrl,"+"Temperature N2,"+"Voltage - N2 - Ctrl,"+"Current - N2 - Ctrl,"
...
class MainWindow(wx.Frame):
    ...
    def Find_Modules_test(self):
        ...
        self.TabID = 1
        Module_Names = ['Sample Heater', 'Dual Heater', 'LiqN2 Control']
        Module_Classes = {'0': mmis.SampleHeater, '1': mmis.DualHeater, '2': mmis.LiqN2Control}
