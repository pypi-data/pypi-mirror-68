...
class Main(wx.Panel):
    ...
    def draw_plot1(self):
        ...
        ymin1 = round(min(self.data1[(-self.Xticks1):]), 0) - self.Yticks1
        ymax1 = round(max(self.data1[(-self.Xticks1):]), 0) + self.Yticks1
    ...
    def draw_plot2(self):
        ...
        ymin2 = round(min(self.data2[(-self.Xticks2):]), 0) - self.Yticks2 
        ymax2 = round(max(self.data2[(-self.Xticks2):]), 0) + self.Yticks2 
    ...
    def on_get_read_timer(self, e):
        ...
        self.five.SetValue(str(self.x[3])[:7]) # Temperature Nitrogen
