...
__jsii_assembly__ = jsii.JSIIAssembly.load("cdk8s", "0.21.0", __name__, "cdk8s@0.21.0.jsii.tgz")


class ApiObject(constructs.Construct, metaclass=jsii.JSIIMeta, jsii_type="cdk8s.ApiObject"):
    """
    stability
    :stability: experimental
    """
    def __init__(self, scope: constructs.Construct, ns: str, *, api_version: str, kind: str, data: typing.Any=None, metadata: typing.Optional["ApiObjectMetadata"]=None) -> None:
...
class Chart(constructs.Construct, metaclass=jsii.JSIIMeta, jsii_type="cdk8s.Chart"):
    ...
    :stability: experimental
    """
    def __init__(self, scope: constructs.Construct, ns: str, *, namespace: typing.Optional[str]=None) -> None:
        """
        :param scope: -
        :param ns: -
        ...
        :stability: experimental
        """
        options = ChartOptions(namespace=namespace)

        jsii.create(Chart, self, [scope, ns, options])

    @jsii.member(jsii_name="of")
    @builtins.classmethod
    def of(cls, c: constructs.Construct) -> "Chart":
...
@jsii.data_type(jsii_type="cdk8s.ChartOptions", jsii_struct_bases=[], name_mapping={'namespace': 'namespace'})
class ChartOptions():
    ...
    def __repr__(self) -> str:
        return 'ChartOptions(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())
...
__all__ = ["ApiObject", "ApiObjectMetadata", "ApiObjectOptions", "App", "AppOptions", "Chart", "ChartOptions", "Testing", "__jsii_assembly__"]
