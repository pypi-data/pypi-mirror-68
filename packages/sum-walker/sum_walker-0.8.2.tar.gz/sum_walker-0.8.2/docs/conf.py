# -*- coding: utf-8 -*-
#
# Sum walker documentation build configuration file, created by
...
htmlhelp_basename = 'Sum walkerdoc'
...
latex_documents = [
  ('index', 'sum_walker.tex', u'Sum walker Documentation',
...
man_pages = [
    ('index', 'sum_walker', u'Sum walker Documentation',
     [u'Shlomi Fish'], 1)
]
