...
class TestCantera(unittest.TestCase):
    ...
    def test_get_range_CTI(self):
        ...
        self.assertEqual(cantera._get_range_CTI(objs=objs), CTI_range_out)
        ...
        self.assertEqual(cantera._get_range_CTI(objs=objs_id), CTI_range_out)
        ...
        self.assertEqual(cantera._get_range_CTI(objs=objs_name), CTI_range_out)
