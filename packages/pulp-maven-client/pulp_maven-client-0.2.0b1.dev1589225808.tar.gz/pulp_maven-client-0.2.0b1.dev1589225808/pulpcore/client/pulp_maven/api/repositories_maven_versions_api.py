...
class RepositoriesMavenVersionsApi(object):
    ...
    def list_with_http_info(self, maven_repository_href, **kwargs):  # noqa: E501
        ...
        all_params = ['maven_repository_href', 'ordering', 'number', 'number__lt', 'number__lte', 'number__gt', 'number__gte', 'number__range', 'pulp_created__lt', 'pulp_created__lte', 'pulp_created__gt', 'pulp_created__gte', 'pulp_created__range', 'content', 'pulp_created', 'limit', 'offset', 'fields', 'exclude_fields']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
