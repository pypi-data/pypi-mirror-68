...
[boto3.CloudFormation 1.13.12](https://boto3.amazonaws.com/v1/documentation/api/1.13.12/reference/services/cloudformation.html#CloudFormation) service
...
stack_rollback_complete_waiter: cloudformation.StackRollbackCompleteWaiter = client.get_waiter("stack_rollback_complete")
