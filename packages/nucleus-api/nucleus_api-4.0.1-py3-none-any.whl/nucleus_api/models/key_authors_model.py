...
class KeyAuthorsModel(object):
    ...
    def __init__(self, dataset=None, query=None, tracked_queries=None, custom_stop_words=None, num_topics=None, num_keywords=None, metadata_selection=None, time_period='1M', period_start=None, period_end=None, num_authors=None, num_keydocs=None, excluded_docs=None, custom_dict_file=None):  # noqa: E501
