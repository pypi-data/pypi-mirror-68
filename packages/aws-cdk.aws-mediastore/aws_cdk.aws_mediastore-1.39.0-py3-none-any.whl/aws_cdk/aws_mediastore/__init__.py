...
class CfnContainer(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-mediastore.CfnContainer"):
    ...
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, container_name: str, access_logging_enabled: typing.Optional[typing.Union[typing.Optional[bool], typing.Optional[aws_cdk.core.IResolvable]]]=None, cors_policy: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.core.IResolvable, "CorsRuleProperty"]]]]]=None, lifecycle_policy: typing.Optional[str]=None, metric_policy: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["MetricPolicyProperty"]]]=None, policy: typing.Optional[str]=None, tags: typing.Optional[typing.List[aws_cdk.core.CfnTag]]=None) -> None:
        ...
        """
        props = CfnContainerProps(container_name=container_name, access_logging_enabled=access_logging_enabled, cors_policy=cors_policy, lifecycle_policy=lifecycle_policy, metric_policy=metric_policy, policy=policy, tags=tags)

        jsii.create(CfnContainer, self, [scope, id, props])

    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnContainer":
    ...
    def metric_policy(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["MetricPolicyProperty"]]]:
    ...
    def metric_policy(self, value: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["MetricPolicyProperty"]]]):
    ...
    class CorsRuleProperty():
        def __init__(self, *, allowed_headers: typing.Optional[typing.List[str]]=None, allowed_methods: typing.Optional[typing.List[str]]=None, allowed_origins: typing.Optional[typing.List[str]]=None, expose_headers: typing.Optional[typing.List[str]]=None, max_age_seconds: typing.Optional[jsii.Number]=None) -> None:
            """
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-mediastore.CfnContainer.MetricPolicyProperty", jsii_struct_bases=[], name_mapping={'container_level_metrics': 'containerLevelMetrics', 'metric_policy_rules': 'metricPolicyRules'})
    class MetricPolicyProperty():
        def __init__(self, *, container_level_metrics: str, metric_policy_rules: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnContainer.MetricPolicyRuleProperty"]]]]]=None) -> None:
            """
            ...
            if metric_policy_rules is not None: self._values["metric_policy_rules"] = metric_policy_rules
        ...
        @builtins.property
        def metric_policy_rules(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnContainer.MetricPolicyRuleProperty"]]]]]:
        ...
        def __repr__(self) -> str:
            return 'MetricPolicyProperty(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


    @jsii.data_type(jsii_type="@aws-cdk/aws-mediastore.CfnContainer.MetricPolicyRuleProperty", jsii_struct_bases=[], name_mapping={'object_group': 'objectGroup', 'object_group_name': 'objectGroupName'})
    class MetricPolicyRuleProperty():
        ...
        def __repr__(self) -> str:
            return 'MetricPolicyRuleProperty(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())



@jsii.data_type(jsii_type="@aws-cdk/aws-mediastore.CfnContainerProps", jsii_struct_bases=[], name_mapping={'container_name': 'containerName', 'access_logging_enabled': 'accessLoggingEnabled', 'cors_policy': 'corsPolicy', 'lifecycle_policy': 'lifecyclePolicy', 'metric_policy': 'metricPolicy', 'policy': 'policy', 'tags': 'tags'})
class CfnContainerProps():
    def __init__(self, *, container_name: str, access_logging_enabled: typing.Optional[typing.Union[typing.Optional[bool], typing.Optional[aws_cdk.core.IResolvable]]]=None, cors_policy: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnContainer.CorsRuleProperty"]]]]]=None, lifecycle_policy: typing.Optional[str]=None, metric_policy: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnContainer.MetricPolicyProperty"]]]=None, policy: typing.Optional[str]=None, tags: typing.Optional[typing.List[aws_cdk.core.CfnTag]]=None) -> None:
        ...
        if metric_policy is not None: self._values["metric_policy"] = metric_policy
    ...
    @builtins.property
    def metric_policy(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnContainer.MetricPolicyProperty"]]]:
        """``AWS::MediaStore::Container.MetricPolicy``.
