...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'mongodbatlas', 'v1.1.0-alpha.1589297891+g75c6690'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource mongodbatlas v1.1.0-alpha.1589297891+g75c6690`
                """)
            else:
                raise
