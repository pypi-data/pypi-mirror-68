...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'mongodbatlas', 'v1.1.0-alpha.1589295991+g34f43ab'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource mongodbatlas v1.1.0-alpha.1589295991+g34f43ab`
                """)
            else:
                raise
