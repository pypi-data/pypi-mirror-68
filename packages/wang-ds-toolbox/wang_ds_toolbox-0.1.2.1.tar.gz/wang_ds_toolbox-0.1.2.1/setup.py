...
setup(
    ...
    version='0.1.2.1',      # Start with a small number and increase it with every change you make
    ...
    download_url='https://github.com/alswang18/wang_ds_toolbox/archive/v_0.1.2.tar.gz',
    # Keywords that define your package best
    keywords=['Data Science', 'Random Forests', 'Visualizations'],
    install_requires=[  # I get to this in a second
        'scikit-learn', 'tqdm', 'Pillow', 'numpy', 'pandas', 'ipython', 'more-itertools', 'isoweek', 'sklearn-pandas', 'pandas-datareader', 'pandas-profiling', 'pandas-summary', 'graphviz', 'matplotlib', 'treeinterpreter', 'pdpbox',
    ],
    classifiers=[
