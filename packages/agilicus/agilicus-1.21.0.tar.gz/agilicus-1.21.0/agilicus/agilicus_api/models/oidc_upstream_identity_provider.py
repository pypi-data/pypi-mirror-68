...
class OIDCUpstreamIdentityProvider(object):
    ...
    def __init__(self, name=None, client_id=None, client_secret=None, issuer_external_host=None, username_key=None, email_key=None, email_verification_required=True, request_user_info=None, local_vars_configuration=None):  # noqa: E501
