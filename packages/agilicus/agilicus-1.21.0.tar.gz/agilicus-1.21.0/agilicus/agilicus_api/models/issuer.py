...
class Issuer(object):
    ...
    def __init__(self, id=None, issuer=None, org_id=None, theme_file_id=None, upstream_redirect_uri=None, managed_upstreams=None, oidc_upstreams=None, clients=None, local_vars_configuration=None):  # noqa: E501
