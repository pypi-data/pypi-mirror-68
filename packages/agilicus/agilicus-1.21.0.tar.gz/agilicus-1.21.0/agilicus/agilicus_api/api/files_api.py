...
class FilesApi(object):
    ...
    def add_file_with_http_info(self, name, file_zip, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'name' in local_var_params and not re.search(r'^[a-zA-Z0-9-:\.]+$', local_var_params['name']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `name` when calling `add_file`, must conform to the pattern `/^[a-zA-Z0-9-:\.]+$/`")  # noqa: E501
        collection_formats = {}
