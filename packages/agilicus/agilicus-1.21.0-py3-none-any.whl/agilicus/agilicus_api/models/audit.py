...
class Audit(object):
    ...
    def __init__(self, user_id=None, target_resource_type=None, api_name=None, org_id=None, time=None, action=None, source_ip=None, target_id=None, token_id=None, trace_id=None, local_vars_configuration=None):  # noqa: E501
