...
class AnsibleCollectionVersion(object):
    ...
    def documentation(self, documentation):
        ...
        if (self.local_vars_configuration.client_side_validation and
                documentation is not None and len(documentation) > 128):
    ...
    def homepage(self, homepage):
        ...
        if (self.local_vars_configuration.client_side_validation and
                homepage is not None and len(homepage) > 128):
    ...
    def issues(self, issues):
        ...
        if (self.local_vars_configuration.client_side_validation and
                issues is not None and len(issues) > 128):
    ...
    def repository(self, repository):
        ...
        if (self.local_vars_configuration.client_side_validation and
                repository is not None and len(repository) > 128):
            raise ValueError("Invalid value for `repository`, length must be less than or equal to `128`")  # noqa: E501
