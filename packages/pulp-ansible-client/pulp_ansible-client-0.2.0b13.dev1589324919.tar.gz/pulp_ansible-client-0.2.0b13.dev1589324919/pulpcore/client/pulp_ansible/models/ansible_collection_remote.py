...
class AnsibleCollectionRemote(object):
    ...
    def __init__(self, pulp_href=None, pulp_created=None, name=None, url=None, ca_cert=None, client_cert=None, client_key=None, tls_validation=None, proxy_url=None, username=None, password=None, pulp_last_updated=None, download_concurrency=None, policy='immediate', requirements_file=None, local_vars_configuration=None):  # noqa: E501
