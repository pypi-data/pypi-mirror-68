...
class CfnApplication(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-elasticbeanstalk.CfnApplication"):
    ...
    class ApplicationResourceLifecycleConfigProperty():
        def __init__(self, *, service_role: typing.Optional[str]=None, version_lifecycle_config: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnApplication.ApplicationVersionLifecycleConfigProperty"]]]=None) -> None:
            """
    ...
    class ApplicationVersionLifecycleConfigProperty():
        def __init__(self, *, max_age_rule: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnApplication.MaxAgeRuleProperty"]]]=None, max_count_rule: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnApplication.MaxCountRuleProperty"]]]=None) -> None:
            """
    ...
    class MaxAgeRuleProperty():
        def __init__(self, *, delete_source_from_s3: typing.Optional[typing.Union[typing.Optional[bool], typing.Optional[aws_cdk.core.IResolvable]]]=None, enabled: typing.Optional[typing.Union[typing.Optional[bool], typing.Optional[aws_cdk.core.IResolvable]]]=None, max_age_in_days: typing.Optional[jsii.Number]=None) -> None:
            """
    ...
    class MaxCountRuleProperty():
        def __init__(self, *, delete_source_from_s3: typing.Optional[typing.Union[typing.Optional[bool], typing.Optional[aws_cdk.core.IResolvable]]]=None, enabled: typing.Optional[typing.Union[typing.Optional[bool], typing.Optional[aws_cdk.core.IResolvable]]]=None, max_count: typing.Optional[jsii.Number]=None) -> None:
            """
...
class CfnApplicationProps():
    def __init__(self, *, application_name: typing.Optional[str]=None, description: typing.Optional[str]=None, resource_lifecycle_config: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnApplication.ApplicationResourceLifecycleConfigProperty"]]]=None) -> None:
...
class CfnApplicationVersion(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-elasticbeanstalk.CfnApplicationVersion"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnApplicationVersion":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
class CfnApplicationVersionProps():
    def __init__(self, *, application_name: str, source_bundle: typing.Union["CfnApplicationVersion.SourceBundleProperty", aws_cdk.core.IResolvable], description: typing.Optional[str]=None) -> None:
...
class CfnConfigurationTemplate(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-elasticbeanstalk.CfnConfigurationTemplate"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnConfigurationTemplate":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    class ConfigurationOptionSettingProperty():
        def __init__(self, *, namespace: str, option_name: str, resource_name: typing.Optional[str]=None, value: typing.Optional[str]=None) -> None:
            """
...
class CfnEnvironment(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-elasticbeanstalk.CfnEnvironment"):
    ...
    class TierProperty():
        def __init__(self, *, name: typing.Optional[str]=None, type: typing.Optional[str]=None, version: typing.Optional[str]=None) -> None:
            """
