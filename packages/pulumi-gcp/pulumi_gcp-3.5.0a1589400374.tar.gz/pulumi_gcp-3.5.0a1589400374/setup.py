...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v3.5.0-alpha.1589400374+g79ef0030'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v3.5.0-alpha.1589400374+g79ef0030`
                """)
            else:
                raise
