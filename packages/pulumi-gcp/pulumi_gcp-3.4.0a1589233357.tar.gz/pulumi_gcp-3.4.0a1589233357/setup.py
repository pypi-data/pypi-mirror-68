...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v3.4.0-alpha.1589233357+g9d271a20'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v3.4.0-alpha.1589233357+g9d271a20`
                """)
            else:
                raise
