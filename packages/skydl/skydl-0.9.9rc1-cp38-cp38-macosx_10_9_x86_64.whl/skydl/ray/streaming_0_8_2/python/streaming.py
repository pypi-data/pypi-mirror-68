...
import ray
import skydl.ray.streaming_0_8_2.python.processor as processor
import skydl.ray.streaming_0_8_2.python.runtime.transfer as transfer
from skydl.ray.streaming_0_8_2.python.communication import DataChannel
from skydl.ray.streaming_0_8_2.python.config import Config
from skydl.ray.streaming_0_8_2.python.jobworker import JobWorker
from skydl.ray.streaming_0_8_2.python.operator import Operator, OpType
from skydl.ray.streaming_0_8_2.python.operator import PScheme, PStrategy
...
class Environment:
    ...
    def execute(self):
        ...
        # For examples, if there is a forward partitioning strategy but
