...
from skydl.ray.streaming_0_8_2.python.operator import PStrategy
from skydl.ray.streaming_0_8_2.python.runtime.transfer import ChannelID
from skydl.ray.runtime_context_0_8_2 import _get_runtime_context
...
class DataInput:
    ...
    def init(self):
        ...
        conf = {
            # Config.TASK_JOB_ID: _get_runtime_context()
            # .current_driver_id,
