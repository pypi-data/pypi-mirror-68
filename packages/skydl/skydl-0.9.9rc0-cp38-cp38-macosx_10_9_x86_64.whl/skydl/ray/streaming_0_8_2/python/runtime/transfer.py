# ref: https://github.com/ray-project/ray/blob/releases/0.8.5/streaming/python/runtime/transfer.py
import logging
import random
...
class ChannelCreationParametersBuilder:
    ...
    _python_reader_async_function_descriptor = PythonFunctionDescriptor(
        ...
        "skydl.ray.streaming_0_8_2.python.jobworker", "on_reader_message", "JobWorker")
    _python_reader_sync_function_descriptor = PythonFunctionDescriptor(
        ...
        "skydl.ray.streaming_0_8_2.python.jobworker", "on_reader_message_sync", "JobWorker")
    _python_writer_async_function_descriptor = PythonFunctionDescriptor(
        ...
        "skydl.ray.streaming_0_8_2.python.jobworker", "on_writer_message", "JobWorker")
    _python_writer_sync_function_descriptor = PythonFunctionDescriptor(
        ...
        "skydl.ray.streaming_0_8_2.python.jobworker", "on_writer_message_sync", "JobWorker")
