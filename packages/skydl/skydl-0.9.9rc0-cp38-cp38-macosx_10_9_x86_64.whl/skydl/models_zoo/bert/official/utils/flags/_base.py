...
from skydl.models_zoo.bert.official.utils.flags._conventions import help_wrap
from skydl.models_zoo.bert.official.utils.logs import hooks_helper
  ...
  if export_dir:
    flags.DEFINE_string(
        ...
        help=help_wrap("If set, a SavedModel serialization of the model will "
                       ...
                       "See the README.md for more details and relevant links.")
    )
