...
class CfnCertificateProps():
    def __init__(self, *, certificate_identifier: typing.Optional[str]=None, certificate_pem: typing.Optional[str]=None, certificate_wallet: typing.Optional[str]=None) -> None:
...
class CfnEndpoint(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-dms.CfnEndpoint"):
    ...
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, endpoint_type: str, engine_name: str, certificate_arn: typing.Optional[str]=None, database_name: typing.Optional[str]=None, dynamo_db_settings: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["DynamoDbSettingsProperty"]]]=None, elasticsearch_settings: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["ElasticsearchSettingsProperty"]]]=None, endpoint_identifier: typing.Optional[str]=None, extra_connection_attributes: typing.Optional[str]=None, kafka_settings: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["KafkaSettingsProperty"]]]=None, kinesis_settings: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["KinesisSettingsProperty"]]]=None, kms_key_id: typing.Optional[str]=None, mongo_db_settings: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["MongoDbSettingsProperty"]]]=None, password: typing.Optional[str]=None, port: typing.Optional[jsii.Number]=None, s3_settings: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["S3SettingsProperty"]]]=None, server_name: typing.Optional[str]=None, ssl_mode: typing.Optional[str]=None, tags: typing.Optional[typing.List[aws_cdk.core.CfnTag]]=None, username: typing.Optional[str]=None) -> None:
        ...
        """
        props = CfnEndpointProps(endpoint_type=endpoint_type, engine_name=engine_name, certificate_arn=certificate_arn, database_name=database_name, dynamo_db_settings=dynamo_db_settings, elasticsearch_settings=elasticsearch_settings, endpoint_identifier=endpoint_identifier, extra_connection_attributes=extra_connection_attributes, kafka_settings=kafka_settings, kinesis_settings=kinesis_settings, kms_key_id=kms_key_id, mongo_db_settings=mongo_db_settings, password=password, port=port, s3_settings=s3_settings, server_name=server_name, ssl_mode=ssl_mode, tags=tags, username=username)
    ...
    def kafka_settings(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["KafkaSettingsProperty"]]]:
    ...
    def kafka_settings(self, value: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["KafkaSettingsProperty"]]]):
    ...
    class DynamoDbSettingsProperty():
        def __init__(self, *, service_access_role_arn: typing.Optional[str]=None) -> None:
            """
    ...
    class ElasticsearchSettingsProperty():
        def __init__(self, *, endpoint_uri: typing.Optional[str]=None, error_retry_duration: typing.Optional[jsii.Number]=None, full_load_error_percentage: typing.Optional[jsii.Number]=None, service_access_role_arn: typing.Optional[str]=None) -> None:
            """
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-dms.CfnEndpoint.KafkaSettingsProperty", jsii_struct_bases=[], name_mapping={'broker': 'broker', 'topic': 'topic'})
    class KafkaSettingsProperty():
        def __init__(self, *, broker: typing.Optional[str]=None, topic: typing.Optional[str]=None) -> None:
            """
            ...
            if broker is not None: self._values["broker"] = broker
        ...
        def __repr__(self) -> str:
            return 'KafkaSettingsProperty(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())
    ...
    class KinesisSettingsProperty():
        def __init__(self, *, message_format: typing.Optional[str]=None, service_access_role_arn: typing.Optional[str]=None, stream_arn: typing.Optional[str]=None) -> None:
            """
...
class CfnEndpointProps():
    def __init__(self, *, endpoint_type: str, engine_name: str, certificate_arn: typing.Optional[str]=None, database_name: typing.Optional[str]=None, dynamo_db_settings: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnEndpoint.DynamoDbSettingsProperty"]]]=None, elasticsearch_settings: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnEndpoint.ElasticsearchSettingsProperty"]]]=None, endpoint_identifier: typing.Optional[str]=None, extra_connection_attributes: typing.Optional[str]=None, kafka_settings: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnEndpoint.KafkaSettingsProperty"]]]=None, kinesis_settings: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnEndpoint.KinesisSettingsProperty"]]]=None, kms_key_id: typing.Optional[str]=None, mongo_db_settings: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnEndpoint.MongoDbSettingsProperty"]]]=None, password: typing.Optional[str]=None, port: typing.Optional[jsii.Number]=None, s3_settings: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnEndpoint.S3SettingsProperty"]]]=None, server_name: typing.Optional[str]=None, ssl_mode: typing.Optional[str]=None, tags: typing.Optional[typing.List[aws_cdk.core.CfnTag]]=None, username: typing.Optional[str]=None) -> None:
        ...
        if kafka_settings is not None: self._values["kafka_settings"] = kafka_settings
    ...
    @builtins.property
    def kafka_settings(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnEndpoint.KafkaSettingsProperty"]]]:
        """``AWS::DMS::Endpoint.KafkaSettings``.
...
class CfnReplicationInstance(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-dms.CfnReplicationInstance"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnReplicationInstance":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
class CfnReplicationSubnetGroup(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-dms.CfnReplicationSubnetGroup"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnReplicationSubnetGroup":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
class CfnReplicationSubnetGroupProps():
    def __init__(self, *, replication_subnet_group_description: str, subnet_ids: typing.List[str], replication_subnet_group_identifier: typing.Optional[str]=None, tags: typing.Optional[typing.List[aws_cdk.core.CfnTag]]=None) -> None:
...
class CfnReplicationTask(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-dms.CfnReplicationTask"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnReplicationTask":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
