...
setup(
    ...
    description="This package focus on build a task schedule.\
    With TaskScheduler you can define a project with tasks \
    which have some dependency on each other, and run this project.",
    author='Zeyan Li',
