...
setup(
  ...
  version = '0.11.3',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/mccutcheonlab/trompy/archive/v0.11.3-alpha.tar.gz',    # I explain this later on
