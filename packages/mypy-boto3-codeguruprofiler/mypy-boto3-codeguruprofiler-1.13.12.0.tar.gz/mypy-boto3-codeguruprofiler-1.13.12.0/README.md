...
[boto3.CodeGuruProfiler 1.13.12](https://boto3.amazonaws.com/v1/documentation/api/1.13.12/reference/services/codeguruprofiler.html#CodeGuruProfiler) service
...
list_profile_times_paginator: codeguruprofiler.ListProfileTimesPaginator = client.get_paginator("list_profile_times")
```
