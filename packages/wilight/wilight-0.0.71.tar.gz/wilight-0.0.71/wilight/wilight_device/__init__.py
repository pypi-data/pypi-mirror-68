...
class WiLightClientFake:
    """WiLight client wrapper Fake class."""
    ...
    def __init__(self, device_id=None, host=None,
        ...
        self.aux = {"on": False, "brightness": 0, "motor_state": "stopped",
                        "position_target": 0, "position_current": 0,
                        "direction": "off", "speed": "low",
                        "timer_target": 1, "timer_current": 1,
                        "hue": 360, "saturation": 100}
        self.status = {"1": self.aux, "2": self.aux, "3": self.aux}
