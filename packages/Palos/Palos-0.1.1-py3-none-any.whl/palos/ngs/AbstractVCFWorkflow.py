...
class AbstractVCFWorkflow(ParentClass, AbstractNGSWorkflow):
    ...
    def addSplitVCFFileJob(self, executable=None, inputFile=None, outputFnamePrefix=None, \
    ...
    def mapEachVCF(self, chromosome=None,VCFJobData=None, passingData=None, transferOutput=False, **keywords):
        """
    ...
    def hierarchicalCombineIntervalJobIntoOneChromosome(self, unionJob=None, refFastaFList=None, fileBasenamePrefix=None,\
        ...
        for i in range(0, len(intervalJobLs), maxNoOfIntervalJobsInOneUnion):
            ...
            subUnionJobData = self.concatenateIntervalsIntoOneVCFSubWorkflow(refFastaFList=refFastaFList, \
    ...
    def reduceManySmallIntervalVCFIntoBigIntervalVCF(self, executable=None, registerReferenceData=None, fileBasenamePrefix=None, \
        ...
        """
            ...
            #. each intervalJob should have an intervalData attached to it , detailing how big an interval it is covering
        ...
        for intervalJob in intervalJobLs:
            ...
            elif intervalData.chromosome!=startIntervalData.chromosome or (intervalData.span+startIntervalData.span)>bigIntervalSize:
                _filenamePartLs = []
    ...
    def addAllJobs(self, inputVCFData=None, chr2IntervalDataLs=None, \
        ...
        for chromosome, jobDataLs in chr2jobDataLs.items():
            ...
            for i in range(len(jobDataLs)):	#each input job is one VCF 
                ...
                if self.mapReduceType==1:	#2013.06.27 type 1: split VCF with fixed number of sites
                    ...
                    for intervalData in chr2IntervalDataLs.get(chromosome):
                        ...
                        linkMapToReduceData = self.linkMapToReduce(mapEachIntervalData=mapEachIntervalData, \
                                            ...
                                            passingData=passingData, \
                                            **keywords)
                reduceEachVCFData = self.reduceEachVCF(chromosome=chromosome, passingData=passingData, \
