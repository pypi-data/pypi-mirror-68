...
class CaaRecordValue():
    def __init__(self, *, flag: jsii.Number, tag: "CaaTag", value: str) -> None:
...
class CfnHealthCheck(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-route53.CfnHealthCheck"):
    ...
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnHealthCheck":
...
class CfnHostedZone(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-route53.CfnHostedZone"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnHostedZone":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    class QueryLoggingConfigProperty():
        def __init__(self, *, cloud_watch_logs_log_group_arn: str) -> None:
            """
    ...
    class VPCProperty():
        def __init__(self, *, vpc_id: str, vpc_region: str) -> None:
            """
...
class CfnHostedZoneProps():
    def __init__(self, *, name: str, hosted_zone_config: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnHostedZone.HostedZoneConfigProperty"]]]=None, hosted_zone_tags: typing.Optional[typing.List["CfnHostedZone.HostedZoneTagProperty"]]=None, query_logging_config: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnHostedZone.QueryLoggingConfigProperty"]]]=None, vpcs: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnHostedZone.VPCProperty"]]]]]=None) -> None:
    ...
    @builtins.property
    def hosted_zone_tags(self) -> typing.Optional[typing.List["CfnHostedZone.HostedZoneTagProperty"]]:
        """``AWS::Route53::HostedZone.HostedZoneTags``.
...
class CfnRecordSet(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-route53.CfnRecordSet"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnRecordSet":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    class AliasTargetProperty():
        def __init__(self, *, dns_name: str, hosted_zone_id: str, evaluate_target_health: typing.Optional[typing.Union[typing.Optional[bool], typing.Optional[aws_cdk.core.IResolvable]]]=None) -> None:
            """
    ...
    class GeoLocationProperty():
        def __init__(self, *, continent_code: typing.Optional[str]=None, country_code: typing.Optional[str]=None, subdivision_code: typing.Optional[str]=None) -> None:
            """
...
class CfnRecordSetGroup(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-route53.CfnRecordSetGroup"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnRecordSetGroup":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
class CommonHostedZoneProps():
    def __init__(self, *, zone_name: str, comment: typing.Optional[str]=None, query_logs_log_group_arn: typing.Optional[str]=None) -> None:
...
class HostedZoneAttributes():
    def __init__(self, *, hosted_zone_id: str, zone_name: str) -> None:
...
class HostedZoneProps(CommonHostedZoneProps):
    def __init__(self, *, zone_name: str, comment: typing.Optional[str]=None, query_logs_log_group_arn: typing.Optional[str]=None, vpcs: typing.Optional[typing.List[aws_cdk.aws_ec2.IVpc]]=None) -> None:
...
class HostedZoneProviderProps():
    def __init__(self, *, domain_name: str, private_zone: typing.Optional[bool]=None, vpc_id: typing.Optional[str]=None) -> None:
...
class MxRecordValue():
    def __init__(self, *, host_name: str, priority: jsii.Number) -> None:
...
class PrivateHostedZoneProps(CommonHostedZoneProps):
    def __init__(self, *, zone_name: str, comment: typing.Optional[str]=None, query_logs_log_group_arn: typing.Optional[str]=None, vpc: aws_cdk.aws_ec2.IVpc) -> None:
...
class PublicHostedZoneProps(CommonHostedZoneProps):
    def __init__(self, *, zone_name: str, comment: typing.Optional[str]=None, query_logs_log_group_arn: typing.Optional[str]=None, caa_amazon: typing.Optional[bool]=None) -> None:
...
class RecordSetOptions():
    def __init__(self, *, zone: "IHostedZone", comment: typing.Optional[str]=None, record_name: typing.Optional[str]=None, ttl: typing.Optional[aws_cdk.core.Duration]=None) -> None:
...
class RecordSetProps(RecordSetOptions):
    def __init__(self, *, zone: "IHostedZone", comment: typing.Optional[str]=None, record_name: typing.Optional[str]=None, ttl: typing.Optional[aws_cdk.core.Duration]=None, record_type: "RecordType", target: "RecordTarget") -> None:
...
class SrvRecordProps(RecordSetOptions):
    def __init__(self, *, zone: "IHostedZone", comment: typing.Optional[str]=None, record_name: typing.Optional[str]=None, ttl: typing.Optional[aws_cdk.core.Duration]=None, values: typing.List["SrvRecordValue"]) -> None:
...
class SrvRecordValue():
    def __init__(self, *, host_name: str, port: jsii.Number, priority: jsii.Number, weight: jsii.Number) -> None:
...
class TxtRecordProps(RecordSetOptions):
    def __init__(self, *, zone: "IHostedZone", comment: typing.Optional[str]=None, record_name: typing.Optional[str]=None, ttl: typing.Optional[aws_cdk.core.Duration]=None, values: typing.List[str]) -> None:
...
class ZoneDelegationOptions():
    def __init__(self, *, comment: typing.Optional[str]=None, ttl: typing.Optional[aws_cdk.core.Duration]=None) -> None:
...
class ZoneDelegationRecordProps(RecordSetOptions):
    def __init__(self, *, zone: "IHostedZone", comment: typing.Optional[str]=None, record_name: typing.Optional[str]=None, ttl: typing.Optional[aws_cdk.core.Duration]=None, name_servers: typing.List[str]) -> None:
...
class ARecordProps(RecordSetOptions):
    def __init__(self, *, zone: "IHostedZone", comment: typing.Optional[str]=None, record_name: typing.Optional[str]=None, ttl: typing.Optional[aws_cdk.core.Duration]=None, target: "RecordTarget") -> None:
...
class CaaRecordProps(RecordSetOptions):
    def __init__(self, *, zone: "IHostedZone", comment: typing.Optional[str]=None, record_name: typing.Optional[str]=None, ttl: typing.Optional[aws_cdk.core.Duration]=None, values: typing.List["CaaRecordValue"]) -> None:
...
class CnameRecordProps(RecordSetOptions):
    def __init__(self, *, zone: "IHostedZone", comment: typing.Optional[str]=None, record_name: typing.Optional[str]=None, ttl: typing.Optional[aws_cdk.core.Duration]=None, domain_name: str) -> None:
...
class MxRecordProps(RecordSetOptions):
    def __init__(self, *, zone: "IHostedZone", comment: typing.Optional[str]=None, record_name: typing.Optional[str]=None, ttl: typing.Optional[aws_cdk.core.Duration]=None, values: typing.List["MxRecordValue"]) -> None:
