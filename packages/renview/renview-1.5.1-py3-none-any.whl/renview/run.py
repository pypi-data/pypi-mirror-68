...
if __name__ == "__main__":
    ...
    try:
        ...
        pass
    default_kwargs = {
        'species_file': r'./data/example_sutton/species_comp.out',
        'reactions_file': r'./data/example_sutton/reaction_rates.out',
        'initial_reactant': 'CH3CH2OH',
        'reaction_cutoffrate': 1.0E-08,
        'elements_desired': ['C', 'O', 'H'],
        'normalization': 2,
        'output_directory': r'./results/example_sutton/',
        }
    run(**default_kwargs)
