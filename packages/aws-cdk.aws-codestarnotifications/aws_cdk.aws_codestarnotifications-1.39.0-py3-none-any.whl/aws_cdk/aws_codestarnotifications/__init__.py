...
class CfnNotificationRule(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-codestarnotifications.CfnNotificationRule"):
    ...
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnNotificationRule":
    ...
    class TargetProperty():
        def __init__(self, *, target_address: typing.Optional[str]=None, target_type: typing.Optional[str]=None) -> None:
            """
...
class CfnNotificationRuleProps():
    def __init__(self, *, detail_type: str, event_type_ids: typing.List[str], name: str, resource: str, targets: typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union["CfnNotificationRule.TargetProperty", aws_cdk.core.IResolvable]]], status: typing.Optional[str]=None, tags: typing.Any=None) -> None:
