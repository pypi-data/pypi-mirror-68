...
setup(
    ...
    install_requires=[
        ...
        u'classutils==1.18.1',
        u'cli_utils==1.0.6',
        u'configurationutil[ui]==3.7.3',
        u'conversionutil==1.4.6',
        u'dbhelperutil==1.1.0',
        u'fdutil==1.15.3',
        u'logging-helper==1.8.7',
        # u'macos_tts==0.0.1',  # Enable this when first release is created
        u'misguided_xml==1.1.0',
        u'networkutil==1.19.9',
        u'pydnserver==2.3.2',
        u'pyhttpintercept==0.28.1',
        u'reportutil==0.0.6',
        u'simpil==1.1.1',
        u'stateutil==1.4.0',
        u'tableutil==2.4.3',
