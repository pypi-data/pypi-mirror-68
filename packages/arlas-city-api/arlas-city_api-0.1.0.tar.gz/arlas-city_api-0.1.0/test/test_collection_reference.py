...
from arlas_city_api_python.models.collection_reference import CollectionReference
...
class TestCollectionReference(unittest.TestCase):
    ...
    def testCollectionReference(self):
        ...
        #model = arlas_city_api_python.models.collection_reference.CollectionReference()
        pass
