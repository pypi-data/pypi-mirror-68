...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'consul', 'v2.2.0-alpha.1589291235+g5f1430c'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource consul v2.2.0-alpha.1589291235+g5f1430c`
                """)
            else:
                raise
