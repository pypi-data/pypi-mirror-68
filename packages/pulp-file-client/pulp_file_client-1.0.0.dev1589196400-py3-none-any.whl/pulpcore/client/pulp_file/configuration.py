...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of pulpcore.client.pulp_file.signing.HttpSigningConfiguration
    ...
    Note you can use the constants defined in the pulpcore.client.pulp_file.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = pulpcore.client.pulp_file.Configuration(
        signing_info = pulpcore.client.pulp_file.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
    ...
    def to_debug_report(self):
        ...
        return "Python SDK Debug Report:\n"\
               ...
               "SDK Package Version: 1.0.0.dev01589196400".\
