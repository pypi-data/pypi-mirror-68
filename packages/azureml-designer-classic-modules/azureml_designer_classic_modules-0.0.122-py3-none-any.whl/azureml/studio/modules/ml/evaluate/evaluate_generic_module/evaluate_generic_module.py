...
class EvaluateModelModule(BaseModule):
    ...
    @classmethod
    def evaluate_generic(cls, scored_data: DataTable, scored_data_to_compare=None, plot=True):
...
def evaluate_generic(scored_data, scored_data_to_compare=None, plot=False):
    evaluation_result, = EvaluateModelModule.evaluate_generic(scored_data, scored_data_to_compare, plot=plot)
