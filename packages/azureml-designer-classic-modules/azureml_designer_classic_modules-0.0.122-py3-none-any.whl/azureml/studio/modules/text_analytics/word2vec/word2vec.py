...
from azureml.studio.common.error import ErrorMapping, NoColumnsSelectedError
...
class Word2VecModule(BaseModule):
    ...
    def word2vec(cls,
        ...
        cls.validate_input_args(dataset=dataset, selected_data=selected_data, target_column=target_column)
        ...
        preprocessed_selected_data = selected_data.data_frame.applymap(lambda x: preprocess_string(x, filters))
    ...
    def glove_english_model(cls, dataset, min_count, max_vocabulary_size):
        ...
        glove_model_wiki = api.load("glove-wiki-gigaword-100")
