...
LOG_FILENAME = '-'.join([__file__.split(os.sep)[len(__file__.split(os.sep))-1],])[:-3]
LOG = logging.getLogger(LOG_FILENAME)
logging.basicConfig(stream=sys.stderr)
hdlr = logging.handlers.RotatingFileHandler(filename=LOG_FILENAME+'.log',mode='a', encoding='utf-8', maxBytes=5242880, backupCount=3)
