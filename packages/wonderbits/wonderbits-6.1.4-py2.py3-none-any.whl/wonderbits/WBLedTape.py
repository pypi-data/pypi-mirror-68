...
class LedTape(WBits):
    ...
    def set_onboard_rgb(self, rgb):
        command = 'ledTape{}.set_onboard_rgb({})'.format(self.index, rgb)
    ...
    def set_leds_rgb(self, start, end, r, g, b):
        ...
        args.append(str(g))
        args.append(str(b))
        command = 'ledTape{}.set_leds_rgb({})'.format(self.index, ",".join(args))
        self._set_command(command)
    ...
    def set_single_led_rgb(self, num, r, g, b):
        ...
        args.append(str(g))
        args.append(str(b))
        command = 'ledTape{}.set_single_led_rgb({})'.format(self.index, ",".join(args))
        self._set_command(command)
    ...
    def start_rolling(self, start, end, speed):
        ...
        command = 'ledTape{}.start_rolling({})'.format(self.index, ",".join(args))
        self._set_command(command)
    ...
    def stop_rolling(self):
        ...
        command = 'ledTape{}.stop_rolling()'.format(self.index)
        self._set_command(command)
