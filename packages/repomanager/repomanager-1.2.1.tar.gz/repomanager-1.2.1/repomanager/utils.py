...
def cmdline_args():
    ...
    parser.add_argument('--clean','-c',
                        action='store_true',
                        default=False,
                        help='Removes all the repositories listed in repolist'
                        )
    parser.add_argument('--yaml','-y',
                        type=str,
                        metavar = 'YAML',
                        default = 'repolist.yaml',
                        help='A YAML file containing list of the repos' 
                        )
    parser.add_argument('--update','-u',
                        action='store_true',
                        default=False,
                        help='Updates/Clones all the listed repositories in the repolist'
                        )
    parser.add_argument('--patch','-p',
                        action='store_true',
                        default=False,
                        help='Applies patches to repositories which have their patch field defined in repolist'
                        )
    parser.add_argument('--unpatch','-r',
                        action='store_true',
                        default=False,
                        help='Removes patches to repositories which have their patch field defined in repolist'
                        )
...
class Command():
    ...
    def run(self, logging=True, **kwargs):
        ...
        return out.decode('ascii'), x.returncode
