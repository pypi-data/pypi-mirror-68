...
from numpy import dot, array, sum, sqrt, exp, ceil, ones, concatenate
from opfunu.cec.utils import BasicFunction


class Model(BasicFunction):
    def __init__(self, problem_size=None, cec_type="cec2014", bound=(-100, 100), dimensions=(10, 20, 30, 50, 100)):
    ...
    def F1(self, solution=None, name="Rotated High Conditioned Elliptic Function", f_shift="shift_data_1.txt", f_matrix="M_1_D", f_bias=100):
    ...
    def F2(self, solution=None, name="Rotated Bent Cigar Function", f_shift="shift_data_2.txt", f_matrix="M_2_D", f_bias=200):
        f_matrix = f_matrix + str(self.problem_size) + ".txt"
        shift, matrix = self.__load_shift_matrix_1__(f_shift, f_matrix)
        z = dot(matrix, solution - shift)
        return self.bent_cigar__(z) + f_bias

    def F3(self, solution=None, name="Rotated Discus Function", f_shift="shift_data_3.txt", f_matrix="M_3_D", f_bias=300):
        f_matrix = f_matrix + str(self.problem_size) + ".txt"
        shift, matrix = self.__load_shift_matrix_1__(f_shift, f_matrix)
        z = dot(matrix, solution - shift)
        return self.discus__(z) + f_bias

    def F4(self, solution=None, name="Shifted and Rotated Rosenbrock’s Function", f_shift="shift_data_4.txt", f_matrix="M_4_D", f_bias=400):
        f_matrix = f_matrix + str(self.problem_size) + ".txt"
        shift, matrix = self.__load_shift_matrix_1__(f_shift, f_matrix)
        z = 2.048 * (solution - shift) / 100
        y = dot(matrix, z) + 1
        return self.rosenbrock__(y) + f_bias

    def F5(self, solution=None, name="Shifted and Rotated Ackley’s Function", f_shift="shift_data_5.txt", f_matrix="M_5_D", f_bias=500):
        f_matrix = f_matrix + str(self.problem_size) + ".txt"
        shift, matrix = self.__load_shift_matrix_1__(f_shift, f_matrix)
        z = dot(matrix, solution - shift)
        return self.ackley__(z) + f_bias

    def F6(self, solution=None, name="Shifted and Rotated Weierstrass Function", f_shift="shift_data_6.txt", f_matrix="M_6_D", f_bias=600):
        f_matrix = f_matrix + str(self.problem_size) + ".txt"
        shift, matrix = self.__load_shift_matrix_1__(f_shift, f_matrix)
        z = 0.5 * (solution - shift) / 100
        y = dot(matrix, z)
        return self.weierstrass__(y) + f_bias

    def F7(self, solution=None, name="Shifted and Rotated Griewank’s Function", f_shift="shift_data_7.txt", f_matrix="M_7_D", f_bias=700):
        f_matrix = f_matrix + str(self.problem_size) + ".txt"
        shift, matrix = self.__load_shift_matrix_1__(f_shift, f_matrix)
        z = 600 * (solution - shift) / 100
        y = dot(matrix, z)
        return self.griewank__(y) + f_bias

    def F8(self, solution=None, name="Shifted Rastrigin’s Function", f_shift="shift_data_8.txt", f_matrix="M_8_D", f_bias=800):
        f_matrix = f_matrix + str(self.problem_size) + ".txt"
        shift, matrix = self.__load_shift_matrix_1__(f_shift, f_matrix)
        z = 5.12 * (solution - shift) / 100
        return self.rastrigin__(z) + f_bias

    def F9(self, solution=None, name="Shifted and Rotated Rastrigin’s Function", f_shift="shift_data_9.txt", f_matrix="M_9_D", f_bias=900):
        f_matrix = f_matrix + str(self.problem_size) + ".txt"
        shift, matrix = self.__load_shift_matrix_1__(f_shift, f_matrix)
        z = 5.12 * (solution - shift) / 100
        y = dot(matrix, z)
    ...
    def F10(self, solution=None, name="Shifted Schwefel’s Function", f_shift="shift_data_10.txt", f_matrix="M_10_D", f_bias=1000):
        f_matrix = f_matrix + str(self.problem_size) + ".txt"
        shift, matrix = self.__load_shift_matrix_1__(f_shift, f_matrix)
        z = 1000 * (solution - shift) / 100
        return self.modified_schwefel__(z) + f_bias

    def F11(self, solution=None, name="Shifted and Rotated Schwefel’s Function", f_shift="shift_data_11.txt", f_matrix="M_11_D", f_bias=1100):
        f_matrix = f_matrix + str(self.problem_size) + ".txt"
        shift, matrix = self.__load_shift_matrix_1__(f_shift, f_matrix)
        z = 1000 * (solution - shift) / 100
        y = dot(matrix, z)
    ...
    def F12(self, solution=None, name="Shifted and Rotated Katsuura Function", f_shift="shift_data_12.txt", f_matrix="M_12_D", f_bias=1200):
        f_matrix = f_matrix + str(self.problem_size) + ".txt"
        shift, matrix = self.__load_shift_matrix_1__(f_shift, f_matrix)
        z = 5 * (solution - shift) / 100
        y = dot(matrix, z)
        return self.katsuura__(y) + f_bias

    def F13(self, solution=None, name="Shifted and Rotated HappyCat Function", f_shift="shift_data_13.txt", f_matrix="M_13_D", f_bias=1300):
        f_matrix = f_matrix + str(self.problem_size) + ".txt"
        shift, matrix = self.__load_shift_matrix_1__(f_shift, f_matrix)
        z = 5 * (solution - shift) / 100
        y = dot(matrix, z)
    ...
    def F14(self, solution=None, name="Shifted and Rotated HGBat Function", f_shift="shift_data_14.txt", f_matrix="M_14_D", f_bias=1400):
        f_matrix = f_matrix + str(self.problem_size) + ".txt"
        shift, matrix = self.__load_shift_matrix_1__(f_shift, f_matrix)
        z = 5 * (solution - shift) / 100
        y = dot(matrix, z)
    ...
    def F15(self, solution=None, name="Shifted and Rotated Expanded Griewank’s plus Rosenbrock’s Function",
    ...
    def F16(self, solution=None, name="Shifted and Rotated Expanded Scaffer’s F6 Function", f_shift="shift_data_16.txt", f_matrix="M_16_D", f_bias=1600):
        f_matrix = f_matrix + str(self.problem_size) + ".txt"
        shift, matrix = self.__load_shift_matrix_1__(f_shift, f_matrix)
        z = dot(matrix, solution - shift) + 1
        return self.expanded_scaffer__(z) + f_bias

    ### Hybrid functions
    def F17(self, solution=None, name="Hybrid Function 1", f_shift="shift_data_17.txt", f_matrix="M_17_D", shuffle=17, f_bias=1700):
        p = array([0.3, 0.3, 0.4])
    ...
    def F18(self, solution=None, name="Hybrid Function 2", f_shift="shift_data_18.txt", f_matrix="M_18_D", shuffle=18, f_bias=1800):
        p = array([0.3, 0.3, 0.4])
        n1 = int(ceil(p[0] * self.problem_size))
        n2 = int(ceil(p[1] * self.problem_size)) + n1
        f_matrix = f_matrix + str(self.problem_size) + ".txt"
    ...
    def F19(self, solution=None, name="Hybrid Function 3", f_shift="shift_data_19.txt", f_matrix="M_19_D", shuffle=19, f_bias=1900):
    ...
    def F20(self, solution=None, name="Hybrid Function 4", f_shift="shift_data_20.txt", f_matrix="M_20_D", shuffle=20, f_bias=2000):
        p = array([0.2, 0.2, 0.3, 0.3])
        n1 = int(ceil(p[0] * self.problem_size))
        n2 = int(ceil(p[1] * self.problem_size)) + n1
        n3 = int(ceil(p[2] * self.problem_size)) + n2
    ...
    def F21(self, solution=None, name="Hybrid Function 5", f_shift="shift_data_21.txt", f_matrix="M_21_D", shuffle=21, f_bias=2100):
    ...
    def F22(self, solution=None, name="Hybrid Function 6", f_shift="shift_data_22.txt", f_matrix="M_22_D", shuffle=22, f_bias=2200):
        p = array([0.1, 0.2, 0.2, 0.2, 0.3])
        n1 = int(ceil(p[0] * self.problem_size))
        n2 = int(ceil(p[1] * self.problem_size)) + n1
        n3 = int(ceil(p[2] * self.problem_size)) + n2
    ...
    def F23(self, solution=None, name="Composition Function 1", f_shift="shift_data_23.txt", f_matrix="M_23_D", f_bias=2300):
        ...
        w1 = (1.0 / sqrt(sum(z ** 2))) * exp(-sum(z ** 2) / (2 * self.problem_size * xichma[0] ** 2))

        # 2. High Conditioned Elliptic Function F1’
        t2 = solution - shift[1]
        g2 = lamda[1] * self.elliptic__(solution=solution) + bias[1]
        w2 = (1.0 / sqrt(sum(t2 ** 2))) * exp(-sum(t2 ** 2) / (2 * self.problem_size * xichma[1] ** 2))

        # 3. Rotated Bent Cigar Function F2’
        t3 = solution - shift[2]
        g3 = lamda[2] * self.bent_cigar__(dot(matrix[2 * self.problem_size: 3 * self.problem_size, :], t3)) + bias[2]
        w3 = (1.0 / sqrt(sum(t3 ** 2))) * exp(-sum(t3 ** 2) / (2 * self.problem_size * xichma[2] ** 2))

        # 4. Rotated Discus Function F3’
        t4 = solution - shift[3]
        g4 = lamda[3] * self.discus__(dot(matrix[3 * self.problem_size: 4 * self.problem_size, :], t4)) + bias[3]
        w4 = (1.0 / sqrt(sum(t4 ** 2))) * exp(-sum(t4 ** 2) / (2 * self.problem_size * xichma[3] ** 2))

        # 4. High Conditioned Elliptic Function F1’
        t5 = solution - shift[4]
        g5 = lamda[4] * self.elliptic__(solution) + bias[4]
        w5 = (1.0 / sqrt(sum(t5 ** 2))) * exp(-sum(t5 ** 2) / (2 * self.problem_size * xichma[4] ** 2))

        sw = sum([w1, w2, w3, w4, w5])
        result = (w1 * g1 + w2 * g2 + w3 * g3 + w4 * g4 + w5 * g5) / sw
        return result + f_bias

    def F24(self, solution=None, name="Composition Function 2", f_shift="shift_data_24.txt", f_matrix="M_24_D", f_bias=2400):
        ...
        t1 = solution - shift[0]
        g1 = lamda[0] * self.modified_schwefel__(solution) + bias[0]
    ...
    def F25(self, solution=None, name="Composition Function 3", f_shift="shift_data_25.txt", f_matrix="M_25_D", f_bias=2500):
    ...
    def F26(self, solution=None, name="Composition Function 4", f_shift="shift_data_26.txt", f_matrix="M_26_D", f_bias=2600):
    ...
    def F27(self, solution=None, name="Composition Function 5", f_shift="shift_data_27.txt", f_matrix="M_27_D", f_bias=2700):
    ...
    def F28(self, solution=None, name="Composition Function 6", f_shift="shift_data_28.txt", f_matrix="M_28_D", f_bias=2800):
        xichma = array([10, 20, 30, 40, 50])
    ...
    def F29(self, solution=None, name="Composition Function 7", f_shift="shift_data_29.txt", f_matrix="M_29_D", f_bias=2900):
        num_funcs = 3
        ...
        for i in range(0, num_funcs):
            ...
            fits[i] = t1
            temp = solution - shift[i]
            weights[i] = (1.0 / sqrt(sum(temp ** 2))) * exp(-sum(temp ** 2) / (2 * self.problem_size * xichma[i] ** 2))
        sw = sum(weights)
        result = 0.0
        for i in range(0, num_funcs):
    ...
    def F30(self, solution=None, name="Composition Function 8", f_shift="shift_data_30.txt", f_matrix="M_30_D", f_bias=3000):
        num_funcs = 3
