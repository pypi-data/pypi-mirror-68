...
def _get_data_loader(dataset_wrapper, is_train=False, transform_fn=None, batch_size=None, oversample=False):
    ...
    if oversample and is_train:
        ...
        return RobustDataLoader(dataset_wrapper, batch_size=batch_size, sampler=sampler, collate_fn=collate_fn)
    else:
        return RobustDataLoader(dataset_wrapper, batch_size=batch_size, shuffle=is_train, collate_fn=collate_fn)
