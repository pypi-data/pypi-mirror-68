...
class AwsCustomResource(aws_cdk.core.Construct, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/custom-resources.AwsCustomResource"):
    ...
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, policy: "AwsCustomResourcePolicy", log_retention: typing.Optional[aws_cdk.aws_logs.RetentionDays]=None, on_create: typing.Optional["AwsSdkCall"]=None, on_delete: typing.Optional["AwsSdkCall"]=None, on_update: typing.Optional["AwsSdkCall"]=None, resource_type: typing.Optional[str]=None, role: typing.Optional[aws_cdk.aws_iam.IRole]=None, timeout: typing.Optional[aws_cdk.core.Duration]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param policy: The policy to apply to the resource. The custom resource also implements ``iam.IGrantable``, making it possible to use the ``grantXxx()`` methods. As this custom resource uses a singleton Lambda function, it's important to note the that function's role will eventually accumulate the permissions/grants from all resources.
        ...
        """
        props = AwsCustomResourceProps(policy=policy, log_retention=log_retention, on_create=on_create, on_delete=on_delete, on_update=on_update, resource_type=resource_type, role=role, timeout=timeout)
    ...
    def get_response_field_reference(self, data_path: str) -> aws_cdk.core.Reference:
...
class AwsCustomResourcePolicy(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/custom-resources.AwsCustomResourcePolicy"):
    """The IAM Policy that will be applied to the different calls."""
    @jsii.member(jsii_name="fromSdkCalls")
    @builtins.classmethod
    def from_sdk_calls(cls, *, resources: typing.List[str]) -> "AwsCustomResourcePolicy":
...
@jsii.data_type(jsii_type="@aws-cdk/custom-resources.AwsCustomResourceProps", jsii_struct_bases=[], name_mapping={'policy': 'policy', 'log_retention': 'logRetention', 'on_create': 'onCreate', 'on_delete': 'onDelete', 'on_update': 'onUpdate', 'resource_type': 'resourceType', 'role': 'role', 'timeout': 'timeout'})
class AwsCustomResourceProps():
    def __init__(self, *, policy: "AwsCustomResourcePolicy", log_retention: typing.Optional[aws_cdk.aws_logs.RetentionDays]=None, on_create: typing.Optional["AwsSdkCall"]=None, on_delete: typing.Optional["AwsSdkCall"]=None, on_update: typing.Optional["AwsSdkCall"]=None, resource_type: typing.Optional[str]=None, role: typing.Optional[aws_cdk.aws_iam.IRole]=None, timeout: typing.Optional[aws_cdk.core.Duration]=None) -> None:
...
@jsii.data_type(jsii_type="@aws-cdk/custom-resources.AwsSdkCall", jsii_struct_bases=[], name_mapping={'action': 'action', 'service': 'service', 'api_version': 'apiVersion', 'ignore_error_codes_matching': 'ignoreErrorCodesMatching', 'output_path': 'outputPath', 'parameters': 'parameters', 'physical_resource_id': 'physicalResourceId', 'region': 'region'})
class AwsSdkCall():
    def __init__(self, *, action: str, service: str, api_version: typing.Optional[str]=None, ignore_error_codes_matching: typing.Optional[str]=None, output_path: typing.Optional[str]=None, parameters: typing.Any=None, physical_resource_id: typing.Optional["PhysicalResourceId"]=None, region: typing.Optional[str]=None) -> None:
        """An AWS SDK call.
        ...
        :param parameters: The parameters for the service action. Default: - no paramters
        ...
        if ignore_error_codes_matching is not None: self._values["ignore_error_codes_matching"] = ignore_error_codes_matching
...
class PhysicalResourceId(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/custom-resources.PhysicalResourceId"):
...
class ProviderProps():
    def __init__(self, *, on_event_handler: aws_cdk.aws_lambda.IFunction, is_complete_handler: typing.Optional[aws_cdk.aws_lambda.IFunction]=None, query_interval: typing.Optional[aws_cdk.core.Duration]=None, total_timeout: typing.Optional[aws_cdk.core.Duration]=None) -> None:
...
@jsii.data_type(jsii_type="@aws-cdk/custom-resources.SdkCallsPolicyOptions", jsii_struct_bases=[], name_mapping={'resources': 'resources'})
class SdkCallsPolicyOptions():
    ...
    def __repr__(self) -> str:
        return 'SdkCallsPolicyOptions(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())
