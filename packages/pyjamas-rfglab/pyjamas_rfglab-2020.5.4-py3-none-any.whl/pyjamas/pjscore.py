...
class PyJAMAS(QtCore.QObject):
    ...
    def setupUI(self):
        ...
        self.addMenuItem(self.menuClassifiers, 'Create and train convolutional neural network - LeNet architecture ...', None,
                         self.classifiers.cbCreateLeNet)
