...
from pygitminer.metrics.process.code_churn import CodeChurn

TEST_COMMIT_DATA = [
    ('test-repos/pygitminer', 'domain/commit.py', 'ab36bf45859a210b0eae14e17683f31d19eea041', '71e053f61fc5d31b3e31eccd9c79df27c31279bf', 47, 34, 16)
]
...
TEST_DATE_DATA = [
    ('test-repos/pygitminer', 'domain/commit.py', datetime(2018, 3, 21), datetime(2018, 3, 27), 47, 34, 16)
]
