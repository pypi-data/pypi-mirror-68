...
from pygitminer.metrics.process.lines_count import LinesCount

TEST_COMMIT_DATA = [
   ('test-repos/pygitminer', '.gitignore', 'ab36bf45859a210b0eae14e17683f31d19eea041', 'ab36bf45859a210b0eae14e17683f31d19eea041', 197, 197, 197),
   ('test-repos/pygitminer', 'domain/modification.py', 'ab36bf45859a210b0eae14e17683f31d19eea041', '71e053f61fc5d31b3e31eccd9c79df27c31279bf', 61, 48, 20)
]
...
TEST_DATE_DATA = [
   ('test-repos/pygitminer', '.gitignore', datetime(2018, 3, 21), datetime(2018, 3, 22), 197, 197, 197),
   ('test-repos/pygitminer', 'domain/modification.py', datetime(2018, 3, 21), datetime(2018, 3, 27), 61, 48, 20)
]
