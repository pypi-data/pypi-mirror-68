...
from pygitminer.metrics.process.change_set import ChangeSet

TEST_COMMIT_DATA = [
    ('test-repos/pygitminer', 'ab36bf45859a210b0eae14e17683f31d19eea041', '71e053f61fc5d31b3e31eccd9c79df27c31279bf', 13, 8)
]
...
TEST_DATE_DATA = [
    ('test-repos/pygitminer', datetime(2018, 3, 21), datetime(2018, 3, 27), 13, 8),
    ('test-repos/pygitminer', datetime(2018, 3, 23), datetime(2018, 3, 23), 0, 0)
]
