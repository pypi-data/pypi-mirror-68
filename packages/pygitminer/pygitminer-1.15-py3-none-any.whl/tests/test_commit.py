...
from pygitminer.domain.commit import Modification, ModificationType
...
def test_filename():
    ...
    m1 = Modification('dspadini/pygitminer/myfile.py',
                      'dspadini/pygitminer/mynewfile.py',
                      ModificationType.ADD, diff_and_sc)
    m3 = Modification('dspadini/pygitminer/myfile.py',
                      'dspadini/pygitminer/mynewfile.py',
                      ModificationType.ADD, diff_and_sc)
    m2 = Modification('dspadini/pygitminer/myfile.py',
                      None,
                      ModificationType.ADD, diff_and_sc)
