...
from pygitminer.domain.developer import Developer
...
class Method:  # pylint: disable=R0902
    ...
    :ref:`pygitminer documentation <Properties>`.
    """
...
class Modification:  # pylint: disable=R0902
    ...
    def filename(self) -> str:
        ...
        "/Users/dspadini/pygitminer/myfile.py") returns only the filename
        (e.g. "myfile.py")
    ...
    def language_supported(self) -> bool:
        """
        Return whether the language used in the modification can be analyzed by pygitminer.
...
class Commit:
    ...
    def _get_modifications(self):
        ...
        if len(self.parents) == 1:
            ...
            # pygitminer will visit the modification in one of the previous
