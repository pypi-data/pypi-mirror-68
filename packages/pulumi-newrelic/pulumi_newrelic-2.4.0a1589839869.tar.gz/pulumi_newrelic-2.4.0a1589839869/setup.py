...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'newrelic', 'v2.4.0-alpha.1589839869+gdbd9ecd'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource newrelic v2.4.0-alpha.1589839869+gdbd9ecd`
                """)
            else:
                raise
