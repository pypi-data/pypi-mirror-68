...
snake_case_functions = ('image_file_reader', 'image_source', 'coocurrence_texture_features_image_filter', 'image_file_writer', 'image_to_image_filter', 'run_length_texture_features_image_filter', )
