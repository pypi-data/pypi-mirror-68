...
snake_case_functions = ('image_source', 'image_to_image_filter', 'run_length_texture_features_image_filter', 'coocurrence_texture_features_image_filter', 'image_file_writer', 'image_file_reader', )
