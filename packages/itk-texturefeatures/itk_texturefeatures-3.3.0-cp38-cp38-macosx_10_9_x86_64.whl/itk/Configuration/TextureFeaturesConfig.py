...
snake_case_functions = ('image_source', 'image_file_reader', 'image_file_writer', 'coocurrence_texture_features_image_filter', 'image_to_image_filter', 'run_length_texture_features_image_filter', )
