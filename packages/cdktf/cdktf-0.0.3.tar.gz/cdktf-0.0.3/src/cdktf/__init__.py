...
class App(constructs.Construct, metaclass=jsii.JSIIMeta, jsii_type="cdktf.App"):
    ...
    def __init__(self, *, outdir: typing.Optional[str]=None) -> None:
        ...
        :param outdir: The directory to output Terraform resources. Default: - CDKTF_OUTDIR if defined, otherwise "dist"
...
@jsii.data_type(jsii_type="cdktf.TerraformGeneratorMetadata", jsii_struct_bases=[], name_mapping={'provider_name': 'providerName'})
...
class TerraformOutput(TerraformElement, metaclass=jsii.JSIIMeta, jsii_type="cdktf.TerraformOutput"):
    ...
    :stability: experimental
    """
    def __init__(self, scope: constructs.Construct, id: str, *, value: typing.Union[str, jsii.Number, bool, typing.List[typing.Any], typing.Mapping[str, typing.Any]], depends_on: typing.Optional[typing.List["TerraformResource"]]=None, description: typing.Optional[str]=None, sensitive: typing.Optional[bool]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param value: 
        ...
        :stability: experimental
        """
        config = TerraformOutputConfig(value=value, depends_on=depends_on, description=description, sensitive=sensitive)
    ...
    def value(self) -> typing.Union[str, jsii.Number, bool, typing.List[typing.Any], typing.Mapping[str, typing.Any]]:
        """
        stability
        :stability: experimental
        """
    ...
    @value.setter
    def value(self, value: typing.Union[str, jsii.Number, bool, typing.List[typing.Any], typing.Mapping[str, typing.Any]]):
...
@jsii.data_type(jsii_type="cdktf.TerraformOutputConfig", jsii_struct_bases=[], name_mapping={'value': 'value', 'depends_on': 'dependsOn', 'description': 'description', 'sensitive': 'sensitive'})
class TerraformOutputConfig():
    def __init__(self, *, value: typing.Union[str, jsii.Number, bool, typing.List[typing.Any], typing.Mapping[str, typing.Any]], depends_on: typing.Optional[typing.List["TerraformResource"]]=None, description: typing.Optional[str]=None, sensitive: typing.Optional[bool]=None) -> None:
        """
        :param value: 
        :param depends_on: 
        :param description: 
...
class TerraformProvider(TerraformElement, metaclass=jsii.JSIIAbstractClass, jsii_type="cdktf.TerraformProvider"):
    ...
    def __init__(self, scope: constructs.Construct, id: str, *, terraform_resource_type: str) -> None:
        """
        :param scope: -
        :param id: -
        ...
        :stability: experimental
        """
        config = TerraformProviderConfig(terraform_resource_type=terraform_resource_type)
...
@jsii.data_type(jsii_type="cdktf.TerraformProviderConfig", jsii_struct_bases=[], name_mapping={'terraform_resource_type': 'terraformResourceType'})
class TerraformProviderConfig():
    def __init__(self, *, terraform_resource_type: str) -> None:
        """
        :param terraform_resource_type: 
...
class TerraformStack(constructs.Construct, metaclass=jsii.JSIIMeta, jsii_type="cdktf.TerraformStack"):
    ...
    @builtins.property
    @jsii.member(jsii_name="providerFile")
    def provider_file(self) -> str:
        """
        stability
        :stability: experimental
        """
        return jsii.get(self, "providerFile")
