...
class tri(object):
   def __init__(self):
      ...
      self.file_mag='YBC/YBC/FILTERNAME'
      self.file_cspec='bc_odfnewbern/FILTERNAME/bc_cspec.dat'
      ...
      self.kind_dustM='1'
                 ...
                 #4: new Nanni tables
      self.file_dustM='tab_dust/tab_dust_dpmod60alox40_FILTERNAME.dat'
      ...
      self.kind_dustC='1'
      self.file_dustC='tab_dust/tab_dust_AMCSIC15_FILTERNAME.dat'
