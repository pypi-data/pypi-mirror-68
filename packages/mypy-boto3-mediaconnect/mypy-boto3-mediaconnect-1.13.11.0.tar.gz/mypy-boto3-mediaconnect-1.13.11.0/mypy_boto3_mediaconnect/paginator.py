...
class ListEntitlementsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListEntitlements.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.13.11/reference/services/mediaconnect.html#MediaConnect.Paginator.ListEntitlements.paginate)
        """
...
class ListFlowsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListFlows.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.13.11/reference/services/mediaconnect.html#MediaConnect.Paginator.ListFlows.paginate)
        """
