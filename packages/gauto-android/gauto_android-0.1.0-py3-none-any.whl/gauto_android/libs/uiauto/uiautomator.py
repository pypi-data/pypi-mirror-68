...
from gauto_android import libs as imap_utf7
...
class Adb(object):
    def __init__(self, serial=None, adb_server_host=None, adb_server_port=None):
        ...
        if self.adb_server_port != '5037':
            ...
            # levyzhang
            # print "self.default_serial: " + str(self.default_serial)
            # print "self.adb_server_host: " + str(self.adb_server_host)
            # print "self.adb_server_port: " + str(self.adb_server_port)
            # print "self.adbHostPortOptions: " + str(self.adbHostPortOptions)
