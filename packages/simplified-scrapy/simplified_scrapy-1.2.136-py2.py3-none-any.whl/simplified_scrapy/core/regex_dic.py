...
class RegexDict(Dict):
    ...
    def getElementsByReg(self,
        ...
        while ele:
            lst.append(ele)
            s = ele._end - self._start - self._rootNode.html.index('>', self._start)
    ...
    def insertAfter(self, html):
        ...
        self._rootNode['html'] = h
        _updatePosition(self._rootNode,self._start,self._start+len(html), self._start)
    ...
    def repleaceSelf(self, html):
        ...
        if s:
            ...
            _updatePosition(self._rootNode,self._start,self._start+len(html), oldEnd)
            self._start = 0
            self._end = 0
            self.clear()
        return self
