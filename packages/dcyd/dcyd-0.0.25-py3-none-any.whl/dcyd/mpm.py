...
def format_payload(
    ...
    custom_kwargs['environment'] = (
            custom_kwargs.get('environment') or constants.DEFAULT_ENVIRONMENT
    )
    custom_kwargs['model'] = custom_kwargs.get('model') or func.__name__
    ...
    payload = {
        'function': {
            ...
            'function_model': custom_kwargs['model'],
            'function_environment': custom_kwargs['environment']
        },
        'request': {
