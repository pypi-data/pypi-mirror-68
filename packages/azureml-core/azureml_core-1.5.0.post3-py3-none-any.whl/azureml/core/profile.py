...
class ModelProfile(_ModelEvaluationResultBase):
    ...
    def wait_for_profiling(self, show_output=False):
        ...
        ModelProfile.wait_for_profiling() method has been deprecated and will be removed in a future release.
        Please migrate to ModelProfile.wait_for_completion().
    ...
    def get_results(self):
        ...
        ModelProfile.get_results() method has been deprecated and will be removed in a future release.
        Please migrate to ModelProfile.get_details().
