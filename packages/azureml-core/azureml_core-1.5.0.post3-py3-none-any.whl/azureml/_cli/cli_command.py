...
def _process_single_return_object(return_object):
    ...
    if isinstance(return_object, Model):
        ...
        raise AzureMLException("Unsupported return type {} from command".format(type(return_object)))
...
def _write_output_metadata_file(return_object, output_metadata_file_path, logger):
    ...
    if os.path.exists(full_path):
        ...
        raise AzureMLException("specified output file {} already exists".format(full_path))
