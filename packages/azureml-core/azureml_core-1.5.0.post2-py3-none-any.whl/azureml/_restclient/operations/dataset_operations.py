...
class DatasetOperations(object):
    ...
    def generate_profile_with_preview(
            self, subscription_id, resource_group_name, workspace_name, id, compute_target, experiment_name=None, custom_headers=None, raw=False, **operation_config):
        """
    ...
    def get_by_id(
            self, subscription_id, resource_group_name, workspace_name, id, check_data_hash=False, custom_headers=None, raw=False, **operation_config):
        """
