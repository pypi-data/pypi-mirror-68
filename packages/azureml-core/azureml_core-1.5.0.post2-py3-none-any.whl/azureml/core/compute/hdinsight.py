...
class HDInsightCompute(ComputeTarget):
    ...
    def attach_configuration(username, subscription_id=None, resource_group=None, cluster_name=None, resource_id=None,
        ...
        The following Azure regions do not support attaching a HDInsight cluster using
        the public IP address of the HDInsight cluster.
        Instead, use the Azure Resource Manager ID of the HDInsight cluster:
        * US East
        * US West 2
        * US South Central
        This is how you can construct the resourceId of your HDInsight cluster using
        subscription_id, resource_group and cluster_name
        ...
        :param cluster_name: The HDI cluster name
        :type cluster_name: str
        :param resource_id: The arm resource_id for the resource to be attached.
