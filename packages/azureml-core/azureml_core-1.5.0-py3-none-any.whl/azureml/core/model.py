...
class Model(object):
    ...
    _expected_payload_keys = ['createdTime', 'description', 'id', 'mimeType', 'name', 'properties', 'unpack', 'url',
                              'version', 'experimentName', 'runId', 'datasets', 'createdBy']
    ...
    def _get(workspace, name=None, id=None, tags=None, properties=None, version=None,
        ...
        params = {'orderBy': 'CreatedAtDesc', 'count': 1}
    ...
    def register(workspace, model_path, model_name, tags=None, properties=None, description=None,
        ...
        prefix_values = [{'prefix': '{}/{}/{}'.format(origin, container, model_base_name)}]
    ...
    @staticmethod
    def list(workspace, name=None, tags=None, properties=None, run_id=None, latest=False, dataset_id=None):
    ...
    @staticmethod
    def profile(workspace, profile_name, models, inference_config, input_data=None,
                input_dataset=None, cpu=None, memory_in_gb=None, description=None):
        ...
        :param inference_config: An InferenceConfig object used to determine required model properties.
        :type inference_config: azureml.core.model.InferenceConfig
        :param input_data: The input data for profiling. input_data parameter has been deprecated and will be removed
                           in a future release. Please refrain from using it and migrate to using
                           input_dataset parameter.
        :type input_data: str
        ...
        """
        if input_data:
            warnings.warn("input_data parameter has been deprecated and will be removed in a future release."
                          " Please migrate to using input_dataset parameter. Learn how to create datasets: %s." %
            ...
            try:
                ...
                raise UserErrorException('Please install azureml-dataprep package in order to use profiling.')
            if not profile_name:
...
class InferenceConfig(object):
    ...
    * :meth:`azureml.core.model.Model.package`
    ...
    def validate_configuration(self):
        ...
        if self.base_image or (self.base_image_registry and self.base_image_registry.address):
    ...
    def build_profile_payload(self, profile_name, input_data=None, workspace=None, models=None,
        ...
        # old workflow
        from azureml._model_management._util import old_profile_payload_template, profile_payload_template
        if input_data:
