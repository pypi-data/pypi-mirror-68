...
class RemoteCompute(ComputeTarget):
    ...
    def attach_configuration(username, subscription_id=None, resource_group=None, vm_name=None, resource_id=None,
        ...
        The following Azure regions do not support attaching a virtual machine using the public IP address of the VM.
        Instead, use the Azure Resource Manager ID of the VM:
        * US East
        * US West 2
        * US South Central
        This is how you can construct the resourceId of your virtual machine
        using subscription_id, resource_group and vm_name
        "/subscriptions/<subscription_id>/resourceGroups/<resource_group>/
        providers/Microsoft.Compute/virtualMachines/<vm_name>"
        For more details: https://aka.ms/azureml-compute-vm
        ...
        :param vm_name: The virtual machine name.
        :type vm_name: str
        :param resource_id: The arm resource_id for the existing resource.
