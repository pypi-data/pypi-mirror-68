...
class GroupListEnvelope(object):
    ...
    """
    openapi_types = {
        'groups': 'list[GroupResponseFields]'
    }
    ...
    def __init__(self, groups=None, local_vars_configuration=None):  # noqa: E501
        """GroupListEnvelope - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GroupListEnvelope):
            return False
