...
class AccountsApi(object):
    ...
    def v1_accounts_account_id_get(self, account_id, **kwargs):
        """Get account information.

        Includes the original configuration information.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v1_accounts_account_id_get(account_id, async_req=True)
        >>> result = thread.get()
    ...
    def v1_identities_get(self, **kwargs):
    ...
    def v1_identities_post(self, body, **kwargs):
