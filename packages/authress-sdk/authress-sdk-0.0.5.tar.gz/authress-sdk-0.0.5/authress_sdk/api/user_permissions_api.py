...
class UserPermissionsApi(object):
    ...
    def v1_users_user_id_resources_get(self, user_id, **kwargs):
    ...
    def v1_users_user_id_resources_resource_uri_permissions_get(self, user_id, resource_uri, **kwargs):
        ...
        :param async_req bool
        :param str user_id: The user to check permissions on (required)
        :param str resource_uri: The uri path of a resource to validate, must be URL encoded, uri segments are allowed. (required)
    ...
    def v1_users_user_id_resources_resource_uri_permissions_permission_get(self, user_id, resource_uri, permission, **kwargs):
        ...
        :param async_req bool
        :param str user_id: The user to check permissions on (required)
        :param str resource_uri: The uri path of a resource to validate, must be URL encoded, uri segments are allowed, the resource must be a full path, and permissions are not inherited by sub resources. (required)
