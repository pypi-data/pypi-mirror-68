...
class ResourcePermissionsApi(object):
    ...
    def v1_resources_get(self, **kwargs):
        ...
        >>> thread = api.v1_resources_get(async_req=True)
        >>> result = thread.get()
    ...
    def v1_resources_resource_uri_get(self, resource_uri, **kwargs):
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v1_resources_resource_uri_get(resource_uri, async_req=True)
        >>> result = thread.get()
    ...
    def v1_resources_resource_uri_put(self, body, resource_uri, **kwargs):
        """Update a resource permissions object.

        Updates the global permissions on a resource. This applies to all users in an account.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v1_resources_resource_uri_put(body, resource_uri, async_req=True)
        >>> result = thread.get()
