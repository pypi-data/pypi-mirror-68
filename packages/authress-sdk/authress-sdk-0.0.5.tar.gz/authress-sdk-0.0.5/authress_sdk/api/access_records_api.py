...
class AccessRecordsApi(object):
    ...
    def v1_claims_post(self, body, **kwargs):
        ...
        >>> thread = api.v1_claims_post(body, async_req=True)
        >>> result = thread.get()
    ...
    def v1_records_get(self, **kwargs):
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v1_records_get(async_req=True)
        >>> result = thread.get()
    ...
    def v1_records_post(self, body, **kwargs):
        """Create a new access record

        Specify user roles for specific resources.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v1_records_post(body, async_req=True)
        >>> result = thread.get()
    ...
    def v1_records_record_id_delete(self, record_id, **kwargs):
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v1_records_record_id_delete(record_id, async_req=True)
        >>> result = thread.get()
    ...
    def v1_records_record_id_put(self, body, record_id, **kwargs):
        """Update an access record.

        Updates an access record adding or removing user permissions to resources.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v1_records_record_id_put(body, record_id, async_req=True)
        >>> result = thread.get()
