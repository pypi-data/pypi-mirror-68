...
import logging
logger = logging.getLogger('antiope.VPC')

class VPC(object):
    """Class to represent a VPC belonging to an Account"""
    def __init__(self, vpc_id, account=None, config=None):
    ...
    def update_vpc_attribute(self, key, value):
        ...
        try:
            ...
            raise AccountUpdateError("Failed to update {} to {} for {}: {}".format(key, value, self, e))
