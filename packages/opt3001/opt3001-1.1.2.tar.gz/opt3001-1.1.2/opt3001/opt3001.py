...
class Opt3001:
    ...
    def write_config_reg(self, data):
        ...
        Ausgang: void
        """
        return self.write_register_16bit(self.I2C_LS_REG_CONFIG, data)
    ...
    def read_manufacture_id(self):
        ...
        """
        return self.read_register_16bit(self.I2C_LS_REG_MANUFACTURERID)
    ...
    def read_device_id(self):
        ...
        Ausgang: manufacture id
        """
        return self.read_register_16bit(self.I2C_LS_REG_DEVICEID)
    ...
    def read_lux_fixpoint(self):
        ...
        """
        # Register Value
        req_value = self.read_register_16bit(self.I2C_LS_REG_RESULT)
