...
class DeboredApp(constructs.Construct, metaclass=jsii.JSIIMeta, jsii_type="cdk8s-debore.DeboredApp"):
    ...
    """
    def __init__(self, scope: constructs.Construct, name: str, *, image: str, auto_scale: typing.Optional[bool]=None, container_port: typing.Optional[jsii.Number]=None, default_replicas: typing.Optional[jsii.Number]=None, ingress: typing.Optional["IngressType"]=None, namespace: typing.Optional[str]=None, port: typing.Optional[jsii.Number]=None, resources: typing.Optional["ResourceRequirements"]=None) -> None:
        """
        :param scope: -
        :param name: -
        :param image: The Docker image to use for this app.
        ...
        :param ingress: The type of ingress. Default: IngressType.SERVICE_LOADBALANCER
        ...
        :stability: experimental
        """
        opts = DeboredOptions(image=image, auto_scale=auto_scale, container_port=container_port, default_replicas=default_replicas, ingress=ingress, namespace=namespace, port=port, resources=resources)

        jsii.create(DeboredApp, self, [scope, name, opts])


@jsii.data_type(jsii_type="cdk8s-debore.DeboredOptions", jsii_struct_bases=[], name_mapping={'image': 'image', 'auto_scale': 'autoScale', 'container_port': 'containerPort', 'default_replicas': 'defaultReplicas', 'ingress': 'ingress', 'namespace': 'namespace', 'port': 'port', 'resources': 'resources'})
class DeboredOptions():
    def __init__(self, *, image: str, auto_scale: typing.Optional[bool]=None, container_port: typing.Optional[jsii.Number]=None, default_replicas: typing.Optional[jsii.Number]=None, ingress: typing.Optional["IngressType"]=None, namespace: typing.Optional[str]=None, port: typing.Optional[jsii.Number]=None, resources: typing.Optional["ResourceRequirements"]=None) -> None:
        """
        :param image: The Docker image to use for this app.
        :param auto_scale: Whether use HPA or not. Default: false
        :param container_port: Internal port. Default: 8080
    ...
    @builtins.property
    def ingress(self) -> typing.Optional["IngressType"]:
        """The type of ingress.
...
@jsii.enum(jsii_type="cdk8s-debore.IngressType")
