...
class APIExperiment(object):
    ...
    def get_curves(self):
        ...
        [{"name": "curve1", "x": [1, 2, 3], "y": [4, 5, 6]}]
        ```
        """
        return [
            self.get_asset(asset["assetId"], return_type="json")
...
class API(object):
    ...
    * API.get_experiments(WORKSPACE, PROJECT_NAME, PATTERN): get all APIExperiments in WORKSPACE/PROJECT/PATTERN
    ...
    def download_registry_model(
        self, workspace, registry_name, version, output_path="./", expand=True
    ):
        """
        ...
        """
        LOGGER.info(
            "Downloading registry model %r, version %r from workspace %r...",
            registry_name,
            version,
            workspace,
        )
