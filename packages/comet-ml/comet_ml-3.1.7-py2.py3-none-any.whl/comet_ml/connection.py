...
class BaseApiClient(object):
    ...
    def __init__(self, server_url, base_url, low_level_api_client, api_key):
        # type: (str, List[str], LowLevelHTTPClient, Optional[str]) -> None
    ...
    def get_from_endpoint(self, endpoint, params, return_type="json"):
        # type: (str, Optional[Dict[str, str]], str) -> Any
...
class RestApiClient(BaseApiClient):
    ...
    def __init__(self, server_url, version, low_level_api_client, api_key):
        # type: (str, str, LowLevelHTTPClient, str) -> None
        super(RestApiClient, self).__init__(
            server_url, ["api/rest/", version + "/"], low_level_api_client, api_key
        )

        self.use_cache = False

        config_minimal_backend_version = get_config(
    ...
    def get_experiment_asset(self, experiment_key, asset_id, return_type="binary"):
        ...
        return self.get_from_endpoint(
            "experiment/asset/get-asset", params, return_type=return_type
        )
    ...
    def get_registry_model_zipfile(self, workspace, registry_name, version):
        params = {
            "workspaceName": workspace,
        ...
        return self.get_from_endpoint(
            "registry-model/item/download", params, return_type="binary"
        )
...
def get_optimizer_api_client(api_key, server_address=None, headers=None):
    ...
    return OptimizerApiClient(api_key, server_url, low_level_api)
...
class OptimizerApiClient(BaseApiClient):
    ...
    def __init__(self, api_key, server_url, low_level_api_client):
        # type: (str, str, LowLevelHTTPClient) -> None
        super(OptimizerApiClient, self).__init__(
            server_url, ["clientlib/"], low_level_api_client, api_key
        )
...
def get_comet_api_client(server_address=None, headers=None):
    ...
    return CometApiClient(server_url, low_level_api)
...
class CometApiClient(BaseApiClient):
    ...
    def __init__(self, server_url, low_level_api_client):
        # type: (str, LowLevelHTTPClient) -> None
        super(CometApiClient, self).__init__(
            server_url, ["api/auth/"], low_level_api_client, None
        )
