...
from flask import Flask, jsonify, request, render_template, url_for, send_file, send_from_directory, safe_join, abort
...
app.config["CLIENT_DATA"] = './static/files'
