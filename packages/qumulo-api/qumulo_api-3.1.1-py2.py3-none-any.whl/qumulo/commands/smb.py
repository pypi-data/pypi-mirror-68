...
class SMBAddShareCommand(qumulo.lib.opts.Subcommand):
    ...
    def main(conninfo, credentials, args, outfile=sys.stdout, smb_mod=smb):
        if args.bytes_per_sector is not None:
            warnings.warn(
                "--bytes-per-sector is deprecated", DeprecationWarning)
    ...
    def options(parser):
        ...
        parser.add_argument(
            ...
            choices=[
                ...
                "SMB2_DIALECT_3_11",
                ""],
            metavar="{smb2_dialect_2_002,smb2_dialect_2_1,smb2_dialect_3_0,"
                "smb2_dialect_3_11}",
            nargs="+",
...
class SMBListFileHandlesCommand(qumulo.lib.opts.Subcommand):
    ...
    def options(parser):
        ...
        parser.add_argument("-p", "--resolve-paths", action='store_true',
...
class SMBCloseFileHandleCommand(qumulo.lib.opts.Subcommand):
    ...
    def main(conninfo, credentials, args):
        ...
        message = "Are you sure you want to force close this file? " \
...
class SMBCloseSessionsCommand(qumulo.lib.opts.Subcommand):
    ...
    SYNOPSIS = "Force close SMB sessions matching one or more of a set of " \
        "filters."
    FORMATTED_DESCRIPTION = SYNOPSIS + textwrap.dedent('''\n
        NOTE: This will prevent the client from sending any new requests for
    ...
    @staticmethod
    def main(
            conninfo, credentials, args, smb_mod=smb, opts_mod=qumulo.lib.opts):
