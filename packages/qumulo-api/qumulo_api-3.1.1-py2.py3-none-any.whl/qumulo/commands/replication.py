...
class ReplicationReplicate(qumulo.lib.opts.Subcommand):
    ...
    SYNOPSIS = "Replicate from the source to the target of the " \
...
class ReplicationGetSourceRelationship(qumulo.lib.opts.Subcommand):
    ...
    SYNOPSIS = "Get information about the specified " \
...
class ReplicationModifySourceRelationship(qumulo.lib.opts.Subcommand):
    ...
    def options(parser):
        ...
        parser.add_argument(
            ...
            help="Network port to replicate to on the target")
        parser.add_argument('-z', '--timezone', type=str_decode,
...
class ReplicationListSourceRelationshipStatuses(qumulo.lib.opts.Subcommand):
    ...
    SYNOPSIS = "List statuses for all existing source replication " \
        "relationships."
...
class ReplicationListTargetRelationshipStatuses(qumulo.lib.opts.Subcommand):
    ...
    SYNOPSIS = "List statuses for all existing target " \
...
class ReplicationGetSourceRelationshipStatus(qumulo.lib.opts.Subcommand):
    ...
    SYNOPSIS = "Get current status of the specified " \
        "source replication relationship."
...
class ReplicationGetTargetRelationshipStatus(qumulo.lib.opts.Subcommand):
    ...
    SYNOPSIS = "Get current target of the specified " \
        "source replication relationship."
...
class ReplicationAuthorize(qumulo.lib.opts.Subcommand):
    ...
    SYNOPSIS = "Authorize the specified replication relationship, "+ \
...
class ReplicationReconnectTargetRelationship(qumulo.lib.opts.Subcommand):
    ...
    SYNOPSIS = "Make the target directory read-only and revert any " \
...
class ReplicationAbortReplication(qumulo.lib.opts.Subcommand):
    ...
    SYNOPSIS = "Abort ongoing replication work for the specified " \
        "source replication relationship."
    ...
    def options(parser):
        ...
        parser.add_argument(
            ...
            metavar='{true,false}',
            help=
                'If set to true and the currently replicating snapshot was '
...
class ReplicationAddBlackoutWindow(qumulo.lib.opts.Subcommand):
    ...
    SYNOPSIS = "Add a blackout window to the specified source replication " \
        "relationship."
    ...
    def options(parser):
        ...
        parser.add_argument("--start-time", required=True, type=str_decode,
            help="The 24 hour time of day start time for the blackout " \
                "window (e.g 15:30).")

        parser.add_argument("--end-time", required=True, type=str_decode,
        ...
        parser.add_argument("--days-of-week", required=True, type=str_decode,
...
class ReplicationDeleteBlackoutWindows(qumulo.lib.opts.Subcommand):
    ...
    SYNOPSIS = "Delete blackout windows of the specified source " \
...
class ReplicationLinkSnapshotPolicy(qumulo.lib.opts.Subcommand):
    ...
    def options(parser):
        ...
        parser.add_argument("-t", "--target-expiration", type=str_decode,
            default=None, help=(
...
class ReplicationUnlinkSnapshotPolicy(qumulo.lib.opts.Subcommand):
    ...
    SYNOPSIS = \
        "Unlink a snapshot policy from a source replication relationship."
    DESCRIPTION = (
...
class ReplicationListQueuedSnapshots(qumulo.lib.opts.Subcommand):
    ...
    SYNOPSIS = "List information for all snapshots awaiting replication " \
...
class ReplicationReleaseQueuedSnapshot(qumulo.lib.opts.Subcommand):
    ...
    SYNOPSIS = "Release a snapshot queued for replication from the queue " \
