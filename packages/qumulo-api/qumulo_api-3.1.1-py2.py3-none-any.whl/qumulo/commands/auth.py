...
class ChangePasswordCommand(qumulo.lib.opts.Subcommand):
    ...
    def options(parser):
        parser.add_argument(
            "-o", "--old-password", type=str_decode, default=None,
            help="Your old password (insecure, visible via ps)")
        parser.add_argument(
            "-p", "--new-password", type=str_decode, default=None,
...
class SetUserPasswordCommand(qumulo.lib.opts.Subcommand):
    ...
    @staticmethod
    def options(parser):
        parser.add_argument("--id", type=str_decode, default=None,
            required=True, help="Name or ID of user to modify")
...
class ListUserCommand(qumulo.lib.opts.Subcommand):
    ...
    def options(parser):
        parser.add_argument("--id", type=str_decode, default=None,
            required=True, help="Name or ID of user to lookup")
...
class AddUserCommand(qumulo.lib.opts.Subcommand):
    ...
    @staticmethod
    def options(parser):
        parser.add_argument("--name", type=str_decode, default=None,
            help="New user's name (windows style)", required=True)
        parser.add_argument("--primary-group", type=str_decode, default=0,
            help="name or id of primary group (default is Users)")
        parser.add_argument("--uid", type=int, default=None,
            help="optional NFS uid")
        parser.add_argument("--home-directory", type=str_decode, default=None,
            help="optional home directory")
        parser.add_argument("-p", "--password", type=str_decode, nargs='?',
            default=None,
...
class ModUserCommand(qumulo.lib.opts.Subcommand):
    ...
    def options(parser):
        ...
        parser.add_argument("--primary-group", type=str_decode, default=None,
            help="Change the user's primary group")
        parser.add_argument("--uid", type=str_decode, default=None,
            help="Change the user's NFS uid (or specify \"none\" to remove)")
        parser.add_argument("--add-group", type=str_decode, default=None,
            help="Add this user to a group")
        parser.add_argument("--remove-group", type=str_decode, default=None,
            help="Remove this user from a group")
        parser.add_argument("--home-directory", type=str_decode, default=None,
            help="Change the user's home directory path. "
                 "(or specify \"none\" to remove")
        parser.add_argument("-p", "--password", type=str_decode, nargs='?',
            const=True, default=None, help="Change the user password")
...
class DeleteUserCommand(qumulo.lib.opts.Subcommand):
    ...
    def options(parser):
        parser.add_argument("--id", type=str_decode, default=None,
            required=True, help="Name or ID of user to delete")
...
class ListGroupCommand(qumulo.lib.opts.Subcommand):
    ...
    @staticmethod
    def options(parser):
        parser.add_argument("--id", type=str_decode,
            required=True, help="Name or ID of group to list")
...
class AddGroupCommand(qumulo.lib.opts.Subcommand):
    ...
    @staticmethod
    def options(parser):
        parser.add_argument("--name", type=str_decode, required=True,
...
class ModGroupCommand(qumulo.lib.opts.Subcommand):
    ...
    def options(parser):
        parser.add_argument("--id", type=str_decode,
            required=True, help="Name or ID of group to modify")
        parser.add_argument("--name", default=None, help="Change group's name")
        parser.add_argument("--gid", type=str_decode, default=None,
...
class DeleteGroupCommand(qumulo.lib.opts.Subcommand):
    ...
    def options(parser):
        parser.add_argument("--id", type=str_decode,
            required=True, help="Name or ID of group to delete")
...
class GetAllRelatedIdentitiesCommand(qumulo.lib.opts.Subcommand):
    ...
    SYNOPSIS = 'Get all identities related to the given ID. ' \
...
def tabulate_id_list(ids):
    ...
    return util.tabulate(
        sorted([
            [str(i) if i.has_name() else u'', i.numeric_str()]
            for i in ids]),
        headers=["Name", "ID"])
