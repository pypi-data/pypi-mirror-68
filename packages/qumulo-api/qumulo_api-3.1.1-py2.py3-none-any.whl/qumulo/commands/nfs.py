...
def pretty_print_export(export, print_json):
    ...
    print(u'32bit-mapped fields: {}'.format(
...
class NFSGetExportCommand(Subcommand):
    ...
    def options(parser):
        ...
        export.add_argument("--id", type=str_decode, default=None,
...
PRESENT_32B_HELP = 'Fields that should be forced to fit in 32 bits for this ' \
...
class NFSAddExportCommand(Subcommand):
    ...
    def options(parser):
        ...
        restriction_arg.add_argument("--restrictions", type=str_decode,
            default=None, metavar='JSON_FILE_PATH', required=False,
        ...
        parser.add_argument(
            ...
            choices=PRESENT_32B_CHOICES, metavar="FIELD", nargs="+",
            required=False, help=PRESENT_32B_HELP)
...
class NFSModExportCommand(Subcommand):
    ...
    def main(conninfo, credentials, args):
        ...
        if args.fields_to_present_as_32_bit is not None:
            export_info['fields_to_present_as_32_bit'] = \
                args.fields_to_present_as_32_bit
...
def add_common_export_args(subparser):
    ...
    anon.add_argument("--anon-local", type=str_decode,
...
class NFSModExportHostAccessCommand(Subcommand):
    ...
    def options(parser):
        ...
        add_entry.add_argument("--hosts", "-o",
            type=str_decode, required=False, nargs="+", default=["*"],
        ...
        mod_entry.add_argument("--hosts", "-o",
            type=str_decode, required=False, nargs="+", default=None,
