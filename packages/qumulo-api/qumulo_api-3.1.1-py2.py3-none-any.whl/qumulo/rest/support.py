...
@request.request
def set_config(conninfo, credentials, enabled=None,
               mq_host=None, mq_port=None,
               mq_proxy_host=None, mq_proxy_port=None,
               s3_proxy_host=None, s3_proxy_port=None,
               s3_proxy_disable_https=None, period=None,
    ...
    for field in ['enabled', 'mq_host', 'mq_port', 'mq_proxy_host',
                  ...
                  's3_proxy_disable_https', 'period', 'vpn_host',
                  'vpn_enabled']:
