...
@request.request
def copy(conninfo, credentials, source_path=None, source_id=None,
        source_snapshot=None, target_path=None, target_id=None,
        source_stream_id=None, target_stream_id=None,
        source_etag=None, target_etag=None,
...
def resolve_paths(conninfo, credentials, ids, snapshot=None):
    ...
    return request.rest_request(
        conninfo, credentials, method, str(uri), body=ids)
...
def acl_explain_rights(
    ...
    return request.rest_request(
        conninfo, credentials, method, str(uri), body=payload)
