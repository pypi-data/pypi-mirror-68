...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'f5bigip', 'v2.2.0-alpha.1589280859+g153c103'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource f5bigip v2.2.0-alpha.1589280859+g153c103`
                """)
            else:
                raise
