...
def test_print():
    command_string = "/1 0 get system.temperature\r\n"
    ac = AsciiCommand(command_string)
    printed_string = str(ac)
    assert(printed_string == command_string.rstrip("\r\n"))
