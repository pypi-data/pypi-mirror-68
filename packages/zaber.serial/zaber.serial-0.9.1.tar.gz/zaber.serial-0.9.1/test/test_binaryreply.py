...
def test_parsing_sign_extension_with_message_id():
    br = BinaryReply(b"\x01\x02\x03\x04\x85\x06", message_id=True)
    assert(br.device_number == 1)
    assert(br.command_number == 2)
    assert(br.data == 0xFF850403 - (1 << 32) == -8059901)
    assert(br.message_id == 6)
