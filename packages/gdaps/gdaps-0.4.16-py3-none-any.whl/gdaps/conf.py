...
DEFAULTS = {
    # enable the automatically configured admin for all models
    "ADMIN": True,
    # the project's name. Mostly, it's the first part of ROOT_URLPATH, but it can differ.
    # It is used for template variables and file names in plugins. Must be a valid identifier.
...
class PluginSettings:
    ...
    def __init__(
        ...
        if not namespace:
            raise RuntimeError(
                "GDAPS plugin settings must be namespaced. Please define one."
            )
