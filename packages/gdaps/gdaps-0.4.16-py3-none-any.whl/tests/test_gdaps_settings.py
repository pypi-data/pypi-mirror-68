...
def test_project_name_empty():
    settings = PluginSettings(namespace="GDAPS")
    assert settings.PROJECT_NAME is None


def test_project_name():
    defaults = {"PROJECT_NAME": "foo_bar"}
    settings = PluginSettings(namespace="GDAPS", defaults=defaults,)
