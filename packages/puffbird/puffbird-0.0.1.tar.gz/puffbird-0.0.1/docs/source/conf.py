...
# (e.g. '10min.rst' or 'puffbird.FrameEngine')
...
import puffbird  # noqa: E402 isort:skip

# version = '%s r%s' % (puffbird.__version__, svn_version())
version = str(puffbird.__version__)
...
html_theme_options = {
    "external_links": [],
    "github_url": "https://github.com/gucky92/puffbird",
...
# extlinks alias
extlinks = {
    "issue": ("https://github.com/gucky92/puffbird/issues/%s", "GH"),
    "wiki": ("https://github.com/gucky92/puffbird/wiki/%s", "wiki "),
}
...
def linkcode_resolve(domain, info):
    ...
    fn = os.path.relpath(fn, start=os.path.dirname(puffbird.__file__))

    if "+" in puffbird.__version__:
        return f"https://github.com/gucky92/puffbird/blob/master/puffbird/{fn}{linespec}"
    else:
        return (
            f"https://github.com/gucky92/puffbird/blob/"
            f"v{puffbird.__version__}/puffbird/{fn}{linespec}"
        )
