...
class Session:
    ...
    def get_cookies(self) -> Optional[BaseCookie]:
        ...
        """
        return self._session.cookie_jar.filter_cookies(URL("https://messenger.com"))

    @classmethod
    async def from_cookies(cls, cookies: BaseCookie):
        ...
        """
        session = session_factory()
        session.cookie_jar.update_cookies(cookies, URL("https://messenger.com"))
        return await cls._from_session(session=session)
