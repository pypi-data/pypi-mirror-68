...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gitlab', 'v2.2.0-alpha.1589289042+gab557ff'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gitlab v2.2.0-alpha.1589289042+gab557ff`
                """)
            else:
                raise
