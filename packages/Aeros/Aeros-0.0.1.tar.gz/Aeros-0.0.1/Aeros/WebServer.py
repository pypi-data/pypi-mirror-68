# import dns.resolver; get_ns = lambda domain: dns.resolver.query(domain, 'NS')
...
class WebServer(Quart):
    ...
    def __init__(self, import_name: str, logging_level: Union[int, str] = None):
    ...
    def start(self, hypercorn_arg_string: str) -> None:
