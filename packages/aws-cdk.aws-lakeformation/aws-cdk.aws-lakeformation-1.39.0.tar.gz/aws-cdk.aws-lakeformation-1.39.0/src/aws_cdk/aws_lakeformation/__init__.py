...
class CfnDataLakeSettings(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-lakeformation.CfnDataLakeSettings"):
    ...
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnDataLakeSettings":
    ...
    class DataLakePrincipalProperty():
        def __init__(self, *, data_lake_principal_identifier: typing.Optional[str]=None) -> None:
            """
...
class CfnDataLakeSettingsProps():
    def __init__(self, *, admins: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union["CfnDataLakeSettings.DataLakePrincipalProperty", aws_cdk.core.IResolvable]]]]]=None) -> None:
...
class CfnPermissions(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-lakeformation.CfnPermissions"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnPermissions":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-lakeformation.CfnPermissions.ColumnWildcardProperty", jsii_struct_bases=[], name_mapping={'excluded_column_names': 'excludedColumnNames'})
    class ColumnWildcardProperty():
        def __init__(self, *, excluded_column_names: typing.Optional[typing.List[str]]=None) -> None:
            """
            ...
            if excluded_column_names is not None: self._values["excluded_column_names"] = excluded_column_names
        ...
        def __repr__(self) -> str:
            return 'ColumnWildcardProperty(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-lakeformation.CfnPermissions.DataLocationResourceProperty", jsii_struct_bases=[], name_mapping={'s3_resource': 's3Resource'})
    class DataLocationResourceProperty():
        def __init__(self, *, s3_resource: typing.Optional[str]=None) -> None:
            ...
            if s3_resource is not None: self._values["s3_resource"] = s3_resource
        ...
        def __repr__(self) -> str:
            return 'DataLocationResourceProperty(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-lakeformation.CfnPermissions.ResourceProperty", jsii_struct_bases=[], name_mapping={'database_resource': 'databaseResource', 'data_location_resource': 'dataLocationResource', 'table_resource': 'tableResource', 'table_with_columns_resource': 'tableWithColumnsResource'})
    class ResourceProperty():
        def __init__(self, *, database_resource: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnPermissions.DatabaseResourceProperty"]]]=None, data_location_resource: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnPermissions.DataLocationResourceProperty"]]]=None, table_resource: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnPermissions.TableResourceProperty"]]]=None, table_with_columns_resource: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnPermissions.TableWithColumnsResourceProperty"]]]=None) -> None:
            """
            ...
            if data_location_resource is not None: self._values["data_location_resource"] = data_location_resource
            if table_resource is not None: self._values["table_resource"] = table_resource
            if table_with_columns_resource is not None: self._values["table_with_columns_resource"] = table_with_columns_resource
        ...
        @builtins.property
        def data_location_resource(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnPermissions.DataLocationResourceProperty"]]]:
        ...
        @builtins.property
        def table_with_columns_resource(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnPermissions.TableWithColumnsResourceProperty"]]]:
    ...
    class TableResourceProperty():
        def __init__(self, *, database_name: typing.Optional[str]=None, name: typing.Optional[str]=None) -> None:
            """
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-lakeformation.CfnPermissions.TableWithColumnsResourceProperty", jsii_struct_bases=[], name_mapping={'column_names': 'columnNames', 'column_wildcard': 'columnWildcard', 'database_name': 'databaseName', 'name': 'name'})
    class TableWithColumnsResourceProperty():
        def __init__(self, *, column_names: typing.Optional[typing.List[str]]=None, column_wildcard: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnPermissions.ColumnWildcardProperty"]]]=None, database_name: typing.Optional[str]=None, name: typing.Optional[str]=None) -> None:
            """
            ...
            if column_names is not None: self._values["column_names"] = column_names
            if column_wildcard is not None: self._values["column_wildcard"] = column_wildcard
            if database_name is not None: self._values["database_name"] = database_name
            if name is not None: self._values["name"] = name
        ...
        @builtins.property
        def column_wildcard(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnPermissions.ColumnWildcardProperty"]]]:
        ...
        def __repr__(self) -> str:
            return 'TableWithColumnsResourceProperty(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())
...
class CfnPermissionsProps():
    def __init__(self, *, data_lake_principal: typing.Union[aws_cdk.core.IResolvable, "CfnPermissions.DataLakePrincipalProperty"], resource: typing.Union[aws_cdk.core.IResolvable, "CfnPermissions.ResourceProperty"], permissions: typing.Optional[typing.List[str]]=None, permissions_with_grant_option: typing.Optional[typing.List[str]]=None) -> None:
...
class CfnResource(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-lakeformation.CfnResource"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnResource":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
class CfnResourceProps():
    def __init__(self, *, resource_arn: str, use_service_linked_role: typing.Union[bool, aws_cdk.core.IResolvable], role_arn: typing.Optional[str]=None) -> None:
