...
def test_RobotsFile():
    ...
    assert robots.test_url('https://www.example.com/something', 'googlebot')['disallowed'] == True
    assert robots.test_url('https://www.example.com/something', 'GOOGLEBOT')['disallowed'] == True
    assert robots.test_url('https://www.example.com/split_block_test', 'googlebot')['disallowed'] == True
    assert robots.test_url('https://www.example.com/something?url_query_test', 'googlebot')['disallowed'] == True
    assert robots.test_url('https://www.example.com/missing_leading_slash', 'googlebot')['disallowed'] == False
    assert robots.test_url('https://www.example.com/default_token', 'some_token')['disallowed'] == True

    assert robots.test_url('https://www.example.com/something', 'googlebot-news')['disallowed'] == True
    assert robots.test_url('https://www.example.com/negative_fallback_test', 'googlebot-images')['disallowed'] == True
    assert robots.test_url('https://www.example.com/something', 'googlebot-images')['disallowed'] == False
    assert robots.test_url('https://www.example.com/something/leading_wildcard', 'googlebot')['disallowed'] == True
    assert robots.test_url('https://www.example.com/something/default_trailing_wildcard', 'googlebot')['disallowed'] == True
    assert robots.test_url('https://www.example.com/same_length_allow_beats_disallow', 'googlebot')['disallowed'] == False
    assert robots.test_url('https://www.example.com/longer_allow_beats_disallow', 'googlebot')['disallowed'] == False
    assert robots.test_url('https://www.example.com/multiple__wildcards__test__', 'googlebot')['disallowed'] == True
