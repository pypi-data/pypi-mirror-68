...
@jsii.data_type(jsii_type="@aws-cdk/aws-apigateway.AccessLogDestinationConfig", jsii_struct_bases=[], name_mapping={'destination_arn': 'destinationArn'})
class AccessLogDestinationConfig():
    ...
    def __repr__(self) -> str:
        return 'AccessLogDestinationConfig(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


class AccessLogField(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-apigateway.AccessLogField"):
    ...
    @builtins.classmethod
    def context_authorizer_claims(cls, property: str) -> str:
    ...
    @builtins.classmethod
    def context_identity_cognito_authentication_provider(cls) -> str:
    ...
    @builtins.classmethod
    def context_identity_cognito_authentication_type(cls) -> str:
    ...
    @builtins.classmethod
    def context_identity_cognito_identity_id(cls) -> str:
    ...
    @builtins.classmethod
    def context_identity_cognito_identity_pool_id(cls) -> str:
    ...
    @builtins.classmethod
    def context_identity_user(cls) -> str:
    ...
    @builtins.classmethod
    def context_request_override_path(cls, path_name: str) -> str:
    ...
    @builtins.classmethod
    def context_request_override_querystring(cls, querystring_name: str) -> str:
    ...
    @builtins.classmethod
    def context_response_override_status(cls) -> str:
    ...
    @builtins.classmethod
    def context_webacl_arn(cls) -> str:
    ...
    @builtins.classmethod
    def context_xray_trace_id(cls) -> str:
...
class AccessLogFormat(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-apigateway.AccessLogFormat"):
    ...
    @builtins.classmethod
    def custom(cls, format: str) -> "AccessLogFormat":
        """Custom log format.
    ...
    @builtins.classmethod
    def json_with_standard_fields(cls, *, caller: bool, http_method: bool, ip: bool, protocol: bool, request_time: bool, resource_path: bool, response_length: bool, status: bool, user: bool) -> "AccessLogFormat":
        ...
        """
        fields = JsonWithStandardFieldProps(caller=caller, http_method=http_method, ip=ip, protocol=protocol, request_time=request_time, resource_path=resource_path, response_length=response_length, status=status, user=user)
...
class BasePathMapping(aws_cdk.core.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-apigateway.BasePathMapping"):
    ...
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, domain_name: "IDomainName", rest_api: "IRestApi", base_path: typing.Optional[str]=None, stage: typing.Optional["Stage"]=None) -> None:
        """
        :param scope: -
        :param id: -
        ...
        """
        props = BasePathMappingProps(domain_name=domain_name, rest_api=rest_api, base_path=base_path, stage=stage)

        jsii.create(BasePathMapping, self, [scope, id, props])


@jsii.data_type(jsii_type="@aws-cdk/aws-apigateway.BasePathMappingOptions", jsii_struct_bases=[], name_mapping={'base_path': 'basePath', 'stage': 'stage'})
class BasePathMappingOptions():
    def __init__(self, *, base_path: typing.Optional[str]=None, stage: typing.Optional["Stage"]=None) -> None:
        """
        :param base_path: The base path name that callers of the API must provide in the URL after the domain name (e.g. ``example.com/base-path``). If you specify this property, it can't be an empty string. Default: - map requests from the domain root (e.g. ``example.com``). If this is undefined, no additional mappings will be allowed on this domain name.
        :param stage: The Deployment stage of API [disable-awslint:ref-via-interface]. Default: - map to deploymentStage of restApi otherwise stage needs to pass in URL
        """
...
@jsii.data_type(jsii_type="@aws-cdk/aws-apigateway.BasePathMappingProps", jsii_struct_bases=[BasePathMappingOptions], name_mapping={'base_path': 'basePath', 'stage': 'stage', 'domain_name': 'domainName', 'rest_api': 'restApi'})
class BasePathMappingProps(BasePathMappingOptions):
    def __init__(self, *, base_path: typing.Optional[str]=None, stage: typing.Optional["Stage"]=None, domain_name: "IDomainName", rest_api: "IRestApi") -> None:
        """
        :param base_path: The base path name that callers of the API must provide in the URL after the domain name (e.g. ``example.com/base-path``). If you specify this property, it can't be an empty string. Default: - map requests from the domain root (e.g. ``example.com``). If this is undefined, no additional mappings will be allowed on this domain name.
        :param stage: The Deployment stage of API [disable-awslint:ref-via-interface]. Default: - map to deploymentStage of restApi otherwise stage needs to pass in URL
        :param domain_name: The DomainName to associate with this base path mapping.
...
class CfnAccountProps():
    def __init__(self, *, cloud_watch_role_arn: typing.Optional[str]=None) -> None:
...
class CfnApiKey(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-apigateway.CfnApiKey"):
    ...
    class StageKeyProperty():
        def __init__(self, *, rest_api_id: typing.Optional[str]=None, stage_name: typing.Optional[str]=None) -> None:
            """
...
class CfnApiKeyProps():
    def __init__(self, *, customer_id: typing.Optional[str]=None, description: typing.Optional[str]=None, enabled: typing.Optional[typing.Union[typing.Optional[bool], typing.Optional[aws_cdk.core.IResolvable]]]=None, generate_distinct_id: typing.Optional[typing.Union[typing.Optional[bool], typing.Optional[aws_cdk.core.IResolvable]]]=None, name: typing.Optional[str]=None, stage_keys: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnApiKey.StageKeyProperty"]]]]]=None, tags: typing.Optional[typing.List[aws_cdk.core.CfnTag]]=None, value: typing.Optional[str]=None) -> None:
...
class CfnBasePathMappingProps():
    def __init__(self, *, domain_name: str, base_path: typing.Optional[str]=None, rest_api_id: typing.Optional[str]=None, stage: typing.Optional[str]=None) -> None:
...
class CfnClientCertificateProps():
    def __init__(self, *, description: typing.Optional[str]=None, tags: typing.Optional[typing.List[aws_cdk.core.CfnTag]]=None) -> None:
...
class CfnDocumentationPart(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-apigateway.CfnDocumentationPart"):
    ...
    class LocationProperty():
        def __init__(self, *, method: typing.Optional[str]=None, name: typing.Optional[str]=None, path: typing.Optional[str]=None, status_code: typing.Optional[str]=None, type: typing.Optional[str]=None) -> None:
            """
...
class CfnDocumentationPartProps():
    def __init__(self, *, location: typing.Union["CfnDocumentationPart.LocationProperty", aws_cdk.core.IResolvable], properties: str, rest_api_id: str) -> None:
...
class CfnDocumentationVersionProps():
    def __init__(self, *, documentation_version: str, rest_api_id: str, description: typing.Optional[str]=None) -> None:
...
class CfnDomainName(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-apigateway.CfnDomainName"):
    ...
    class EndpointConfigurationProperty():
        def __init__(self, *, types: typing.Optional[typing.List[str]]=None) -> None:
            """
...
class CfnDomainNameV2Props():
    def __init__(self, *, domain_name: str, domain_name_configurations: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnDomainNameV2.DomainNameConfigurationProperty"]]]]]=None, tags: typing.Any=None) -> None:
...
class CfnMethod(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-apigateway.CfnMethod"):
    ...
    class IntegrationResponseProperty():
        def __init__(self, *, status_code: str, content_handling: typing.Optional[str]=None, response_parameters: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.Mapping[str, str]]]]=None, response_templates: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.Mapping[str, str]]]]=None, selection_pattern: typing.Optional[str]=None) -> None:
            """
...
class CfnModelProps():
    def __init__(self, *, rest_api_id: str, content_type: typing.Optional[str]=None, description: typing.Optional[str]=None, name: typing.Optional[str]=None, schema: typing.Any=None) -> None:
...
class CfnResourceProps():
    def __init__(self, *, parent_id: str, path_part: str, rest_api_id: str) -> None:
...
class CfnRestApi(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-apigateway.CfnRestApi"):
    ...
    class EndpointConfigurationProperty():
        def __init__(self, *, types: typing.Optional[typing.List[str]]=None, vpc_endpoint_ids: typing.Optional[typing.List[str]]=None) -> None:
            """
    ...
    class S3LocationProperty():
        def __init__(self, *, bucket: typing.Optional[str]=None, e_tag: typing.Optional[str]=None, key: typing.Optional[str]=None, version: typing.Optional[str]=None) -> None:
            """
...
class CfnStageV2Props():
    def __init__(self, *, api_id: str, stage_name: str, access_log_settings: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnStageV2.AccessLogSettingsProperty"]]]=None, auto_deploy: typing.Optional[typing.Union[typing.Optional[bool], typing.Optional[aws_cdk.core.IResolvable]]]=None, client_certificate_id: typing.Optional[str]=None, default_route_settings: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnStageV2.RouteSettingsProperty"]]]=None, deployment_id: typing.Optional[str]=None, description: typing.Optional[str]=None, route_settings: typing.Any=None, stage_variables: typing.Any=None, tags: typing.Any=None) -> None:
...
class CfnUsagePlan(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-apigateway.CfnUsagePlan"):
    ...
    class ApiStageProperty():
        def __init__(self, *, api_id: typing.Optional[str]=None, stage: typing.Optional[str]=None, throttle: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.Mapping[str, typing.Union[aws_cdk.core.IResolvable, "CfnUsagePlan.ThrottleSettingsProperty"]]]]]=None) -> None:
            """
    ...
    class QuotaSettingsProperty():
        def __init__(self, *, limit: typing.Optional[jsii.Number]=None, offset: typing.Optional[jsii.Number]=None, period: typing.Optional[str]=None) -> None:
            """
    ...
    class ThrottleSettingsProperty():
        def __init__(self, *, burst_limit: typing.Optional[jsii.Number]=None, rate_limit: typing.Optional[jsii.Number]=None) -> None:
            """
...
class CfnUsagePlanKeyProps():
    def __init__(self, *, key_id: str, key_type: str, usage_plan_id: str) -> None:
...
class CfnVpcLinkProps():
    def __init__(self, *, name: str, target_arns: typing.List[str], description: typing.Optional[str]=None) -> None:
...
class DeploymentProps():
    def __init__(self, *, api: "IRestApi", description: typing.Optional[str]=None, retain_deployments: typing.Optional[bool]=None) -> None:
        """
        :param api: The Rest API to deploy.
        :param description: A description of the purpose of the API Gateway deployment. Default: - No description.
        :param retain_deployments: When an API Gateway model is updated, a new deployment will automatically be created. If this is true, the old API Gateway Deployment resource will not be deleted. This will allow manually reverting back to a previous deployment in case for example Default: false
...
class DomainNameAttributes():
    def __init__(self, *, domain_name: str, domain_name_alias_hosted_zone_id: str, domain_name_alias_target: str) -> None:
        """
...
@jsii.data_type(jsii_type="@aws-cdk/aws-apigateway.DomainNameOptions", jsii_struct_bases=[], name_mapping={'certificate': 'certificate', 'domain_name': 'domainName', 'endpoint_type': 'endpointType', 'security_policy': 'securityPolicy'})
class DomainNameOptions():
    def __init__(self, *, certificate: aws_cdk.aws_certificatemanager.ICertificate, domain_name: str, endpoint_type: typing.Optional["EndpointType"]=None, security_policy: typing.Optional["SecurityPolicy"]=None) -> None:
        """
...
@jsii.data_type(jsii_type="@aws-cdk/aws-apigateway.DomainNameProps", jsii_struct_bases=[DomainNameOptions], name_mapping={'certificate': 'certificate', 'domain_name': 'domainName', 'endpoint_type': 'endpointType', 'security_policy': 'securityPolicy', 'mapping': 'mapping'})
class DomainNameProps(DomainNameOptions):
    def __init__(self, *, certificate: aws_cdk.aws_certificatemanager.ICertificate, domain_name: str, endpoint_type: typing.Optional["EndpointType"]=None, security_policy: typing.Optional["SecurityPolicy"]=None, mapping: typing.Optional["IRestApi"]=None) -> None:
        """
        :param certificate: The reference to an AWS-managed certificate for use by the edge-optimized endpoint for the domain name. For "EDGE" domain names, the certificate needs to be in the US East (N. Virginia) region.
        :param domain_name: The custom domain name for your API. Uppercase letters are not supported.
        :param endpoint_type: The type of endpoint for this DomainName. Default: REGIONAL
...
@jsii.data_type(jsii_type="@aws-cdk/aws-apigateway.EndpointConfiguration", jsii_struct_bases=[], name_mapping={'types': 'types', 'vpc_endpoints': 'vpcEndpoints'})
class EndpointConfiguration():
    def __init__(self, *, types: typing.List["EndpointType"], vpc_endpoints: typing.Optional[typing.List[aws_cdk.aws_ec2.IVpcEndpoint]]=None) -> None:
        """The endpoint configuration of a REST API, including VPCs and endpoint types.

        EndpointConfiguration is a property of the AWS::ApiGateway::RestApi resource.

        :param types: A list of endpoint types of an API or its custom domain name. Default: - no endpoint types.
        ...
        if vpc_endpoints is not None: self._values["vpc_endpoints"] = vpc_endpoints
    ...
    @builtins.property
    def vpc_endpoints(self) -> typing.Optional[typing.List[aws_cdk.aws_ec2.IVpcEndpoint]]:
        """A list of VPC Endpoints against which to create Route53 ALIASes.

        default
        :default: - no ALIASes are created for the endpoint.
        """
        return self._values.get('vpc_endpoints')
    ...
    def __repr__(self) -> str:
        return 'EndpointConfiguration(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())
...
@jsii.data_type(jsii_type="@aws-cdk/aws-apigateway.GatewayResponseOptions", jsii_struct_bases=[], name_mapping={'type': 'type', 'response_headers': 'responseHeaders', 'status_code': 'statusCode', 'templates': 'templates'})
class GatewayResponseOptions():
    def __init__(self, *, type: "ResponseType", response_headers: typing.Optional[typing.Mapping[str, str]]=None, status_code: typing.Optional[str]=None, templates: typing.Optional[typing.Mapping[str, str]]=None) -> None:
        ...
        if response_headers is not None: self._values["response_headers"] = response_headers
        if status_code is not None: self._values["status_code"] = status_code
        if templates is not None: self._values["templates"] = templates
    ...
    @builtins.property
    def response_headers(self) -> typing.Optional[typing.Mapping[str, str]]:
        """Custom headers parameters for response.

        default
        :default: - no headers
        """
        return self._values.get('response_headers')
    ...
    @builtins.property
    def templates(self) -> typing.Optional[typing.Mapping[str, str]]:
        """Custom templates to get mapped as response.

        default
        :default: - Response from api will be returned without applying any transformation.
        """
        return self._values.get('templates')
    ...
    def __repr__(self) -> str:
        return 'GatewayResponseOptions(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


@jsii.data_type(jsii_type="@aws-cdk/aws-apigateway.GatewayResponseProps", jsii_struct_bases=[GatewayResponseOptions], name_mapping={'type': 'type', 'response_headers': 'responseHeaders', 'status_code': 'statusCode', 'templates': 'templates', 'rest_api': 'restApi'})
class GatewayResponseProps(GatewayResponseOptions):
    def __init__(self, *, type: "ResponseType", response_headers: typing.Optional[typing.Mapping[str, str]]=None, status_code: typing.Optional[str]=None, templates: typing.Optional[typing.Mapping[str, str]]=None, rest_api: "IRestApi") -> None:
    ...
    def __repr__(self) -> str:
        return 'GatewayResponseProps(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())
...
class HttpIntegrationProps():
    def __init__(self, *, http_method: typing.Optional[str]=None, options: typing.Optional["IntegrationOptions"]=None, proxy: typing.Optional[bool]=None) -> None:
        """
...
class IAccessLogDestination(jsii.compat.Protocol):
...
class _IAccessLogDestinationProxy():
    """Access log destination for a RestApi Stage."""
    __jsii_type__ = "@aws-cdk/aws-apigateway.IAccessLogDestination"
    @jsii.member(jsii_name="bind")
    def bind(self, stage: "IStage") -> "AccessLogDestinationConfig":
        """Binds this destination to the RestApi Stage.
...
class IGatewayResponse(aws_cdk.core.IResource, jsii.compat.Protocol):
...
class _IGatewayResponseProxy(jsii.proxy_for(aws_cdk.core.IResource)):
    """Represents gateway response resource."""
    __jsii_type__ = "@aws-cdk/aws-apigateway.IGatewayResponse"
    pass
...
class IResource(aws_cdk.core.IResource, jsii.compat.Protocol):
    ...
    def add_method(self, http_method: str, target: typing.Optional["Integration"]=None, *, api_key_required: typing.Optional[bool]=None, authorization_scopes: typing.Optional[typing.List[str]]=None, authorization_type: typing.Optional["AuthorizationType"]=None, authorizer: typing.Optional["IAuthorizer"]=None, method_responses: typing.Optional[typing.List["MethodResponse"]]=None, operation_name: typing.Optional[str]=None, request_models: typing.Optional[typing.Mapping[str, "IModel"]]=None, request_parameters: typing.Optional[typing.Mapping[str, bool]]=None, request_validator: typing.Optional["IRequestValidator"]=None, request_validator_options: typing.Optional["RequestValidatorOptions"]=None) -> "Method":
...
class _IResourceProxy(jsii.proxy_for(aws_cdk.core.IResource)):
    ...
    def add_method(self, http_method: str, target: typing.Optional["Integration"]=None, *, api_key_required: typing.Optional[bool]=None, authorization_scopes: typing.Optional[typing.List[str]]=None, authorization_type: typing.Optional["AuthorizationType"]=None, authorizer: typing.Optional["IAuthorizer"]=None, method_responses: typing.Optional[typing.List["MethodResponse"]]=None, operation_name: typing.Optional[str]=None, request_models: typing.Optional[typing.Mapping[str, "IModel"]]=None, request_parameters: typing.Optional[typing.Mapping[str, bool]]=None, request_validator: typing.Optional["IRequestValidator"]=None, request_validator_options: typing.Optional["RequestValidatorOptions"]=None) -> "Method":
        ...
        :return: The newly created ``Method`` object.
        """
        options = MethodOptions(api_key_required=api_key_required, authorization_scopes=authorization_scopes, authorization_type=authorization_type, authorizer=authorizer, method_responses=method_responses, operation_name=operation_name, request_models=request_models, request_parameters=request_parameters, request_validator=request_validator, request_validator_options=request_validator_options)
...
class _IStageProxy(jsii.proxy_for(aws_cdk.core.IResource)):
    """Represents an APIGateway Stage."""
    __jsii_type__ = "@aws-cdk/aws-apigateway.IStage"
    @builtins.property
    @jsii.member(jsii_name="restApi")
    def rest_api(self) -> "IRestApi":
        """RestApi to which this stage is associated."""
...
class IdentitySource(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-apigateway.IdentitySource"):
    ...
    @builtins.classmethod
    def context(cls, context: str) -> str:
    ...
    @builtins.classmethod
    def header(cls, header_name: str) -> str:
    ...
    @builtins.classmethod
    def query_string(cls, query_string: str) -> str:
    ...
    @builtins.classmethod
    def stage_variable(cls, stage_variable: str) -> str:
...
class IntegrationResponse():
    def __init__(self, *, status_code: str, content_handling: typing.Optional["ContentHandling"]=None, response_parameters: typing.Optional[typing.Mapping[str, str]]=None, response_templates: typing.Optional[typing.Mapping[str, str]]=None, selection_pattern: typing.Optional[str]=None) -> None:
        """
...
@jsii.data_type(jsii_type="@aws-cdk/aws-apigateway.JsonWithStandardFieldProps", jsii_struct_bases=[], name_mapping={'caller': 'caller', 'http_method': 'httpMethod', 'ip': 'ip', 'protocol': 'protocol', 'request_time': 'requestTime', 'resource_path': 'resourcePath', 'response_length': 'responseLength', 'status': 'status', 'user': 'user'})
class JsonWithStandardFieldProps():
    def __init__(self, *, caller: bool, http_method: bool, ip: bool, protocol: bool, request_time: bool, resource_path: bool, response_length: bool, status: bool, user: bool) -> None:
    ...
    def __repr__(self) -> str:
        return 'JsonWithStandardFieldProps(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


@jsii.data_type(jsii_type="@aws-cdk/aws-apigateway.LambdaAuthorizerProps", jsii_struct_bases=[], name_mapping={'handler': 'handler', 'assume_role': 'assumeRole', 'authorizer_name': 'authorizerName', 'results_cache_ttl': 'resultsCacheTtl'})
class LambdaAuthorizerProps():
    def __init__(self, *, handler: aws_cdk.aws_lambda.IFunction, assume_role: typing.Optional[aws_cdk.aws_iam.IRole]=None, authorizer_name: typing.Optional[str]=None, results_cache_ttl: typing.Optional[aws_cdk.core.Duration]=None) -> None:
    ...
    def __repr__(self) -> str:
        return 'LambdaAuthorizerProps(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())
...
class LogGroupLogDestination(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-apigateway.LogGroupLogDestination"):
    """Use CloudWatch Logs as a custom access log destination for API Gateway."""
    def __init__(self, log_group: aws_cdk.aws_logs.ILogGroup) -> None:
        """
        :param log_group: -
        """
...
@jsii.data_type(jsii_type="@aws-cdk/aws-apigateway.MethodOptions", jsii_struct_bases=[], name_mapping={'api_key_required': 'apiKeyRequired', 'authorization_scopes': 'authorizationScopes', 'authorization_type': 'authorizationType', 'authorizer': 'authorizer', 'method_responses': 'methodResponses', 'operation_name': 'operationName', 'request_models': 'requestModels', 'request_parameters': 'requestParameters', 'request_validator': 'requestValidator', 'request_validator_options': 'requestValidatorOptions'})
class MethodOptions():
    def __init__(self, *, api_key_required: typing.Optional[bool]=None, authorization_scopes: typing.Optional[typing.List[str]]=None, authorization_type: typing.Optional["AuthorizationType"]=None, authorizer: typing.Optional["IAuthorizer"]=None, method_responses: typing.Optional[typing.List["MethodResponse"]]=None, operation_name: typing.Optional[str]=None, request_models: typing.Optional[typing.Mapping[str, "IModel"]]=None, request_parameters: typing.Optional[typing.Mapping[str, bool]]=None, request_validator: typing.Optional["IRequestValidator"]=None, request_validator_options: typing.Optional["RequestValidatorOptions"]=None) -> None:
        """
        :param api_key_required: Indicates whether the method requires clients to submit a valid API key. Default: false
        :param authorization_scopes: A list of authorization scopes configured on the method. The scopes are used with a COGNITO_USER_POOLS authorizer to authorize the method invocation. Default: - no authorization scopes
        :param authorization_type: Method authorization. If the value is set of ``Custom``, an ``authorizer`` must also be specified. If you're using one of the authorizers that are available via the {@link Authorizer} class, such as {@link Authorizer#token()}, it is recommended that this option not be specified. The authorizer will take care of setting the correct authorization type. However, specifying an authorization type using this property that conflicts with what is expected by the {@link Authorizer} will result in an error. Default: - open access unless ``authorizer`` is specified
        ...
        :param request_validator_options: Request validator options to create new validator Only one of ``requestValidator`` or ``requestValidatorOptions`` must be specified. Works together with ``requestModels`` or ``requestParameters`` to validate the request before it reaches integration like Lambda Proxy Integration. Default: - No default validator
        """
        if isinstance(request_validator_options, dict): request_validator_options = RequestValidatorOptions(**request_validator_options)
        self._values = {
        }
        if api_key_required is not None: self._values["api_key_required"] = api_key_required
        if authorization_scopes is not None: self._values["authorization_scopes"] = authorization_scopes
        ...
        if request_validator_options is not None: self._values["request_validator_options"] = request_validator_options
    ...
    def request_validator_options(self) -> typing.Optional["RequestValidatorOptions"]:
        ...
        :default: - No default validator
        """
        return self._values.get('request_validator_options')
...
class MethodProps():
    def __init__(self, *, http_method: str, resource: "IResource", integration: typing.Optional["Integration"]=None, options: typing.Optional["MethodOptions"]=None) -> None:
        """
        :param http_method: The HTTP method ("GET", "POST", "PUT", ...) that clients use to call this method.
        :param resource: The resource this method is associated with. For root resource methods, specify the ``RestApi`` object.
        :param integration: The backend system that the method calls when it receives a request. Default: - a new ``MockIntegration``.
...
class MethodResponse():
    def __init__(self, *, status_code: str, response_models: typing.Optional[typing.Mapping[str, "IModel"]]=None, response_parameters: typing.Optional[typing.Mapping[str, bool]]=None) -> None:
        """
...
class ModelOptions():
    def __init__(self, *, schema: "JsonSchema", content_type: typing.Optional[str]=None, description: typing.Optional[str]=None, model_name: typing.Optional[str]=None) -> None:
        """
        :param schema: The schema to use to transform data to one or more output formats. Specify null ({}) if you don't want to specify a schema.
        :param content_type: The content type for the model. You can also force a content type in the request or response model mapping. Default: 'application/json'
        :param description: A description that identifies this model. Default: None
...
class ModelProps(ModelOptions):
    def __init__(self, *, schema: "JsonSchema", content_type: typing.Optional[str]=None, description: typing.Optional[str]=None, model_name: typing.Optional[str]=None, rest_api: "IRestApi") -> None:
        """
        :param schema: The schema to use to transform data to one or more output formats. Specify null ({}) if you don't want to specify a schema.
        :param content_type: The content type for the model. You can also force a content type in the request or response model mapping. Default: 'application/json'
        :param description: A description that identifies this model. Default: None
...
class QuotaSettings():
    def __init__(self, *, limit: typing.Optional[jsii.Number]=None, offset: typing.Optional[jsii.Number]=None, period: typing.Optional["Period"]=None) -> None:
...
class RateLimitedApiKey(aws_cdk.core.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-apigateway.RateLimitedApiKey"):
    ...
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, api_stages: typing.Optional[typing.List["UsagePlanPerApiStage"]]=None, quota: typing.Optional["QuotaSettings"]=None, throttle: typing.Optional["ThrottleSettings"]=None, api_key_name: typing.Optional[str]=None, customer_id: typing.Optional[str]=None, description: typing.Optional[str]=None, enabled: typing.Optional[bool]=None, generate_distinct_id: typing.Optional[bool]=None, resources: typing.Optional[typing.List["RestApi"]]=None, default_cors_preflight_options: typing.Optional["CorsOptions"]=None, default_integration: typing.Optional["Integration"]=None, default_method_options: typing.Optional["MethodOptions"]=None) -> None:
        ...
        :param resources: [disable-awslint:ref-via-interface] A list of resources this api key is associated with. Default: none
        :param default_cors_preflight_options: Adds a CORS preflight OPTIONS method to this resource and all child resources. You can add CORS at the resource-level using ``addCorsPreflight``. Default: - CORS is disabled
        :param default_integration: An integration to use as a default for all methods created within this API unless an integration is specified. Default: - Inherited from parent.
        :param default_method_options: Method options to use as a default for all methods created within this API unless custom options are specified. Default: - Inherited from parent.
        """
        props = RateLimitedApiKeyProps(api_stages=api_stages, quota=quota, throttle=throttle, api_key_name=api_key_name, customer_id=customer_id, description=description, enabled=enabled, generate_distinct_id=generate_distinct_id, resources=resources, default_cors_preflight_options=default_cors_preflight_options, default_integration=default_integration, default_method_options=default_method_options)
...
@jsii.data_type(jsii_type="@aws-cdk/aws-apigateway.RequestAuthorizerProps", jsii_struct_bases=[LambdaAuthorizerProps], name_mapping={'handler': 'handler', 'assume_role': 'assumeRole', 'authorizer_name': 'authorizerName', 'results_cache_ttl': 'resultsCacheTtl', 'identity_sources': 'identitySources'})
class RequestAuthorizerProps(LambdaAuthorizerProps):
    def __init__(self, *, handler: aws_cdk.aws_lambda.IFunction, assume_role: typing.Optional[aws_cdk.aws_iam.IRole]=None, authorizer_name: typing.Optional[str]=None, results_cache_ttl: typing.Optional[aws_cdk.core.Duration]=None, identity_sources: typing.List[str]) -> None:
    ...
    def __repr__(self) -> str:
        return 'RequestAuthorizerProps(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())
...
class RequestValidatorOptions():
    def __init__(self, *, request_validator_name: typing.Optional[str]=None, validate_request_body: typing.Optional[bool]=None, validate_request_parameters: typing.Optional[bool]=None) -> None:
        """
        :param request_validator_name: The name of this request validator. Default: None
        :param validate_request_body: Indicates whether to validate the request body according to the configured schema for the targeted API and method. Default: false
        :param validate_request_parameters: Indicates whether to validate request parameters. Default: false
...
class RequestValidatorProps(RequestValidatorOptions):
    def __init__(self, *, request_validator_name: typing.Optional[str]=None, validate_request_body: typing.Optional[bool]=None, validate_request_parameters: typing.Optional[bool]=None, rest_api: "IRestApi") -> None:
        """
        :param request_validator_name: The name of this request validator. Default: None
        :param validate_request_body: Indicates whether to validate the request body according to the configured schema for the targeted API and method. Default: false
        :param validate_request_parameters: Indicates whether to validate request parameters. Default: false
...
class ResourceBase(aws_cdk.core.Resource, metaclass=jsii.JSIIAbstractClass, jsii_type="@aws-cdk/aws-apigateway.ResourceBase"):
    ...
    @jsii.member(jsii_name="addMethod")
    def add_method(self, http_method: str, integration: typing.Optional["Integration"]=None, *, api_key_required: typing.Optional[bool]=None, authorization_scopes: typing.Optional[typing.List[str]]=None, authorization_type: typing.Optional["AuthorizationType"]=None, authorizer: typing.Optional["IAuthorizer"]=None, method_responses: typing.Optional[typing.List["MethodResponse"]]=None, operation_name: typing.Optional[str]=None, request_models: typing.Optional[typing.Mapping[str, "IModel"]]=None, request_parameters: typing.Optional[typing.Mapping[str, bool]]=None, request_validator: typing.Optional["IRequestValidator"]=None, request_validator_options: typing.Optional["RequestValidatorOptions"]=None) -> "Method":
        """Defines a new method for this resource.
...
class ResourceOptions():
    def __init__(self, *, default_cors_preflight_options: typing.Optional["CorsOptions"]=None, default_integration: typing.Optional["Integration"]=None, default_method_options: typing.Optional["MethodOptions"]=None) -> None:
        """
        :param default_cors_preflight_options: Adds a CORS preflight OPTIONS method to this resource and all child resources. You can add CORS at the resource-level using ``addCorsPreflight``. Default: - CORS is disabled
        :param default_integration: An integration to use as a default for all methods created within this API unless an integration is specified. Default: - Inherited from parent.
        :param default_method_options: Method options to use as a default for all methods created within this API unless custom options are specified. Default: - Inherited from parent.
...
class ResourceProps(ResourceOptions):
    def __init__(self, *, default_cors_preflight_options: typing.Optional["CorsOptions"]=None, default_integration: typing.Optional["Integration"]=None, default_method_options: typing.Optional["MethodOptions"]=None, parent: "IResource", path_part: str) -> None:
        """
        :param default_cors_preflight_options: Adds a CORS preflight OPTIONS method to this resource and all child resources. You can add CORS at the resource-level using ``addCorsPreflight``. Default: - CORS is disabled
        :param default_integration: An integration to use as a default for all methods created within this API unless an integration is specified. Default: - Inherited from parent.
        :param default_method_options: Method options to use as a default for all methods created within this API unless custom options are specified. Default: - Inherited from parent.
...
class ResponseType(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-apigateway.ResponseType"):
    ...
    @builtins.classmethod
    def of(cls, type: str) -> "ResponseType":
...
class RestApi(aws_cdk.core.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-apigateway.RestApi"):
    ...
    public endpoint.
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, api_key_source_type: typing.Optional["ApiKeySourceType"]=None, binary_media_types: typing.Optional[typing.List[str]]=None, clone_from: typing.Optional["IRestApi"]=None, cloud_watch_role: typing.Optional[bool]=None, deploy: typing.Optional[bool]=None, deploy_options: typing.Optional["StageOptions"]=None, description: typing.Optional[str]=None, domain_name: typing.Optional["DomainNameOptions"]=None, endpoint_configuration: typing.Optional["EndpointConfiguration"]=None, endpoint_export_name: typing.Optional[str]=None, endpoint_types: typing.Optional[typing.List["EndpointType"]]=None, fail_on_warnings: typing.Optional[bool]=None, minimum_compression_size: typing.Optional[jsii.Number]=None, parameters: typing.Optional[typing.Mapping[str, str]]=None, policy: typing.Optional[aws_cdk.aws_iam.PolicyDocument]=None, rest_api_name: typing.Optional[str]=None, retain_deployments: typing.Optional[bool]=None, default_cors_preflight_options: typing.Optional["CorsOptions"]=None, default_integration: typing.Optional["Integration"]=None, default_method_options: typing.Optional["MethodOptions"]=None) -> None:
        """
        :param scope: -
        :param id: -
        ...
        :param endpoint_configuration: The EndpointConfiguration property type specifies the endpoint types of a REST API. Default: - No endpoint configuration
        ...
        :param default_method_options: Method options to use as a default for all methods created within this API unless custom options are specified. Default: - Inherited from parent.
        """
        props = RestApiProps(api_key_source_type=api_key_source_type, binary_media_types=binary_media_types, clone_from=clone_from, cloud_watch_role=cloud_watch_role, deploy=deploy, deploy_options=deploy_options, description=description, domain_name=domain_name, endpoint_configuration=endpoint_configuration, endpoint_export_name=endpoint_export_name, endpoint_types=endpoint_types, fail_on_warnings=fail_on_warnings, minimum_compression_size=minimum_compression_size, parameters=parameters, policy=policy, rest_api_name=rest_api_name, retain_deployments=retain_deployments, default_cors_preflight_options=default_cors_preflight_options, default_integration=default_integration, default_method_options=default_method_options)
    ...
    def add_domain_name(self, id: str, *, certificate: aws_cdk.aws_certificatemanager.ICertificate, domain_name: str, endpoint_type: typing.Optional["EndpointType"]=None, security_policy: typing.Optional["SecurityPolicy"]=None) -> "DomainName":
        ...
        :param security_policy: The Transport Layer Security (TLS) version + cipher suite for this domain name. Default: SecurityPolicy.TLS_1_0
        """
        options = DomainNameOptions(certificate=certificate, domain_name=domain_name, endpoint_type=endpoint_type, security_policy=security_policy)

        return jsii.invoke(self, "addDomainName", [id, options])

    @jsii.member(jsii_name="addGatewayResponse")
    def add_gateway_response(self, id: str, *, type: "ResponseType", response_headers: typing.Optional[typing.Mapping[str, str]]=None, status_code: typing.Optional[str]=None, templates: typing.Optional[typing.Mapping[str, str]]=None) -> "GatewayResponse":
        ...
        :param templates: Custom templates to get mapped as response. Default: - Response from api will be returned without applying any transformation.
        """
        options = GatewayResponseOptions(type=type, response_headers=response_headers, status_code=status_code, templates=templates)
...
class RestApiProps(ResourceOptions):
    def __init__(self, *, default_cors_preflight_options: typing.Optional["CorsOptions"]=None, default_integration: typing.Optional["Integration"]=None, default_method_options: typing.Optional["MethodOptions"]=None, api_key_source_type: typing.Optional["ApiKeySourceType"]=None, binary_media_types: typing.Optional[typing.List[str]]=None, clone_from: typing.Optional["IRestApi"]=None, cloud_watch_role: typing.Optional[bool]=None, deploy: typing.Optional[bool]=None, deploy_options: typing.Optional["StageOptions"]=None, description: typing.Optional[str]=None, domain_name: typing.Optional["DomainNameOptions"]=None, endpoint_configuration: typing.Optional["EndpointConfiguration"]=None, endpoint_export_name: typing.Optional[str]=None, endpoint_types: typing.Optional[typing.List["EndpointType"]]=None, fail_on_warnings: typing.Optional[bool]=None, minimum_compression_size: typing.Optional[jsii.Number]=None, parameters: typing.Optional[typing.Mapping[str, str]]=None, policy: typing.Optional[aws_cdk.aws_iam.PolicyDocument]=None, rest_api_name: typing.Optional[str]=None, retain_deployments: typing.Optional[bool]=None) -> None:
        ...
        if isinstance(endpoint_configuration, dict): endpoint_configuration = EndpointConfiguration(**endpoint_configuration)
        self._values = {
        }
        if default_cors_preflight_options is not None: self._values["default_cors_preflight_options"] = default_cors_preflight_options
        if default_integration is not None: self._values["default_integration"] = default_integration
...
class StageOptions(MethodDeploymentOptions):
    def __init__(self, *, cache_data_encrypted: typing.Optional[bool]=None, cache_ttl: typing.Optional[aws_cdk.core.Duration]=None, caching_enabled: typing.Optional[bool]=None, data_trace_enabled: typing.Optional[bool]=None, logging_level: typing.Optional["MethodLoggingLevel"]=None, metrics_enabled: typing.Optional[bool]=None, throttling_burst_limit: typing.Optional[jsii.Number]=None, throttling_rate_limit: typing.Optional[jsii.Number]=None, access_log_destination: typing.Optional["IAccessLogDestination"]=None, access_log_format: typing.Optional["AccessLogFormat"]=None, cache_cluster_enabled: typing.Optional[bool]=None, cache_cluster_size: typing.Optional[str]=None, client_certificate_id: typing.Optional[str]=None, description: typing.Optional[str]=None, documentation_version: typing.Optional[str]=None, method_options: typing.Optional[typing.Mapping[str, "MethodDeploymentOptions"]]=None, stage_name: typing.Optional[str]=None, tracing_enabled: typing.Optional[bool]=None, variables: typing.Optional[typing.Mapping[str, str]]=None) -> None:
        """
        :param cache_data_encrypted: Indicates whether the cached responses are encrypted. Default: false
        :param cache_ttl: Specifies the time to live (TTL), in seconds, for cached responses. The higher the TTL, the longer the response will be cached. Default: Duration.minutes(5)
        :param caching_enabled: Specifies whether responses should be cached and returned for requests. A cache cluster must be enabled on the stage for responses to be cached. Default: - Caching is Disabled.
        ...
        if throttling_burst_limit is not None: self._values["throttling_burst_limit"] = throttling_burst_limit
        if throttling_rate_limit is not None: self._values["throttling_rate_limit"] = throttling_rate_limit
        if access_log_destination is not None: self._values["access_log_destination"] = access_log_destination
        if access_log_format is not None: self._values["access_log_format"] = access_log_format
        if cache_cluster_enabled is not None: self._values["cache_cluster_enabled"] = cache_cluster_enabled
        if cache_cluster_size is not None: self._values["cache_cluster_size"] = cache_cluster_size
        if client_certificate_id is not None: self._values["client_certificate_id"] = client_certificate_id
        if description is not None: self._values["description"] = description
    ...
    def access_log_destination(self) -> typing.Optional["IAccessLogDestination"]:
        ...
        """
        return self._values.get('access_log_destination')
    ...
    def access_log_format(self) -> typing.Optional["AccessLogFormat"]:
        ...
        """
        return self._values.get('access_log_format')
...
class StageProps(StageOptions):
    def __init__(self, *, cache_data_encrypted: typing.Optional[bool]=None, cache_ttl: typing.Optional[aws_cdk.core.Duration]=None, caching_enabled: typing.Optional[bool]=None, data_trace_enabled: typing.Optional[bool]=None, logging_level: typing.Optional["MethodLoggingLevel"]=None, metrics_enabled: typing.Optional[bool]=None, throttling_burst_limit: typing.Optional[jsii.Number]=None, throttling_rate_limit: typing.Optional[jsii.Number]=None, access_log_destination: typing.Optional["IAccessLogDestination"]=None, access_log_format: typing.Optional["AccessLogFormat"]=None, cache_cluster_enabled: typing.Optional[bool]=None, cache_cluster_size: typing.Optional[str]=None, client_certificate_id: typing.Optional[str]=None, description: typing.Optional[str]=None, documentation_version: typing.Optional[str]=None, method_options: typing.Optional[typing.Mapping[str, "MethodDeploymentOptions"]]=None, stage_name: typing.Optional[str]=None, tracing_enabled: typing.Optional[bool]=None, variables: typing.Optional[typing.Mapping[str, str]]=None, deployment: "Deployment") -> None:
        """
        :param cache_data_encrypted: Indicates whether the cached responses are encrypted. Default: false
        :param cache_ttl: Specifies the time to live (TTL), in seconds, for cached responses. The higher the TTL, the longer the response will be cached. Default: Duration.minutes(5)
        :param caching_enabled: Specifies whether responses should be cached and returned for requests. A cache cluster must be enabled on the stage for responses to be cached. Default: - Caching is Disabled.
...
@jsii.data_type(jsii_type="@aws-cdk/aws-apigateway.TokenAuthorizerProps", jsii_struct_bases=[LambdaAuthorizerProps], name_mapping={'handler': 'handler', 'assume_role': 'assumeRole', 'authorizer_name': 'authorizerName', 'results_cache_ttl': 'resultsCacheTtl', 'identity_source': 'identitySource', 'validation_regex': 'validationRegex'})
class TokenAuthorizerProps(LambdaAuthorizerProps):
    def __init__(self, *, handler: aws_cdk.aws_lambda.IFunction, assume_role: typing.Optional[aws_cdk.aws_iam.IRole]=None, authorizer_name: typing.Optional[str]=None, results_cache_ttl: typing.Optional[aws_cdk.core.Duration]=None, identity_source: typing.Optional[str]=None, validation_regex: typing.Optional[str]=None) -> None:
...
class UsagePlanPerApiStage():
    def __init__(self, *, api: typing.Optional["IRestApi"]=None, stage: typing.Optional["Stage"]=None, throttle: typing.Optional[typing.List["ThrottlingPerMethod"]]=None) -> None:
...
class UsagePlanProps():
    def __init__(self, *, api_key: typing.Optional["IApiKey"]=None, api_stages: typing.Optional[typing.List["UsagePlanPerApiStage"]]=None, description: typing.Optional[str]=None, name: typing.Optional[str]=None, quota: typing.Optional["QuotaSettings"]=None, throttle: typing.Optional["ThrottleSettings"]=None) -> None:
        """
        :param api_key: ApiKey to be associated with the usage plan. Default: none
        :param api_stages: API Stages to be associated with the usage plan. Default: none
        :param description: Represents usage plan purpose. Default: none
...
class VpcLinkProps():
    def __init__(self, *, description: typing.Optional[str]=None, targets: typing.Optional[typing.List[aws_cdk.aws_elasticloadbalancingv2.INetworkLoadBalancer]]=None, vpc_link_name: typing.Optional[str]=None) -> None:
...
class ApiKeyProps(ResourceOptions):
    def __init__(self, *, default_cors_preflight_options: typing.Optional["CorsOptions"]=None, default_integration: typing.Optional["Integration"]=None, default_method_options: typing.Optional["MethodOptions"]=None, api_key_name: typing.Optional[str]=None, customer_id: typing.Optional[str]=None, description: typing.Optional[str]=None, enabled: typing.Optional[bool]=None, generate_distinct_id: typing.Optional[bool]=None, resources: typing.Optional[typing.List["RestApi"]]=None) -> None:
        """ApiKey Properties.
    ...
    def resources(self) -> typing.Optional[typing.List["RestApi"]]:
        """[disable-awslint:ref-via-interface] A list of resources this api key is associated with.
...
class Authorizer(aws_cdk.core.Resource, metaclass=jsii.JSIIAbstractClass, jsii_type="@aws-cdk/aws-apigateway.Authorizer"):
    ...
    @builtins.classmethod
    def is_authorizer(cls, x: typing.Any) -> bool:
        """Return whether the given object is an Authorizer.

        :param x: -
        """
        return jsii.sinvoke(cls, "isAuthorizer", [x])
...
class DomainName(aws_cdk.core.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-apigateway.DomainName"):
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, mapping: typing.Optional["IRestApi"]=None, certificate: aws_cdk.aws_certificatemanager.ICertificate, domain_name: str, endpoint_type: typing.Optional["EndpointType"]=None, security_policy: typing.Optional["SecurityPolicy"]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param mapping: If specified, all requests to this domain will be mapped to the production deployment of this API. If you wish to map this domain to multiple APIs with different base paths, don't specify this option and use ``addBasePathMapping``. Default: - you will have to call ``addBasePathMapping`` to map this domain to API endpoints.
        ...
        :param security_policy: The Transport Layer Security (TLS) version + cipher suite for this domain name. Default: SecurityPolicy.TLS_1_0
        """
        props = DomainNameProps(mapping=mapping, certificate=certificate, domain_name=domain_name, endpoint_type=endpoint_type, security_policy=security_policy)
    ...
    def add_base_path_mapping(self, target_api: "IRestApi", *, base_path: typing.Optional[str]=None, stage: typing.Optional["Stage"]=None) -> "BasePathMapping":
...
class GatewayResponse(aws_cdk.core.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-apigateway.GatewayResponse"):
    """Configure the response received by clients, produced from the API Gateway backend.

    resource:
    :resource:: AWS::ApiGateway::GatewayResponse
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, rest_api: "IRestApi", type: "ResponseType", response_headers: typing.Optional[typing.Mapping[str, str]]=None, status_code: typing.Optional[str]=None, templates: typing.Optional[typing.Mapping[str, str]]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param rest_api: Rest api resource to target.
        ...
        :param templates: Custom templates to get mapped as response. Default: - Response from api will be returned without applying any transformation.
        """
        props = GatewayResponseProps(rest_api=rest_api, type=type, response_headers=response_headers, status_code=status_code, templates=templates)
...
class ProxyResourceOptions(ResourceOptions):
    def __init__(self, *, default_cors_preflight_options: typing.Optional["CorsOptions"]=None, default_integration: typing.Optional["Integration"]=None, default_method_options: typing.Optional["MethodOptions"]=None, any_method: typing.Optional[bool]=None) -> None:
        """
        :param default_cors_preflight_options: Adds a CORS preflight OPTIONS method to this resource and all child resources. You can add CORS at the resource-level using ``addCorsPreflight``. Default: - CORS is disabled
        :param default_integration: An integration to use as a default for all methods created within this API unless an integration is specified. Default: - Inherited from parent.
        :param default_method_options: Method options to use as a default for all methods created within this API unless custom options are specified. Default: - Inherited from parent.
...
class ProxyResourceProps(ProxyResourceOptions):
    def __init__(self, *, default_cors_preflight_options: typing.Optional["CorsOptions"]=None, default_integration: typing.Optional["Integration"]=None, default_method_options: typing.Optional["MethodOptions"]=None, any_method: typing.Optional[bool]=None, parent: "IResource") -> None:
        """
        :param default_cors_preflight_options: Adds a CORS preflight OPTIONS method to this resource and all child resources. You can add CORS at the resource-level using ``addCorsPreflight``. Default: - CORS is disabled
        :param default_integration: An integration to use as a default for all methods created within this API unless an integration is specified. Default: - Inherited from parent.
        :param default_method_options: Method options to use as a default for all methods created within this API unless custom options are specified. Default: - Inherited from parent.
...
@jsii.data_type(jsii_type="@aws-cdk/aws-apigateway.RateLimitedApiKeyProps", jsii_struct_bases=[ApiKeyProps], name_mapping={'default_cors_preflight_options': 'defaultCorsPreflightOptions', 'default_integration': 'defaultIntegration', 'default_method_options': 'defaultMethodOptions', 'api_key_name': 'apiKeyName', 'customer_id': 'customerId', 'description': 'description', 'enabled': 'enabled', 'generate_distinct_id': 'generateDistinctId', 'resources': 'resources', 'api_stages': 'apiStages', 'quota': 'quota', 'throttle': 'throttle'})
class RateLimitedApiKeyProps(ApiKeyProps):
    def __init__(self, *, default_cors_preflight_options: typing.Optional["CorsOptions"]=None, default_integration: typing.Optional["Integration"]=None, default_method_options: typing.Optional["MethodOptions"]=None, api_key_name: typing.Optional[str]=None, customer_id: typing.Optional[str]=None, description: typing.Optional[str]=None, enabled: typing.Optional[bool]=None, generate_distinct_id: typing.Optional[bool]=None, resources: typing.Optional[typing.List["RestApi"]]=None, api_stages: typing.Optional[typing.List["UsagePlanPerApiStage"]]=None, quota: typing.Optional["QuotaSettings"]=None, throttle: typing.Optional["ThrottleSettings"]=None) -> None:
    ...
    def __repr__(self) -> str:
        return 'RateLimitedApiKeyProps(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


@jsii.implements(IAuthorizer)
class RequestAuthorizer(Authorizer, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-apigateway.RequestAuthorizer"):
    ...
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, identity_sources: typing.List[str], handler: aws_cdk.aws_lambda.IFunction, assume_role: typing.Optional[aws_cdk.aws_iam.IRole]=None, authorizer_name: typing.Optional[str]=None, results_cache_ttl: typing.Optional[aws_cdk.core.Duration]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param identity_sources: An array of request header mapping expressions for identities. Supported parameter types are Header, Query String, Stage Variable, and Context. For instance, extracting an authorization token from a header would use the identity source ``IdentitySource.header('Authorizer')``. Note: API Gateway uses the specified identity sources as the request authorizer caching key. When caching is enabled, API Gateway calls the authorizer's Lambda function only after successfully verifying that all the specified identity sources are present at runtime. If a specified identify source is missing, null, or empty, API Gateway returns a 401 Unauthorized response without calling the authorizer Lambda function.
        ...
        :param results_cache_ttl: How long APIGateway should cache the results. Max 1 hour. Disable caching by setting this to 0. Default: Duration.minutes(5)
        """
        props = RequestAuthorizerProps(identity_sources=identity_sources, handler=handler, assume_role=assume_role, authorizer_name=authorizer_name, results_cache_ttl=results_cache_ttl)

        jsii.create(RequestAuthorizer, self, [scope, id, props])

    @jsii.member(jsii_name="lazyRestApiId")
    def _lazy_rest_api_id(self) -> str:
        """Returns a token that resolves to the Rest Api Id at the time of synthesis.

        Throws an error, during token resolution, if no RestApi is attached to this authorizer.
        """
        return jsii.invoke(self, "lazyRestApiId", [])

    @jsii.member(jsii_name="setupPermissions")
    def _setup_permissions(self) -> None:
        """Sets up the permissions necessary for the API Gateway service to invoke the Lambda function."""
        return jsii.invoke(self, "setupPermissions", [])
    ...
    def _handler(self) -> aws_cdk.aws_lambda.IFunction:
        """The Lambda function handler that this authorizer uses."""
        return jsii.get(self, "handler")

    @builtins.property
    @jsii.member(jsii_name="role")
    def _role(self) -> typing.Optional[aws_cdk.aws_iam.IRole]:
        """The IAM role that the API Gateway service assumes while invoking the Lambda function."""
        return jsii.get(self, "role")

    @builtins.property
    @jsii.member(jsii_name="restApiId")
    def _rest_api_id(self) -> typing.Optional[str]:
        return jsii.get(self, "restApiId")

    @_rest_api_id.setter
    def _rest_api_id(self, value: typing.Optional[str]):
        jsii.set(self, "restApiId", value)
...
class TokenAuthorizer(Authorizer, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-apigateway.TokenAuthorizer"):
    ...
    :resource:: AWS::ApiGateway::Authorizer
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, identity_source: typing.Optional[str]=None, validation_regex: typing.Optional[str]=None, handler: aws_cdk.aws_lambda.IFunction, assume_role: typing.Optional[aws_cdk.aws_iam.IRole]=None, authorizer_name: typing.Optional[str]=None, results_cache_ttl: typing.Optional[aws_cdk.core.Duration]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param identity_source: The request header mapping expression for the bearer token. This is typically passed as part of the header, in which case this should be ``method.request.header.Authorizer`` where Authorizer is the header containing the bearer token. Default: ``IdentitySource.header('Authorization')``
        ...
        :param results_cache_ttl: How long APIGateway should cache the results. Max 1 hour. Disable caching by setting this to 0. Default: Duration.minutes(5)
        """
        props = TokenAuthorizerProps(identity_source=identity_source, validation_regex=validation_regex, handler=handler, assume_role=assume_role, authorizer_name=authorizer_name, results_cache_ttl=results_cache_ttl)
