.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_auto_examples_segmentation_plot_segmentations.py>`     to download the full example code or to run this example in your browser via Binder
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    /home/emma/code/scikit-image/doc/examples/segmentation/plot_segmentations.py:99: FutureWarning: skimage.measure.label's indexing starts from 0. In future version it will start from 1. To disable this warning, explicitely set the `start_label` parameter to 1.
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: binder-badge
    ...
    .. image:: https://mybinder.org/badge_logo.svg
      :target: https://mybinder.org/v2/gh/scikit-image/scikit-image/v0.17.x?filepath=notebooks/auto_examples/segmentation/plot_segmentations.ipynb
      :width: 150 px
