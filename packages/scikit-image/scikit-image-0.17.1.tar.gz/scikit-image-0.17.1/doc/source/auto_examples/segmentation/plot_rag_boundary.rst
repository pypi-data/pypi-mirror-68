...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    /home/emma/code/scikit-image/doc/examples/segmentation/plot_rag_boundary.py:22: FutureWarning: skimage.measure.label's indexing starts from 0. In future version it will start from 1. To disable this warning, explicitely set the `start_label` parameter to 1.
