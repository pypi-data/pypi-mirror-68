.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_auto_examples_features_detection_plot_multiblock_local_binary_pattern.py>`     to download the full example code or to run this example in your browser via Binder
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: binder-badge
    ...
    .. image:: https://mybinder.org/badge_logo.svg
      :target: https://mybinder.org/v2/gh/scikit-image/scikit-image/v0.17.x?filepath=notebooks/auto_examples/features_detection/plot_multiblock_local_binary_pattern.ipynb
      :width: 150 px
