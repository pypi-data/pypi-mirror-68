...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'rabbitmq', 'v2.2.0-alpha.1589831435+g4e5f742'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource rabbitmq v2.2.0-alpha.1589831435+g4e5f742`
                """)
            else:
                raise
