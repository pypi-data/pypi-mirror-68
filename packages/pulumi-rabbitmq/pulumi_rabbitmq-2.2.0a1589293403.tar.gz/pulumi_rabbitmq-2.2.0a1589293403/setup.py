...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'rabbitmq', 'v2.2.0-alpha.1589293403+g060faea'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource rabbitmq v2.2.0-alpha.1589293403+g060faea`
                """)
            else:
                raise
