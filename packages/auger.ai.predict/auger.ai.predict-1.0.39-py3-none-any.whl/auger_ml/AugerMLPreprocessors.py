...
class AugerMLPreprocessors(object):
    ...
    def update_minority_target_class(self, ds):
        ...
        if res_categoricals and ds.options.get('minority_target_class'):
            ds.options['minority_target_class_pos'] = res_categoricals[
                self.options.get('targetFeature')]['categories'].index(ds.options.get('minority_target_class'))
