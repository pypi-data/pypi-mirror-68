...
class ApiResponseData(object):
    ...
    def __init__(self, waybill_id=None, order_sn=None, order_ref=None, seller_order_ref=None, domestic_delivery_company=None, delivery_status=None, delivery_note=None, delivery_slip_url=None, tracking_url=None, local_vars_configuration=None):  # noqa: E501
