...
class Interface(object):
    ...
    .. note::
        ...
        |
        | APP_LINK: :py:class:`ask_smapi_model.v1.skill.manifest.app_link_interface.AppLinkInterface`,
        |
    ...
    discriminator_value_class_map = {
        ...
        'APP_LINK': 'ask_smapi_model.v1.skill.manifest.app_link_interface.AppLinkInterface',
