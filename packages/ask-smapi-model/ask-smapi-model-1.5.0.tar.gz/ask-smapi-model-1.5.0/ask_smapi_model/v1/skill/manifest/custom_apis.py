...
if typing.TYPE_CHECKING:
    ...
    from ask_smapi_model.v1.skill.manifest.app_link import AppLinkV1
...
class CustomApis(object):
    ...
    def __init__(self, regions=None, endpoint=None, interfaces=None, tasks=None, connections=None, app_link=None):
        # type: (Optional[Dict[str, RegionV1]], Optional[SkillManifestEndpointV1], Optional[List[InterfaceV1]], Optional[List[SkillManifestCustomTaskV1]], Optional[CustomConnectionsV1], Optional[AppLinkV1]) -> None
        """Defines the structure for custom api of the skill.
