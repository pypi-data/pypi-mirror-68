...
if typing.TYPE_CHECKING:
    ...
    from ask_smapi_model.v1.skill.manifest.catalog_info import CatalogInfoV1
    from ask_smapi_model.v1.skill.manifest.friendly_name import FriendlyNameV1
...
class LinkedApplication(object):
    ...
    def __init__(self, catalog_info=None, custom_schemes=None, domains=None, friendly_name=None):
        # type: (Optional[CatalogInfoV1], Optional[List[object]], Optional[List[object]], Optional[FriendlyNameV1]) -> None
        """Applications associated with the skill.
