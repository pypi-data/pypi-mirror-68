# -*- coding: utf-8 -*-
'''
All data and functions for using the Joback group contribution method.
'''
...
class Joback(object):
    ...
    def Cpig(self, T):
        ...
        return horner_polynomial.function(reversed(self.calculated_Cpig_coeffs), T)
