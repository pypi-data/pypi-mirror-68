...
from ..base import InterpolatedTDependentModel, mu, TPDependentHandleBuilder, TDependentModel, PhaseTPHandleBuilder
...
@mu.l(doc='auto-header', ref='[4]_ [5]_')
