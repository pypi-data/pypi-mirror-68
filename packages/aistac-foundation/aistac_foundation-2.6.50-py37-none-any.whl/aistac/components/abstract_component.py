...
class AbstractComponent(ABC):
    ...
    literal blocks::
        ...
        def from_uri(cls, task_name: str, uri_pm_path: str, pm_file_type: str=None, pm_module: str=None,
                 pm_handler: str=None, pm_kwargs: dict=None, username: str=None, default_save=None,
    ...
    def from_uri(cls, task_name: str, uri_pm_path: str, pm_file_type: str=None, pm_module: str=None,
        ...
        See class inline docs for an example method
         ...
         :param username: (optional) a user name for this task activity.
    ...
    def _init_properties(cls, property_manager: AbstractPropertyManager, uri_pm_path: str, pm_file_type: str=None,
        ...
        _path = os.path.join(_path, f"aistac_pm_{property_manager.manager_name()}_{property_manager.task_name}."
                                    f"{_file_type}")
    ...
    def from_env(cls, task_name: str, default_save=None, reset_templates: bool=None, align_connectors: bool=None,
        ...
        This method calls to the Factory Method 'from_uri(...)' returning the initialised class instance
         ...
         :return: the initialised class instance
         """
        pm_file_type = os.environ.get('AISTAC_PM_TYPE', 'json')
        ...
        username = os.environ.get('AISTAC_USER', os.environ.get('USER', 'Unknown'))
        ...
        return cls.from_uri(task_name=task_name, username=username, uri_pm_path=pm_uri,
