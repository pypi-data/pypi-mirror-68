...
class AbstractPropertyManager(ABC):
    ...
    @abstractmethod
    def __init__(self, task_name: str, root_keys: list, knowledge_keys: list, username: str=None):
        ...
        self._username = username if isinstance(username, str) else 'default'
    ...
    def persist_properties(self, only_branch: bool=None):
    ...
    def load_properties(self, replace=False) -> bool:
        ...
        if replace:
            self.reset_all()
        return self._base_pm.load(handler=connector_handler, replace=replace)
    ...
    def set_intent(self, intent_param: dict, level: [int, str]=None, order: int=None, replace_intent: bool=None,
        ...
        intent_param['intent_creator'] = self.username
    ...
    def file_pattern(self, connector_name: str, path: [str, list]=None, prefix: str=None, suffix: str=None,
        ...
        _pattern = "_".join(["aistac", self.manager_name(), self.task_name, connector_name])
    ...
    def report_connectors(self, connector_filter: [str, list]=None) -> dict:
