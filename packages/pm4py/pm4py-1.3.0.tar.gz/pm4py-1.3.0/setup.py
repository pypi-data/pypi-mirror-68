...
setup(
    ...
    packages=['pm4py', 'pm4py.algo', 'pm4py.algo.discovery', 'pm4py.algo.discovery.dfg',
              ...
              'pm4py.algo.discovery.transition_system.versions', 'pm4py.algo.filtering', 'pm4py.algo.filtering.dfg',
              ...
              'pm4py.objects.log.exporter', 'pm4py.objects.log.exporter.csv', 'pm4py.objects.log.exporter.csv.variants',
              'pm4py.objects.log.exporter.csv.versions', 'pm4py.objects.log.exporter.xes',
              'pm4py.objects.log.exporter.xes.util', 'pm4py.objects.log.exporter.xes.variants',
              'pm4py.objects.log.exporter.xes.versions', 'pm4py.objects.log.exporter.parquet',
              'pm4py.objects.log.exporter.parquet.versions', 'pm4py.objects.log.importer',
              ...
              'pm4py.objects.stochastic_petri', 'pm4py.objects.transition_system', 'pm4py.streaming',
              'pm4py.streaming.algo', 'pm4py.streaming.algo.discovery', 'pm4py.streaming.algo.conformance',
              'pm4py.streaming.stream', 'pm4py.evaluation', 'pm4py.evaluation.precision',
              ...
              'pm4py.evaluation.replay_fitness.versions', 'pm4py.simulation', 'pm4py.simulation.playout',
