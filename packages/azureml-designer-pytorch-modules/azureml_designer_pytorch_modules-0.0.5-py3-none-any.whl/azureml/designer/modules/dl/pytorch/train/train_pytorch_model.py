...
def save_trained_model(trained_model_path, best_model, init_params, class_to_idx, task_type):
    ...
    conda = {
        ...
        "dependencies": [
            "python=3.6.8", {
                "pip": [
                    "azureml-designer-pytorch-modules==0.0.1",
                    "--extra-index-url=https://azureml-modules:bhl567famexj26udbnf5k6ont7siu3ksyv7qtn7lozpjxqbgwpeq"
                    "@msdata.pkgs.visualstudio.com/_packaging/azureml-modules%40Local/pypi/simple/"
                ]
            }
        ]
    }
