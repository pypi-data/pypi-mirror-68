...
kwargs = json.loads("""
{
    ...
    "install_requires": [
        "jsii>=1.5.0, <2.0.0",
        "publication>=0.0.3",
        "aws-cdk.aws-applicationautoscaling==1.38.0",
        "aws-cdk.aws-autoscaling==1.38.0",
        "aws-cdk.aws-autoscaling-hooktargets==1.38.0",
        "aws-cdk.aws-certificatemanager==1.38.0",
        "aws-cdk.aws-cloudwatch==1.38.0",
        "aws-cdk.aws-ec2==1.38.0",
        "aws-cdk.aws-ecr==1.38.0",
        "aws-cdk.aws-ecr-assets==1.38.0",
        "aws-cdk.aws-elasticloadbalancing==1.38.0",
        "aws-cdk.aws-elasticloadbalancingv2==1.38.0",
        ...
        "aws-cdk.aws-secretsmanager==1.38.0",
        "aws-cdk.aws-servicediscovery==1.38.0",
