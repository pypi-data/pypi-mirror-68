...
[boto3.GuardDuty 1.13.12](https://boto3.amazonaws.com/v1/documentation/api/1.13.12/reference/services/guardduty.html#GuardDuty) service
...
list_organization_admin_accounts_paginator: guardduty.ListOrganizationAdminAccountsPaginator = client.get_paginator("list_organization_admin_accounts")
