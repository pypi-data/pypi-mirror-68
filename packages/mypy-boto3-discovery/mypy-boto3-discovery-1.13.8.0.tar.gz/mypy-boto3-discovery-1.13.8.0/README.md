...
[boto3.ApplicationDiscoveryService 1.13.8](https://boto3.amazonaws.com/v1/documentation/api/1.13.8/reference/services/discovery.html#ApplicationDiscoveryService) service
