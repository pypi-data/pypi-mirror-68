...
[boto3.ApplicationDiscoveryService 1.13.7](https://boto3.amazonaws.com/v1/documentation/api/1.13.7/reference/services/discovery.html#ApplicationDiscoveryService) service
