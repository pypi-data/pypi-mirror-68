...
@jsii.data_type(jsii_type="@aws-cdk/aws-elasticloadbalancingv2.AddRuleProps", jsii_struct_bases=[], name_mapping={'host_header': 'hostHeader', 'path_pattern': 'pathPattern', 'path_patterns': 'pathPatterns', 'priority': 'priority'})
class AddRuleProps():
    def __init__(self, *, host_header: typing.Optional[str]=None, path_pattern: typing.Optional[str]=None, path_patterns: typing.Optional[typing.List[str]]=None, priority: typing.Optional[jsii.Number]=None) -> None:
        ...
        if path_patterns is not None: self._values["path_patterns"] = path_patterns
...
class ApplicationListenerAttributes():
    def __init__(self, *, listener_arn: str, default_port: typing.Optional[jsii.Number]=None, security_group: typing.Optional[aws_cdk.aws_ec2.ISecurityGroup]=None, security_group_allows_all_outbound: typing.Optional[bool]=None, security_group_id: typing.Optional[str]=None) -> None:
...
class ApplicationListenerCertificateProps():
    def __init__(self, *, listener: "IApplicationListener", certificate_arns: typing.Optional[typing.List[str]]=None, certificates: typing.Optional[typing.List["IListenerCertificate"]]=None) -> None:
...
class ApplicationListenerRule(aws_cdk.core.Construct, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-elasticloadbalancingv2.ApplicationListenerRule"):
    ...
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, listener: "IApplicationListener", priority: jsii.Number, fixed_response: typing.Optional["FixedResponse"]=None, host_header: typing.Optional[str]=None, path_pattern: typing.Optional[str]=None, path_patterns: typing.Optional[typing.List[str]]=None, redirect_response: typing.Optional["RedirectResponse"]=None, target_groups: typing.Optional[typing.List["IApplicationTargetGroup"]]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param listener: The listener to attach the rule to.
        ...
        """
        props = ApplicationListenerRuleProps(listener=listener, priority=priority, fixed_response=fixed_response, host_header=host_header, path_pattern=path_pattern, path_patterns=path_patterns, redirect_response=redirect_response, target_groups=target_groups)
...
@jsii.data_type(jsii_type="@aws-cdk/aws-elasticloadbalancingv2.ApplicationLoadBalancerAttributes", jsii_struct_bases=[], name_mapping={'load_balancer_arn': 'loadBalancerArn', 'security_group_id': 'securityGroupId', 'load_balancer_canonical_hosted_zone_id': 'loadBalancerCanonicalHostedZoneId', 'load_balancer_dns_name': 'loadBalancerDnsName', 'security_group_allows_all_outbound': 'securityGroupAllowsAllOutbound', 'vpc': 'vpc'})
class ApplicationLoadBalancerAttributes():
    def __init__(self, *, load_balancer_arn: str, security_group_id: str, load_balancer_canonical_hosted_zone_id: typing.Optional[str]=None, load_balancer_dns_name: typing.Optional[str]=None, security_group_allows_all_outbound: typing.Optional[bool]=None, vpc: typing.Optional[aws_cdk.aws_ec2.IVpc]=None) -> None:
...
@jsii.data_type(jsii_type="@aws-cdk/aws-elasticloadbalancingv2.BaseApplicationListenerRuleProps", jsii_struct_bases=[], name_mapping={'priority': 'priority', 'fixed_response': 'fixedResponse', 'host_header': 'hostHeader', 'path_pattern': 'pathPattern', 'path_patterns': 'pathPatterns', 'redirect_response': 'redirectResponse', 'target_groups': 'targetGroups'})
...
class BaseLoadBalancerProps():
    def __init__(self, *, vpc: aws_cdk.aws_ec2.IVpc, deletion_protection: typing.Optional[bool]=None, internet_facing: typing.Optional[bool]=None, load_balancer_name: typing.Optional[str]=None, vpc_subnets: typing.Optional[aws_cdk.aws_ec2.SubnetSelection]=None) -> None:
...
class BaseNetworkListenerProps():
    def __init__(self, *, port: jsii.Number, certificates: typing.Optional[typing.List["IListenerCertificate"]]=None, default_target_groups: typing.Optional[typing.List["INetworkTargetGroup"]]=None, protocol: typing.Optional["Protocol"]=None, ssl_policy: typing.Optional["SslPolicy"]=None) -> None:
...
class BaseTargetGroupProps():
    def __init__(self, *, deregistration_delay: typing.Optional[aws_cdk.core.Duration]=None, health_check: typing.Optional["HealthCheck"]=None, target_group_name: typing.Optional[str]=None, target_type: typing.Optional["TargetType"]=None, vpc: typing.Optional[aws_cdk.aws_ec2.IVpc]=None) -> None:
...
class CfnListener(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-elasticloadbalancingv2.CfnListener"):
    ...
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnListener":
    ...
    class ActionProperty():
        def __init__(self, *, type: str, authenticate_cognito_config: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnListener.AuthenticateCognitoConfigProperty"]]]=None, authenticate_oidc_config: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnListener.AuthenticateOidcConfigProperty"]]]=None, fixed_response_config: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnListener.FixedResponseConfigProperty"]]]=None, forward_config: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnListener.ForwardConfigProperty"]]]=None, order: typing.Optional[jsii.Number]=None, redirect_config: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnListener.RedirectConfigProperty"]]]=None, target_group_arn: typing.Optional[str]=None) -> None:
            ...
            if forward_config is not None: self._values["forward_config"] = forward_config
        ...
        @builtins.property
        def forward_config(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnListener.ForwardConfigProperty"]]]:
    ...
    class AuthenticateCognitoConfigProperty():
        def __init__(self, *, user_pool_arn: str, user_pool_client_id: str, user_pool_domain: str, authentication_request_extra_params: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.Mapping[str, str]]]]=None, on_unauthenticated_request: typing.Optional[str]=None, scope: typing.Optional[str]=None, session_cookie_name: typing.Optional[str]=None, session_timeout: typing.Optional[jsii.Number]=None) -> None:
            """
    ...
    class FixedResponseConfigProperty():
        def __init__(self, *, status_code: str, content_type: typing.Optional[str]=None, message_body: typing.Optional[str]=None) -> None:
            """
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-elasticloadbalancingv2.CfnListener.ForwardConfigProperty", jsii_struct_bases=[], name_mapping={'target_groups': 'targetGroups', 'target_group_stickiness_config': 'targetGroupStickinessConfig'})
    class ForwardConfigProperty():
        def __init__(self, *, target_groups: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnListener.TargetGroupTupleProperty"]]]]]=None, target_group_stickiness_config: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnListener.TargetGroupStickinessConfigProperty"]]]=None) -> None:
            """
            ...
            if target_groups is not None: self._values["target_groups"] = target_groups
            if target_group_stickiness_config is not None: self._values["target_group_stickiness_config"] = target_group_stickiness_config

        @builtins.property
        def target_groups(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnListener.TargetGroupTupleProperty"]]]]]:
        ...
        @builtins.property
        def target_group_stickiness_config(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnListener.TargetGroupStickinessConfigProperty"]]]:
        ...
        def __repr__(self) -> str:
            return 'ForwardConfigProperty(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())
    ...
    class RedirectConfigProperty():
        def __init__(self, *, status_code: str, host: typing.Optional[str]=None, path: typing.Optional[str]=None, port: typing.Optional[str]=None, protocol: typing.Optional[str]=None, query: typing.Optional[str]=None) -> None:
            """
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-elasticloadbalancingv2.CfnListener.TargetGroupStickinessConfigProperty", jsii_struct_bases=[], name_mapping={'duration_seconds': 'durationSeconds', 'enabled': 'enabled'})
    class TargetGroupStickinessConfigProperty():
        def __init__(self, *, duration_seconds: typing.Optional[jsii.Number]=None, enabled: typing.Optional[typing.Union[typing.Optional[bool], typing.Optional[aws_cdk.core.IResolvable]]]=None) -> None:
            """
            ...
            if duration_seconds is not None: self._values["duration_seconds"] = duration_seconds
        ...
        def __repr__(self) -> str:
            return 'TargetGroupStickinessConfigProperty(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


    @jsii.data_type(jsii_type="@aws-cdk/aws-elasticloadbalancingv2.CfnListener.TargetGroupTupleProperty", jsii_struct_bases=[], name_mapping={'target_group_arn': 'targetGroupArn', 'weight': 'weight'})
    class TargetGroupTupleProperty():
        def __init__(self, *, target_group_arn: typing.Optional[str]=None, weight: typing.Optional[jsii.Number]=None) -> None:
            """
        ...
        def __repr__(self) -> str:
            return 'TargetGroupTupleProperty(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())
...
class CfnListenerCertificate(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-elasticloadbalancingv2.CfnListenerCertificate"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnListenerCertificate":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
class CfnListenerCertificateProps():
    def __init__(self, *, certificates: typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnListenerCertificate.CertificateProperty"]]], listener_arn: str) -> None:
...
class CfnListenerRule(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-elasticloadbalancingv2.CfnListenerRule"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnListenerRule":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    class ActionProperty():
        ...
        @builtins.property
        def forward_config(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnListenerRule.ForwardConfigProperty"]]]:
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-elasticloadbalancingv2.CfnListenerRule.ForwardConfigProperty", jsii_struct_bases=[], name_mapping={'target_groups': 'targetGroups', 'target_group_stickiness_config': 'targetGroupStickinessConfig'})
    class ForwardConfigProperty():
        def __init__(self, *, target_groups: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnListenerRule.TargetGroupTupleProperty"]]]]]=None, target_group_stickiness_config: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnListenerRule.TargetGroupStickinessConfigProperty"]]]=None) -> None:
            """
        ...
        @builtins.property
        def target_groups(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnListenerRule.TargetGroupTupleProperty"]]]]]:
        ...
        @builtins.property
        def target_group_stickiness_config(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnListenerRule.TargetGroupStickinessConfigProperty"]]]:
    ...
    class HttpHeaderConfigProperty():
        def __init__(self, *, http_header_name: typing.Optional[str]=None, values: typing.Optional[typing.List[str]]=None) -> None:
            """
    ...
    class QueryStringConfigProperty():
        def __init__(self, *, values: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnListenerRule.QueryStringKeyValueProperty"]]]]]=None) -> None:
            """
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-elasticloadbalancingv2.CfnListenerRule.TargetGroupStickinessConfigProperty", jsii_struct_bases=[], name_mapping={'duration_seconds': 'durationSeconds', 'enabled': 'enabled'})
    class TargetGroupStickinessConfigProperty():
        def __init__(self, *, duration_seconds: typing.Optional[jsii.Number]=None, enabled: typing.Optional[typing.Union[typing.Optional[bool], typing.Optional[aws_cdk.core.IResolvable]]]=None) -> None:
            """
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-elasticloadbalancingv2.CfnListenerRule.TargetGroupTupleProperty", jsii_struct_bases=[], name_mapping={'target_group_arn': 'targetGroupArn', 'weight': 'weight'})
    class TargetGroupTupleProperty():
        def __init__(self, *, target_group_arn: typing.Optional[str]=None, weight: typing.Optional[jsii.Number]=None) -> None:
            """
...
class CfnLoadBalancer(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-elasticloadbalancingv2.CfnLoadBalancer"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnLoadBalancer":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    class SubnetMappingProperty():
        def __init__(self, *, allocation_id: str, subnet_id: str) -> None:
            """
...
class CfnTargetGroup(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-elasticloadbalancingv2.CfnTargetGroup"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any) -> "CfnTargetGroup":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    class TargetDescriptionProperty():
        def __init__(self, *, id: str, availability_zone: typing.Optional[str]=None, port: typing.Optional[jsii.Number]=None) -> None:
            """
...
class FixedResponse():
    def __init__(self, *, status_code: str, content_type: typing.Optional["ContentType"]=None, message_body: typing.Optional[str]=None) -> None:
        """A fixed response.
...
@jsii.data_type(jsii_type="@aws-cdk/aws-elasticloadbalancingv2.HealthCheck", jsii_struct_bases=[], name_mapping={'enabled': 'enabled', 'healthy_http_codes': 'healthyHttpCodes', 'healthy_threshold_count': 'healthyThresholdCount', 'interval': 'interval', 'path': 'path', 'port': 'port', 'protocol': 'protocol', 'timeout': 'timeout', 'unhealthy_threshold_count': 'unhealthyThresholdCount'})
class HealthCheck():
    def __init__(self, *, enabled: typing.Optional[bool]=None, healthy_http_codes: typing.Optional[str]=None, healthy_threshold_count: typing.Optional[jsii.Number]=None, interval: typing.Optional[aws_cdk.core.Duration]=None, path: typing.Optional[str]=None, port: typing.Optional[str]=None, protocol: typing.Optional["Protocol"]=None, timeout: typing.Optional[aws_cdk.core.Duration]=None, unhealthy_threshold_count: typing.Optional[jsii.Number]=None) -> None:
...
class IApplicationListener(aws_cdk.core.IResource, aws_cdk.aws_ec2.IConnectable, jsii.compat.Protocol):
    ...
    def add_target_groups(self, id: str, *, target_groups: typing.List["IApplicationTargetGroup"], host_header: typing.Optional[str]=None, path_pattern: typing.Optional[str]=None, path_patterns: typing.Optional[typing.List[str]]=None, priority: typing.Optional[jsii.Number]=None) -> None:
...
class _IApplicationListenerProxy(jsii.proxy_for(aws_cdk.core.IResource), jsii.proxy_for(aws_cdk.aws_ec2.IConnectable)):
    ...
    def add_target_groups(self, id: str, *, target_groups: typing.List["IApplicationTargetGroup"], host_header: typing.Optional[str]=None, path_pattern: typing.Optional[str]=None, path_patterns: typing.Optional[typing.List[str]]=None, priority: typing.Optional[jsii.Number]=None) -> None:
        ...
        :param priority: Priority of this target group. The rule with the lowest priority will be used for every request. If priority is not given, these target groups will be added as defaults, and must not have conditions. Priorities must be unique. Default: Target groups are used as defaults
        """
        props = AddApplicationTargetGroupsProps(target_groups=target_groups, host_header=host_header, path_pattern=path_pattern, path_patterns=path_patterns, priority=priority)
    ...
    def add_targets(self, id: str, *, deregistration_delay: typing.Optional[aws_cdk.core.Duration]=None, health_check: typing.Optional["HealthCheck"]=None, port: typing.Optional[jsii.Number]=None, protocol: typing.Optional["ApplicationProtocol"]=None, slow_start: typing.Optional[aws_cdk.core.Duration]=None, stickiness_cookie_duration: typing.Optional[aws_cdk.core.Duration]=None, target_group_name: typing.Optional[str]=None, targets: typing.Optional[typing.List["IApplicationLoadBalancerTarget"]]=None, host_header: typing.Optional[str]=None, path_pattern: typing.Optional[str]=None, path_patterns: typing.Optional[typing.List[str]]=None, priority: typing.Optional[jsii.Number]=None) -> "ApplicationTargetGroup":
        ...
        :return: The newly created target group
        """
        props = AddApplicationTargetsProps(deregistration_delay=deregistration_delay, health_check=health_check, port=port, protocol=protocol, slow_start=slow_start, stickiness_cookie_duration=stickiness_cookie_duration, target_group_name=target_group_name, targets=targets, host_header=host_header, path_pattern=path_pattern, path_patterns=path_patterns, priority=priority)
...
class LoadBalancerTargetProps():
    def __init__(self, *, target_type: "TargetType", target_json: typing.Any=None) -> None:
...
class NetworkListenerProps(BaseNetworkListenerProps):
    def __init__(self, *, port: jsii.Number, certificates: typing.Optional[typing.List["IListenerCertificate"]]=None, default_target_groups: typing.Optional[typing.List["INetworkTargetGroup"]]=None, protocol: typing.Optional["Protocol"]=None, ssl_policy: typing.Optional["SslPolicy"]=None, load_balancer: "INetworkLoadBalancer") -> None:
...
class NetworkLoadBalancer(BaseLoadBalancer, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-elasticloadbalancingv2.NetworkLoadBalancer"):
    ...
    @builtins.classmethod
    def from_network_load_balancer_attributes(cls, scope: aws_cdk.core.Construct, id: str, *, load_balancer_arn: str, load_balancer_canonical_hosted_zone_id: typing.Optional[str]=None, load_balancer_dns_name: typing.Optional[str]=None, vpc: typing.Optional[aws_cdk.aws_ec2.IVpc]=None) -> "INetworkLoadBalancer":
        """
        :param scope: -
        :param id: -
        :param load_balancer_arn: ARN of the load balancer.
        ...
        """
        attrs = NetworkLoadBalancerAttributes(load_balancer_arn=load_balancer_arn, load_balancer_canonical_hosted_zone_id=load_balancer_canonical_hosted_zone_id, load_balancer_dns_name=load_balancer_dns_name, vpc=vpc)
...
@jsii.data_type(jsii_type="@aws-cdk/aws-elasticloadbalancingv2.NetworkLoadBalancerAttributes", jsii_struct_bases=[], name_mapping={'load_balancer_arn': 'loadBalancerArn', 'load_balancer_canonical_hosted_zone_id': 'loadBalancerCanonicalHostedZoneId', 'load_balancer_dns_name': 'loadBalancerDnsName', 'vpc': 'vpc'})
class NetworkLoadBalancerAttributes():
    def __init__(self, *, load_balancer_arn: str, load_balancer_canonical_hosted_zone_id: typing.Optional[str]=None, load_balancer_dns_name: typing.Optional[str]=None, vpc: typing.Optional[aws_cdk.aws_ec2.IVpc]=None) -> None:
        """Properties to reference an existing load balancer.
...
class NetworkLoadBalancerProps(BaseLoadBalancerProps):
    def __init__(self, *, vpc: aws_cdk.aws_ec2.IVpc, deletion_protection: typing.Optional[bool]=None, internet_facing: typing.Optional[bool]=None, load_balancer_name: typing.Optional[str]=None, vpc_subnets: typing.Optional[aws_cdk.aws_ec2.SubnetSelection]=None, cross_zone_enabled: typing.Optional[bool]=None) -> None:
...
class TargetGroupAttributes():
    def __init__(self, *, target_group_arn: str, default_port: typing.Optional[str]=None, load_balancer_arns: typing.Optional[str]=None) -> None:
...
class TargetGroupBase(aws_cdk.core.Construct, metaclass=jsii.JSIIAbstractClass, jsii_type="@aws-cdk/aws-elasticloadbalancingv2.TargetGroupBase"):
    ...
    def configure_health_check(self, *, enabled: typing.Optional[bool]=None, healthy_http_codes: typing.Optional[str]=None, healthy_threshold_count: typing.Optional[jsii.Number]=None, interval: typing.Optional[aws_cdk.core.Duration]=None, path: typing.Optional[str]=None, port: typing.Optional[str]=None, protocol: typing.Optional["Protocol"]=None, timeout: typing.Optional[aws_cdk.core.Duration]=None, unhealthy_threshold_count: typing.Optional[jsii.Number]=None) -> None:
        ...
        :param unhealthy_threshold_count: The number of consecutive health check failures required before considering a target unhealthy. For Application Load Balancers, the default is 2. For Network Load Balancers, this value must be the same as the healthy threshold count. Default: 2
        """
        health_check = HealthCheck(enabled=enabled, healthy_http_codes=healthy_http_codes, healthy_threshold_count=healthy_threshold_count, interval=interval, path=path, port=port, protocol=protocol, timeout=timeout, unhealthy_threshold_count=unhealthy_threshold_count)
...
@jsii.data_type(jsii_type="@aws-cdk/aws-elasticloadbalancingv2.AddApplicationTargetGroupsProps", jsii_struct_bases=[AddRuleProps], name_mapping={'host_header': 'hostHeader', 'path_pattern': 'pathPattern', 'path_patterns': 'pathPatterns', 'priority': 'priority', 'target_groups': 'targetGroups'})
class AddApplicationTargetGroupsProps(AddRuleProps):
    def __init__(self, *, host_header: typing.Optional[str]=None, path_pattern: typing.Optional[str]=None, path_patterns: typing.Optional[typing.List[str]]=None, priority: typing.Optional[jsii.Number]=None, target_groups: typing.List["IApplicationTargetGroup"]) -> None:
...
@jsii.data_type(jsii_type="@aws-cdk/aws-elasticloadbalancingv2.AddApplicationTargetsProps", jsii_struct_bases=[AddRuleProps], name_mapping={'host_header': 'hostHeader', 'path_pattern': 'pathPattern', 'path_patterns': 'pathPatterns', 'priority': 'priority', 'deregistration_delay': 'deregistrationDelay', 'health_check': 'healthCheck', 'port': 'port', 'protocol': 'protocol', 'slow_start': 'slowStart', 'stickiness_cookie_duration': 'stickinessCookieDuration', 'target_group_name': 'targetGroupName', 'targets': 'targets'})
class AddApplicationTargetsProps(AddRuleProps):
    def __init__(self, *, host_header: typing.Optional[str]=None, path_pattern: typing.Optional[str]=None, path_patterns: typing.Optional[typing.List[str]]=None, priority: typing.Optional[jsii.Number]=None, deregistration_delay: typing.Optional[aws_cdk.core.Duration]=None, health_check: typing.Optional["HealthCheck"]=None, port: typing.Optional[jsii.Number]=None, protocol: typing.Optional["ApplicationProtocol"]=None, slow_start: typing.Optional[aws_cdk.core.Duration]=None, stickiness_cookie_duration: typing.Optional[aws_cdk.core.Duration]=None, target_group_name: typing.Optional[str]=None, targets: typing.Optional[typing.List["IApplicationLoadBalancerTarget"]]=None) -> None:
...
@jsii.data_type(jsii_type="@aws-cdk/aws-elasticloadbalancingv2.AddFixedResponseProps", jsii_struct_bases=[AddRuleProps, FixedResponse], name_mapping={'host_header': 'hostHeader', 'path_pattern': 'pathPattern', 'path_patterns': 'pathPatterns', 'priority': 'priority', 'status_code': 'statusCode', 'content_type': 'contentType', 'message_body': 'messageBody'})
class AddFixedResponseProps(AddRuleProps, FixedResponse):
    def __init__(self, *, host_header: typing.Optional[str]=None, path_pattern: typing.Optional[str]=None, path_patterns: typing.Optional[typing.List[str]]=None, priority: typing.Optional[jsii.Number]=None, status_code: str, content_type: typing.Optional["ContentType"]=None, message_body: typing.Optional[str]=None) -> None:
...
@jsii.data_type(jsii_type="@aws-cdk/aws-elasticloadbalancingv2.AddRedirectResponseProps", jsii_struct_bases=[AddRuleProps, RedirectResponse], name_mapping={'host_header': 'hostHeader', 'path_pattern': 'pathPattern', 'path_patterns': 'pathPatterns', 'priority': 'priority', 'status_code': 'statusCode', 'host': 'host', 'path': 'path', 'port': 'port', 'protocol': 'protocol', 'query': 'query'})
...
class ApplicationListener(BaseListener, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-elasticloadbalancingv2.ApplicationListener"):
    ...
    @jsii.member(jsii_name="addFixedResponse")
    def add_fixed_response(self, id: str, *, host_header: typing.Optional[str]=None, path_pattern: typing.Optional[str]=None, path_patterns: typing.Optional[typing.List[str]]=None, priority: typing.Optional[jsii.Number]=None, status_code: str, content_type: typing.Optional["ContentType"]=None, message_body: typing.Optional[str]=None) -> None:
        """Add a fixed response.
        ...
        :param message_body: The message. Default: no message
        """
        props = AddFixedResponseProps(host_header=host_header, path_pattern=path_pattern, path_patterns=path_patterns, priority=priority, status_code=status_code, content_type=content_type, message_body=message_body)

        return jsii.invoke(self, "addFixedResponse", [id, props])

    @jsii.member(jsii_name="addRedirectResponse")
    def add_redirect_response(self, id: str, *, host_header: typing.Optional[str]=None, path_pattern: typing.Optional[str]=None, path_patterns: typing.Optional[typing.List[str]]=None, priority: typing.Optional[jsii.Number]=None, status_code: str, host: typing.Optional[str]=None, path: typing.Optional[str]=None, port: typing.Optional[str]=None, protocol: typing.Optional[str]=None, query: typing.Optional[str]=None) -> None:
        """Add a redirect response.
        ...
        :param query: The query parameters, URL-encoded when necessary, but not percent-encoded. Do not include the leading "?", as it is automatically added. You can specify any of the reserved keywords. Default: origin query string of request
        """
        props = AddRedirectResponseProps(host_header=host_header, path_pattern=path_pattern, path_patterns=path_patterns, priority=priority, status_code=status_code, host=host, path=path, port=port, protocol=protocol, query=query)
...
class ApplicationListenerProps(BaseApplicationListenerProps):
    def __init__(self, *, certificate_arns: typing.Optional[typing.List[str]]=None, certificates: typing.Optional[typing.List["IListenerCertificate"]]=None, default_target_groups: typing.Optional[typing.List["IApplicationTargetGroup"]]=None, open: typing.Optional[bool]=None, port: typing.Optional[jsii.Number]=None, protocol: typing.Optional["ApplicationProtocol"]=None, ssl_policy: typing.Optional["SslPolicy"]=None, load_balancer: "IApplicationLoadBalancer") -> None:
...
@jsii.data_type(jsii_type="@aws-cdk/aws-elasticloadbalancingv2.ApplicationListenerRuleProps", jsii_struct_bases=[BaseApplicationListenerRuleProps], name_mapping={'priority': 'priority', 'fixed_response': 'fixedResponse', 'host_header': 'hostHeader', 'path_pattern': 'pathPattern', 'path_patterns': 'pathPatterns', 'redirect_response': 'redirectResponse', 'target_groups': 'targetGroups', 'listener': 'listener'})
class ApplicationListenerRuleProps(BaseApplicationListenerRuleProps):
    def __init__(self, *, priority: jsii.Number, fixed_response: typing.Optional["FixedResponse"]=None, host_header: typing.Optional[str]=None, path_pattern: typing.Optional[str]=None, path_patterns: typing.Optional[typing.List[str]]=None, redirect_response: typing.Optional["RedirectResponse"]=None, target_groups: typing.Optional[typing.List["IApplicationTargetGroup"]]=None, listener: "IApplicationListener") -> None:
...
class ApplicationLoadBalancerProps(BaseLoadBalancerProps):
    def __init__(self, *, vpc: aws_cdk.aws_ec2.IVpc, deletion_protection: typing.Optional[bool]=None, internet_facing: typing.Optional[bool]=None, load_balancer_name: typing.Optional[str]=None, vpc_subnets: typing.Optional[aws_cdk.aws_ec2.SubnetSelection]=None, http2_enabled: typing.Optional[bool]=None, idle_timeout: typing.Optional[aws_cdk.core.Duration]=None, ip_address_type: typing.Optional["IpAddressType"]=None, security_group: typing.Optional[aws_cdk.aws_ec2.ISecurityGroup]=None) -> None:
...
class ApplicationTargetGroupProps(BaseTargetGroupProps):
    def __init__(self, *, deregistration_delay: typing.Optional[aws_cdk.core.Duration]=None, health_check: typing.Optional["HealthCheck"]=None, target_group_name: typing.Optional[str]=None, target_type: typing.Optional["TargetType"]=None, vpc: typing.Optional[aws_cdk.aws_ec2.IVpc]=None, port: typing.Optional[jsii.Number]=None, protocol: typing.Optional["ApplicationProtocol"]=None, slow_start: typing.Optional[aws_cdk.core.Duration]=None, stickiness_cookie_duration: typing.Optional[aws_cdk.core.Duration]=None, targets: typing.Optional[typing.List["IApplicationLoadBalancerTarget"]]=None) -> None:
