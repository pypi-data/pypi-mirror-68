...
_NEWDEPLOYSREQUEST = _descriptor.Descriptor(
  name='NewDeploysRequest',
  full_name='io.casperlabs.comm.gossiping.NewDeploysRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='sender', full_name='io.casperlabs.comm.gossiping.NewDeploysRequest.sender', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='deploy_hashes', full_name='io.casperlabs.comm.gossiping.NewDeploysRequest.deploy_hashes', index=1,
      number=2, type=12, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_NEWDEPLOYSRESPONSE = _descriptor.Descriptor(
  name='NewDeploysResponse',
  full_name='io.casperlabs.comm.gossiping.NewDeploysResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='is_new', full_name='io.casperlabs.comm.gossiping.NewDeploysResponse.is_new', index=0,
      number=1, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_STREAMDEPLOYSUMMARIESREQUEST = _descriptor.Descriptor(
  name='StreamDeploySummariesRequest',
  full_name='io.casperlabs.comm.gossiping.StreamDeploySummariesRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='deploy_hashes', full_name='io.casperlabs.comm.gossiping.StreamDeploySummariesRequest.deploy_hashes', index=0,
      number=1, type=12, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETBLOCKCHUNKEDREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='exclude_deploy_bodies', full_name='io.casperlabs.comm.gossiping.GetBlockChunkedRequest.exclude_deploy_bodies', index=3,
...
_STREAMDEPLOYSCHUNKEDREQUEST = _descriptor.Descriptor(
  name='StreamDeploysChunkedRequest',
  full_name='io.casperlabs.comm.gossiping.StreamDeploysChunkedRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='deploy_hashes', full_name='io.casperlabs.comm.gossiping.StreamDeploysChunkedRequest.deploy_hashes', index=0,
      number=1, type=12, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='chunk_size', full_name='io.casperlabs.comm.gossiping.StreamDeploysChunkedRequest.chunk_size', index=1,
      number=2, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='accepted_compression_algorithms', full_name='io.casperlabs.comm.gossiping.StreamDeploysChunkedRequest.accepted_compression_algorithms', index=2,
      number=3, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_NEWDEPLOYSREQUEST.fields_by_name['sender'].message_type = node__pb2._NODE
...
DESCRIPTOR.message_types_by_name['NewDeploysRequest'] = _NEWDEPLOYSREQUEST
DESCRIPTOR.message_types_by_name['NewDeploysResponse'] = _NEWDEPLOYSRESPONSE
DESCRIPTOR.message_types_by_name['StreamBlockSummariesRequest'] = _STREAMBLOCKSUMMARIESREQUEST
DESCRIPTOR.message_types_by_name['StreamDeploySummariesRequest'] = _STREAMDEPLOYSUMMARIESREQUEST
...
DESCRIPTOR.message_types_by_name['StreamDeploysChunkedRequest'] = _STREAMDEPLOYSCHUNKEDREQUEST
...
NewDeploysRequest = _reflection.GeneratedProtocolMessageType('NewDeploysRequest', (_message.Message,), {
  'DESCRIPTOR' : _NEWDEPLOYSREQUEST,
  '__module__' : 'gossiping_pb2'
  # @@protoc_insertion_point(class_scope:io.casperlabs.comm.gossiping.NewDeploysRequest)
  })
_sym_db.RegisterMessage(NewDeploysRequest)

NewDeploysResponse = _reflection.GeneratedProtocolMessageType('NewDeploysResponse', (_message.Message,), {
  'DESCRIPTOR' : _NEWDEPLOYSRESPONSE,
  '__module__' : 'gossiping_pb2'
  # @@protoc_insertion_point(class_scope:io.casperlabs.comm.gossiping.NewDeploysResponse)
  })
_sym_db.RegisterMessage(NewDeploysResponse)
...
StreamDeploySummariesRequest = _reflection.GeneratedProtocolMessageType('StreamDeploySummariesRequest', (_message.Message,), {
  'DESCRIPTOR' : _STREAMDEPLOYSUMMARIESREQUEST,
  '__module__' : 'gossiping_pb2'
  # @@protoc_insertion_point(class_scope:io.casperlabs.comm.gossiping.StreamDeploySummariesRequest)
  })
_sym_db.RegisterMessage(StreamDeploySummariesRequest)
...
StreamDeploysChunkedRequest = _reflection.GeneratedProtocolMessageType('StreamDeploysChunkedRequest', (_message.Message,), {
  'DESCRIPTOR' : _STREAMDEPLOYSCHUNKEDREQUEST,
  '__module__' : 'gossiping_pb2'
  # @@protoc_insertion_point(class_scope:io.casperlabs.comm.gossiping.StreamDeploysChunkedRequest)
  })
_sym_db.RegisterMessage(StreamDeploysChunkedRequest)
...
_GOSSIPSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='NewDeploys',
    full_name='io.casperlabs.comm.gossiping.GossipService.NewDeploys',
    index=1,
    containing_service=None,
    input_type=_NEWDEPLOYSREQUEST,
    output_type=_NEWDEPLOYSRESPONSE,
    serialized_options=None,
  ),
  _descriptor.MethodDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='StreamDeploySummaries',
    full_name='io.casperlabs.comm.gossiping.GossipService.StreamDeploySummaries',
    index=5,
    containing_service=None,
    input_type=_STREAMDEPLOYSUMMARIESREQUEST,
    output_type=consensus__pb2._DEPLOYSUMMARY,
    serialized_options=None,
  ),
  _descriptor.MethodDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='StreamDeploysChunked',
    full_name='io.casperlabs.comm.gossiping.GossipService.StreamDeploysChunked',
    index=7,
    containing_service=None,
    input_type=_STREAMDEPLOYSCHUNKEDREQUEST,
    output_type=_CHUNK,
    serialized_options=None,
  ),
  _descriptor.MethodDescriptor(
