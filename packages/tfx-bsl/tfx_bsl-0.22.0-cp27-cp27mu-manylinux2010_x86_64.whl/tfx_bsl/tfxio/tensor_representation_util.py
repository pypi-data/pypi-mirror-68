...
from tfx_bsl.types_compat import List, Dict, Mapping, Optional, Text, Tuple, Union
...
def SetTensorRepresentationsInSchema(
    ...
    tensor_representation_group_name       = _DEFAULT_TENSOR_REPRESENTATION_GROUP
    )        :
...
def _ShouldUseLegacyLogic(schema                   )        :
