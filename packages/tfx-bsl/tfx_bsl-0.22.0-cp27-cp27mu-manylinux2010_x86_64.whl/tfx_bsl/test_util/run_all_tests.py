...
import six
from tfx_bsl.types_compat import Dict, List, Optional, Text
...
class _Test(object):
  ...
  def __init__(self, path      , shard_id     , total_shards     ):
    self.path = path
...
def _RunTests(tests             , parallelism     )        :
