...
from tfx_bsl.types_compat import Any, Callable, Dict, Iterable, List, Optional, Set, Text, Union
...
class BatchedCSVRowsToRecordBatch(beam.DoFn):
  ...
  def _process_column_infos(self, column_infos                  ):
