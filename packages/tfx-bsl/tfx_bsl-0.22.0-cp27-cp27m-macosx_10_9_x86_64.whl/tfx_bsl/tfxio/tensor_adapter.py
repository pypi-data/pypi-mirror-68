...
import typing
from tfx_bsl.types_compat import Any, Callable, Dict, List, Text, Optional, Tuple, Union
...
class _TypeHandler(object):
  ...
  @abc.abstractmethod
  def GetTensor(self, record_batch                ,
                produce_eager_tensors      )       :
