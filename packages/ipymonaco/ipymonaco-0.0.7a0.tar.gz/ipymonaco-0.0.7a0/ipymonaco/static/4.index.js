...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__workerManager_js__ = __webpack_require__(856);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__languageFeatures_js__ = __webpack_require__(857);
/*---------------------------------------------------------------------------------------------
...
function setupMode(defaults, modeId) {
    ...
    monaco.languages.registerCompletionItemProvider(modeId, new __WEBPACK_IMPORTED_MODULE_1__languageFeatures_js__["l" /* SuggestAdapter */](worker));
    monaco.languages.registerSignatureHelpProvider(modeId, new __WEBPACK_IMPORTED_MODULE_1__languageFeatures_js__["k" /* SignatureHelpAdapter */](worker));
    monaco.languages.registerHoverProvider(modeId, new __WEBPACK_IMPORTED_MODULE_1__languageFeatures_js__["h" /* QuickInfoAdapter */](worker));
    monaco.languages.registerDocumentHighlightProvider(modeId, new __WEBPACK_IMPORTED_MODULE_1__languageFeatures_js__["f" /* OccurrencesAdapter */](worker));
    monaco.languages.registerDefinitionProvider(modeId, new __WEBPACK_IMPORTED_MODULE_1__languageFeatures_js__["b" /* DefinitionAdapter */](worker));
    monaco.languages.registerReferenceProvider(modeId, new __WEBPACK_IMPORTED_MODULE_1__languageFeatures_js__["i" /* ReferenceAdapter */](worker));
    monaco.languages.registerDocumentSymbolProvider(modeId, new __WEBPACK_IMPORTED_MODULE_1__languageFeatures_js__["g" /* OutlineAdapter */](worker));
    monaco.languages.registerDocumentRangeFormattingEditProvider(modeId, new __WEBPACK_IMPORTED_MODULE_1__languageFeatures_js__["d" /* FormatAdapter */](worker));
    monaco.languages.registerOnTypeFormattingEditProvider(modeId, new __WEBPACK_IMPORTED_MODULE_1__languageFeatures_js__["e" /* FormatOnTypeAdapter */](worker));
    monaco.languages.registerCodeActionProvider(modeId, new __WEBPACK_IMPORTED_MODULE_1__languageFeatures_js__["a" /* CodeActionAdaptor */](worker));
    monaco.languages.registerRenameProvider(modeId, new __WEBPACK_IMPORTED_MODULE_1__languageFeatures_js__["j" /* RenameAdapter */](worker));
    new __WEBPACK_IMPORTED_MODULE_1__languageFeatures_js__["c" /* DiagnosticsAdapter */](defaults, modeId, worker);
    return worker;
}
...
"use strict";
/* unused harmony export flattenDiagnosticMessageText */
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "l", function() { return SuggestAdapter; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "k", function() { return SignatureHelpAdapter; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return QuickInfoAdapter; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return OccurrencesAdapter; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return OutlineAdapter; });
/* unused harmony export Kind */
/* unused harmony export FormatHelper */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return FormatAdapter; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return FormatOnTypeAdapter; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CodeActionAdaptor; });
