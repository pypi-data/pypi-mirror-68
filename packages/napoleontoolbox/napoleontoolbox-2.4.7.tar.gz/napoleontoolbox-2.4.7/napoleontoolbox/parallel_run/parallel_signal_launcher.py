                ...
                for normalization in normalizations:
                    for signal_type, params  in signal_idiosyncratic_paramaters.items():
                        for param in params:
                            ...
                            self.args.append((self,rand_hash,trigger,signal_type, json.dumps(param, sort_keys=True), transaction_cost, normalization))
                            self.key_args.append((rand_hash, trigger, signal_type, json.dumps(param, sort_keys=True),transaction_cost, normalization))
