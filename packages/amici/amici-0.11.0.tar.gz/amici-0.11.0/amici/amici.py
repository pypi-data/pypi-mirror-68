...
class ReturnDataPtr(object):
    ...
    cpu_time = property(_amici.ReturnDataPtr_cpu_time_get, _amici.ReturnDataPtr_cpu_time_set, doc=r""" computation time of forward solve [s]""")
    cpu_timeB = property(_amici.ReturnDataPtr_cpu_timeB_get, _amici.ReturnDataPtr_cpu_timeB_set, doc=r""" computation time of backward solve [s]""")
    preeq_status = property(_amici.ReturnDataPtr_preeq_status_get, _amici.ReturnDataPtr_preeq_status_set, doc=r""" flag indicating success of Newton solver (preequilibration)""")
    preeq_cpu_time = property(_amici.ReturnDataPtr_preeq_cpu_time_get, _amici.ReturnDataPtr_preeq_cpu_time_set, doc=r""" computation time of the Newton solver [s] (preequilibration)""")
    posteq_status = property(_amici.ReturnDataPtr_posteq_status_get, _amici.ReturnDataPtr_posteq_status_set, doc=r""" flag indicating success of Newton solver  (postequilibration)""")
    posteq_cpu_time = property(_amici.ReturnDataPtr_posteq_cpu_time_get, _amici.ReturnDataPtr_posteq_cpu_time_set, doc=r""" computation time of the Newton solver [s]  (postequilibration)""")
    ...
    (length = newton_maxsteps * 2)
    """)
    preeq_t = property(_amici.ReturnDataPtr_preeq_t_get, _amici.ReturnDataPtr_preeq_t_set, doc=r"""time at which steadystate was reached in the simulation based approach (preequilibration)""")
    ...
    """)
    posteq_t = property(_amici.ReturnDataPtr_posteq_t_get, _amici.ReturnDataPtr_posteq_t_set, doc=r"""time at which steadystate was reached in the simulation based approach (postequilibration)""")
...
class ReturnData(object):
    ...
    cpu_time = property(_amici.ReturnData_cpu_time_get, _amici.ReturnData_cpu_time_set, doc=r""" computation time of forward solve [s]""")
    cpu_timeB = property(_amici.ReturnData_cpu_timeB_get, _amici.ReturnData_cpu_timeB_set, doc=r""" computation time of backward solve [s]""")
    preeq_status = property(_amici.ReturnData_preeq_status_get, _amici.ReturnData_preeq_status_set, doc=r""" flag indicating success of Newton solver (preequilibration)""")
    preeq_cpu_time = property(_amici.ReturnData_preeq_cpu_time_get, _amici.ReturnData_preeq_cpu_time_set, doc=r""" computation time of the Newton solver [s] (preequilibration)""")
    posteq_status = property(_amici.ReturnData_posteq_status_get, _amici.ReturnData_posteq_status_set, doc=r""" flag indicating success of Newton solver  (postequilibration)""")
    posteq_cpu_time = property(_amici.ReturnData_posteq_cpu_time_get, _amici.ReturnData_posteq_cpu_time_set, doc=r""" computation time of the Newton solver [s]  (postequilibration)""")
    ...
    (length = newton_maxsteps * 2)
    """)
    preeq_t = property(_amici.ReturnData_preeq_t_get, _amici.ReturnData_preeq_t_set, doc=r"""time at which steadystate was reached in the simulation based approach (preequilibration)""")
    preeq_wrms = property(_amici.ReturnData_preeq_wrms_get, _amici.ReturnData_preeq_wrms_set, doc=r"""
    weighted root-mean-square of the rhs when steadystate
    was reached (preequilibration)
    """)
    posteq_t = property(_amici.ReturnData_posteq_t_get, _amici.ReturnData_posteq_t_set, doc=r"""time at which steadystate was reached in the simulation based approach (postequilibration)""")
...
class Model_ODE(Model):
    ...
    def fJB(self, t: "amici::realtype", x: "N_Vector", xB: "N_Vector", xBdot: "N_Vector", JB: "SUNMatrix") -> "void":
        r"""
    ...
    def fJSparseB(self, t: "amici::realtype", x: "N_Vector", xB: "N_Vector", xBdot: "N_Vector", JB: "SUNMatrix") -> "void":
        r"""
...
class Model_DAE(Model):
    ...
    def fJB(self, t: "amici::realtype", cj: "amici::realtype", x: "N_Vector", dx: "N_Vector", xB: "N_Vector", dxB: "N_Vector", JB: "SUNMatrix") -> "void":
        r"""
    ...
    def fJSparseB(self, t: "amici::realtype", cj: "amici::realtype", x: "N_Vector", dx: "N_Vector", xB: "N_Vector", dxB: "N_Vector", JB: "SUNMatrix") -> "void":
        r"""
...
def createOrOpenForWriting(hdf5filename: "std::string const &") -> "H5::H5File":
    r"""
    Open the given file for writing. Append if exists, create if not.
...
def writeSolverSettingsToHDF5(*args) -> "void":
    r"""
    *Overload 1:*

    Write solver options from HDF5 file
    :param hdf5Filenamehdf5: Name of HDF5 file
    :type solver: :py:class:`Solver`
    :param solver: solver to write options from
    :type hdf5Location: string
...
def readSolverSettingsFromHDF5(*args) -> "void":
    r"""
    *Overload 1:*
...
def readModelDataFromHDF5(*args) -> "void":
    r"""
    *Overload 1:*
...
def writeReturnData(*args) -> "void":
    return _amici.writeReturnData(*args)

def writeReturnDataDiagnosis(rdata: "ReturnData", file: "H5::H5File const &", hdf5Location: "std::string const &") -> "void":
    return _amici.writeReturnDataDiagnosis(rdata, file, hdf5Location)

def createGroup(file: "H5::H5File const &", groupPath: "std::string const &", recursively: "bool"=True) -> "void":
    r"""
...
def readSimulationExpData(hdf5Filename: "std::string const &", hdf5Root: "std::string const &", model: "Model") -> "std::unique_ptr< amici::ExpData >":
    r"""
    readSimulationExpData reads AMICI experimental data from attributes in
    HDF5 file.
    :type hdf5Filename: string
    :param hdf5Filename: Name of HDF5 file
    :type hdf5Root: string
    :param hdf5Root: Path inside the HDF5 file to object having ExpData as
        attributes
    :type model: :py:class:`Model`
    :param model: The model for which data is to be read
    :rtype: std::unique_ptr< amici::ExpData >
    :return: 
    """
    return _amici.readSimulationExpData(hdf5Filename, hdf5Root, model)

def writeSimulationExpData(edata: "ExpData", file: "H5::H5File const &", hdf5Location: "std::string const &") -> "void":
    r"""
    writeSimulationExpData writes AMICI experimental data to attributes in
    HDF5 file.
    :type edata: :py:class:`ExpData`
...
def attributeExists(*args) -> "bool":
    return _amici.attributeExists(*args)

def createAndWriteInt1DDataset(file: "H5::H5File const &", datasetName: "std::string const &", buffer: "gsl::span< int const >") -> "void":
    return _amici.createAndWriteInt1DDataset(file, datasetName, buffer)

def createAndWriteInt2DDataset(file: "H5::H5File const &", datasetName: "std::string const &", buffer: "gsl::span< int const >", m: "hsize_t", n: "hsize_t") -> "void":
    return _amici.createAndWriteInt2DDataset(file, datasetName, buffer, m, n)

def createAndWriteDouble1DDataset(file: "H5::H5File const &", datasetName: "std::string const &", buffer: "gsl::span< double const >") -> "void":
    return _amici.createAndWriteDouble1DDataset(file, datasetName, buffer)

def createAndWriteDouble2DDataset(file: "H5::H5File const &", datasetName: "std::string const &", buffer: "gsl::span< double const >", m: "hsize_t", n: "hsize_t") -> "void":
    return _amici.createAndWriteDouble2DDataset(file, datasetName, buffer, m, n)

def createAndWriteDouble3DDataset(file: "H5::H5File const &", datasetName: "std::string const &", buffer: "gsl::span< double const >", m: "hsize_t", n: "hsize_t", o: "hsize_t") -> "void":
    return _amici.createAndWriteDouble3DDataset(file, datasetName, buffer, m, n, o)

def getDoubleScalarAttribute(file: "H5::H5File const &", optionsObject: "std::string const &", attributeName: "std::string const &") -> "double":
    return _amici.getDoubleScalarAttribute(file, optionsObject, attributeName)

def getIntScalarAttribute(file: "H5::H5File const &", optionsObject: "std::string const &", attributeName: "std::string const &") -> "int":
    return _amici.getIntScalarAttribute(file, optionsObject, attributeName)

def getIntDataset1D(file: "H5::H5File const &", name: "std::string const &") -> "std::vector< int,std::allocator< int > >":
    return _amici.getIntDataset1D(file, name)

def getDoubleDataset1D(file: "H5::H5File const &", name: "std::string const &") -> "std::vector< double,std::allocator< double > >":
    return _amici.getDoubleDataset1D(file, name)

def getDoubleDataset2D(file: "H5::H5File const &", name: "std::string const &", m: "hsize_t &", n: "hsize_t &") -> "std::vector< double,std::allocator< double > >":
    return _amici.getDoubleDataset2D(file, name, m, n)

def getDoubleDataset3D(file: "H5::H5File const &", name: "std::string const &", m: "hsize_t &", n: "hsize_t &", o: "hsize_t &") -> "std::vector< double,std::allocator< double > >":
    return _amici.getDoubleDataset3D(file, name, m, n, o)

def locationExists(*args) -> "bool":
