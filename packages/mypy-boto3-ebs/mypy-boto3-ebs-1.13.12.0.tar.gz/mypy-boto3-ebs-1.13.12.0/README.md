...
[boto3.EBS 1.13.12](https://boto3.amazonaws.com/v1/documentation/api/1.13.12/reference/services/ebs.html#EBS) service
...
client: ebs.EBSClient = boto3.client("ebs")

# works for session as well
session = boto3.session.Session(region="us-west-1")
session_client: ebs.EBSClient = session.client("ebs")
