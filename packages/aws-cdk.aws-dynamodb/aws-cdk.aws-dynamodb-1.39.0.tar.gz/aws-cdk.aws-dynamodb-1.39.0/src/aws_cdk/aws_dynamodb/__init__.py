...
class CfnTable(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-dynamodb.CfnTable"):
    ...
    class LocalSecondaryIndexProperty():
        def __init__(self, *, index_name: str, key_schema: typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union["CfnTable.KeySchemaProperty", aws_cdk.core.IResolvable]]], projection: typing.Union[aws_cdk.core.IResolvable, "CfnTable.ProjectionProperty"]) -> None:
            """
    ...
    class PointInTimeRecoverySpecificationProperty():
        def __init__(self, *, point_in_time_recovery_enabled: typing.Optional[typing.Union[typing.Optional[bool], typing.Optional[aws_cdk.core.IResolvable]]]=None) -> None:
            """
    ...
    class ProjectionProperty():
        def __init__(self, *, non_key_attributes: typing.Optional[typing.List[str]]=None, projection_type: typing.Optional[str]=None) -> None:
            """
    ...
    class SSESpecificationProperty():
        def __init__(self, *, sse_enabled: typing.Union[bool, aws_cdk.core.IResolvable], kms_master_key_id: typing.Optional[str]=None, sse_type: typing.Optional[str]=None) -> None:
            """
    ...
    class TimeToLiveSpecificationProperty():
        def __init__(self, *, attribute_name: str, enabled: typing.Union[bool, aws_cdk.core.IResolvable]) -> None:
            """
...
class ITable(aws_cdk.core.IResource, jsii.compat.Protocol):
    ...
    def metric_consumed_read_capacity_units(self, *, account: typing.Optional[str]=None, color: typing.Optional[str]=None, dimensions: typing.Optional[typing.Mapping[str, typing.Any]]=None, label: typing.Optional[str]=None, period: typing.Optional[aws_cdk.core.Duration]=None, region: typing.Optional[str]=None, statistic: typing.Optional[str]=None, unit: typing.Optional[aws_cdk.aws_cloudwatch.Unit]=None) -> aws_cdk.aws_cloudwatch.Metric:
    ...
    def metric_system_errors(self, *, account: typing.Optional[str]=None, color: typing.Optional[str]=None, dimensions: typing.Optional[typing.Mapping[str, typing.Any]]=None, label: typing.Optional[str]=None, period: typing.Optional[aws_cdk.core.Duration]=None, region: typing.Optional[str]=None, statistic: typing.Optional[str]=None, unit: typing.Optional[aws_cdk.aws_cloudwatch.Unit]=None) -> aws_cdk.aws_cloudwatch.Metric:
    ...
    def metric_user_errors(self, *, account: typing.Optional[str]=None, color: typing.Optional[str]=None, dimensions: typing.Optional[typing.Mapping[str, typing.Any]]=None, label: typing.Optional[str]=None, period: typing.Optional[aws_cdk.core.Duration]=None, region: typing.Optional[str]=None, statistic: typing.Optional[str]=None, unit: typing.Optional[aws_cdk.aws_cloudwatch.Unit]=None) -> aws_cdk.aws_cloudwatch.Metric:
...
class SecondaryIndexProps():
    def __init__(self, *, index_name: str, non_key_attributes: typing.Optional[typing.List[str]]=None, projection_type: typing.Optional["ProjectionType"]=None) -> None:
...
class Table(aws_cdk.core.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-dynamodb.Table"):
    ...
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, table_name: typing.Optional[str]=None, partition_key: "Attribute", billing_mode: typing.Optional["BillingMode"]=None, encryption: typing.Optional["TableEncryption"]=None, encryption_key: typing.Optional[aws_cdk.aws_kms.IKey]=None, point_in_time_recovery: typing.Optional[bool]=None, read_capacity: typing.Optional[jsii.Number]=None, removal_policy: typing.Optional[aws_cdk.core.RemovalPolicy]=None, replication_regions: typing.Optional[typing.List[str]]=None, server_side_encryption: typing.Optional[bool]=None, sort_key: typing.Optional["Attribute"]=None, stream: typing.Optional["StreamViewType"]=None, time_to_live_attribute: typing.Optional[str]=None, write_capacity: typing.Optional[jsii.Number]=None) -> None:
        ...
        """
        props = TableProps(table_name=table_name, partition_key=partition_key, billing_mode=billing_mode, encryption=encryption, encryption_key=encryption_key, point_in_time_recovery=point_in_time_recovery, read_capacity=read_capacity, removal_policy=removal_policy, replication_regions=replication_regions, server_side_encryption=server_side_encryption, sort_key=sort_key, stream=stream, time_to_live_attribute=time_to_live_attribute, write_capacity=write_capacity)
    ...
    @builtins.classmethod
    def from_table_attributes(cls, scope: aws_cdk.core.Construct, id: str, *, encryption_key: typing.Optional[aws_cdk.aws_kms.IKey]=None, table_arn: typing.Optional[str]=None, table_name: typing.Optional[str]=None, table_stream_arn: typing.Optional[str]=None) -> "ITable":
        ...
        """
        attrs = TableAttributes(encryption_key=encryption_key, table_arn=table_arn, table_name=table_name, table_stream_arn=table_stream_arn)
...
@jsii.data_type(jsii_type="@aws-cdk/aws-dynamodb.TableAttributes", jsii_struct_bases=[], name_mapping={'encryption_key': 'encryptionKey', 'table_arn': 'tableArn', 'table_name': 'tableName', 'table_stream_arn': 'tableStreamArn'})
class TableAttributes():
    def __init__(self, *, encryption_key: typing.Optional[aws_cdk.aws_kms.IKey]=None, table_arn: typing.Optional[str]=None, table_name: typing.Optional[str]=None, table_stream_arn: typing.Optional[str]=None) -> None:
        ...
        if table_name is not None: self._values["table_name"] = table_name
        if table_stream_arn is not None: self._values["table_stream_arn"] = table_stream_arn
...
@jsii.data_type(jsii_type="@aws-cdk/aws-dynamodb.TableOptions", jsii_struct_bases=[], name_mapping={'partition_key': 'partitionKey', 'billing_mode': 'billingMode', 'encryption': 'encryption', 'encryption_key': 'encryptionKey', 'point_in_time_recovery': 'pointInTimeRecovery', 'read_capacity': 'readCapacity', 'removal_policy': 'removalPolicy', 'replication_regions': 'replicationRegions', 'server_side_encryption': 'serverSideEncryption', 'sort_key': 'sortKey', 'stream': 'stream', 'time_to_live_attribute': 'timeToLiveAttribute', 'write_capacity': 'writeCapacity'})
class TableOptions():
    def __init__(self, *, partition_key: "Attribute", billing_mode: typing.Optional["BillingMode"]=None, encryption: typing.Optional["TableEncryption"]=None, encryption_key: typing.Optional[aws_cdk.aws_kms.IKey]=None, point_in_time_recovery: typing.Optional[bool]=None, read_capacity: typing.Optional[jsii.Number]=None, removal_policy: typing.Optional[aws_cdk.core.RemovalPolicy]=None, replication_regions: typing.Optional[typing.List[str]]=None, server_side_encryption: typing.Optional[bool]=None, sort_key: typing.Optional["Attribute"]=None, stream: typing.Optional["StreamViewType"]=None, time_to_live_attribute: typing.Optional[str]=None, write_capacity: typing.Optional[jsii.Number]=None) -> None:
        ...
        if replication_regions is not None: self._values["replication_regions"] = replication_regions
...
@jsii.data_type(jsii_type="@aws-cdk/aws-dynamodb.TableProps", jsii_struct_bases=[TableOptions], name_mapping={'partition_key': 'partitionKey', 'billing_mode': 'billingMode', 'encryption': 'encryption', 'encryption_key': 'encryptionKey', 'point_in_time_recovery': 'pointInTimeRecovery', 'read_capacity': 'readCapacity', 'removal_policy': 'removalPolicy', 'replication_regions': 'replicationRegions', 'server_side_encryption': 'serverSideEncryption', 'sort_key': 'sortKey', 'stream': 'stream', 'time_to_live_attribute': 'timeToLiveAttribute', 'write_capacity': 'writeCapacity', 'table_name': 'tableName'})
class TableProps(TableOptions):
    def __init__(self, *, partition_key: "Attribute", billing_mode: typing.Optional["BillingMode"]=None, encryption: typing.Optional["TableEncryption"]=None, encryption_key: typing.Optional[aws_cdk.aws_kms.IKey]=None, point_in_time_recovery: typing.Optional[bool]=None, read_capacity: typing.Optional[jsii.Number]=None, removal_policy: typing.Optional[aws_cdk.core.RemovalPolicy]=None, replication_regions: typing.Optional[typing.List[str]]=None, server_side_encryption: typing.Optional[bool]=None, sort_key: typing.Optional["Attribute"]=None, stream: typing.Optional["StreamViewType"]=None, time_to_live_attribute: typing.Optional[str]=None, write_capacity: typing.Optional[jsii.Number]=None, table_name: typing.Optional[str]=None) -> None:
...
class LocalSecondaryIndexProps(SecondaryIndexProps):
    def __init__(self, *, index_name: str, non_key_attributes: typing.Optional[typing.List[str]]=None, projection_type: typing.Optional["ProjectionType"]=None, sort_key: "Attribute") -> None:
