...
define(["require", "exports", "./app", "../lib/weya/weya", "./cache", "./run_ui", "./configs", "./indicators", "./view_components/info_list", "./view_components/format"], function (require, exports, app_1, weya_1, cache_1, run_ui_1, configs_1, indicators_1, info_list_1, format_1) {
    "use strict";
    ...
    class RunView {
        constructor(experimentName, runUuid) {
            this.events = {
                ...
                dirty: () => {
                    app_1.ROUTER.navigate(`/experiment/${this.run.experimentName}/${this.run.info.uuid}/diff`);
                },
                loadRun: () => {
                    app_1.ROUTER.navigate(`/experiment/${this.run.experimentName}/${this.run.info.load_run}`);
                },
                experiment: () => {
                    app_1.ROUTER.navigate(`/experiment/${this.run.experimentName}`);
                },
                ...
                editComment: (e) => __awaiter(this, void 0, void 0, function* () {
                ...
                saveComment: (e) => __awaiter(this, void 0, void 0, function* () {
                    this.saveComment(this.commentInput.value).then();
                }),
                onCommentKeyDown_: (e) => __awaiter(this, void 0, void 0, function* () {
                    if (e.key === 'Enter') {
                        this.saveComment(this.commentInput.value).then();
                    }
                }),
        ...
        renderRun() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                weya_1.Weya(this.runView, $ => {
                    $('h1', $ => {
                        $('label', `${this.run.experimentName}`, { on: { click: this.events.experiment } });
                        $('span', ":" + ' ');
                        $('span', $ => {
                            this.commentSpan = $('span', comment, {
                                on: { click: this.events.editComment }
                            });
                            this.commentInputContainer = $('div.input-container', $ => {
                    ...
                    $('div.block', $ => {
                        ...
                        new info_list_1.InfoList([
                            ['.key', 'Total size'],
                            ['.value', format_1.formatSize(size)]
                        ], '.mono').render($);
                        new info_list_1.InfoList([
                            ['.key', 'Checkpoints'],
                            ['.value', format_1.formatSize(info.checkpoints_size)]
                        ], '.mono').render($);
                        new info_list_1.InfoList([
                            ['.key', 'SQLite'],
                            ['.value', format_1.formatSize(info.sqlite_size)]
                        ], '.mono').render($);
                        new info_list_1.InfoList([
                            ['.key', 'Analytics'],
                            ['.value', format_1.formatSize(info.analytics_size)]
                        ], '.mono').render($);
                        new info_list_1.InfoList([
                            ['.key', 'TensorBoard'],
                            ['.value', format_1.formatSize(info.tensorboard_size)]
                        ], '.mono').render($);
                    });
    ...
    class RunHandler {
        constructor() {
            this.handleRun = (name, runUuid) => {
                app_1.SCREEN.setView(new RunView(name, runUuid));
            };
            app_1.ROUTER.route('experiment/:name/:runUuid', [this.handleRun]);
        }
    }
