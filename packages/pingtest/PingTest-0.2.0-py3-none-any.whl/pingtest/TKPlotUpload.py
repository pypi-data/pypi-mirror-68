...
def TKPlotUpload():
 ...
 #       self.lock = lock
    ...
    def myanimate(i):
        ...
        line             = pandas.read_sql("select uploadspeed from colin.downloadtest where testdatetime > curdate()-1 ", dbConnection);
...
#label = Tk.Label(root,text="SHM Simulation").grid(column=0, row=0)
    ...
    ax.set_title('ISP Upload Speed Mbits per sec')
    ax.legend()
