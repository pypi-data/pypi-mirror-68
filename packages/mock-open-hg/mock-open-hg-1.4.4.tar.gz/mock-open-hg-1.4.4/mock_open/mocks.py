...
class MockOpen(Mock):
    ...
    def __call__(self, path, mode='r', *args, **kws):
        ...
        elif not self.__mock_other:
            return self.__real_open(path, mode, *args, **kws)
