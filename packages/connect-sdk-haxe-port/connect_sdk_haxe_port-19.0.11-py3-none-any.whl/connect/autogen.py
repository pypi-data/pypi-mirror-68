...
class Std:
    _hx_class_name = "Std"
    __slots__ = ()
    _hx_statics = ["downcast", "instance", "isMetaType", "is", "string", "int", "parseInt", "shortenPossibleNumber", "parseFloat", "random"]
...
class haxe_SysTools:
    ...
    def quoteWinArg(argument,escapeMetaCharacters):
        ...
        if (_this.matchObj is None):
            ...
            needquote = None
            startIndex = None
            if (((argument.find(" ") if ((startIndex is None)) else argument.find(" ", startIndex))) == -1):
                startIndex1 = None
                needquote = (((argument.find("\t") if ((startIndex1 is None)) else argument.find("\t", startIndex1))) != -1)
            else:
                needquote = True
        ...
        if escapeMetaCharacters:
            result_b1 = python_lib_io_StringIO()
            _g4 = 0
            _g11 = len(argument)
            while (_g4 < _g11):
                i1 = _g4
                ...
                if (python_internal_ArrayImpl.indexOf(haxe_SysTools.winMetaCharacters,c2,None) >= 0):
                    result_b1.write("".join(map(chr,[94])))
                result_b1.write("".join(map(chr,[c2])))
            return result_b1.getvalue()
        else:
            return argument
...
class StringTools:
    ...
    def htmlUnescape(s):
        ...
        _this4 = _this3.split("&quot;")
        _this5 = "\"".join([python_Boot.toString1(x1,'') for x1 in _this4])
        _this6 = _this5.split("&#039;")
        _this7 = "'".join([python_Boot.toString1(x1,'') for x1 in _this6])
        _this8 = _this7.split("&amp;")
    ...
    def contains(s,value):
        startIndex = None
        return (((s.find(value) if ((startIndex is None)) else s.find(value, startIndex))) != -1)
    ...
    def quoteWinArg(argument,escapeMetaCharacters):
        ...
        if (_this.matchObj is None):
            ...
            needquote = None
            startIndex = None
            if (((argument1.find(" ") if ((startIndex is None)) else argument1.find(" ", startIndex))) == -1):
                startIndex1 = None
                needquote = (((argument1.find("\t") if ((startIndex1 is None)) else argument1.find("\t", startIndex1))) != -1)
            else:
                needquote = True
        ...
        if escapeMetaCharacters:
            ...
            while (_g4 < _g11):
                i1 = _g4
                _g4 = (_g4 + 1)
                c2 = HxString.charCodeAt(argument1,i1)
                if (python_internal_ArrayImpl.indexOf(haxe_SysTools.winMetaCharacters,c2,None) >= 0):
                    result_b1.write("".join(map(chr,[94])))
                result_b1.write("".join(map(chr,[c2])))
            return result_b1.getvalue()
...
class connect_Base:
    ...
    def __getattr__(self,key):
        ...
        if (python_internal_ArrayImpl.indexOf(fields,camelized,None) > -1):
            ...
            raise AttributeError((((("'" + ("null" if className is None else className)) + "' object has no attribute '") + ("null" if key is None else key)) + "'"))
...
class connect_Config(connect_Base):
    ...
    def __init__(self,apiUrl,apiKey,products,data):
        ...
        startIndex = None
        self.apiKey = (apiKey if ((((apiKey.find("ApiKey ") if ((startIndex is None)) else apiKey.find("ApiKey ", startIndex))) == 0)) else ("ApiKey " + ("null" if apiKey is None else apiKey)))
...
class connect_Env(connect_Base):
    ...
    def initConfig(apiUrl,apiKey,products):
        if (connect_Env.config is None):
            ...
            raise _HxException("Config instance is already initialized.")
    ...
    def loadConfig(filename):
        if (connect_Env.config is None):
            ...
            products = (configProducts if (Std._hx_is(configProducts,connect_util_Collection)) else (connect_util_Collection._fromArray([configProducts]) if (Std._hx_is(configProducts,str)) else None))
    ...
    def initLogger(config):
        if (connect_Env.logger is None):
            ...
            raise _HxException("Logger instance is already initialized.")
    ...
    def initDefaultQuery(query):
        if (connect_Env.defaultQuery is None):
            ...
            raise _HxException("Default Query instance in already initialized.")
    ...
    def createInstance(interfaceName):
        ...
        if (classObj is not None):
            ...
            raise _HxException((("Cannot find class name \"" + ("null" if className is None else className)) + "\""))
...
class connect_Flow(connect_Base):
    ...
    __slots__ = ("filterFunc", "steps", "model", "originalModelStr", "data", "abortRequested", "abortMessage")
    _hx_fields = ["filterFunc", "steps", "model", "originalModelStr", "data", "abortRequested", "abortMessage"]
    _hx_methods = ["setup", "step", "getAssetRequest", "getListing", "getTierConfigRequest", "getUsageFile", "setData", "getData", "approveByTemplate", "approveByTile", "fail", "inquire", "pend", "_run", "getCurrentAttempt", "process", "processSetup", "loadStepDataIfStored", "getStepParam", "processStep", "prepareRequestAndOpenLogSection", "processAbortAndCloseLogSection", "abort", "logStepData", "getClassName"]
    _hx_statics = ["STEP_PARAM_ID", "ATTEMPT_PARAM", "getFormattedRequest", "getFormattedData", "getDataTable"]
    _hx_interfaces = []
    _hx_super = connect_Base
    ...
    def getAssetRequest(self):
        def _hx_local_2():
            def _hx_local_1():
                ...
                if (Std._hx_is(_hx_local_0,connect_models_AssetRequest) or ((_hx_local_0 is None))):
                    _hx_local_0
                else:
    ...
    def getListing(self):
        def _hx_local_2():
            def _hx_local_1():
                _hx_local_0 = self.model
                if (Std._hx_is(_hx_local_0,connect_models_Listing) or ((_hx_local_0 is None))):
                    _hx_local_0
                else:
                    raise _HxException("Class cast error")
                return _hx_local_0
    ...
    def getTierConfigRequest(self):
        def _hx_local_2():
            def _hx_local_1():
                _hx_local_0 = self.model
                if (Std._hx_is(_hx_local_0,connect_models_TierConfigRequest) or ((_hx_local_0 is None))):
                    _hx_local_0
                else:
                    raise _HxException("Class cast error")
                return _hx_local_0
    ...
    def getUsageFile(self):
        def _hx_local_2():
            def _hx_local_1():
                _hx_local_0 = self.model
                if (Std._hx_is(_hx_local_0,connect_models_UsageFile) or ((_hx_local_0 is None))):
                    _hx_local_0
                else:
                    raise _HxException("Class cast error")
                return _hx_local_0
    ...
    def _run(self,_hx_list):
        ...
        def _hx_local_5():
            def _hx_local_3(m):
                def _hx_local_2():
                    def _hx_local_1():
                        _hx_local_0 = m
                        if (Std._hx_is(_hx_local_0,connect_models_IdModel) or ((_hx_local_0 is None))):
                            _hx_local_0
                        else:
                            raise _HxException("Class cast error")
                        return _hx_local_0
        ...
        while model.hasNext():
            ...
            def _hx_local_7():
                _hx_local_6 = model1
                if (Std._hx_is(_hx_local_6,connect_models_IdModel) or ((_hx_local_6 is None))):
                    _hx_local_6
                else:
                    raise _HxException("Class cast error")
                return _hx_local_6
    ...
    def getCurrentAttempt(self):
        if (not self.data.exists(connect_Flow.ATTEMPT_PARAM)):
            self.data.set(connect_Flow.ATTEMPT_PARAM,0)
        return self.data.get(connect_Flow.ATTEMPT_PARAM)
    ...
    def processSetup(self):
        ...
        try:
            ...
            if (self.getAssetRequest() is not None):
                self.getAssetRequest()._updateConversation(("Skipping request because an exception was thrown: " + ("null" if exStr is None else exStr)))
            connect_Env.getLogger().closeSection()
            return False
        connect_Env.getLogger().closeSection()
        return True
    ...
    def getStepParam(self):
        if (self.getAssetRequest() is not None):
            return self.getAssetRequest().asset.getParamById(connect_Flow.STEP_PARAM_ID)
        else:
            return None
    ...
    def prepareRequestAndOpenLogSection(self,model):
        ...
        product = (assetRequest.asset.product if ((assetRequest is not None)) else (listing.product if ((listing is not None)) else (tierConfigRequest.product if ((tierConfigRequest is not None)) else (usageFile.product if ((usageFile is not None)) else None))))
        productPath = ((HxOverrides.stringOrNull(product.id) + "/") if ((product is not None)) else "")
        if (assetRequest is not None):
            connect_Env.getLogger().setFilename(((("" + ("null" if productPath is None else productPath)) + HxOverrides.stringOrNull(assetRequest.asset.id)) + ".md"))
        elif (listing is not None):
            connect_Env.getLogger().setFilename(((("" + ("null" if productPath is None else productPath)) + HxOverrides.stringOrNull(listing.id)) + ".md"))
        elif (tierConfigRequest is not None):
            connect_Env.getLogger().setFilename(((("" + ("null" if productPath is None else productPath)) + HxOverrides.stringOrNull(tierConfigRequest.configuration.id)) + ".md"))
        elif (usageFile is not None):
            connect_Env.getLogger().setFilename(((("" + ("null" if productPath is None else productPath)) + HxOverrides.stringOrNull(usageFile.id)) + ".md"))
    ...
    def processAbortAndCloseLogSection(self,index,requestStr,dataStr):
        if self.abortRequested:
            if (self.abortMessage is None):
                param = (self.getAssetRequest().asset.getParamById(connect_Flow.STEP_PARAM_ID) if ((self.getAssetRequest() is not None)) else None)
                connect_Env.getLogger().write(connect_logger_Logger.LEVEL_INFO,"Skipping request. Trying to save step data.")
                if self.data.exists(connect_Flow.ATTEMPT_PARAM):
                    self.data.set(connect_Flow.ATTEMPT_PARAM,python_Boot._add_dynamic(self.data.get(connect_Flow.ATTEMPT_PARAM),1))
                else:
                    self.data.set(connect_Flow.ATTEMPT_PARAM,1)
                saveResult = connect_storage_StepStorage.save(self.model,connect_storage_StepData(index,self.data,connect_storage_StorageType.ConnectStorage),param,Reflect.field(self.model,"update"))
    ...
    def getFormattedRequest(request,lastRequest,fmt):
        if (request != lastRequest):
            if (connect_Env.getLogger().getLevel() == connect_logger_Logger.LEVEL_DEBUG):
                ...
                return (("" + ("null" if requestTitle is None else requestTitle)) + HxOverrides.stringOrNull(fmt.formatCodeBlock(connect_Env.getLogger().getLevel(),requestStr,"json")))
            else:
    ...
    def getDataTable(data,fmt):
        ...
        def _hx_local_0(key2):
            tmp = connect_util_Collection().push(key2).push(data.get(key2))
            dataCol.push(tmp)
...
class connect_Processor(connect_Base):
    ...
    def run(self,modelClass,filters):
        ...
        if (_g.index == 6):
            if (_g.params[0] == str):
                def _hx_local_1():
                    ...
                    if (Std._hx_is(_hx_local_0,str) or ((_hx_local_0 is None))):
                        _hx_local_0
                    else:
                        raise _HxException("Class cast error")
                    return _hx_local_0
        ...
        try:
            ...
            _g3 = self.flows
            while (_g2 < len(_g3)):
                flow = (_g3[_g2] if _g2 >= 0 and _g2 < len(_g3) else None)
                _g2 = (_g2 + 1)
                flow._run(_hx_list)
        except Exception as _hx_e:
            _hx_e1 = _hx_e.val if isinstance(_hx_e, _HxException) else _hx_e
...
class connect_api_ConnectHelper:
    ...
    def connectSyncRequest(method,path,headers,params = None,rqlParams = None,data = None,fileArg = None,fileName = None,fileContent = None):
        ...
        return connect_Env.getApiClient().syncRequest(method,url,headers,data,fileArg,fileName,fileContent)
    ...
    def checkResponse(response):
        if (response.status < 400):
            ...
            raise _HxException(response.text)
...
class connect_api_Query(connect_Base):
    ...
    _hx_statics = ["fromObject", "fromJson", "stringMapToObject", "valueToObject", "arrayToObject"]
    _hx_interfaces = []
    _hx_super = connect_Base
    ...
    def copy(self):
        ...
        while k2.hasNext():
            k3 = k2.next()
            value1 = list(self.out_.h.get(k3,None))
            _g1.h[k3] = value1
        copy.out_ = _g1
        ...
        while k4.hasNext():
            ...
            _g3 = []
            _g4 = 0
            _g5 = self.relOps.h.get(k5,None)
            while (_g4 < len(_g5)):
                kv = (_g5[_g4] if _g4 >= 0 and _g4 < len(_g5) else None)
                _g4 = (_g4 + 1)
    ...
    def default_(self):
        ...
        while k.hasNext():
            ...
            _g.append(k1)
        def _hx_local_0(k2):
            if (not (k2 in _gthis.in__.h)):
                _this = _gthis.in__
                value = list(_hx_def.in__.h.get(k2,None))
                _this.h[k2] = value
            return
        Lambda.iter(_g,_hx_local_0)
        _g1 = []
        k3 = _hx_def.out_.keys()
        while k3.hasNext():
            k4 = k3.next()
            _g1.append(k4)
        def _hx_local_1(k5):
            if (not (k5 in _gthis.out_.h)):
                _this1 = _gthis.out_
                value1 = list(_hx_def.out_.h.get(k5,None))
                _this1.h[k5] = value1
            return
        Lambda.iter(_g1,_hx_local_1)
        ...
        if (_hx_def.ordering_ is not None):
            ...
            def _hx_local_2(e):
                if (python_internal_ArrayImpl.indexOf(_gthis.ordering_,e,None) == -1):
                    _this2 = _gthis.ordering_
                    _this2.append(e)
                return
            Lambda.iter(_hx_def.ordering_,_hx_local_2)
        _g2 = []
        k6 = _hx_def.like_.keys()
        while k6.hasNext():
            k7 = k6.next()
            _g2.append(k7)
        def _hx_local_3(k8):
            if (not (k8 in _gthis.like_.h)):
                _this3 = _gthis.like_
                value2 = _hx_def.like_.h.get(k8,None)
                _this3.h[k8] = value2
            return
        Lambda.iter(_g2,_hx_local_3)
        _g3 = []
        k9 = _hx_def.ilike_.keys()
        while k9.hasNext():
            k10 = k9.next()
            _g3.append(k10)
        def _hx_local_4(k11):
            if (not (k11 in _gthis.ilike_.h)):
                _this4 = _gthis.ilike_
                value3 = _hx_def.ilike_.h.get(k11,None)
                _this4.h[k11] = value3
            return
        Lambda.iter(_g3,_hx_local_4)
        if (_hx_def.select_ is not None):
            if (self.select_ is None):
                self.select_ = []
            def _hx_local_5(e1):
                if (python_internal_ArrayImpl.indexOf(_gthis.select_,e1,None) == -1):
                    _this5 = _gthis.select_
                    _this5.append(e1)
                return
            Lambda.iter(_hx_def.select_,_hx_local_5)
        _g4 = []
        k12 = _hx_def.relOps.keys()
        while k12.hasNext():
            k13 = k12.next()
            _g4.append(k13)
        def _hx_local_10(k14):
            if (k14 in _gthis.relOps.h):
                thisK = _gthis.relOps.h.get(k14,None)
                _g5 = 0
                _g6 = _hx_def.relOps.h.get(k14,None)
                while (_g5 < len(_g6)):
                    kv = [(_g6[_g5] if _g5 >= 0 and _g5 < len(_g6) else None)]
                    _g5 = (_g5 + 1)
                    def _hx_local_8(kv1):
                        def _hx_local_7(thisKV):
                            return thisKV.equals((kv1[0] if 0 < len(kv1) else None))
                        return _hx_local_7
                ...
                _this6 = _gthis.relOps
                _g51 = []
                _g61 = 0
                _g7 = _hx_def.relOps.h.get(k14,None)
                while (_g61 < len(_g7)):
                    kv2 = (_g7[_g61] if _g61 >= 0 and _g61 < len(_g7) else None)
                    _g61 = (_g61 + 1)
                    x1 = connect_api__Query_KeyValue(kv2.key,kv2.value)
                    _g51.append(x1)
                _this6.h[k14] = _g51
        Lambda.iter(_g4,_hx_local_10)
        return self
    ...
    def toString(self):
        ...
        if (self.select_ is not None):
            ...
            rql.append(x)
        likeKeys = self.like_.keys()
        if likeKeys.hasNext():
            key = likeKeys
            while key.hasNext():
                key1 = key.next()
                x1 = (((("like(" + ("null" if key1 is None else key1)) + ",") + HxOverrides.stringOrNull(self.like_.h.get(key1,None))) + ")")
                rql.append(x1)
        ilikeKeys = self.ilike_.keys()
        if ilikeKeys.hasNext():
            key2 = ilikeKeys
            while key2.hasNext():
                key3 = key2.next()
                x2 = (((("ilike(" + ("null" if key3 is None else key3)) + ",") + HxOverrides.stringOrNull(self.ilike_.h.get(key3,None))) + ")")
                rql.append(x2)
        inKeys = self.in__.keys()
        if inKeys.hasNext():
            key4 = inKeys
            while key4.hasNext():
                key5 = key4.next()
                _this1 = self.in__.h.get(key5,None)
                x3 = (((("in(" + ("null" if key5 is None else key5)) + ",(") + HxOverrides.stringOrNull(",".join([python_Boot.toString1(x1,'') for x1 in _this1]))) + "))")
                rql.append(x3)
        outKeys = self.out_.keys()
        if outKeys.hasNext():
            key6 = outKeys
            while key6.hasNext():
                key7 = key6.next()
                _this2 = self.out_.h.get(key7,None)
                x4 = (((("out(" + ("null" if key7 is None else key7)) + ",(") + HxOverrides.stringOrNull(",".join([python_Boot.toString1(x1,'') for x1 in _this2]))) + "))")
                rql.append(x4)
        relOpsKeys = self.relOps.keys()
        if relOpsKeys.hasNext():
            relOp = relOpsKeys
            while relOp.hasNext():
                relOp1 = relOp.next()
                arguments = self.relOps.h.get(relOp1,None)
                _g = 0
                while (_g < len(arguments)):
                    argument = (arguments[_g] if _g >= 0 and _g < len(arguments) else None)
                    _g = (_g + 1)
                    x5 = (((((("" + ("null" if relOp1 is None else relOp1)) + "(") + HxOverrides.stringOrNull(argument.key)) + ",") + HxOverrides.stringOrNull(argument.value)) + ")")
                    rql.append(x5)
        if (self.ordering_ is not None):
            _this3 = self.ordering_
            x6 = (("ordering(" + HxOverrides.stringOrNull(",".join([python_Boot.toString1(x1,'') for x1 in _this3]))) + ")")
            rql.append(x6)
        if (self.limit_ is not None):
            x7 = ("limit=" + Std.string(self.limit_))
            rql.append(x7)
        if (self.orderBy_ is not None):
            x8 = ("order_by=" + HxOverrides.stringOrNull(self.orderBy_))
            rql.append(x8)
        if (self.offset_ is not None):
            x9 = ("offset=" + Std.string(self.offset_))
            rql.append(x9)
        if (len(rql) > 0):
    ...
    def toPlain(self):
        ...
        if ("eq" in self.relOps.h):
            ...
            while (_g < len(arguments)):
                ...
                rql.append(x)
        if (self.limit_ is not None):
            x1 = ("limit=" + Std.string(self.limit_))
            rql.append(x1)
        if (self.orderBy_ is not None):
            x2 = ("order_by=" + HxOverrides.stringOrNull(self.orderBy_))
            rql.append(x2)
        if (self.offset_ is not None):
            x3 = ("offset=" + Std.string(self.offset_))
            rql.append(x3)
        if (len(rql) > 0):
            return ("?" + HxOverrides.stringOrNull("&".join([python_Boot.toString1(x1,'') for x1 in rql])))
        else:
    ...
    def toObject(self):
        ...
        while (_g < _g1):
            i = _g
            _g = (_g + 1)
            field1 = (keys[i] if i >= 0 and i < len(keys) else None)
            value1 = Reflect.field(obj,(keys[i] if i >= 0 and i < len(keys) else None))
            setattr(out,(("_hx_" + field1) if ((field1 in python_Boot.keywords)) else (("_hx_" + field1) if (((((len(field1) > 2) and ((ord(field1[0]) == 95))) and ((ord(field1[1]) == 95))) and ((ord(field1[(len(field1) - 1)]) != 95)))) else field1)),value1)
        return out
    ...
    def addRelOp(self,op,property,value):
        if (not (op in self.relOps.h)):
            ...
            value1 = list()
            _this.h[op] = value1
        _this1 = self.relOps.h.get(op,None)
    ...
    def fromObject(obj):
        ...
        if (ilike is not None):
            fields1 = python_Boot.fields(ilike)
            def _hx_local_1(field1):
                _this1 = rql.ilike_
                value1 = Reflect.field(ilike,field1)
                _this1.h[field1] = value1
                return
            Lambda.iter(fields1,_hx_local_1)
        if (in_ is not None):
            fields2 = python_Boot.fields(in_)
            def _hx_local_2(field2):
                _this2 = rql.in__
                value2 = Reflect.field(in_,field2)
                _this2.h[field2] = value2
                return
            Lambda.iter(fields2,_hx_local_2)
        if (out is not None):
            fields3 = python_Boot.fields(out)
            def _hx_local_3(field3):
                _this3 = rql.out_
                value3 = Reflect.field(out,field3)
                _this3.h[field3] = value3
                return
            Lambda.iter(fields3,_hx_local_3)
        if (relOps is not None):
            fields4 = python_Boot.fields(relOps)
            def _hx_local_5(field4):
                array = Reflect.field(relOps,field4)
                _this4 = rql.relOps
                def _hx_local_4(kv):
                    return connect_api__Query_KeyValue(kv.key,kv.value)
                value4 = list(map(_hx_local_4,array))
                _this4.h[field4] = value4
            Lambda.iter(fields4,_hx_local_5)
    ...
    def stringMapToObject(_hx_map):
        ...
        def _hx_local_0(f):
            ...
            tmp = (("_hx_" + f) if ((f in python_Boot.keywords)) else (("_hx_" + f) if (((((len(f) > 2) and ((ord(f[0]) == 95))) and ((ord(f[1]) == 95))) and ((ord(f[(len(f) - 1)]) != 95)))) else f))
            setattr(obj,tmp,value)
            return
        Lambda.iter(fields,_hx_local_0)
        return obj
    ...
    def arrayToObject(arr):
        _g = []
        x = python_HaxeIterator(arr.__iter__())
        while x.hasNext():
            x1 = x.next()
...
class connect_api_impl_ApiClientImpl(connect_Base):
    ...
    def syncRequest(self,method,url,headers,body,fileArg,fileName,fileContent):
        response = connect_api_impl_ApiClientImpl.syncRequestPython(method,url,headers,body,fileArg,fileName,fileContent)
    ...
    @staticmethod
    def syncRequestPython(method,url,headers,body,fileArg,fileName,fileContent):
        try:
            return connect_native_PythonRequest.request(method,url,headers,body,fileArg,fileName,fileContent,300)
        except Exception as _hx_e:
            _hx_e1 = _hx_e.val if isinstance(_hx_e, _HxException) else _hx_e
            ex = _hx_e1
    ...
    def logRequest(level,method,url,headers,body,response):
        ...
        while handler.hasNext():
            ...
            if (headers is not None):
                requestList.push(("Headers:" + HxOverrides.stringOrNull(connect_api_impl_ApiClientImpl.getHeadersTable(headers,fmt))))
            if (body is not None):
            ...
            connect_Env.getLogger()._writeToHandler(level,fmt.formatBlock(level,(("" + ("null" if firstMessage is None else firstMessage)) + HxOverrides.stringOrNull(fmt.formatList(level,requestList)))),handler1)
    ...
    def getHeadersTable(headers,fmt):
        ...
        def _hx_local_0(key2):
            tmp = connect_util_Collection().push(key2).push(fixedHeaders.get(key2))
            headersCol.push(tmp)
...
class connect_api_impl_GeneralApiImpl(connect_Base):
    ...
    def getProductItems(self,id):
        return connect_api_ConnectHelper.get(connect_api_impl_GeneralApiImpl.PRODUCTS_PATH,id,"items")
...
class connect_logger_ILoggerFormatter:
    ...
    __slots__ = ()
    _hx_methods = ["formatSection", "formatBlock", "formatCodeBlock", "formatList", "formatTable", "formatLine"]
...
class connect_logger_Logger(connect_Base):
    ...
    _hx_statics = ["LEVEL_ERROR", "LEVEL_INFO", "LEVEL_DEBUG"]
    _hx_interfaces = []
    _hx_super = connect_Base
    ...
    def __init__(self,config):
        self.compact = None
        config = (config if ((config is not None)) else connect_logger_LoggerConfig())
        _this = config.path_
        ...
        b1 = connect_logger_Logger.LEVEL_DEBUG
    ...
    def setFilename(self,filename):
        ...
        def _hx_local_0(o,last):
            if last:
                return o.writer.setFilename(fullname)
            else:
                return False
    ...
    def getFilename(self):
        ...
        if (firstWriter is not None):
            ...
            if (filename is not None):
                _hx_str = self.path
                startIndex = None
                fixedFilename = (((filename.find(_hx_str) if ((startIndex is None)) else filename.find(_hx_str, startIndex))) == 0)
            else:
                fixedFilename = False
    ...
    def writeCodeBlock(self,level,code,language):
        ...
        while output.hasNext():
            output1 = output.next()
            self._writeToHandler(level,output1.formatter.formatCodeBlock(level,code,language),output1)
    ...
    def writeSections(self):
        ...
        while (_g < _g1):
            ...
            if (not (self.sections[i] if i >= 0 and i < len(self.sections) else None).written):
                ...
                while output.hasNext():
                    output1 = output.next()
                    section = output1.formatter.formatSection((i + 1),(self.sections[i] if i >= 0 and i < len(self.sections) else None).name)
...
class connect_logger_LoggerConfig(connect_Base):
    ...
    __slots__ = ("path_", "level_", "handlers_", "maskedFields_", "compact_", "regexMaskingList_", "levelTranslation")
    _hx_fields = ["path_", "level_", "handlers_", "maskedFields_", "compact_", "regexMaskingList_", "levelTranslation"]
    _hx_methods = ["path", "level", "levelName", "handlers", "maskedFields", "compact", "regexMasks"]
    _hx_statics = []
    _hx_interfaces = []
    _hx_super = connect_Base
    ...
    def __init__(self):
        ...
        _g.h["INFO"] = 2
        _g.h["DEBUG"] = 3
        self.levelTranslation = _g
        self.path_ = "logs"
        self.level_ = connect_logger_Logger.LEVEL_INFO
        self.handlers_ = connect_util_Collection().push(connect_logger_LoggerHandler(connect_logger_MarkdownLoggerFormatter(),connect_logger_FileLoggerWriter()))
    ...
    def levelName(self,level):
        self.level_ = connect_logger_Logger.LEVEL_INFO
        if (level in self.levelTranslation.h):
            self.level_ = self.levelTranslation.h.get(level,None)
        return self
    ...
    def regexMasks(self,expressions):
        ...
        while expression.hasNext():
            ...
            expression1 = (expression1 if (expression1.startswith("(")) else ("(" + ("null" if expression1 is None else expression1)))
            if expression1.endswith(")"):
...
class connect_logger_MarkdownLoggerFormatter(connect_Base):
    ...
    def formatSection(self,level,text):
        hashes = StringTools.rpad("","#",level)
    ...
    def formatBlock(self,level,text):
        lines = connect_logger_MarkdownLoggerFormatter.getLines(text)
        _g = []
        _g1 = 0
        while (_g1 < len(lines)):
    ...
    def formatList(self,level,lines):
        if (lines.length() > 0):
            _g = []
            line = lines.iterator()
            while line.hasNext():
            ...
            lines1 = _g
            return (("\n" + HxOverrides.stringOrNull("\n".join([python_Boot.toString1(x1,'') for x1 in lines1]))) + "\n")
        else:
            return "\n\n"
...
class connect_models_Model(connect_Base):
            ...
            if (field != "_footprint"):
                ...
                if ((field != "fieldClassNames") and ((value is not None))):
                    ...
                    if (tmp == 5):
                        ...
                        if (_g12 == str):
                        ...
                        elif (_g12 == connect_util_DateTime):
                            ...
                            className = Type.getClassName(class_)
                            startIndex = None
                            if (((className.find("connect.util.Collection") if ((startIndex is None)) else className.find("connect.util.Collection", startIndex))) == 0):
                                def _hx_local_2():
                                    _hx_local_1 = value
                                    if (Std._hx_is(_hx_local_1,connect_util_Collection) or ((_hx_local_1 is None))):
                                        _hx_local_1
                                    else:
                                        raise _HxException("Class cast error")
                                    return _hx_local_1
                                ...
                                while elem.hasNext():
                                    ...
                                    startIndex1 = None
                                    if (((elemClassName.find("connect.models.") if ((startIndex1 is None)) else elemClassName.find("connect.models.", startIndex1))) == 0):
                                        x = elem1.toObject()
                                        arr.append(x)
                                    else:
                                        arr.append(elem1)
                                ...
                                startIndex2 = None
                                if (((className.find("connect.models.") if ((startIndex2 is None)) else className.find("connect.models.", startIndex2))) == 0):
                                    def _hx_local_4():
                                        _hx_local_3 = value
                                        if (Std._hx_is(_hx_local_3,connect_models_Model) or ((_hx_local_3 is None))):
                                            _hx_local_3
                                        else:
                                            raise _HxException("Class cast error")
                                        return _hx_local_3
    ...
    def parse(modelClass,body):
        ...
        if Std._hx_is(obj,list):
            raise _HxException("Model.parse cannot parse a Json that contains an array.")
    ...
    def parseArray(modelClass,body):
        ...
        if (not Std._hx_is(array,list)):
            raise _HxException("Model.parseArray can only parse a Json that contains an array.")
    ...
    def _parse(modelClass,obj):
        ...
        def _hx_local_1():
            ...
            if (Std._hx_is(_hx_local_0,connect_models_Model) or ((_hx_local_0 is None))):
                _hx_local_0
            else:
                raise _HxException("Class cast error")
            return _hx_local_0
            ...
            if python_Boot.hasField(obj,snakeField):
                ...
                if (tmp == 4):
                    ...
                    if (classObj is not None):
                        ...
                        raise _HxException((("Cannot find class \"" + ("null" if className is None else className)) + "\""))
                elif (tmp == 6):
...
class connect_models_Action(connect_models_IdModel):
    ...
    __slots__ = ("title", "type", "description", "scope")
    _hx_fields = ["title", "type", "description", "scope"]
    _hx_methods = []
    _hx_statics = []
    _hx_interfaces = []
    _hx_super = connect_models_IdModel
...
class connect_models_Asset(connect_models_IdModel):
    ...
    _hx_methods = ["getRequests", "getNewItems", "getChangedItems", "getRemovedItems", "getParamById", "getItemById", "getItemByMpn", "getItemByGlobalId"]
    _hx_statics = ["list", "get"]
    _hx_interfaces = []
    _hx_super = connect_models_IdModel
...
class connect_models_Item(connect_models_IdModel):
    ...
    __slots__ = ("mpn", "quantity", "oldQuantity", "renewal", "params", "displayName", "globalId", "itemType", "period", "type", "name")
    _hx_fields = ["mpn", "quantity", "oldQuantity", "renewal", "params", "displayName", "globalId", "itemType", "period", "type", "name"]
    _hx_methods = ["getParamById"]
    _hx_statics = []
    _hx_interfaces = []
    _hx_super = connect_models_IdModel
...
class connect_models_Product(connect_models_IdModel):
    ...
    _hx_methods = ["listActions", "getAction", "getActionLink", "getConnections", "getItems", "getParameters", "getTemplates", "getVersions", "getVersion", "getVersionActions", "getVersionAction", "getVersionActionLink", "getVersionItems", "getVersionParameters", "getVersionTemplates", "listConfigurations", "setConfigurationParam", "listAgreements", "listMedia", "createMedia", "getMedia", "updateMedia", "deleteMedia"]
    _hx_statics = ["list", "get"]
    _hx_interfaces = []
    _hx_super = connect_models_IdModel
    ...
    def getItems(self):
        try:
            items = connect_Env.getGeneralApi().getProductItems(self.id)
...
class connect_models_TierConfig(connect_models_IdModel):
    ...
    __slots__ = ("name", "account", "product", "tierLevel", "params", "connection", "openRequest", "template", "contract", "marketplace", "configuration", "events", "status")
    _hx_fields = ["name", "account", "product", "tierLevel", "params", "connection", "openRequest", "template", "contract", "marketplace", "configuration", "events", "status"]
    _hx_methods = ["getParamById"]
    _hx_statics = ["list", "get"]
    _hx_interfaces = []
    _hx_super = connect_models_IdModel
...
class connect_models_UsageFile(connect_models_IdModel):
    ...
    def getTemplate(self):
        try:
            ...
            response = connect_Env.getApiClient().syncRequest("GET",link,None,None,None,None,None)
    ...
    def createSpreadsheet(records,fileId):
        ...
        while (_g < _g1):
            ...
            x = [("s:" + HxOverrides.stringOrNull(((record.recordId if ((record.recordId is not None)) else ((("" + ("null" if fileId is None else fileId)) + "_record_") + Std.string(i)))))), ("s:" + HxOverrides.stringOrNull(((record.recordNote if ((record.recordNote is not None)) else "")))), ("s:" + HxOverrides.stringOrNull(((record.itemSearchCriteria if ((record.itemSearchCriteria is not None)) else "")))), ("s:" + HxOverrides.stringOrNull(((record.itemSearchValue if ((record.itemSearchValue is not None)) else "")))), ("n:" + Std.string(record.amount)), ("n:" + Std.string(record.quantity)), ("s:" + HxOverrides.stringOrNull(((record.startTimeUtc.toString() if ((record.startTimeUtc is not None)) else "")))), ("s:" + HxOverrides.stringOrNull(((record.endTimeUtc.toString() if ((record.endTimeUtc is not None)) else "")))), ("s:" + HxOverrides.stringOrNull(((record.assetSearchCriteria if ((record.assetSearchCriteria is not None)) else "")))), ("s:" + HxOverrides.stringOrNull(((record.assetSearchValue if ((record.assetSearchValue is not None)) else "")))), ("s:" + HxOverrides.stringOrNull(((record.itemName if ((record.itemName is not None)) else "")))), ("s:" + HxOverrides.stringOrNull(((record.itemMpn if ((record.itemMpn is not None)) else "")))), ("s:" + HxOverrides.stringOrNull(((record.itemPrecision if ((record.itemPrecision is not None)) else "")))), ("s:" + HxOverrides.stringOrNull(((record.itemUnit if ((record.itemUnit is not None)) else "")))), ("s:" + HxOverrides.stringOrNull(((record.categoryId if ((record.categoryId is not None)) else "generic_category")))), ("s:" + HxOverrides.stringOrNull(((record.assetReconId if ((record.assetReconId is not None)) else "")))), ("n:" + Std.string(record.tier))]
            sheet.append(x)
    ...
    def getStrings(sheet):
        ...
        while (_g1 < len(sheet)):
            ...
            _g11 = 0
            while (_g11 < len(row)):
                col = (row[_g11] if _g11 >= 0 and _g11 < len(row) else None)
                _g11 = (_g11 + 1)
...
class connect_native_PythonRequest:
    ...
    @staticmethod
    def request(method,url,headers,body,fileArg,fileName,fileContent,timeout):
        import requests
        parsedHeaders = dict()
        if (headers is not None):
            key = headers.keys()
        ...
        resp = (requests.request(method, url, headers=parsedHeaders, data=body.encode() if body else None, timeout=timeout) if ((files is None)) else requests.request(method, url, headers=parsedHeaders, files=files, timeout=timeout))
...
class connect_storage_StepData:
    ...
    __slots__ = ("firstIndex", "data", "storage")
    _hx_fields = ["firstIndex", "data", "storage"]

    def __init__(self,firstIndex,data,storage):
        self.firstIndex = firstIndex
        self.data = connect_util_Dictionary()
        self.storage = storage
        if Std._hx_is(data,connect_util_Dictionary):
            def _hx_local_1():
                _hx_local_0 = data
                if (Std._hx_is(_hx_local_0,connect_util_Dictionary) or ((_hx_local_0 is None))):
                    _hx_local_0
                else:
                    raise _HxException("Class cast error")
                return _hx_local_0
            ...
            while key.hasNext():
                ...
                className = (Type.getClassName(Type.getClass(value)) if (Std._hx_is(value,connect_models_Model)) else "")
            ...
            while (_g < len(_g1)):
                ...
                parsedValue = (connect_models_Model.parse(fieldClass,haxe_format_JsonPrinter.print(value1,None,None)) if ((fieldClass is not None)) else value1)
...
class connect_storage_StepStorage:
    ...
    def load(requestId,param):
        ...
        if (stepData is not None):
            ...
            return connect_storage_StepData(0,_hx_AnonObject({}),connect_storage_StorageType.FailedStorage)
    ...
    def objWithRequestData(obj,requestId,stepData):
        ...
        value = _hx_AnonObject({'current_step': stepData.firstIndex, 'data': stepData.data.toObject()})
    ...
    def getRequestField(object,requestId,storage):
        if python_Boot.hasField(object,requestId):
            ...
            return connect_storage_StepData(stepData.current_step,stepData.data,storage)
        return None
...
class connect_util_Collection(connect_Base):
    ...
    def iterator(self):
        return python_HaxeIterator(self._array.__iter__())
...
class connect_util_DateTime:
    ...
    _hx_methods = ["getYear", "getMonth", "getDay", "getHours", "getMinutes", "getSeconds", "toString", "compare", "equals", "isBetweenDates"]
    ...
    def compare(self,other):
        ...
        try:
            ...
            e = _hx_e1
            tmp = None
        x1 = ((otherDate.date.timestamp() * 1000) / 1000)
        tmp1 = None
        try:
            tmp1 = int(x1)
        except Exception as _hx_e:
    ...
    def fromString(s):
        ...
        if (len(dateTimeSplit) > 1):
            _this1 = (dateTimeSplit[1] if 1 < len(dateTimeSplit) else None)
            timeSplit = _this1.split(":")
        else:
    ...
    def fromObject_r(x):
        ...
        if (tmp == 4):
            ...
            if (_g.params[0] == list):
                ...
                _g2 = 0
                while (_g2 < len(arr)):
                    elem = (arr[_g2] if _g2 >= 0 and _g2 < len(arr) else None)
                    _g2 = (_g2 + 1)
...
class connect_util_Diff:
    ...
    def __init__(self,first,second):
        ...
        _g2 = []
        _g3 = 0
        while (_g3 < len(firstFields)):
            f1 = (firstFields[_g3] if _g3 >= 0 and _g3 < len(firstFields) else None)
            _g3 = (_g3 + 1)
            if (not python_Boot.hasField(second,f1)):
                _g2.append(f1)
        deletedFields = _g2
        _g4 = []
        _g5 = 0
        while (_g5 < len(firstFields)):
            f2 = (firstFields[_g5] if _g5 >= 0 and _g5 < len(firstFields) else None)
            _g5 = (_g5 + 1)
            if python_Boot.hasField(second,f2):
                _g4.append(f2)
        commonFields = _g4
        def _hx_local_3(f3):
            return (not connect_util_Diff.areEqual(Reflect.field(first,f3),Reflect.field(second,f3)))
        changedFields = list(filter(_hx_local_3,commonFields))
        self.a = haxe_ds_StringMap()
        def _hx_local_4(f4):
            _this = _gthis.a
            value = Reflect.field(second,f4)
            _this.h[f4] = value
            return
    ...
    def apply(self,obj):
        ...
        addedKeys = _g
        def _hx_local_0(k2):
            value = _gthis.a.h.get(k2,None)
            tmp = (("_hx_" + k2) if ((k2 in python_Boot.keywords)) else (("_hx_" + k2) if (((((len(k2) > 2) and ((ord(k2[0]) == 95))) and ((ord(k2[1]) == 95))) and ((ord(k2[(len(k2) - 1)]) != 95)))) else k2))
            setattr(out,tmp,value)
            return
        ...
        deletedKeys = _g1
        def _hx_local_1(k5):
            return Reflect.deleteField(out,k5)
        ...
        changedKeys = _g2
        def _hx_local_2(k8):
            change = _gthis.c.h.get(k8,None)
            if Std._hx_is(change,list):
                if (Reflect.field(change,"length") == 2):
                    tmp1 = (("_hx_" + k8) if ((k8 in python_Boot.keywords)) else (("_hx_" + k8) if (((((len(k8) > 2) and ((ord(k8[0]) == 95))) and ((ord(k8[1]) == 95))) and ((ord(k8[(len(k8) - 1)]) != 95)))) else k8))
                    setattr(out,tmp1,HxOverrides.arrayGet(change, 1))
                else:
                    field = Reflect.field(out,k8)
                    original = (field if ((field is not None)) else [])
                    value1 = connect_util_Diff.applyArray(original,change)
                    tmp2 = (("_hx_" + k8) if ((k8 in python_Boot.keywords)) else (("_hx_" + k8) if (((((len(k8) > 2) and ((ord(k8[0]) == 95))) and ((ord(k8[1]) == 95))) and ((ord(k8[(len(k8) - 1)]) != 95)))) else k8))
                    setattr(out,tmp2,value1)
            else:
                field1 = Reflect.field(out,k8)
                original1 = (field1 if ((field1 is not None)) else _hx_AnonObject({}))
                value2 = Reflect.field(change,"apply")(original1)
                tmp3 = (("_hx_" + k8) if ((k8 in python_Boot.keywords)) else (("_hx_" + k8) if (((((len(k8) > 2) and ((ord(k8[0]) == 95))) and ((ord(k8[1]) == 95))) and ((ord(k8[(len(k8) - 1)]) != 95)))) else k8))
                setattr(out,tmp3,value2)
    ...
    def swap(self):
        ...
        changedKeys = _g
        def _hx_local_0(k2):
            change = _gthis.c.h.get(k2,None)
            if Std._hx_is(change,list):
                if (Reflect.field(change,"length") == 2):
                    changes.h[k2] = [HxOverrides.arrayGet(change, 1), HxOverrides.arrayGet(change, 0)]
                else:
                    value = connect_util_Diff.swapArray(change)
                    changes.h[k2] = value
            else:
                value1 = Reflect.field(change,"swap")()
                changes.h[k2] = value1
    ...
    def toObject(self):
        ...
        def _hx_local_0(key):
            ...
            if Std._hx_is(value,connect_util_Diff):
                o = obj.c
                ...
                o1 = obj.c
                value2 = connect_util_Diff.changeArrayToObject(value)
                setattr(o1,(("_hx_" + key) if ((key in python_Boot.keywords)) else (("_hx_" + key) if (((((len(key) > 2) and ((ord(key[0]) == 95))) and ((ord(key[1]) == 95))) and ((ord(key[(len(key) - 1)]) != 95)))) else key)),value2)
            else:
    ...
    def applyArray(obj,arr):
        ...
        def _hx_local_0(change):
            ...
            tmp = ((change[2] if 2 < len(change) else None) if ((len(change) == 3)) else (connect_util_Diff.applyArray(originalArray,(change[1] if 1 < len(change) else None)) if (Std._hx_is((change[1] if 1 < len(change) else None),list)) else Reflect.field((change[1] if 1 < len(change) else None),"apply")(originalObject)))
            python_internal_ArrayImpl._set(out, i, tmp)
    ...
    def swapArray(arr):
        ...
        def _hx_local_0(change):
            ...
            swappedChange = ([i, second, first] if ((len(change) == 3)) else ([i, connect_util_Diff.swapArray(first)] if (Std._hx_is(first,list)) else [i, Reflect.field(first,"swap")()]))
    ...
    def parse(obj):
        ...
        def _hx_local_1(f1):
            value1 = Reflect.field(Reflect.field(obj,"d"),f1)
            deletions.h[f1] = value1
            return
        Lambda.iter(python_Boot.fields(Reflect.field(obj,"d")),_hx_local_1)
        changes = haxe_ds_StringMap()
        def _hx_local_2(f2):
            change = Reflect.field(Reflect.field(obj,"c"),f2)
            if Std._hx_is(change,list):
                if (Reflect.field(change,"length") == 2):
                    changes.h[f2] = change
                else:
                    value2 = connect_util_Diff.parseArray(change)
                    changes.h[f2] = value2
            else:
                value3 = connect_util_Diff.parse(change)
                changes.h[f2] = value3
    ...
    def parseArray(arr):
        ...
        def _hx_local_0(el):
            ...
            elif Std._hx_is((el[1] if 1 < len(el) else None),list):
    ...
    def compareArrays(first,second):
        ...
        i = 0
        _g = []
        x = python_HaxeIterator(fixedFirst.__iter__())
        while x.hasNext():
            x1 = x.next()
            i1 = i
            i = (i + 1)
        ...
        _g1 = []
        _g11 = 0
        while (_g11 < len(changeList)):
            el = (changeList[_g11] if _g11 >= 0 and _g11 < len(changeList) else None)
            _g11 = (_g11 + 1)
            _g1.append(el)
        def _hx_local_1(el1):
            return (el1 is not None)
        changes = list(filter(_hx_local_1,_g1))
    ...
    def isSupported(v):
        cls = Type.getClass(v)
        isSimple = (((cls is None) or ((Type.getClassName(cls) is None))) or Std._hx_is(v,str))
    ...
    def checkStructs(first,second):
        if ((not connect_util_Util.isStruct(first)) or (not connect_util_Util.isStruct(second))):
            raise _HxException(("Unsupported types in Diff. Values must be structs. " + (((("Got: " + Std.string(Type.typeof(first))) + ", ") + Std.string(Type.typeof(second))))))
    ...
    def mapToObject(_hx_map):
        ...
        def _hx_local_0(key):
            ...
            tmp = (("_hx_" + key) if ((key in python_Boot.keywords)) else (("_hx_" + key) if (((((len(key) > 2) and ((ord(key[0]) == 95))) and ((ord(key[1]) == 95))) and ((ord(key[(len(key) - 1)]) != 95)))) else key))
            setattr(obj,tmp,value)
            return
    ...
    def changeArrayToObject(arr):
        _g = []
        x = python_HaxeIterator((arr[2] if 2 < len(arr) else None).__iter__())
        while x.hasNext():
            x1 = x.next()
            x2 = ([(x1[0] if 0 < len(x1) else None), Reflect.field((x1[1] if 1 < len(x1) else None),"toObject")()] if (Std._hx_is((x1[1] if 1 < len(x1) else None),connect_util_Diff)) else ([(x1[0] if 0 < len(x1) else None), connect_util_Diff.changeArrayToObject((x1[1] if 1 < len(x1) else None))] if (connect_util_Util.isArray((x1[1] if 1 < len(x1) else None))) else x1))
            _g.append(x2)
        changesList = _g
        _g1 = []
        _g11 = 0
        while (_g11 < len(changesList)):
            change = (changesList[_g11] if _g11 >= 0 and _g11 < len(changesList) else None)
            _g11 = (_g11 + 1)
            _g1.append(change)
        changes = _g1
...
class connect_util_Util:
    ...
    __slots__ = ()
    _hx_statics = ["replaceStrSensitiveData", "beautify", "beautifyObject", "maskFields", "isJson", "isJsonObject", "isJsonArray", "isArray", "isStruct", "createObjectDiff", "addIdsToObject", "compactArray"]
            ...
            if (Type.typeof(obj) == ValueType.TObject):
                ...
                def _hx_local_0(el):
                    if python_Boot.hasField(el,"id"):
                        ...
                        _this1 = python_Boot.fields(el)
                        return (("{ " + HxOverrides.stringOrNull(", ".join([python_Boot.toString1(x1,'') for x1 in _this1]))) + " }")
                    else:
    ...
    def maskFields(obj):
        ...
        if (Type.typeof(obj) == ValueType.TObject):
            ...
            while (_g < len(_g1)):
                ...
                elif (((Type.typeof(obj) == ValueType.TObject) or Std._hx_is(obj,connect_util_Collection)) or Std._hx_is(obj,list)):
    ...
    def addIdsToObject(object,original):
        ...
        if ((not python_Boot.hasField(object,id)) and python_Boot.hasField(original,id)):
            ...
            tmp = (("_hx_" + id) if ((id in python_Boot.keywords)) else (("_hx_" + id) if (((((len(id) > 2) and ((ord(id[0]) == 95))) and ((ord(id[1]) == 95))) and ((ord(id[(len(id) - 1)]) != 95)))) else id))
            setattr(out,tmp,value)
        def _hx_local_4(field):
            value1 = Reflect.field(object,field)
            if python_Boot.hasField(original,field):
                originalValue = Reflect.field(original,field)
                if (connect_util_Util.isStruct(value1) and connect_util_Util.isStruct(originalValue)):
                    value2 = connect_util_Util.addIdsToObject(value1,originalValue)
                    tmp1 = (("_hx_" + field) if ((field in python_Boot.keywords)) else (("_hx_" + field) if (((((len(field) > 2) and ((ord(field[0]) == 95))) and ((ord(field[1]) == 95))) and ((ord(field[(len(field) - 1)]) != 95)))) else field))
                    setattr(out,tmp1,value2)
                elif (connect_util_Util.isArray(value1) and connect_util_Util.isArray(originalValue)):
                    def _hx_local_1():
                        _hx_local_0 = value1
                        if (Std._hx_is(_hx_local_0,list) or ((_hx_local_0 is None))):
                            _hx_local_0
                        else:
                            raise _HxException("Class cast error")
                        return _hx_local_0
                    ...
                    def _hx_local_3():
                        ...
                        if (Std._hx_is(_hx_local_2,list) or ((_hx_local_2 is None))):
                            _hx_local_2
                        else:
                            raise _HxException("Class cast error")
                        return _hx_local_2
                    originalValueArr = _hx_local_3()
                    value3 = connect_util_Util.compactArray(valueArr,originalValueArr)
                    tmp2 = (("_hx_" + field) if ((field in python_Boot.keywords)) else (("_hx_" + field) if (((((len(field) > 2) and ((ord(field[0]) == 95))) and ((ord(field[1]) == 95))) and ((ord(field[(len(field) - 1)]) != 95)))) else field))
                    setattr(out,tmp2,value3)
                else:
                    tmp3 = (("_hx_" + field) if ((field in python_Boot.keywords)) else (("_hx_" + field) if (((((len(field) > 2) and ((ord(field[0]) == 95))) and ((ord(field[1]) == 95))) and ((ord(field[(len(field) - 1)]) != 95)))) else field))
                    setattr(out,tmp3,value1)
            else:
                tmp4 = (("_hx_" + field) if ((field in python_Boot.keywords)) else (("_hx_" + field) if (((((len(field) > 2) and ((ord(field[0]) == 95))) and ((ord(field[1]) == 95))) and ((ord(field[(len(field) - 1)]) != 95)))) else field))
                setattr(out,tmp4,value1)
...
class haxe__Int64_Int64_Impl_:
    ...
    __slots__ = ()
    _hx_statics = ["_new", "copy", "make", "ofInt", "toInt", "is", "getHigh", "getLow", "isNeg", "isZero", "compare", "ucompare", "toStr", "toString", "parseString", "fromFloat", "divMod", "neg", "preIncrement", "postIncrement", "preDecrement", "postDecrement", "add", "addInt", "sub", "subInt", "intSub", "mul", "mulInt", "div", "divInt", "intDiv", "mod", "modInt", "intMod", "eq", "eqInt", "neq", "neqInt", "lt", "ltInt", "intLt", "lte", "lteInt", "intLte", "gt", "gtInt", "intGt", "gte", "gteInt", "intGte", "complement", "and", "or", "xor", "shl", "shr", "ushr", "get_high", "set_high", "get_low", "set_low"]
    high = None
    low = None
    ...
    def compare(a,b):
        ...
        v = (v if ((v != 0)) else haxe__Int32_Int32_Impl_.ucompare(a.low,b.low))
        if (a.high < 0):
            if (b.high < 0):
                return v
            else:
    ...
    def toString(this1):
        ...
        if (i.high < 0):
            neg = True
        this2 = haxe__Int64____Int64(0,10)
        ten = this2
        while True:
            b_high1 = 0
            b_low1 = 0
            if (not (((i.high != b_high1) or (i.low != b_low1)))):
                break
            ...
            if (r.modulus.high < 0):
                ...
                this3 = haxe__Int64____Int64(high1,low1)
                i = this3
            else:
    ...
    def divMod(dividend,divisor):
        ...
        if (dividend.high < 0):
            ...
            modulus = this4
        if (divisor.high < 0):
            high1 = ((~divisor.high + (2 ** 31)) % (2 ** 32) - (2 ** 31))
            low1 = (((~divisor.low + 1) + (2 ** 31)) % (2 ** 32) - (2 ** 31))
            if (low1 == 0):
                ret1 = high1
                high1 = (high1 + 1)
                high1 = ((high1 + (2 ** 31)) % (2 ** 32) - (2 ** 31))
        ...
        while (not ((divisor.high < 0))):
            ...
            if (b == 0):
                ...
                this9 = haxe__Int64____Int64(((((((((divisor.high << b)) + (2 ** 31)) % (2 ** 32) - (2 ** 31)) | HxOverrides.rshift(divisor.low, ((32 - b))))) + (2 ** 31)) % (2 ** 32) - (2 ** 31)),((((divisor.low << b)) + (2 ** 31)) % (2 ** 32) - (2 ** 31)))
                divisor = this9
            else:
            ...
            if (b1 == 0):
                ...
                this12 = haxe__Int64____Int64(((((((((mask.high << b1)) + (2 ** 31)) % (2 ** 32) - (2 ** 31)) | HxOverrides.rshift(mask.low, ((32 - b1))))) + (2 ** 31)) % (2 ** 32) - (2 ** 31)),((((mask.low << b1)) + (2 ** 31)) % (2 ** 32) - (2 ** 31)))
                mask = this12
            else:
        ...
        while True:
            ...
            if (((v1 if ((v1 != 0)) else haxe__Int32_Int32_Impl_.ucompare(modulus.low,divisor.low))) >= 0):
                this14 = haxe__Int64____Int64(((((quotient.high | mask.high)) + (2 ** 31)) % (2 ** 32) - (2 ** 31)),((((quotient.low | mask.low)) + (2 ** 31)) % (2 ** 32) - (2 ** 31)))
                quotient = this14
                ...
                this15 = haxe__Int64____Int64(high2,low2)
                modulus = this15
            b2 = 1
            b2 = (b2 & 63)
            if (b2 == 0):
                this16 = haxe__Int64____Int64(mask.high,mask.low)
                mask = this16
            elif (b2 < 32):
                this17 = haxe__Int64____Int64(HxOverrides.rshift(mask.high, b2),((((((((mask.high << (32 - b2))) + (2 ** 31)) % (2 ** 32) - (2 ** 31)) | HxOverrides.rshift(mask.low, b2))) + (2 ** 31)) % (2 ** 32) - (2 ** 31)))
                mask = this17
            else:
                this18 = haxe__Int64____Int64(0,HxOverrides.rshift(mask.high, ((b2 - 32))))
                mask = this18
            b3 = 1
            b3 = (b3 & 63)
            if (b3 == 0):
                this19 = haxe__Int64____Int64(divisor.high,divisor.low)
                divisor = this19
            elif (b3 < 32):
                this20 = haxe__Int64____Int64(HxOverrides.rshift(divisor.high, b3),((((((((divisor.high << (32 - b3))) + (2 ** 31)) % (2 ** 32) - (2 ** 31)) | HxOverrides.rshift(divisor.low, b3))) + (2 ** 31)) % (2 ** 32) - (2 ** 31)))
                divisor = this20
            else:
                this21 = haxe__Int64____Int64(0,HxOverrides.rshift(divisor.high, ((b3 - 32))))
                divisor = this21
        if divSign:
            high3 = ((~quotient.high + (2 ** 31)) % (2 ** 32) - (2 ** 31))
            low3 = (((~quotient.low + 1) + (2 ** 31)) % (2 ** 32) - (2 ** 31))
            if (low3 == 0):
                ret3 = high3
                high3 = (high3 + 1)
                high3 = ((high3 + (2 ** 31)) % (2 ** 32) - (2 ** 31))
            this22 = haxe__Int64____Int64(high3,low3)
            quotient = this22
        if (dividend.high < 0):
            high4 = ((~modulus.high + (2 ** 31)) % (2 ** 32) - (2 ** 31))
            low4 = (((~modulus.low + 1) + (2 ** 31)) % (2 ** 32) - (2 ** 31))
            if (low4 == 0):
                ret4 = high4
                high4 = (high4 + 1)
                high4 = ((high4 + (2 ** 31)) % (2 ** 32) - (2 ** 31))
            this23 = haxe__Int64____Int64(high4,low4)
            modulus = this23
    ...
    def intDiv(a,b):
        ...
        if (x.high != ((((x.low >> 31)) + (2 ** 31)) % (2 ** 32) - (2 ** 31))):
            raise _HxException("Overflow")
        x1 = x.low
        this2 = haxe__Int64____Int64((x1 >> 31),x1)
        return this2
    ...
    def ltInt(a,b):
        ...
        v = (v if ((v != 0)) else haxe__Int32_Int32_Impl_.ucompare(a.low,b_low))
    ...
    def intLt(a,b):
        ...
        v = (v if ((v != 0)) else haxe__Int32_Int32_Impl_.ucompare(a_low,b.low))
    ...
    def shl(a,b):
        ...
        if (b == 0):
            ...
            this2 = haxe__Int64____Int64(((((((((a.high << b)) + (2 ** 31)) % (2 ** 32) - (2 ** 31)) | HxOverrides.rshift(a.low, ((32 - b))))) + (2 ** 31)) % (2 ** 32) - (2 ** 31)),((((a.low << b)) + (2 ** 31)) % (2 ** 32) - (2 ** 31)))
            return this2
        else:
            this3 = haxe__Int64____Int64(((((a.low << (b - 32))) + (2 ** 31)) % (2 ** 32) - (2 ** 31)),0)
            return this3
    ...
    def shr(a,b):
        ...
        if (b == 0):
            ...
            this2 = haxe__Int64____Int64(((((a.high >> b)) + (2 ** 31)) % (2 ** 32) - (2 ** 31)),((((((((a.high << (32 - b))) + (2 ** 31)) % (2 ** 32) - (2 ** 31)) | HxOverrides.rshift(a.low, b))) + (2 ** 31)) % (2 ** 32) - (2 ** 31)))
            return this2
        else:
            this3 = haxe__Int64____Int64(((((a.high >> 31)) + (2 ** 31)) % (2 ** 32) - (2 ** 31)),((((a.high >> (b - 32))) + (2 ** 31)) % (2 ** 32) - (2 ** 31)))
            return this3
    ...
    def ushr(a,b):
        ...
        if (b == 0):
            ...
            this2 = haxe__Int64____Int64(HxOverrides.rshift(a.high, b),((((((((a.high << (32 - b))) + (2 ** 31)) % (2 ** 32) - (2 ** 31)) | HxOverrides.rshift(a.low, b))) + (2 ** 31)) % (2 ** 32) - (2 ** 31)))
            return this2
        else:
            this3 = haxe__Int64____Int64(0,HxOverrides.rshift(a.high, ((b - 32))))
            return this3
    ...
    def parseString(sParam):
        ...
        while (_g < _g1):
            ...
            if ((digitInt < 0) or ((digitInt > 9))):
                raise _HxException("NumberFormatError")
            if (digitInt != 0):
                ...
                if sIsNegative:
                    ...
                    if (not ((current.high < 0))):
                        raise _HxException("NumberFormatError: Underflow")
                else:
                    mask1 = 65535
                    ...
                    if (haxe__Int32_Int32_Impl_.ucompare(low3,current.low) < 0):
                        ...
                        high3 = (high3 + 1)
                        high3 = ((high3 + (2 ** 31)) % (2 ** 32) - (2 ** 31))
                    this4 = haxe__Int64____Int64(high3,low3)
                    current = this4
                    if (current.high < 0):
                        raise _HxException("NumberFormatError: Overflow")
            mask2 = 65535
            ...
            this5 = haxe__Int64____Int64(high4,low4)
            multiplier = this5
        return current
    ...
    def fromFloat(f):
        ...
        while (rest >= 1):
            ...
            if (curr >= 1):
                ...
                b1 = None
                if (b == 0):
                    this2 = haxe__Int64____Int64(a_high,a_low)
                    b1 = this2
                elif (b < 32):
                    this3 = haxe__Int64____Int64(((((((((a_high << b)) + (2 ** 31)) % (2 ** 32) - (2 ** 31)) | HxOverrides.rshift(a_low, ((32 - b))))) + (2 ** 31)) % (2 ** 32) - (2 ** 31)),((((a_low << b)) + (2 ** 31)) % (2 ** 32) - (2 ** 31)))
                    b1 = this3
                else:
                    this4 = haxe__Int64____Int64(((((a_low << (b - 32))) + (2 ** 31)) % (2 ** 32) - (2 ** 31)),0)
                    b1 = this4
            ...
            i = (i + 1)
        if neg:
            high1 = ((~result.high + (2 ** 31)) % (2 ** 32) - (2 ** 31))
            low1 = (((~result.low + 1) + (2 ** 31)) % (2 ** 32) - (2 ** 31))
            if (low1 == 0):
                ret1 = high1
                high1 = (high1 + 1)
                high1 = ((high1 + (2 ** 31)) % (2 ** 32) - (2 ** 31))
...
class haxe_io_Bytes:
    ...
    def ofHex(s):
        _hx_len = len(s)
        if (((_hx_len & 1)) != 0):
            raise _HxException("Not a hex string (odd number of digits)")
...
class haxe_ds_BalancedTree:
    ...
    __slots__ = ("root",)
    _hx_fields = ["root"]
    _hx_methods = ["set", "get", "remove", "exists", "iterator", "keyValueIterator", "keys", "copy", "setLoop", "removeLoop", "iteratorLoop", "keysLoop", "merge", "minBinding", "removeMinBinding", "balance", "compare", "toString", "clear"]
    _hx_interfaces = [haxe_IMap]
...
class haxe_ds__HashMap_HashMap_Impl_:
    ...
    __slots__ = ()
    _hx_statics = ["_new", "set", "get", "exists", "remove", "keys", "copy", "iterator", "clear"]
...
class haxe_io_Path:
    ...
    def unescape(path):
        ...
        def _hx_local_1():
            def _hx_local_0(regex1):
                code = Std.parseInt(regex1.matchObj.group(1))
...
class haxe_zip_Writer:
    ...
    def writeEntryHeader(self,f):
        ...
        if (f.data is None):
            ...
            if (f.crc32 is None):
                if f.compressed:
                    raise _HxException("CRC32 must be processed before compression")
        ...
        e1 = haxe_io_BytesOutput()
        if (Reflect.field(f,"extraFields") is not None):
            _g_head1 = Reflect.field(f,"extraFields").h
            while (_g_head1 is not None):
                ...
                if (tmp == 0):
                    ...
                    tag = f1.params[0]
                    e1.writeUInt16(tag)
                    e1.writeUInt16(_hx_bytes.length)
                    e1.write(_hx_bytes)
                elif (tmp == 1):
                    crc = f1.params[1]
                    name = f1.params[0]
...
class python_internal_ArrayImpl:
    ...
    __slots__ = ()
    _hx_statics = ["get_length", "concat", "copy", "iterator", "indexOf", "lastIndexOf", "join", "toString", "pop", "push", "unshift", "remove", "shift", "slice", "sort", "splice", "map", "filter", "insert", "reverse", "_get", "_set", "unsafeGet", "unsafeSet", "resize"]
...
class HxOverrides:
    ...
    __slots__ = ()
    _hx_statics = ["iterator", "eq", "stringOrNull", "shift", "pop", "push", "join", "filter", "map", "toUpperCase", "toLowerCase", "split", "length", "rshift", "modf", "mod", "arrayGet", "arraySet", "mapKwArgs", "reverseMapKwArgs"]
...
connect_Flow.ATTEMPT_PARAM = "attempt"
